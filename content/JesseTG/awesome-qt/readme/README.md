...
[🏠 Home](/README.md) · [🔥 Feed](https://test.trackawesomelist.com/JesseTG/awesome-qt/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 JesseTG/awesome-qt](https://github.com/JesseTG/awesome-qt/blob/master/README.md) · ⭐ 1.1K · 🏷️ Platforms

[ [Daily](/content/JesseTG/awesome-qt/README.md) / [Weekly](/content/JesseTG/awesome-qt/week/README.md) / Overview ]
...
*   [neiasound](https://github.com/lucaspcamargo/neiasound) [:octocat:](https://github.com/lucaspcamargo/neiasound) - OpenAL wrapper designed for games, with [stb\_vorbis](https://nothings.org/stb_vorbis) and [libsndfile](http://www.mega-nerd.com/libsndfile) support.
...
To the extent possible under law, [Jesse Talavera-Greenberg](https://jessetg.github.io) has waived all copyright and related or neighboring rights to this work.  See the [LICENSE](https://github.com/JesseTG/awesome-qt/blob/master/README.md/LICENSE) file for details.
