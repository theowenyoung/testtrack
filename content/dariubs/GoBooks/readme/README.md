...
[🏠 Home](/README.md) · [🔥 Feed](https://test.trackawesomelist.com/dariubs/GoBooks/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 dariubs/GoBooks](https://github.com/dariubs/GoBooks/blob/master/README.md) · ⭐ 13K · 🏷️ Books
...
A book filled with examples on how to use Docker and Go to create the ultimate 12 Factor applications. It goes over individual steps of [The Twelve-Factor App](https://github.com/dariubs/GoBooks/blob/master/README.md/12factor.net) guidelines and how to implement them with Go and Docker.
