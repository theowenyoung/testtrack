...
*   String
    *   [string\_pattern](https://github.com/MarioRuiz/string_pattern) - Generate strings supplying a simple pattern.
...
*   Extra
    ...
    *   [cuke\_modeler](https://github.com/enkessler/cuke_modeler) - An modeling library for `.feature` files that is an abstration layer on top of the `gherkin` gem, providing a stable base upon which to build other Gherkin related tools.
    ...
    *   [power\_assert](https://github.com/k-tsj/power_assert) - Power Assert for Ruby.
...
*   [fb\_graph2](https://github.com/nov/fb_graph2) - A full-stack Facebook Graph API wrapper.
...
*   [itunes\_store\_transporter](https://github.com/sshaw/itunes_store_transporter) - Ruby wrapper around Apple's iTMSTransporter program.
...
*   [active\_link\_to](https://github.com/comfy/active_link_to) - View helper to manage "active" state of a link.
*   [auto\_html](https://github.com/dejan/auto_html) - Rails extension for transforming URLs to appropriate resource (image, link, YouTube, Vimeo video...).
...
*   [render\_async](https://github.com/renderedtext/render_async) - Render partials to your views asynchronously and increase load performance of your pages.
