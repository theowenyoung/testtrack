# Track Awesome Flame Updates Weekly

An awesome list that curates the best Flame games, projects, libraries, tools, tutorials, articles and more.

[🏠 Home](/README.md) · [🔍 Search](https://test.trackawesomelist.com/search/) · [🔥 Feed](https://test.trackawesomelist.com/flame-engine/awesome-flame/week/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 flame-engine/awesome-flame](https://github.com/flame-engine/awesome-flame/blob/main/README.md) · ⭐ 607 · 🏷️ Gaming
...
*   [Dino Run (⭐94)](https://github.com/ufrshubham/dino_run) - A 2D infinite side scroller mobile game made in Flutter using Flame engine. Get it on [Play Store](https://play.google.com/store/apps/details?id=com.nobs.dino_run). By [DevKage](https://www.youtube.com/devkage "DevKage").
...
*   [Flutters (⭐178)](https://github.com/ecklf/flutters) - A mixture of Flappy Bird and Doodle Jump. By [ecklf](https://github.com/ecklf)
