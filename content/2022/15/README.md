...
*   ### JavaScript
    ...
    *   #### JavaScript: Game Engine w/Editor
        ...
        *   🎉 [GDevelop](https://gdevelop.io/) [:octocat: (⭐4.3k)](https://github.com/4ian/GDevelop) - Full-featured, open source 2D game development software platform.
    ...
    *   #### JavaScript: Graphics - 2D
        ...
        *   🎉 [Two.js](https://two.js.org/) [:octocat: (⭐7.8k)](https://github.com/jonobr1/two.js) - Renderer agnostic 2D drawing api for the web.
    ...
    *   #### JavaScript: Gui
        ...
        *   🎉 [Magic Circle](https://magic-circle.dev/) [:octocat: (⭐25)](https://github.com/dpwoert/magic-circle) - Multi-functional gui inspired by dat.GUI, Unity and Framer.
    ...
    *   #### JavaScript: Utility
        ...
        *   🎉 [Struct Vec (⭐19)](https://github.com/moomoolive/struct-vec) - JavaScript array-like containers for multithreading.
    *   #### JavaScript: Timeline
...
*   ### Rust
    ...
    *   #### Rust: Game Framework
        ...
        *   🎉 [Bevy](https://bevyengine.org) [:octocat: (⭐19k)](https://github.com/bevyengine/bevy) - 🔥 Refreshingly simple data-driven 2D / 3D game engine built in Rust.
...
*   ### Geometry
    ...
    *   #### CSG (Constructive Solid Geometry)
        ...
        *   🎉 [csg.js](https://evanw.github.io/csg.js/) [:octocat: (⭐1.6k)](https://github.com/evanw/csg.js/) - Javacsript library implementing CSG (Constructive Solid Geometry).
    *   #### Meshes
        *   📚 [Mesh Transforms](https://ciechanow.ski/mesh-transforms/) [:octocat: (⭐3)](https://github.com/olegtyshcneko/CAMeshTransform) - Apples private API that allows manipulation of the mesh of any UIView.
    *   #### Smoothing
...
*   ### Physics
    ...
    *   #### Ropes / Chains
        ...
        *   🌎 [Matter.js: Chains](https://brm.io/matter-js/demo/#chains) [:octocat: (⭐14k)](https://github.com/liabru/matter-js/blob/master/examples/chains.js) - Chains demo using the JavaScript library Matter.js.
    *   #### Soft Body
        ...
        *   🌎 [Oryol: Bullet Cloth](https://floooh.github.io/oryol-samples/wasm/BulletPhysicsCloth.html) [:octocat: (⭐77)](https://github.com/floooh/oryol-samples/blob/master/src/BulletPhysicsCloth/BulletPhysicsCloth.cc) - Bullet Physics 3D cloth using the Oryol game framework.
        *   🌎 [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) [:octocat: (⭐86k)](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html) - Demo of 3D soft body volumes using Ammo.js and Three.js.
    *   #### Verlet Physics
...
*   ### Scripting
    ...
    *   📚 [List of Embedded Scripting Languages (⭐970)](https://github.com/dbohdan/embedded-scripting-languages) - Scripting languages to use in your app / game.
    *   📚 [Scriptorium (⭐475)](https://github.com/r-lyeh-archived/scriptorium) - Game scripting languages benchmarked.
...
*   ### Audio Tools
    *   #### Music
        *   🆓 [Ardour](https://ardour.org) [:octocat: (⭐2.7k)](https://github.com/Ardour/ardour) - Free, open source, very capable. Record, edit, and mix.
        *   🆓 [Audacity](https://www.audacityteam.org) [:octocat: (⭐8.3k)](https://github.com/audacity/audacity) - Cross-platform, multi-track audio editor and recorder.
        ...
        *   🆓 [LMMS](https://lmms.io) [:octocat: (⭐6.2k)](https://github.com/lmms/lmms) - 🔥 Free, cross-platform music production software.
        *   🆓 [PixiTracker](https://warmplace.ru/soft/pixitracker/) - Quickly create musical sketches, chiptunes and sound experiments.
        *   🆓 [Sound Box](https://sb.bitsnbites.eu) [:octocat: (⭐399)](https://github.com/mbitsnbites/soundbox) - Compose synthetic music in your browser. Great for small JavaScript demos.
        ...
        *   🆓 [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) [:octocat: (⭐355)](https://github.com/keithclark/ZzFXM) - Music generator for use in tiny JavaScript productions.
    *   #### Sound Effects
        *   🆓 [Bfxr](https://www.bfxr.net) [:octocat: (⭐868)](https://github.com/increpare/bfxr) - Program of choice for many people looking to make sound effects for games.
        ...
        *   🆓 [ZzFX](https://killedbyapixel.github.io/ZzFX/) [:octocat: (⭐424)](https://github.com/KilledByAPixel/ZzFX) - Tiny JavaScript Sound FX System / Zuper Zmall Zound Zynth.
*   ### Color / Palettes
...
*   ### Image Editors
    *   🆓 [GIMP](https://www.gimp.org) [:octocat: (⭐3.6k)](https://github.com/GNOME/gimp) - GNU Image Manipulation Program, free and open-source cross-platform image editor.
    *   🆓 [Photopea](https://www.photopea.com) - Very capable online photo editor.
*   ### Materials / Textures
    *   🆓 [ArmorLab](https://armorlab.org) [:octocat: (⭐125)](https://github.com/armory3d/armorlab) - Generate PBR materials by drag & dropping your photos.
    ...
    *   🆓 [Material Maker](https://www.materialmaker.org) [:octocat: (⭐2.1k)](https://github.com/RodZill4/material-maker) - Procedural PBR ([Physically Based Rendering](https://en.wikipedia.org/wiki/Physically_based_rendering)) materials authoring tool.
    *   🆓 [Materialize](http://boundingboxsoftware.com/materialize/) [:octocat: (⭐1.1k)](https://github.com/BoundingBoxSoftware/Materialize) - Stand alone tool for creating materials from images to be used in games.
    ...
    *   🆓 [Texgen.js](https://texgenjs.org) [:octocat: (⭐1.7k)](https://github.com/mrdoob/texgen.js) - JavaScript texture generator tool.
...
*   ### Modeling Tools
    ...
    *   🆓 [ArmorPaint](https://armorpaint.org) [:octocat: (⭐2.4k)](https://github.com/armory3d/armorpaint) - Physically-based texture painting, drop in your 3D models and start painting.
    *   💰 [Asset Forge](https://assetforge.io) - Allows anyone to create 3D models and 2D sprites using building blocks.
    *   🆓 [Blender](https://www.blender.org) [:octocat: (⭐6.9k)](https://github.com/blender/blender) - 🔥 Free and open source, supports the entirety of the 3D pipeline.
    *   🆓 [Meshroom](https://alicevision.org/#meshroom) [:octocat: (⭐8.5k)](https://github.com/alicevision/meshroom) - Free, open-source 3D reconstruction software based on the AliceVision framework.
...
*   ### Pixel Art
    *   💸 [Aseprite](https://www.aseprite.org) [:octocat: (⭐19k)](https://github.com/aseprite/aseprite) - Animated sprite editor and pixel art tool.
    ...
    *   🆓 [Piskel](https://www.piskelapp.com) [:octocat: (⭐9.1k)](https://github.com/piskelapp/piskel) - Free online editor for animated sprites & pixel art.
...
*   ### Vector Editors
    ...
    *   🆓 [Krita](https://krita.org/en/) [:octocat: (⭐4.3k)](https://github.com/KDE/krita) - Professional free and open source painting program.
...
## [20. Alternative Front Ends](/content/mendel5/alternative-front-ends/week/README.md)
...
## [28. Awesome Video](/content/krzemienski/awesome-video/week/README.md)
...
*   [chrome-extension-boilerplate-react-vite (⭐203)](https://github.com/Jonghakseo/chrome-extension-boilerplate-react-vite) - React + TypeScript + SASS + Prettier + ESLint + GitHub Actions + Chrome Extension Manifest v3.
...
- Prev: [Apr 18 - Apr 24, 2022](/content/2022/16/README.md)
- Next: [Apr 04 - Apr 10, 2022](/content/2022/14/README.md)