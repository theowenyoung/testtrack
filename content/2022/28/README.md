...
## [3. Awesome Fastapi](/content/mjhea0/awesome-fastapi/week/README.md)
...
*   [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles (⭐4.3k)](https://github.com/matteobruni/tsparticles) particles animations samples
...
## [17. Awesome Qr Code](/content/make-github-pseudonymous-again/awesome-qr-code/week/README.md)
...
## [20. Awesome Executable Packing](/content/packing-box/awesome-executable-packing/week/README.md)
...
## [27. Awesome WebExtensions](/content/fregante/Awesome-WebExtensions/week/README.md)
...
*   [dockprom (⭐5.1k)](https://github.com/stefanprodan/dockprom) - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager by [@stefanprodan](https://github.com/stefanprodan)
...
*   [Træfɪk (⭐40k)](https://github.com/containous/traefik) - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd... By [@EmileVauge](https://github.com/emilevauge)
...
*   [Derrick (⭐650)](https://github.com/alibaba/derrick) - A tool help you to automate the generation of Dockerfile and dockerize application by scanning the code. By [@alibaba](https://github.com/alibaba).
...
*   [Drone (⭐26k)](https://github.com/drone/drone) - Continuous integration server built on Docker and configured using YAML files.
...
*   [Docker-sync (⭐3.4k)](https://github.com/EugenMayer/docker-sync) - Drastically improves performance ([50-70x (⭐3.4k)](https://github.com/EugenMayer/docker-sync/wiki/4.-Performance)) when using Docker for development on Mac OS X/Windows and Linux while sharing code to the container. By [@EugenMayer](https://github.com/EugenMayer)
...
*   [AMP (⭐78)](https://github.com/appcelerator-archive/amp) :skull: - The open source unified CaaS/FaaS platform for Docker, batteries included. By [@Appcelerator](https://github.com/appcelerator-archive)
...
*   [subuser (⭐873)](https://github.com/subuser-security/subuser) - Makes it easy to securely and portably run graphical desktop applications in Docker
...
*   [Cloud Native Landscape (⭐8.5k)](https://github.com/cncf/landscape)
...
*   [Awesome CI/CD (⭐1.5k)](https://github.com/cicdops/awesome-ciandcd) - Not specific to docker but relevant.
*   [Awesome Compose (⭐19k)](https://github.com/docker/awesome-compose) - Docker Compose samples
*   [Awesome Kubernetes (⭐13k)](https://github.com/ramitsurana/awesome-kubernetes) by [@ramitsurana](https://github.com/ramitsurana)
*   [Awesome Linux Container (⭐1.4k)](https://github.com/Friz-zy/awesome-linux-containers) more general about container than this repo, by [@Friz-zy](https://github.com/Friz-zy).
*   [Awesome Selfhosted (⭐106k)](https://github.com/awesome-selfhosted/awesome-selfhosted) list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container. By [@Kickball](https://github.com/Kickball)
*   [Awesome Sysadmin (⭐15k)](https://github.com/n1trux/awesome-sysadmin) by [@n1trux](https://github.com/n1trux)
...
*   [Local Docker DB (⭐242)](https://github.com/alexmacarthur/local-docker-db) a list of docker-compose samples for a lot of databases by [@alexmacarthur](https://github.com/alexmacarthur)
*   [Webstack-micro (⭐75)](https://github.com/ferbs/webstack-micro) Demo web app showing how Docker Compose might be used to set up an API Gateway, centralized authentication, background workers, and WebSockets as containerized services.
...
*   [Get Docker up and running on the RaspberryPi in three steps (⭐736)](https://github.com/umiddelb/armhf/wiki/Get-Docker-up-and-running-on-the-RaspberryPi-%28ARMv6%29-in-three-steps)
*   [git push docker containers to linux devices](https://www.balena.io) Modern DevOps for IoT, leveraging git and Docker.
*   [Installing, running, using Docker on armhf (ARMv7) devices (⭐736)](https://github.com/umiddelb/armhf/wiki/Installing,-running,-using-docker-on-armhf-%28ARMv7%29-devices)

### Security / Other

*   [Bringing new security features to Docker](https://opensource.com/business/14/9/security-for-docker)
*   [CVE Scanning Alpine images with Multi-stage builds in Docker 17.05 (⭐9)](https://github.com/tomwillfixit/alpine-cvecheck) by [@tomwillfixit](https://twitter.com/tomwillfixit)
...
*   [Docker Security Cheat Sheet (⭐204)](https://github.com/konstruktoid/Docker/blob/master/Security/CheatSheet.adoc)
...
*   [How CVE's are handled on Offical Docker Images (⭐5.5k)](https://github.com/docker-library/official-images/issues/1448)
...
*   [Docker in Production](https://www.youtube.com/watch?v=Glk5d5WP6MI) by [@jpetazzo](https://github.com/jpetazzo) (36:05)
...
*   [Introduction to Docker and containers](https://www.youtube.com/watch?v=ZVaRK10HBjo) (3:09:00) by [@jpetazzo](https://github.com/jpetazzo)
...
## [31. Awesome Browser Extensions for Github](/content/stefanbuck/awesome-browser-extensions-for-github/week/README.md)
...
## [46. Awesome Scala](/content/lauris/awesome-scala/week/README.md)
...
## [50. Awesome Groovy](/content/kdabir/awesome-groovy/week/README.md)
...
- Prev: [Jul 18 - Jul 24, 2022](/content/2022/29/README.md)
- Next: [Jul 04 - Jul 10, 2022](/content/2022/27/README.md)