# Awesome Vehicle Security Overview

🚗  A curated list of resources for learning about vehicle security and car hacking.

[🏠 Home](/README.md) · [🔥 Feed](https://test.trackawesomelist.com/jaredthecoder/awesome-vehicle-security/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 jaredthecoder/awesome-vehicle-security](https://github.com/jaredthecoder/awesome-vehicle-security/blob/master/README.md) · ⭐ 2.2K · 🏷️ Security
...
*   [mazda\_getInfo](https://github.com/shipcod3/mazda_getInfo) - A PoC that the USB port is an attack surface for a Mazda car's infotainment system and how Mazda hacks are made (known bug in the CMU).
