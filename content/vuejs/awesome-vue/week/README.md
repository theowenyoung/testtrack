# Track Awesome Vue Updates Weekly

🎉 A curated list of awesome things related to Vue.js

[🏠 Home](/README.md) · [🔍 Search](https://test.trackawesomelist.com/search/) · [🔥 Feed](https://test.trackawesomelist.com/vuejs/awesome-vue/week/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 vuejs/awesome-vue](https://github.com/vuejs/awesome-vue/blob/master/README.md) · ⭐ 67K · 🏷️ Front-End Development
...
*   [vue-facing-decorator (⭐72)](https://github.com/facing-dev/vue-facing-decorator) - Vue 3 typescript class component decorators, like `vue-property-decorator` in Vue 2.
...
*   [virtual-list (⭐4)](https://github.com/phphe/virtual-list) - Virtual list component. Features: Vue2, Vue3, TypeScript, SSR, horizontal list, virtual table.
...
*   [Vue 3.0 and decentralized app (dApp) (⭐16)](https://github.com/hypescale/moralis-vue-boilerplate)
...
*   [Vue E-Store Templet (⭐87)](https://github.com/rash0/Vue-Ecom) - An e-commerce template build with vue/vuex/vue-router and bootstrap4.
*   [VueSolitaire (⭐120)](https://github.com/silent-lad/VueSolitaire) - Solitaire (spider,klondike) implemented in Vue.js.
*   [Afterman (⭐40)](https://github.com/itsalb3rt/afterman) - 🌕 Create beautiful docs in markdown and HTML from postman collection. Using Quasar Framework
...
*   [CodeDependencyScanner (⭐38)](https://github.com/NeutroniumCore/CodeDependencyScanner/) - A C# desktop application that display .Net assembly code dependencies build with Vue, Neutronium and D3.js.
*   [Fanmio](https://fanmio.com) - Meet your favorite celebrities through personal video experiences on Fanmio

### Components & Libraries / UI Components

*   [@myena/vue-table (⭐30)](https://github.com/myENA/vue-table) - Table Components for Client/Server data handling. Filter, sort, paginate, group, expanding details row. Highly customizable via slots for filter, headers, column, pagination, details row.
*   [vue-topmodal (⭐7)](https://github.com/adileo/vue-topmodal) - A fully customizable, easy to use, Vue.js modal component. (Responsive, Stackable, Scrollable, Animated)
...
*   [@innologica/vue-dropdown-menu (⭐67)](https://github.com/Innologica/vue-dropdown-menu) - Dropdown menu component for Vue. Any element can be dropdown trigger and anything can be dropped down content.
*   [vue-split-carousel (⭐42)](https://github.com/Aaron00101010/vue-split-carousel) - A carousel component meanwhile display several carousel item, support vue 2 and vue 3.
*   [vue-simple-calendar (⭐743)](https://github.com/richardtallent/vue-simple-calendar) - Flexbox-based Vue month calendar component; supports multi-day events, localization, holiday emoji, drag/drop. No dependencies.
...
*   [vue-star-rating (⭐593)](https://github.com/craigh411/vue-star-rating) - A simple, highly customizable star rating component ⭐️ ⭐️ ⭐️
*   [vue-turnjs (⭐21)](https://github.com/Reidond/vue-turnjs) - A component library to add book experience to your app.
*   [vue-advanced-chat (⭐1k)](https://github.com/antoine92190/vue-advanced-chat) - Feature-rich and fully customizable chat rooms component. Support files, images, videos, audio, emojis, customised actions, etc.
*   [vue-wheel-picker (⭐4)](https://github.com/vanishmax/vue-wheel-picker) - Customizable Picker with 3D wheel and all gestures supported for Vue 2.
*   [vue-input-facade (⭐142)](https://github.com/RonaldJerez/vue-input-facade) - A lightweight and dependency free input masking library created specific for Vue, originally a fork of the famous *vue-text-mask* but actively maintained and with lots of improvements after there.
*   [vue-playlist (⭐27)](https://github.com/MishaPetrov/vue-playlist) - A lightweight vue (2.0) component with no dependencies that offers truly seamless html5 video playback. The one and only working solution for seamless video play done with vanilla JS. It takes an array of videos and stitches them together into a single video.
...
*   [vue-typed-js (⭐364)](https://github.com/Orlandster1998/vue-typed-js) Typed.js integration to easily create typing animations.
...
*   [vue-cli-plugin-chrome-extension-cli (⭐159)](https://github.com/sanyu1225/vue-cli-plugin-chrome-extension-cli) - Vue CLI Plugin generate chrome extension template

### Components & Libraries / Dev Tools

*   [bruit-io (⭐60)](https://github.com/Moventes/bruit.io) - Collect feedback with screenshot and technical data and post them to an API like [bruit.io](https://bruit.io).
...
*   [@formkit/auto-animate (⭐6k)](https://github.com/formkit/auto-animate) Add motion to your apps with a single line of code
...
*   [awesome-image (⭐54)](https://github.com/newbeea/awesome-image) - An universal image component for Vue2 / Vue3 / Nuxt with Lazyload / Responsive / Progressive / Auto-WebP / WebGL Filter / WebGL Transition supported.
...
*   [vue-next-i18n (⭐11)](https://github.com/Aaronlamz/vue-next-i18n) - A lightweight internationalization plugin for Vue 3.
...
*   [vue-pro-sidebar (⭐72)](https://github.com/boussadjra/vue-pro-sidebar) : A responsive template starter with the ecosystem configuration (vue-router, vuex), this boilerplate allows you to choose your preferred colors. [Live demo](http://boussadjra.github.io/vue-pro-sidebar)

### Components & Libraries / UI Utilities

*   [vue-form-container (⭐23)](https://github.com/VitorLuizC/vue-form-container) - A `Provider Component` that encapsulates your forms and handles their states and validations.
...
*   [vue-stickto (⭐53)](https://github.com/JALBAA/vue-stickto) - A vue directive that supports multiple DOM nodes stick to top automatically
...
*   [vue-api-request (⭐125)](https://github.com/ftgibran/vue-api-request) - A plugin that provides full control on your APIs, making your request simple, fast, and easy to implement.
*   [vue-request (⭐777)](https://github.com/Attojs/vue-request) - ⚡️ Vue 3 Composable for data fetching, supports SWR, polling, error retry, cache request, pagination, and other cool features.
*   [vue-worker (⭐556)](https://github.com/israelss/vue-worker) - A Vue.js plugin to use webworkers in a simple way.
...
*   [vue3-emoji-picker (⭐37)](https://github.com/delowardev/vue3-emoji-picker) - Simple and Powerful Emoji Picker for Vue3.
...
*   [element-pro-components (⭐135)](https://github.com/tolking/element-pro-components) A component library for Vue 3 base on element-plus
*   [Tailmin (⭐42)](https://github.com/otezz/tailmin) - Admin dashboard built with Vue.js and Tailwind CSS. [Live demo](https://tailmin.vercel.app/)
...
*   [vue3-circle-progress (⭐18)](https://github.com/delowardev/vue3-circle-progress) - Highly customizable Vue.js 3 circular progressbar component.
...
*   [Google Keep Clone with Vue + Firestore (⭐84)](https://github.com/wobsoriano/vue-keep) - Google Keep clone with Vue and Firestore written in TypeScript.
*   [Vue 3 Shopping Cart (⭐68)](https://github.com/wobsoriano/vue-cart) - A Shopping cart example using Vue 3, Vite, [daisyUI](https://daisyui.com/) and [Pinia](https://pinia.esm.dev/).
...
*   [vuestic-admin (⭐8.9k)](https://github.com/epicmaxco/vuestic-admin) - Vue Admin Dashboard built with Vue 3 and `vuestic-ui`.
...
*   [Samaya (⭐4)](https://github.com/bibhuticoder/samaya) - Friendly personal dashboard on Chrome's new tab; featuring Nepali calendar, daily Nepali quotes & Nepali wallpapers.
...
*   [Peer to Peer game of telephone (⭐58)](https://github.com/ably-labs/depict-it) - A party game for 4 to 8 players (ideally!) where you mutate a phrase through drawings and captions, to make up funny scenarios with your friends. The project is an example of how to build a Peer-to-Peer game with Vue.
...
*   [@vueform/slider (⭐166)](https://github.com/vueform/slider) - Vue 3 slider component with multihandles, tooltips merging and formatting.
*   [@vueform/toggle (⭐74)](https://github.com/vueform/toggle) - Vue 3 toggle component with labels, custom slots and styling options.
...
*   [vue-lang-router (⭐56)](https://github.com/adbrosaci/vue-lang-router) - Vue.js 2 & 3 language routing with (optional) URL localization.
...
*   [Building a realtime quiz with VueJS using a starter kit (⭐44)](https://github.com/ably-labs/realtime-quiz-framework/blob/main/TUTORIAL.md) by Srushtika Neelakantam (October 2020)

### Resources / Examples

*   [Shopify Theme Lab (⭐622)](https://github.com/uicrooks/shopify-theme-lab) - Shopify theme development starter using Vue, Vuex and Tailwind CSS

### Projects Using Vue.js / Open Source

*   [Realtime quiz framework (⭐44)](https://github.com/ably-labs/realtime-quiz-framework) - A starter kit built with NodeJS, VueJS and Ably providing the scalable base networking framework to host a live quiz
...
*   [vue-my-toasts (⭐129)](https://github.com/Tahul/vue-my-toasts) - Provide your component and let us toast the rest.
*   [vue-use-sound (⭐283)](https://github.com/Tahul/vue-use-sound) - A Vue Hook for playing sound effects.
*   [@vueform/multiselect (⭐527)](https://github.com/vueform/multiselect) - Vue 3 multiselect component with single select, multiselect and tagging options.

### Components & Libraries / Frameworks

*   [element3 (⭐3.2k)](https://github.com/kkbjs/element3) - A Vue.js 3.0 UI Toolkit for Web is based on element-ui
*   [Qui (⭐225)](https://github.com/Qvant-lab/qui) - A Vue 2.x Design System for Web
...
*   [FUE (⭐10)](https://github.com/elaijuh/fue) - Admin SPA client and server-side boilerplate with Vue.js + Vue Router + Vuex + Vuetify + FeathersJS

### Components & Libraries / UI Components

*   [vue-datasource (⭐422)](https://github.com/coderdiaz/vue-datasource) - A vue.js server-side component to create dynamic tables.
...
*   [vue-file-agent (⭐699)](https://github.com/safrazik/vue-file-agent) - Full-featured drag & drop enabled Vue file upload component with previews and upload progress
...
*   [Framework7-Vue (⭐17k)](https://github.com/framework7io/framework7) - Build full-featured iOS & Android apps using Framework7 & Vue.
...
*   [vue-chimera (⭐164)](https://github.com/SasanFarrokh/vue-chimera) - A full-featured RESTful resource based client, compatible with Nuxt.js and allows server-side fetch.

### Components & Libraries / Integrations

*   [vuexpress (⭐100)](https://github.com/vuexpress/vuexpress) - Vue + Express.js = VueXpress / A server-side rendering engine for Express.js. Use .vue files as your express.js templates.
*   [Prisma (⭐4)](https://github.com/sherl0g/prisma) - Logs visualization client for @sherlog/cli

### Components & Libraries / Scaffold

*   [Friendly Vue Starter (⭐37)](https://github.com/mcongy/friendly-vue-starter) - A full-featured Vue.js starter project with GraphQL support via Apollo-client (Vuex, Vue-router, Vue-i18n, Webpack 3, Eslint, Prettier, ...)
*   [SSR Boilerplate (⭐159)](https://github.com/fenivana/vue-ssr-boilerplate) - Vue.js server-side rendering boilerplate without polluting Vuex.
*   [Vue.js/Nuxt.js full-featured boilerplate (⭐104)](https://github.com/GrabarzUndPartner/gp-vue-boilerplate) - professional agency frontend template for building fast, robust, and adaptable web apps or sites by vuejs/nuxtjs.
*   [DotVue (⭐67)](https://github.com/mbdavid/DotVue) - Implement .vue file handler in .NET with server ViewModel postback. Single-file components with server-side ViewModel. Use all power of VueJS with simple C# server-side data access.
...
*   [vue-component-boilerplate (⭐7)](https://github.com/codetheorist/vue-component-boilerplate) - Template for generating the boilerplate code for a VueJS component, with build scripts and testing pre-installed.
...
*   [YouGet (⭐187)](https://github.com/ahmetzeybek/YouGet) - YouTube Video/Audio/Subtitle Downloader + Cutter
...
*   [Epiboard (⭐305)](https://github.com/Alexays/Epiboard) - A new tab page extension with material design and useful features :new: :tada:
*   [zhudyos/duic (⭐292)](https://github.com/zhudyos/duic) - Distributed configuration center :new:
*   [Vuemmerce (⭐360)](https://github.com/ivanlori/Vuemmerce) - Free ecommerce template built with Vue.js and Bulma framework :new:
*   [Carpoolear (⭐78)](https://github.com/STS-Rosario/carpoolear) - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
*   [Eplee (⭐301)](https://github.com/Janglee123/eplee) - Sweet, simple epub reader made with Vue.js and Electron.js.
...
*   [vue-js-datatable (⭐8)](https://github.com/Parthfaladu/vue-js-datatable) - VueJS light weight wrapper datatable component for [datatables.net](https://datatables.net)
...
*   [v-idle (⭐59)](https://github.com/malekim/v-idle) - A Vue.js plugin to detect idle/non-active users.
...
*   [vue-form-builder (⭐373)](https://github.com/openfext/vue-form-builder) - Build powerful vue form with JSON schema and composition api, popular ui frameworks such as Element UI, View UI, Ant Design Vue are supported. [Online Demo](https://openfext.github.io/vue-form-builder)
...
*   [loopback-vue (⭐199)](https://github.com/qxl1231/generator-loopback-vue) loopback+vue+vue-resource,ionic-app,vue page 分页功能,authenticate 权限控制,accesstoken 机制,credentials,CI,docker [qxl1231](https://github.com/qxl1231)
...
*   [vue.js 与 laravel 结合的前后端分离开发模板 (⭐880)](https://github.com/wmhello/laravel_template_with_vue)- A template website to laravel passport / Vue.JS & Element UI.
...
*   [AdminLTE-VueJS2 (⭐88)](https://github.com/otezz/AdminLTE-VueJS2) - An open source project that implements VueJS (v2.x) on AdminLTE.
...
*   [Dermail (⭐26)](https://github.com/zllovesuki/dermail-webmail) - A webmail client written in Vue.js for Dermail, a mail system written in node.js.
...
*   [Todoist Tribute (⭐212)](https://github.com/rohitpaulk/todoist-tribute/) - Todoist clone, written in Rails + Vue
...
*   [brain bits (⭐158)](https://github.com/dashersw/brain-bits) - A P300 online spelling mechanism for Emotiv headsets
...
*   [Keynote (⭐244)](https://github.com/znck/keynote) - Present with Vue.
*   [HappyPlants (⭐237)](https://github.com/morkro/happy-plants) - A progressive web app for organizing your plants 🌱.
...
*   [Remote-Access-SSH (⭐10)](https://github.com/mritunjaygoutam12/Remote-host) - Web based remote host access with node-ssh
...
*   [OneConcern](https://oneconcern.com) [source (⭐15)](https://github.com/acidjazz/oneconcern)
...
*   [Vue Spotify (⭐466)](https://github.com/gk4m/vue-spotify) - Spotify client built with vue.js / vuex
...
*   [web-riimote](https://web-riimote.herokuapp.com) - Turn your smartphone into a 3D controller ([source code (⭐472)](https://github.com/konaraddio/web-riimote))
*   [CSS ColorVars](https://csscolorvars.github.io/) - Interactive tool code generation ([source code (⭐9)](https://github.com/CSSColorVars/csscolorvars))
...
*   [vuetiful-datatable (⭐491)](https://github.com/andrewcourtice/vuetiful/tree/master/src/components/datatable) - Datatable component with sorting, filtering, pagination, grouping and aggregation.
*   [vue-materialize-datatable (⭐171)](https://github.com/MicroDroid/vue-materialize-datatable) - VueJS datatable for Materialize CSS
...
*   [vue-grid (⭐113)](https://github.com/dzwillia/vue-grid) - A flexible grid component for Vue.js
*   [vue-easytable (⭐3k)](https://github.com/huangshuwei/vue-easytable) - A powerful table components based on Vue2.x
*   [vue2-datatable-component (⭐889)](https://github.com/OneWayTech/vue2-datatable) - The best Datatable for Vue.js 2.x which never sucks
*   [vue-js-grid (⭐935)](https://github.com/euvl/vue-js-grid) - Vue.js 2.x responsive grid system with smooth sorting, drag-n-drop and reordering
*   [vue-handsontable-official (⭐754)](https://github.com/handsontable/vue-handsontable-official) A Vue.js wrapper for the Handsontable spreadsheet component
...
*   [el-search-table-pagination (⭐294)](https://github.com/zollero/el-search-table-pagination) - Combines Form, Table and Pagination components of Element UI together. Based on Vue 2.x.([Detail](https://mp.weixin.qq.com/s/r_OumEQB79lpEETThHA70g))
*   [vue-crud-x (⭐440)](https://github.com/ais-one/vue-crud-x) - Extensible crud component using Vuetify layout, other than the usual page, sort, filter, it is able to do nested CRUD, custom forms, filters, operations.
*   [Vue Datatable (⭐621)](https://github.com/laravel-enso/vuedatatable) - VueJS powered Datatable with Laravel server-side loading and JSON template setup
...
*   [el-data-table (⭐454)](https://github.com/FEMessage/el-data-table) - base on element-ui, makes crud easily
...
*   [@marketconnect/vue-pivot-table (⭐212)](https://github.com/MarketConnect/vue-pivot-table) - A vue component for pivot table
*   [vue-teible (⭐57)](https://github.com/hiendv/teible) - Lightweight and flexible table component for the web :zap:
*   [vue-jqxgrid (⭐56)](https://github.com/jqwidgets/vue/tree/master/grid) - Vue data grid with filtering, sorting, editing, grouping, data export and other features.
*   [vue-jqxpivotgrid (⭐56)](https://github.com/jqwidgets/vue/tree/master/pivotgrid) - Vue pivot data grid with pivot designer, drill through cells, pivot functions.
*   [toast-ui.vue-grid (⭐53)](https://github.com/nhnent/toast-ui.vue-grid) - Vue Wrapper for [TOAST UI Grid](http://ui.toast.com/tui-grid/).
*   [vueye-datatable (⭐113)](https://github.com/boussadjra/vueye-table) - Vueye data table is a responsive data table component based on Vue.js 2, it organizes your data per pages in order to navigate easily.
*   [vue-sorted-table (⭐33)](https://github.com/BernhardtD/vue-sorted-table) - A plugin to turn tables into sorted tables. Supports nested object keys, custom icons and reusable components.
*   [vue-bootstrap4-table (⭐219)](https://github.com/rubanraj54/vue-bootstrap4-table) - An advanced data table based on Vue 2 and Bootstrap 4, which includes Multi column filtering, Multi column sorting, Pagination & Info, Checkbox rows and Highly customizable slot options.
*   [vuejs-smart-table (⭐181)](https://github.com/tochoromero/vuejs-smart-table) - Straight Forward Table Component using the vanilla HTML Table Structure with Sorting, Filtering, Pagination and Selection out of the box.
*   [vue-jd-table (⭐75)](https://github.com/jamesdruhan/vue-jd-table) - Advanced and flexible data table component for Vue 2. Feature Rich: search, filtering, exporting, pagination (traditional and virtual scroll) and so much more!
*   [iview-table-page (⭐9)](https://github.com/MengFangui/iview-table-page) - Combines Table and Page components of iview UI together. Based on Vue 2.x. And Hear are some examples to use iview-table-page.
...
*   [vue-notifications (⭐698)](https://github.com/se-panfilov/vue-notifications) - Vue.js agnostic non-blocking notifications library.
*   [vue-easy-toast (⭐122)](https://github.com/noru/vue-easy-toast) - A toast plugin for vue/vue2.
...
*   [vue2-notify (⭐35)](https://github.com/websmurf/vue2-notify) - Vue.js 2+ notification plugin.
*   [vue-notifyjs (⭐165)](https://github.com/cristijora/vue-notifyjs) - Minimalist, 3kb themable notification plugin
*   [vueup (⭐108)](https://github.com/chryb/vueup) - Simple, lightweight and elegant global notification popup for Vue.js
*   [vuex-flash (⭐57)](https://github.com/ahmed-dinar/vuex-flash) - Flash message component for VueJS 2.x within Vuex 2.x.
*   [vue-snotify (⭐782)](https://github.com/artemsky/vue-snotify) - Vue.js 2 Notification Center
*   [vue-notify-me (⭐143)](https://github.com/PygmySlowLoris/vue-notify-me) - Stackable notification Alert for Vue
...
*   [vue-izitoast (⭐132)](https://github.com/arthurvasconcelos/vue-izitoast) - A Vue.js 2 wrapper around IziToast.
...
*   [vue-m-message (⭐156)](https://github.com/mengdu/m-message) - A message plugin for vue.
*   [vue-notification-bell (⭐67)](https://github.com/Carrene/vue-notification-bell) - A Vue UI component for showing notifications.
...
*   [vue-toast-notification (⭐406)](https://github.com/ankurk91/vue-toast-notification) - Yet another Vue.js Toast notification plugin.
*   [VueToastify (⭐177)](https://github.com/nandi95/vue-toastify) - A fuss free notification component.
*   [vue-toastification (⭐2k)](https://github.com/Maronato/vue-toastification) - Light, easy and beautiful toasts for Vue
*   [@smartweb/vue-flash-message (⭐66)](https://github.com/smwbtech/vue-flash-message) - The component to display single flash message or multiple flash messages to user
...
*   [vue-radial-progress (⭐464)](https://github.com/wyzant-dev/vue-radial-progress) - Radial progress bar component for Vue.js.
*   [vue-simple-spinner (⭐420)](https://github.com/dzwillia/vue-simple-spinner) - A simple, flexible spinner for Vue.js
*   [vue-wait (⭐1.9k)](https://github.com/f/vue-wait) - Complex Loader Management for Vue/Vuex and Nuxt applications.
*   [vue-progress-path (⭐408)](https://github.com/Akryum/vue-progress-path) - Customizable progress indicators and spinners that support any custom SVG path.
...
*   [svg-progress-bar (⭐112)](https://github.com/chenxuan0000/svg-progress-bar) - A simple progress bar for Vue.js.
*   [vue-loading-overlay (⭐1.1k)](https://github.com/ankurk91/vue-loading-overlay) - Tiny full screen loading indicator
*   [vue-loaders (⭐153)](https://github.com/Hokid/vue-loaders) - vue wrappers for [loaders.css (⭐10k)](https://github.com/ConnorAtherton/loaders.css)
*   [vue-promise-btn (⭐175)](https://github.com/STUkh/vue-promise-btn) - Tiny and powerful tool for asynchronous buttons(or any other tag) lock with fancy built-in spinner
*   [vue-spinkit (⭐108)](https://github.com/TonPC64/vue-spinkit) - 🌈 A collection of loading indicators animated with CSS for VueJS
...
*   [vue-element-loading (⭐313)](https://github.com/biigpongsatorn/vue-element-loading) - ⏳ Loading inside a container or full screen for Vue.js
*   [tb-skeleton (⭐88)](https://github.com/anthinkingcoder/tb-skeleton) - A skeleton screen loading for Vue.js
*   [vue-spinners (⭐309)](https://github.com/Saeris/vue-spinners) - 💫 A collection of loading spinner components for Vuejs
...
*   [vue-loading (⭐20)](https://github.com/HELMAB/vue-loading) - 🔄 Block page while requesting API
*   [vue-preloaders (⭐40)](https://github.com/igaloly/vue-preloaders) - Attach your preloader at any time, to any element easily and quickly
*   [vue-ellipse-progress (⭐241)](https://github.com/setaman/vue-ellipse-progress) - A flexible Vue.js component to create beautiful animated circular progress bars and loaders
*   [vue-progressbar (⭐1.4k)](https://github.com/hilongjw/vue-progressbar) - A lightweight progress bar for vue.
*   [vue2-loading-bar (⭐268)](https://github.com/BosNaufal/vue2-loading-bar) - Simplest Youtube Like Loading Bar Component For Vue 2.
...
*   [vue-progress-button (⭐75)](https://github.com/websmurf/vue-progress-button) - Vue.js 2.x animated button component.
*   [vue-simple-progress (⭐87)](https://github.com/dzwillia/vue-simple-progress) - A simple, flexible progress bar for Vue.js
*   [vue-component-loading (⭐17)](https://github.com/val-bubbleflat/vue-component-loading) - Manage a loading state inside each component and display the global loading state with a progressbar.
*   [vue-scroll-progress (⭐96)](https://github.com/spemer/vue-scroll-progress) - Simple Vue.js plugin for page scroll progress bar
*   [vue-read-progress (⭐36)](https://github.com/ajerez/vue-read-progress) - Customizable progress bar at the top of the page that shows the scroll progress
*   [easy-circular-progress (⭐114)](https://github.com/dreambo8563/easy-circular-progress) - Easy circular progress component with counting effect
*   [vue-twitter-counter (⭐33)](https://github.com/LucasLeandro1204/vue-twitter-counter) - Counter component inspired in Twitter with Vue
*   [v-tooltip (⭐2.5k)](https://github.com/Akryum/vue-tooltip) - Easy tooltips with Vue 2.x.
*   [vue-popper-component (⭐47)](https://github.com/antongorodezkiy/vue-popper-component) - Popper.js directive for Vue.js.
*   [vue-directive-tooltip (⭐171)](https://github.com/hekigan/vue-directive-tooltip) - Simple, flexible tooltip directive (based on Popper.js) [![Vue.js](https://img.shields.io/badge/vue-2-green.svg)](https://vuejs.org)
*   [k-pop (⭐15)](https://github.com/ChristianKienle/k-pop) - Simple popover component based on [popper.js](https://popper.js.org/). Highly customizable. Comes with themes. Supports custom triggers and can listen to any event.
*   [vue-parallax (⭐83)](https://github.com/vue-comps/vue-parallax) - Scrolls an image slower than the window to create a neat optical effect.
*   [vue-parallaxy (⭐626)](https://github.com/apertureless/vue-parallax) - Vue.js component for parallax image scroll effects.
*   [vue-mouse-parallax (⭐83)](https://github.com/Aminerman/vue-mouse-parallax) - A simple to use Mouse Parallax Component - Made with Vue.js
...
*   [vue-ionicons (⭐92)](https://github.com/mazipan/vue-ionicons) - Vue Icon Set Components from Ionic Team.
*   [vue-ico (⭐18)](https://github.com/paulcollett/vue-ico) - Dead easy icons for Vue with drop-in browser support & selective bundling
*   [mdi-vue (⭐80)](https://github.com/therufa/mdi-vue) - Material Design Icon components for Vuejs
*   [vue-fontawesome (⭐2.3k)](https://github.com/FortAwesome/vue-fontawesome) - Font Awesome 5 Vue component
...
*   [vue-country-flag (⭐137)](https://github.com/P3trur0/vue-country-flag) - Vue component for country flag icons
*   [vicon (⭐5)](https://github.com/Lt0/vicon) - Vicon is an simple iconfont component for vue.
*   [vue-lang-code-flags (⭐13)](https://github.com/qWici/vue-lang-code-flags) - Vue component which shows the flag of the country from which the language comes from
*   [vue-zondicons (⭐20)](https://github.com/TerryMooreII/vue-zondicons) - Vue component for the beautiful [Zondicon](http://www.zondicons.com/icons.html) svg icons
*   [vue-eva-icons (⭐197)](https://github.com/antonreshetov/vue-eva-icons) - Simply beautiful open source eva icons as Vue components.
*   [vue-unicons (⭐965)](https://github.com/antonreshetov/vue-unicons) - 1000+ Pixel-perfect svg unicons for your next project as Vue components.
*   [vue-fa (⭐23)](https://github.com/Cweili/vue-fa) - Simple FontAwesome 5 Vue.js 2 component.
*   [vue-cryptoicon (⭐88)](https://github.com/man15h/vue-cryptoicon) - Beautiful pixel perfect 400+ cryptocurrency and 10+ Fiat currency icon.
*   [vue-hero-icons (⭐96)](https://github.com/matschik/vue-hero-icons) - A set of high-quality SVG icons, sourced from [@refactoringui/heroicons (⭐17k)](https://github.com/refactoringui/heroicons), as Vue functional components.
...
*   [vue-accordion (⭐172)](https://github.com/zeratulmdq/vue-accordion) - Simple accordion nav menu component for Vue.js.
*   [vue-js-dropdown (⭐453)](https://github.com/euvl/vue-js-dropdown) - Vue.js 2 dropdown menu component. Light, easy to use and extend, no external deps.
...
*   [vue-quick-menu (⭐219)](https://github.com/AshleyLv/vue-quick-menu) - This is web navigation component base on vue.js2.
*   [@hscmap/vue-menu (⭐257)](https://github.com/michitaro/vue-menu) - Menu / Context Menu component for vue2.
*   [vue-router-nav (⭐32)](https://github.com/classicalconditioning/vue-router-nav) - Minimalistic responsive navigation bar that renders routes of vue-router.
*   [vue-drawer-layout (⭐404)](https://github.com/hjl19911127/vue-drawer-layout) - A simple DrawerLayout component like Android has for Vue.js.
*   [vue-tree-navigation (⭐156)](https://github.com/MisRob/vue-tree-navigation) - Vue.js 2 tree navigation with vue-router support
*   [bp-vuejs-dropdown (⭐48)](https://github.com/borisbutenko/bp-vuejs-dropdown) - Vuejs => 2 dropdown. Easy to use, no external, optional.
*   [vue-bulma-accordion (⭐34)](https://github.com/Lunrtick/vue-bulma-accordion) - Simple, easily configurable accordion or collapsible styled with Bulma custom or built in icons available
*   [v-selectmenu (⭐185)](https://github.com/TerryZ/v-selectmenu) - A simple, easier and highly customized menu solution for Vue2.
*   [vue-burger-menu (⭐728)](https://github.com/mbj36/vue-burger-menu) - An off-canvas sidebar Menu component with different CSS animations.
*   [vue-dynamic-dropdown (⭐40)](https://github.com/JonathanDn/vue-dropdown) - A Highly Customizable, easy-to-use elegant dropdown component
*   [vue-navigation-bar (⭐149)](https://github.com/johndatserakis/vue-navigation-bar) - A simple, pretty navbar for your Vue projects.
...
*   [vue-stripe-menu (⭐457)](https://github.com/Alexeykhr/vue-stripe-menu) - Creating a navigation menu with animations like on Stripe
*   [vue-burger-button (⭐42)](https://github.com/VitorLuizC/vue-burger-button) - A pretty simple Vue functional component for menu burger buttons.
...
*   [vue-integer-plusminus (⭐18)](https://github.com/Keiwen/vue-integer-plusminus) - Integer input with increment and decrement buttons for vue 2.
*   [vue-numeric-input (⭐72)](https://github.com/JayeshLab/vue-numeric-input) - Number input component with controls.
*   [vue-easy-slider (⭐353)](https://github.com/shhdgit/vue-easy-slider) - Slider Component of Vue.js.
...
*   [vue-awesome-swiper (⭐12k)](https://github.com/surmon-china/vue-awesome-swiper) - Swiper(slide) component for Vue.js(1.x \~ 2.x).
*   [vue-lory (⭐42)](https://github.com/vue-bulma/lory) - Vue Slider Component based on lory.
*   [vue-slick (⭐597)](https://github.com/staskjs/vue-slick) - Vue component for Slick-carousel.
*   [vue-flickity (⭐368)](https://github.com/drewjbartlett/vue-flickity) - A Vue Component for Flickity.js.
*   [vue-carousel-3d (⭐885)](https://github.com/wlada/vue-carousel-3d) - Vue Carousel 3D - Beautiful, flexible and touch supported 3D Carousel for Vue.js.
...
*   [vue-tiny-slider (⭐137)](https://github.com/viktorlarsson/vue-tiny-slider) – A carousel component created by ganlanyuan, written in Vue.js. No jQuery. Works in IE8+.
*   [vue2-text-swimlane (⭐72)](https://github.com/mubaidr/vue-swimlane) - A Text Swimlane plugin for Vue.js
*   [vue-picture-swipe (⭐382)](https://github.com/rap2hpoutre/vue-picture-swipe) - Vue Picture Swipe Gallery (a gallery of image with thumbnails, lazy-load and swipe) backed by photoswipe.
*   [vue2-siema](https://github.com/sainf/vue2-siema) - Plugin wrapper for the very tiny Siema carousel/slider library.
*   [vue-flux (⭐458)](https://github.com/deulos/vue-flux) - Image slider which comes with 20 cool transitions.
*   [vue-glide (⭐266)](https://github.com/antonreshetov/vue-glide) - Vue slider & carousel component on top of the [Glide.js (⭐6.7k)](https://github.com/glidejs/glide)
*   [vue-owl-carousel (⭐158)](https://github.com/s950329/vue-owl-carousel) - Vue component for [Owl Carousel 2](https://owlcarousel2.github.io/OwlCarousel2/)
*   [vueper-slides (⭐498)](https://github.com/antoniandre/vueper-slides) - A touch ready and responsive slideshow / carousel for Vue JS.
*   [Hooper (⭐694)](https://github.com/baianat/hooper) - Customizable accessible carousel slider optimized for Vue
*   [Lingallery (⭐60)](https://github.com/ChristophAnastasiades/Lingallery) - Simple image gallery component for Vue which displays a large image with thumbnails below
*   [vue-piece-slider (⭐95)](https://github.com/dreambo8563/vue-piece-slider) - Animated slides in a fragmented look
...
*   [vue-pswipe (⭐100)](https://github.com/GuoQichen/vue-pswipe) - Easy to use, no need to set the size, support rotation, photoswipe based vue swipe plugin
*   [vue-cat-carousel (⭐10)](https://github.com/hanssagita/vue-cat-carousel) - Lightweight, simple and customizable for Vue Js
*   [slither-slider (⭐36)](https://github.com/dolbex/slither-slider) - Carousel for images, videos, or components. Throw pretty much anything you want at it.
*   [vue-slick-carousel (⭐714)](https://github.com/gs-shop/vue-slick-carousel) - A carousel with slick features & SSR support written for faster Luxstay
*   [@jfm/vue-carousel (⭐1)](https://github.com/jiangfengming/vue-carousel) - A Vue carousel component.
*   [vue-morris (⭐230)](https://github.com/bbonnin/vue-morris) - VueJS component wrapping Morris.js.
*   [vue-chartjs (⭐4.9k)](https://github.com/apertureless/vue-chartjs) - Vue.js wrapper for Chart.js.
*   [vue-echarts (⭐7.6k)](https://github.com/Justineo/vue-echarts) - ECharts component for Vue.js.
*   [vuetrend (⭐1.2k)](https://github.com/QingWei-Li/vue-trend) - Simple, elegant spark lines for Vue.js.
*   [vue-highcharts (⭐406)](https://github.com/weizhenye/vue-highcharts) - Highcharts component for Vue.
*   [vue-echarts-v3 (⭐900)](https://github.com/xlsdg/vue-echarts-v3) - Vue.js(v2.x+) component wrap for ECharts.js(v3.x+).
*   [vue-chartist (⭐42)](https://github.com/lakb248/vue-chartist) - Vue.js 2.0 component wrap for Chartist.
*   [vuebars (⭐443)](https://github.com/DeviaVir/vue-bar) - Simple, elegant spark bars for Vue.js.
*   [vue-d3-network (⭐479)](https://github.com/emiliorizzo/vue-d3-network) - Vue component to graph networks using d3-force
*   [vue2vis (⭐220)](https://github.com/alexcode/vue2vis) - Vue2 wrapper for [Visjs](http://visjs.org).
*   [vue-c3 (⭐78)](https://github.com/chryb/vue-c3) - A reusable vue component for c3 charts
*   [vue-d2b (⭐38)](https://github.com/d2bjs/vue-d2b) - Vue components for d2b charts. (Including axis, pie, sankey, and sunburst charts)
*   [VueChart (⭐24)](https://github.com/SeregPie/VueChart) - A very simple Vue wrapper for Chart.
*   [vue-chartkick (⭐740)](https://github.com/ankane/vue-chartkick) - Create beautiful JavaScript charts with one line of Vue
*   [d3vue (⭐92)](https://github.com/ignoreintuition/d3vue) - A D3 Plugin for Creating Reactive Data Visualizations in VueJS
*   [vue2-frappe (⭐148)](https://github.com/JustSteveKing/vue2-frappe) - A simple wrapper around Frappe Charts for VueJS
*   [vue-google-charts (⭐417)](https://github.com/devstark-com/vue-google-charts) - Reactive Vue.js wrapper for Google Charts lib
*   [vue-graph (⭐126)](https://github.com/juijs/vue-graph) - Data visualization library for dashboard implementation in Vue.js
*   [vue.d3.sunburst (⭐62)](https://github.com/David-Desmaisons/Vue.D3.sunburst) - Reactive sunburst component based on D3.js
...
*   [vue-jqxchart (⭐56)](https://github.com/jqwidgets/vue/tree/master/chart) - Charting component with Pie, Bubble, Donut, Line, Bar, Column, Area, Waterfall, Polar & Spider series.
*   [toast-ui.vue-chart (⭐53)](https://github.com/nhnent/toast-ui.vue-chart) - Vue Wrapper for [TOAST UI Chart](http://ui.toast.com/tui-chart/).
*   [vue-apexcharts (⭐1.1k)](https://github.com/apexcharts/vue-apexcharts) - Vue.js component for [ApexCharts (⭐12k)](https://github.com/apexcharts/apexcharts.js).
*   [vue-doughnut-chart (⭐32)](https://github.com/mazipan/vue-doughnut-chart) - Doughnut chart component for Vue.js.
*   [v-charts (⭐6.7k)](https://github.com/ElemeFE/v-charts) - Chart components based on Vue2.x and Echarts.
*   [vue-css-donut-chart (⭐125)](https://github.com/dumptyd/vue-css-donut-chart) - Lightweight Vue component for drawing pure CSS donut charts.
*   [vue-trend-chart (⭐246)](https://github.com/dmtrbrl/vue-trend-chart) - Simple trend charts for Vue.js
*   [vueplotlib (⭐23)](https://github.com/keller-mark/vueplotlib) - Declarative, interactive, linked plot components
*   [vgauge (⭐48)](https://github.com/amroessam/vgauge) - A Vue Wrapper to GaugeJS - Create beautiful gauges
*   [vue-plotly (⭐225)](https://github.com/David-Desmaisons/vue-plotly) - Wrapper for [plotly.js](https://plot.ly/javascript/) declarative charting library that ships with 20 chart types, including 3D charts, statistical graphs, and SVG maps.
*   [vue-funnel-graph-js (⭐198)](https://github.com/greghub/vue-funnel-graph-js) - Funnel graph drawing library for Vue.js. Create vertical and horizontal animated SVG funnel charts and add labels, values, legend and other info.
*   [pure-vue-chart (⭐61)](https://github.com/djaxho/pure-vue-chart) - Lightweight vue charts implemented without any chart library dependencies
*   [f2-vue (⭐10)](https://github.com/justice47/f2-vue) - Vue wrapper of f2 - elegant, interactive and flexible mobile chart library
*   [ZingChart-Vue (⭐24)](https://github.com/zingchart/zingchart-vue) - Vue component made by ZingChart with 35+ chart types.
*   [jscharting-vue (⭐43)](https://github.com/jscharting/jscharting-vue) - Vue chart component offering a complete set of chart types and engaging data visualizations with [JSCharting](https://jscharting.com/).
*   [flowchart-vue (⭐274)](https://github.com/joyceworks/flowchart-vue) - Flowchart & Flowchart designer component for Vue.js.
*   [vue-timeago (⭐742)](https://github.com/egoist/vue-timeago) - A tiny timeago component for Vue.
*   [vue-moment-jalaali (⭐60)](https://github.com/saman/vue-moment-jalaali) - Jalaali Moment.js filters for your Vue.js project.
*   [vue-countdown-timer (⭐24)](https://github.com/sagarkbhatt/vuejs-countdown-timer) - Added timezone conversion support.
*   [vue-analog-clock-range (⭐53)](https://github.com/f/vue-analog-clock-range) - Analog clock range to show time difference.
*   [vue-moment-lib (⭐30)](https://github.com/julon/vue-moment-lib) - A simple Vue.js 2.0 MomentJS library (filters & globals) using the same momentjs API.
*   [vuejs-countdown (⭐100)](https://github.com/getanwar/vuejs-countdown) - A simple countdown timer component for vue js 2.0
*   [vue2-flip-countdown (⭐210)](https://github.com/philipjkim/vue2-flip-countdown) - A countdown timer with flip effect for Vue 2.x
*   [timeline-vuejs (⭐116)](https://github.com/pablosirera/timeline-vuejs) - A minimalist timeline for Vue
*   [vue-awesome-countdown (⭐186)](https://github.com/mlinquan/vue-awesome-countdown) - Countdown plug-in with high performance and high accuracy for Vue 2.5.0+. Official site: <https://vac.js.org>
*   [vue-clock2 (⭐81)](https://github.com/bestvist/vue-clock2) - Display clock component for Vue.
*   [vuemodoro (⭐41)](https://github.com/P3trur0/vuemodoro) - Pomodoro timer as single file Vue component.
*   [digital-clock-vue (⭐7)](https://github.com/zkerhcy/digital-clock-vue) - ️A digital clock simulation build on Vue.
*   [bs-vue-timeline (⭐11)](https://github.com/x10sv/bs-vue-timeline) - An alternative responsive boostrap-vue timeline
*   [simple-vue-timeline (⭐22)](https://github.com/scottie34/simple-vue-timeline) - A simple but customizable and reactive timeline vue component
*   [vue-moment (⭐1.3k)](https://github.com/brockpetrie/vue-moment) - Handy Moment.js filters for your Vue.js project.
*   [vue-fullcalendar (⭐1.5k)](https://github.com/Wanderxx/vue-fullcalendar) - Vue calendar fullCalendar. No jQuery required. Schedule events management.
*   [vue-event-calendar (⭐632)](https://github.com/GeoffZhu/vue-event-calendar) - A simple events calendar for Vue2, no dependencies except Vue2.
*   [vue-calendar-picker (⭐48)](https://github.com/FranckFreiburger/vue-calendar-picker) - Lightweight calendar component for events display, period selection and date picker.
*   [vue-lunar-calendar (⭐70)](https://github.com/KimWooHyun/vue-lunar-calendar) - A vue component for lunar calendar. Uses Moment.js for date operations.
*   [vue-jlunar-datepicker (⭐56)](https://github.com/tuhe32/vue-jLunar-datePicker) - A Chinese lunar datepicker component with festivals and solar terms.
*   [vue-full-calendar (⭐488)](https://github.com/CroudSupport/vue-fullcalendar) - A complete [fullcalendar.io](https://fullcalendar.io) wrapper for both Vue 1 and 2
*   [v-calendar (⭐3.6k)](https://github.com/nathanreyes/v-calendar) - Animated calendar/datepicker that displays regions, indicators and day popovers for simple & recurring dates.
*   [vue-infinite-calendar (⭐15)](https://github.com/laleshii/vue-infinite-calendar) - A simple infinite calendar implementation for Vue 2
*   [vue-calendar (⭐47)](https://github.com/kylin-z/vue-calendar) - A simple calendar components for Vue 2.1.5+, support custom content. No dependencies.
*   [vue2-event-calendar (⭐76)](https://github.com/kitwon/vue2-event-calendar) - An events calendar for Vue2, support customize event items and calendar header.
*   [vue2-datePicker-infinite (⭐17)](https://github.com/leepyng/vue-datepicker-infinite) - An infinite datePicker for Vue2, easy to use and no dependencies.
*   [vue2-slot-calendar (⭐486)](https://github.com/icai/vue2-calendar) - A vue 2 calendar, datepicker component which supported lunar or date event, bootstrap style.
*   [quasar-calendar (⭐261)](https://github.com/stormseed/quasar-calendar) - A vue.js calendar using the Quasar framework that implements monthly, multi-day and agenda views.
*   [vue2-datepicker (⭐1.4k)](https://github.com/mengxiong10/vue2-datepicker) - A beautiful datepicker / datetimepicker component for Vue2
*   [vue-pikaday (⭐37)](https://github.com/enrian/vue-pikaday) - VueJS wrapper component for [Pikaday (⭐7.9k)](https://github.com/dbushell/Pikaday) datepicker
*   [vue-tuicalendar (⭐129)](https://github.com/lkmadushan/vue-tuicalendar) - VueJS wrapper component for [tui.calendar (⭐10k)](https://github.com/nhnent/tui.calendar) calendar
*   [vue-jqxscheduler (⭐56)](https://github.com/jqwidgets/vue/tree/master/scheduler) - VueJS Scheduler component.
*   [toast-ui.vue-calendar (⭐197)](https://github.com/nhnent/toast-ui.vue-calendar) - Vue Wrapper for [TOAST UI Calendar](http://ui.toast.com/tui-calendar).
*   [vue-functional-calendar (⭐419)](https://github.com/ManukMinasyan/vue-functional-calendar) - Lightweight, high performance calendar component(Date Picker, Date Range) based on Vue.
*   [vue-cal (⭐941)](https://github.com/antoniandre/vue-cal) - A Vue JS full calendar, no dependency, no BS. 🤘.
*   [vue-material-year-calendar (⭐110)](https://github.com/nono1526/vue-material-year-calendar) - A full year (12 months on a page) calendar for Vue2. Uses dayjs.
*   [vuelendar (⭐76)](https://github.com/codesthq/vuelendar) - Simple and clean calendar written in VueJS
*   [vue-date-tools (⭐13)](https://github.com/misterfresh/vue-date-tools/) - Most lightweight VueJS Date picker & Daterange picker using date-fns and no other dependencies
*   [vue2-google-maps (⭐1.9k)](https://github.com/xkjyeah/vue-google-maps) - Google maps component for vue with 2-way data binding.
*   [vue2-leaflet (⭐1.9k)](https://github.com/KoRiGaN/Vue2Leaflet) - Vue 2 components for Leaflet maps.
*   [vue-mapbox-gl (⭐265)](https://github.com/phegman/vue-mapbox-gl) - Vue 2.x component for Mapbox GL JS
*   [vue-yandex-maps (⭐334)](https://github.com/PNKBizz/vue-yandex-map) - Vue 2.x component for Yandex Maps
*   [vue-baidu-map (⭐2.3k)](https://github.com/Dafrok/vue-baidu-map) - Vue 2.x component for Baidu Maps.
*   [vue-choropleth (⭐116)](https://github.com/voluntadpear/vue-choropleth) - Vue 2.x component to display a choropleth map.
*   [vuelayers (⭐659)](https://github.com/ghettovoice/vuelayers) - Vue 2 components to work with OpenLayers.
*   [vue-googlemaps (⭐533)](https://github.com/Akryum/vue-googlemaps) - Vue 2.x components to integrate Google Maps.
*   [vue-static-map (⭐24)](https://github.com/eperedo/vue-static-map) - Vue 2.x simple component to generate an static google map
*   [vue-mapbox (⭐421)](https://github.com/soal/vue-mapbox) - Vue 2.x wrapper around Mapbox GL JS library that provides vueish-way to interact with the map.
*   [vue-async-gmaps (⭐3)](https://github.com/vanderb/vue-async-gmaps) - Let users decide to load google-maps script for better privacy
*   [Vue-APlayer (⭐1.3k)](https://github.com/SevenOutman/vue-aplayer) - :cake: Easy-to-config music player for Vue 2.x.
*   [vue-audio (⭐172)](https://github.com/shershen08/vuejs-sound-player) - audio-tag wrapper; sound player component for Vue 2.x
*   [vue-dplayer (⭐602)](https://github.com/sinchang/vue-dplayer) - A Vue 2.x video player component based on DPlayer.
*   [vue-canvasvideo (⭐39)](https://github.com/chrishurlburt/vue-canvasvideo) - A Vue 2.x component for video backgrounds and autoplay video on iOS/Safari.
*   [vue-music (⭐25)](https://github.com/petsgre/music) - A Vue component base on html5 `<audio>`.
*   [vue-audio-visual (⭐536)](https://github.com/staskobzar/vue-audio-visual) - Vue HTML5 audio visualization components.
*   [vue-plyr (⭐691)](https://github.com/redxtech/vue-plyr) - A set of Vue components for the plyr video & audio player.
*   [v-playback (⭐19)](https://github.com/TerryZ/v-playback) - A Vue2 plugin to make video play easier.
*   [vue-audio-recorder (⭐435)](https://github.com/grishkovelli/vue-audio-recorder) - Audio recorder for Vue.js. It allows to create, play, download and store records on a server
*   [vue-video-section (⭐32)](https://github.com/johndatserakis/vue-video-section) - A simple video header/section component for Vue. Good for video backgrounds and overlaying content on them.
*   [vue-waveform (⭐34)](https://github.com/chenqiaoen521/vue-waveform) -It is use canvas waveform audio player wavesurfer component contains timeline bar line for Vue 2.x
*   [vue-responsive-video-background-player (⭐222)](https://github.com/avidofood/vue-responsive-video-background-player) - Play your own videos in background responsively in different resolutions.
*   [vue-h5-audio-controls (⭐9)](https://github.com/cycjimmy/vue-h5-audio-controls) - A simple h5 music controller for Vue.
*   [xns-audio-player-simple (⭐9)](https://github.com/xinnks/xns-audio-player-simple) - A light and customizable Vue 2.x audio player powered HTMLAudioElement.
*   [vue-core-video-player (⭐362)](https://github.com/core-player/vue-core-video-player) - A Lightweight Video Player For Vue.js
*   [vue-player (⭐21)](https://github.com/algoz098/vue-player) - A simple html5 video player with img placeholder for Vue 2.x.
*   [vue-audio-better (⭐105)](https://github.com/forijk/vue-audio-better) - Easy to create custom audio player components for Vue 2.x. A progress bar with soul.
*   [vue-sounds (⭐11)](https://github.com/redcodemohammed/vue-sounds) - Easy to add sounds to your components.
*   [vue-infinite-loading (⭐2.6k)](https://github.com/PeachScript/vue-infinite-loading) - An infinite scroll plugin for Vue.js 1.0 & Vue.js 2.0.
*   [vue-mugen-scroll (⭐544)](https://github.com/egoist/vue-mugen-scroll) - Infinite scroll component for Vue.js 2.
*   [vue-infinite-scroll (⭐2.8k)](https://github.com/ElemeFE/vue-infinite-scroll) - An infinite scroll directive for vue.js.
*   [vue-loop (⭐829)](https://github.com/lookstudios/vue-loop) - An infinite content loop component for Vue.js 2.
*   [vue-scroller (⭐1.8k)](https://github.com/wangdahoo/vue-scroller) - An infinite content loop component for Vue.js 2, including functionalities such as 'pull-to-refresh', 'infinite-loading', 'snaping-scroll'.
*   [vue-infinite-list (⭐27)](https://github.com/legeneek/vue-infinite-list) - An infinite list mixin can recycle dom for Vue.js 2
*   [vue-infinite-slide-bar (⭐230)](https://github.com/biigpongsatorn/vue-infinite-slide-bar) - ∞ Infinite slide bar component.
*   [vue-virtual-infinite-scroll (⭐49)](https://github.com/zuolei828/vue-virtual-infinite-scroll) - A vue2 component based on Iscroll, supports big data list with high performance scroll, infinite load and pull refresh.
*   [@egjs/vue-infinitegrid (⭐1.4k)](https://github.com/naver/egjs-infinitegrid/blob/master/packages/vue-infinitegrid/) - Arrange infinite card elements according to various layout types like masonry for Vue.js 2.
*   [vue-pull-refresh (⭐136)](https://github.com/lakb248/vue-pull-refresh) - A pull to refresh component for Vue.js 2.0.
*   [vue-data-loading (⭐63)](https://github.com/bedlate/vue-data-loading) - Another component for infinite scroll and pull down/up to load data.
*   [vue-quick-loadmore (⭐133)](https://github.com/duyanpeng/vue-quick-loadmore) - A pull-down refresh and pull-up infinite scroll plugin for Vue.
*   [vue-markdown (⭐1.8k)](https://github.com/miaolz123/vue-markdown) - A Powerful and Highspeed Markdown Parser for Vue.
*   [vue-mavonEditor (⭐5.8k)](https://github.com/hinesboy/mavonEditor) - A markdown editor based on Vue that supports a variety of personalized features.
*   [vue-simple-markdown (⭐82)](https://github.com/Vivify-Ideas/vue-simple-markdown) - A Simple and Highspeed Markdown Parser for Vue.
*   [vue-simplemde (⭐756)](https://github.com/F-loat/vue-simplemde) - A wrapper around [simplemde (⭐9.2k)](https://github.com/sparksuite/simplemde-markdown-editor). Delightful editing for beginners and experts alike. Features built-in autosaving and spell checking.
*   [vue-pdf (⭐1.9k)](https://github.com/FranckFreiburger/vue-pdf) - A pdf viewer based on mozilla's PDF.js
*   [Vue.D3.tree (⭐808)](https://github.com/David-Desmaisons/Vue.D3.tree) - A Tree View based on [D3.js](https://d3js.org/)
*   [vue-json-tree-view (⭐457)](https://github.com/arvidkahl/vue-json-tree-view) - A JSON Tree View Component for Vue.js.
*   [vue-tree (⭐926)](https://github.com/halower/vue2-tree) - A Tree Component for Vue.js 2.X.
*   [liquor-tree (⭐381)](https://github.com/amsik/liquor-tree) - Amazing Vue Tree component
*   [vue-trees-ui (⭐21)](https://github.com/wyr1227/vue-trees) - A Tree Ui Base On Vue.
*   [Bosket (⭐451)](https://github.com/elbywan/bosket) - Collection of tree view components for front-end frameworks (Vue, React, Angular and Riot).
*   [plantain-00/tree-component (⭐145)](https://github.com/plantain-00/tree-component) - A reactjs, angular and vuejs tree component.
*   [sl-vue-tree (⭐319)](https://github.com/holiber/sl-vue-tree) - A simple customizable draggable tree component for Vue.js
*   [he-tree-vue (⭐126)](https://github.com/phphe/he-tree-vue) - A draggable sortable vue tree component, with dragging placeholder, types definition. 14 KB gzipped.
*   [vuejs-tree (⭐298)](https://github.com/scalia/vuejs-tree) - A highly customizable VueJs tree viewer
*   [vue-jstree (⭐564)](https://github.com/zdy1988/vue-jstree) - A Tree Plugin For Vue2 with beautiful icons and drag\&drop
*   [vue-vtree (⭐7)](https://github.com/XAHTEP26/vue-vtree) - Universal and flexible tree component for Vue.js
*   [vue-json-component (⭐79)](https://github.com/tylerkrupicka/vue-json-component) - JSON tree view with no dependencies, TypeScript support, and easy customization.
*   [vue-tree-list (⭐422)](https://github.com/ParadeTo/vue-tree-list) - A vue component for tree structure
*   [vue-finder (⭐149)](https://github.com/jledentu/vue-finder) - A component to display hierarchical data, with selection, filtering and drag & drop
*   [vue-pipeline (⭐291)](https://github.com/jinfang134/vue-pipeline) - A easy-to-use component to show beautiful responsive pipeline like jenkins blue ocean plugin.
*   [vue-social-sharing (⭐1.3k)](https://github.com/nicolasbeauvais/vue-social-sharing) - A renderless Vue.js component for sharing links to social networks, compatible with SSR
*   [vue-goodshare (⭐425)](https://github.com/koddr/vue-goodshare) - Vue.js component for social share with beautiful button design. Simple install, extensive documentation, developer support, SEO friendly, clean code without scripts tracking user activity on the page, high speed. Work with Vue.js 2.x.
*   [vue-socialmedia-share (⭐67)](https://github.com/mbj36/vue-socialmedia-share) - A Vue.js component for sharing links to social networks, with Vue 2.X
*   [vue-picture-sharesheet (⭐32)](https://github.com/Onatcer/vue-picture-sharesheet) - A Vue Picture Sharesheet Component heavily inspired by the Image Sharesheet in Apple's Newsroom
*   [vue-twitter (⭐14)](https://github.com/chiaweilee/vue-twitter) - A Vue.js component for embed twitter widgets (e.g timeline, buttons)
*   [vue-share-buttons (⭐49)](https://github.com/Alexandrshy/vue-share-buttons) - Vue.js component for placing buttons in your project using which you can share anything
*   [vue-share-it (⭐21)](https://github.com/thisDOTname/vue-share-it) - A Vue.js component for sharing links to social networks
*   [vuesocial (⭐51)](https://github.com/growthbunker/vuesocial) - 🧞‍♀️🧞‍♂️ One easy-to-use button component for Vue.js with 65+ social networks.
*   [vue-qriously (⭐271)](https://github.com/theomessin/vue-qriously) - A Vue.js 2 component to draw QR codes on an HTML Canvas using qrious.
*   [vue-qart (⭐297)](https://github.com/superman66/vue-qart) - The directive of vue 2.x for qart.js.
*   [vue-qrcode-reader (⭐1.6k)](https://github.com/gruhn/vue-qrcode-reader) - A Vue.js 2 component which detects and decodes QR codes from a camera stream.
*   [vue-fuse (⭐309)](https://github.com/shayneo/vue-fuse) - A lightweight plugin for fuzzy search library, Fuse.js
...
*   [vue-innersearch (⭐137)](https://github.com/InnerSearch/vue-innersearch) - A Vue.js wrapper for Elasticsearch
*   [reactivesearch-vue (⭐4.7k)](https://github.com/appbaseio/reactivesearch) - UI components for building data-driven apps with Elasticsearch
*   [vue-search-panel (⭐35)](https://github.com/TheoXiong/vue-search-panel) - A Vue component for searching with suggestions
*   [vue-avatar (⭐611)](https://github.com/eliep/vue-avatar) - An avatar component for vue.js.
*   [vue-touch-ripple (⭐461)](https://github.com/surmon-china/vue-touch-ripple) - Touch ripple component for Vue.js(1.x \~ 2.x).
*   [vue-typer (⭐775)](https://github.com/cngu/vue-typer) - Vue component that simulates a user typing, selecting, and erasing text.
*   [vue-keyboard (⭐154)](https://github.com/MartyWallace/vue-keyboard) - Vue 2 virtual keyboard component.
*   [vue-twentytwenty (⭐205)](https://github.com/mhayes/vue-twentytwenty) - Image comparison component, works with Vue.js 2.x
*   [vue-cookie-law (⭐372)](https://github.com/apertureless/vue-cookie-law) - Cookie info plugin for Vue.js 2.x
*   [vue-gravatar (⭐111)](https://github.com/JiriChara/vue-gravatar) - A dead-simple gravatar component for Vue.js 2.x
*   [vue-clipboard2 (⭐1.7k)](https://github.com/Inndy/vue-clipboard2) - An easy to use clipboard.js binding for Vue.js 2.x
*   [vue-flashcard (⭐120)](https://github.com/cuduy197/vue-flashcard) - FLashcard component with animation for Vue.js 2.x :bulb:
*   [vue-truncate-collapsed (⭐106)](https://github.com/kavalcante/vue-truncate-collapsed) - A simple component that truncates your text and adds a 'Read More/Show Less' clickable for Vue.js 2.x
*   [vue-kanban (⭐729)](https://github.com/BrockReece/vue-kanban) - A flexible drag and drop kanban board component
*   [vue-letter-avatar (⭐62)](https://github.com/aidewoode/vue-letter-avatar) - A simple and elegant letter avatar component for vue.js
*   [vue-highlightjs (⭐331)](https://github.com/metachris/vue-highlightjs) - Syntax highlighting with highlight.js
*   [v-clipboard (⭐478)](https://github.com/euvl/v-clipboard) - Simple, tiny and easy to use directive to save your models to clipboard (less than 2kb minified, no dependencies)
...
*   [vue-embed (⭐62)](https://github.com/Gomah/vue-embed) - Embed component is based on embed.js for Vue 2.x, a component that embeds emojis, media, maps, tweets, gists, code, services and markdown.
*   [vue-particles (⭐1.4k)](https://github.com/creotip/vue-particles) - Vue.js component for particles backgrounds
*   [vue-uniq-ids (⭐33)](https://github.com/termosa/vue-uniq-ids) - Vue.js 2.x plugin that helps to use id-related attributes with no side-effect
*   [vue-multivue (⭐16)](https://github.com/drewjbartlett/vue-multivue) - Use multiple vue apps of the same class on the same page.
*   [vue-affix (⭐404)](https://github.com/eddiemf/vue-affix) - A Vue.js 2.x plugin that affixes an element in the window while you scroll, similar to Bootstrap Affix but much simpler and smarter
*   [X-Browser-Update-Vue (⭐25)](https://github.com/OXOYO/X-Browser-Update-Vue) - A Vue.js browser-update plugin.
*   [vue-query-builder (⭐611)](https://github.com/dabernathy89/vue-query-builder) - A UI component for building complex queries with nested conditionals.
*   [vue-info-card (⭐191)](https://github.com/karakanb/vue-info-card) - A simple and beautiful card component with an elegant spark line and CSS3 flip animation.
*   [v-offline (⭐352)](https://github.com/vinayakkulkarni/v-offline) - Simple, tiny and easy to use detection of offline & online events for your Vue app (less than 390b minified)
*   [vue-word-cloud (⭐330)](https://github.com/SeregPie/VueWordCloud) - A word cloud generator.
*   [vue-flat-surface-shader (⭐126)](https://github.com/grzhan/vue-flat-surface-shader) - A Vue component for [flat surface shader (⭐2.4k)](https://github.com/wagerfield/flat-surface-shader)
*   [vue-easteregg (⭐13)](https://github.com/ddgll/vue-easteregg) - Easey add an easteregg to your vue app (default with konami code)
*   [vue-barcode-scanner (⭐133)](https://github.com/noomerzx/vue-barcode-scanner)
*   [vue-heatmapjs (⭐190)](https://github.com/BrockReece/vue-heatmapjs) - A Vue directive for tracking and visualising mouse activity
*   [vue-maze (⭐66)](https://github.com/meganetaaan/vue-maze) - An itty-bitty maze game made as Vue.js component
*   [vue-drag-verify (⭐193)](https://github.com/AshleyLv/vue-drag-verify) - This is a vue component, which is sliding to unlock for login or sign up.
*   [vue-balloon (⭐84)](https://github.com/kevinwarne/vue-balloon) - Vue components for creating fixed, zoomable containers in the corner of a page. Similar to the mail composition wrapper used in gmail.
*   [vue-sticker (⭐192)](https://github.com/KamilOcean/vue-sticker) - Sticker effect to any directions
*   [v-rating (⭐48)](https://github.com/vinayakkulkarni/v-rating) - ⭐️ Rating component in Semantic-UI made with VueJS (< 500B gzipped, blazing fast)
*   [vue-content-placeholders (⭐1.6k)](https://github.com/michalsnik/vue-content-placeholders) - Composable components for rendering fake (progressive) content like facebook in vue
*   [vue-page-designer (⭐827)](https://github.com/fireyy/vue-page-designer) - Vue component for drag-and-drop to design and build mobile website.
*   [vue-creativecommons (⭐9)](https://github.com/julon/vue-creativecommons) - CreativeCommons.org Vue.js components library.
*   [vue-status-indicator (⭐159)](https://github.com/coderdiaz/vue-status-indicator) - A Vue.js component to show status indicator as colored dots.
*   [vue-google-adsense (⭐244)](https://github.com/mazipan/vue-google-adsense) - Vue.js Google Adsense Component with InFeed and InArticle Ads support
*   [emoji-vue (⭐132)](https://github.com/shershen08/emoji-vue) - Emoji 😎👌🏻 dropdown for Vue.js project
*   [vue-chessboard (⭐146)](https://github.com/vitogit/vue-chessboard) - Chessboard vue component to load positions, create positions and see threats.
*   [vue-mindmap (⭐554)](https://github.com/anteriovieira/vue-mindmap) - Vue component for mindnode maps.
*   [v-currency (⭐25)](https://github.com/ignoreintuition/v-currency) - Vue component for formatting currency.
*   [vue-emoji-picker (⭐296)](https://github.com/DCzajkowski/vue-emoji-picker) - Highly customizable unicode emoji picker 🔥🚀
*   [vue-8-puzzle (⭐29)](https://github.com/meganetaaan/vue-8-puzzle) - An itty-bitty slide puzzle game made as Vue.js component
*   [vue-e164 (⭐10)](https://github.com/evildvl/vue-e164) - Customizable phone formatter with E.164 standart support
*   [vue-pgn (⭐6)](https://github.com/deemaagog/vue-pgn) - Vue.js component for viewing chess games in pgn format
*   [vue-avatar-editor (⭐86)](https://github.com/fpluquet/vue-avatar-editor) - Resize, rotate and crop your uploaded avatar using a clear user interface.
*   [vue-connection-listener (⭐86)](https://github.com/Botre/vue-connection-listener) - Vue event bus plugin listening for online/offline changes.
*   [vue-sauce (⭐91)](https://github.com/Botre/vue-sauce) - "View source" directive for Vue.
*   [vue-prom (⭐150)](https://github.com/Botre/vue-prom) - Vue promise wrapper component.
*   [numeric-keyboard (⭐350)](https://github.com/viclm/numeric-keyboard) - Numeric keyboard for mobile browsers.
*   [vue-zoom-on-hover (⭐154)](https://github.com/Intera/vue-zoom-on-hover) - Image zoom on mouse hover
*   [vue-responsive-image (⭐55)](https://github.com/HCESrl/vue-responsive-image) - A Vue component that lets you quickly create responsive image tags with an optimal number of image sources for all devices.
*   [vue-highlight-text (⭐55)](https://github.com/TonPC64/vue-highlight-text) - Vue component for highlight multiple instances of a word
*   [vue-cast-props (⭐5)](https://github.com/anteriovieira/vue-cast-props) - Provides a convenient way of converting props to common data types.
*   [vue2-heropatterns (⭐12)](https://github.com/JustSteveKing/vue2-heropatterns) - A Vue2 implementation allowing you to add the popular Hero Patterns onto any Div
*   [vue-link (⭐65)](https://github.com/Developmint/vue-link) - One component to link them all 🔗 (treat external and internal links same)
*   [vue-identify-network (⭐60)](https://github.com/vinayakkulkarni/vue-identify-network) - ⚡️Identify what kinda internet your users are using!
*   [vue-cloneya (⭐15)](https://github.com/ridaamirini/vue-cloneya) - A vue component to clone DOM elements
*   [vue-survey-builder (⭐104)](https://github.com/FissionHQ/vue-survey-builder) - Survey builder for vue.js applications
*   [vue-if-bot (⭐63)](https://github.com/Developmint/vue-if-bot) - A lightweight component to hide/show content to clients based on the user agent
*   [vue-clampy (⭐81)](https://github.com/clampy-js/vue-clampy) - Vue.js (2+) directive that clamps the content of an element by adding an ellipsis to it if the content inside is too long.
*   [vue-cookie-accept-decline (⭐120)](https://github.com/promosis/vue-cookie-accept-decline) - Show a banner with text, a decline button, and an accept button on your page. Remembers selection using cookies. Emits an event with current selection on creation. Good for GDPR requirements.
*   [@lossendae/vue-avatar (⭐13)](https://github.com/lossendae/vue-avatar) - An avatar component for VueJS 2.0.
*   [vue-text-highlight (⭐303)](https://github.com/AlbertLucianto/vue-text-highlight) - Text highlighter library for Vue.js 💄
*   [vue2-hammer (⭐247)](https://github.com/bsdfzzzy/vue2-hammer) Hammer.js wrapper for Vue 2.x to support mobile touch..
*   [vue-countable (⭐26)](https://github.com/johndatserakis/vue-countable) - Vue binding for countable.js. Provides real-time paragraph, sentence, word, and character counting.
*   [v-show-slide (⭐105)](https://github.com/phegman/v-show-slide) - A Vue.js directive for animating an element to and from height: auto in a sliding motion.
*   [vue-swipe-actions (⭐212)](https://github.com/eCollect/vue-swipe-actions) - iOS style swipe actions for Vue.js
*   [vue-friendly-iframe (⭐285)](https://github.com/officert/vue-friendly-iframe) - A Vue js component for creating super fast loading, non-blocking iframes.
*   [vue-beautiful-chat (⭐1.2k)](https://github.com/mattmezza/vue-beautiful-chat) - A simple and beautiful Vue chat component backend agnostic, fully customizable and extendable.
*   [vue-magnifier (⭐58)](https://github.com/zeknoss/vue-magnifier) - A simple image zooming / magnifying component for Vue.js 2.x.
*   [vue-highlight-words (⭐57)](https://github.com/Astray-git/vue-highlight-words) - Vue component to highlight words within a larger body of text. Ported from [react-highlight-words (⭐1.8k)](https://github.com/bvaughn/react-highlight-words)
*   [vue-tags-ball (⭐11)](https://github.com/yanthems/vue-tags-ball) - Create a beautiful and spherical tag with this plugin
*   [vue-rippler (⭐45)](https://github.com/spemer/vue-rippler) - Simple Vue.js plugin for custom ripple effect
*   [vue-contacts (⭐9)](https://github.com/chiaweilee/vue-contacts) - Mobile contacts component for Vue
*   [basic-vue-chat (⭐69)](https://github.com/jmaczan/basic-vue-chat) - Easy to use Vue.js chat
*   [vue-resize-text (⭐66)](https://github.com/JayeshLab/vue-resize-text) - A vue directive which automatically resize font size based on element width.
*   [vue-github-profile (⭐16)](https://github.com/GabrielBibiano/vue-github-profile) - A vue component to view the profile and repos of determined user
*   [vue-niege (⭐31)](https://github.com/P3trur0/vue-niege) - 🎄 🎅 Single File Vue component to add a snow storm through a canvas.
*   [vue-dynamic-star-rating (⭐100)](https://github.com/JonathanDn/vue-stars-rating) - A highly dynamic vue stars rating component, like google play rating ⭐️ ⭐️ ⭐️ ⭐️ ⭐️
*   [vue-katex (⭐105)](https://github.com/lucpotage/vue-katex) - Simple plugin for math typsetting using KaTeX in Vue.js
*   [vue-baberrage (⭐351)](https://github.com/superhos/vue-baberrage) - A simple Barrage plugin Base on Vue.js😎
*   [vue-terminal-ui (⭐52)](https://github.com/shershen08/vue-terminal-ui) - 🖥Terminal UI emulator Vue: custom and basic commands
*   [vue-command (⭐191)](https://github.com/ndabAP/vue-command) - A fully working Vue.js terminal emulator
*   [vue-ribbon (⭐16)](https://github.com/P3trur0/vue-ribbon) - Vue component for GitHub ribbons
*   [avatio-avatar (⭐17)](https://github.com/trunda/avatio-avatar) - Vue component for illustrated avatars - used by [Avatio](https://avatio.cool)
*   [vue-jazzicon (⭐44)](https://github.com/man15h/vue-jazzicon) - A dead-simple Jazzicon component for Vue.
*   [vue-fixed-header (⭐166)](https://github.com/potato4d/vue-fixed-header) - Simple and cross-browser friendly fixed header component for Vue.js written by TypeScript.
*   [vue-particle-effect-buttons (⭐253)](https://github.com/dreambo8563/vue-particle-effect-buttons)A bursting particles effects buttons component.
*   [vue-insomnia (⭐11)](https://github.com/gorbypark/vue-insomnia) - Prevent display screen from sleeping (wake lock).
*   [vue-car-plate-keyboard (⭐9)](https://github.com/yimocanxue/vue-car-plate-keyboard) - A car license plate number keyboard for VueJS 2.x.(车牌号输入键盘，支持新能源车牌 🚗🚗🚗)
*   [vue-dataflow-editor (⭐78)](https://github.com/krthr/vue-dataflow-editor) - Vue2 dataflow graph editor
*   [vue-twemoji-picker (⭐195)](https://github.com/kevinfaguiar/vue-twemoji-picker) - A fast plug-n-play Twemoji Picker (+textarea for Twemoji rendering) for Vue.
*   [vuejs-avataaars (⭐218)](https://github.com/orgordin/vuejs-avataaars) - Simple avatar generator Vue component for avataaars.
*   [vue-moveable (⭐957)](https://github.com/probil/vue-moveable) - A Vue Component that creates Moveable, Draggable, Resizable, Scalable, Rotatable, Warpable and more.
*   [vue-camera-gestures (⭐46)](https://github.com/danielelkington/vue-camera-gestures) - Let users control your Vue app using AI and gestures in front of their camera in just 1 line in your HTML template!
*   [vue-aspect-ratio (⭐37)](https://github.com/albertodeago/vue-aspect-ratio) - A tiny component to handle aspect ratios with no effort.
*   [query-builder-vue (⭐72)](https://github.com/rtucek/vue-query-builder) - A query-builder library for building complex and nested queries with draggable re-ordering.
*   [vue-meeting-selector (⭐74)](https://github.com/IneoO/vue-meeting-selector) - A meeting selector inspired by doctolib, fast and fully custom made with Typescript.
*   [cool-emoji-picker (⭐195)](https://github.com/kevinfaguiar/cool-emoji-picker) - A fast plug-n-play \[Tw]emoji Picker (+textarea for Twemoji rendering) component for Vue.
*   [vue-web-cam (⭐247)](https://github.com/VinceG/vue-web-cam) - Webcam component for VueJs.
*   [vue-cursor-fx (⭐56)](https://github.com/LuXDAmore/vue-cursor-fx) - An animated custom cursor effects for interactive elements like navigation, galleries and carousels.
*   [vuetimeline (⭐322)](https://github.com/growthbunker/vuetimeline) - One easy-to-use component to build beautiful responsive timelines.
*   [v-emoji-picker (⭐325)](https://github.com/joaoeudes7/v-emoji-picker) - :star2: A Lightweight and customizable package of Emoji Picker in Vue using emojis natives (unicode).
*   [learnawesome-flashcard (⭐28)](https://github.com/learn-awesome/flashcard) - Deck of flashcards with spaced-repetition via localStorage :bulb:
...
*   [vue-tabs (⭐254)](https://github.com/cristijora/vue-tabs) - Simple tabs and pills.
*   [vue-swipe-tabs (⭐51)](https://github.com/zhangxiang958/vue-tab) - A touch swipe tab component for vue.js(vue2).
*   [vue-tabs-component (⭐627)](https://github.com/spatie/vue-tabs-component) - An easy way to display tabs with Vue.
*   [vue-k-tabs (⭐8)](https://github.com/kevindesousa/vue-k-tabs) - A simple tabs components with Gitlab design.
*   [vue-tabs-with-active-line (⭐101)](https://github.com/karambafe/vue-tabs-with-active-line) - Simple Vue 2 component, that allows you to make tabs with moving bottom line
*   [vue-tabs-chrome (⭐203)](https://github.com/viewweiwu/vue-tabs-chrome) - A Vue component for Chrome-like tabs.
*   [vue-tiny-tabs (⭐23)](https://github.com/mevinoth/vue-tiny-tabs) - A minimalistic tabs component as tinytabs Vuejs wrapper (size < 3.1kb)
*   [vue-phone-number-input (⭐549)](https://github.com/LouisMazel/vue-phone-number-input) - A beautiful input to format & valid phone number with country code :fire:
*   [vue-tel-input (⭐569)](https://github.com/EducationLink/vue-tel-input) - International Telephone Input with Vue.
*   [vue-pincode-input (⭐129)](https://github.com/Seokky/vue-pincode-input) - Smart pincode input component
*   [vue-smooth-picker (⭐213)](https://github.com/hiyali/vue-smooth-picker) - A smooth picker component for Vue 2.x, like iOS native datetime picker.
*   [vue-scroll-picker (⭐161)](https://github.com/wan2land/vue-scroll-picker) - A scroll picker component for Vue 2.x. Support all gestures of mouse(also wheel) and touch.
*   [vue-fontawesome-picker (⭐17)](https://github.com/zolamk/vue-fontawesome-picker) - a font awesome icon picker component for Vue 2.x.
*   [FormSchema Native (⭐454)](https://github.com/formschema/native) - Generate a form using JSON Schema and Vue.js
*   [vue-generator (⭐6)](https://github.com/michaellyu/vue-generator) - Initial router and components for the Vue project.
*   [vue-form-json (⭐92)](https://github.com/14nrv/vue-form-json) - Generate a vue form with validation and bulma style, from json
*   [form-create (⭐4.5k)](https://github.com/xaboy/form-create) - Form builder with dynamic rendering, data collection, validation, and submission capabilities, supporting json data
*   [element-form-builder (⭐373)](https://github.com/codetrial/element-form-builder) - Build element-ui forms with JSON Schema.
*   [ncform (⭐1.2k)](https://github.com/ncform/ncform) - a very nice configuration generation way to develop form
*   [Laraform (⭐334)](https://github.com/laraform/laraform) - Advanced form builder for Vue.js with Laravel support
*   [vue-ele-form (⭐838)](https://github.com/dream2023/vue-ele-form) - Vue DataForm, based on element-ui
*   [vue-form-generator (⭐2.9k)](https://github.com/vue-generators/vue-form-generator) A schema-based form generator component for Vue.js.
...
*   [vue-select (⭐4.4k)](https://github.com/sagalbot/vue-select) - A native Vue.js component that provides similar functionality to Select2 without the overhead of jQuery.
*   [vue-multiselect (⭐6.2k)](https://github.com/monterail/vue-multiselect) - Universal select/multiselect/tagging component for Vue.js.
*   [stf-vue-select (⭐62)](https://github.com/stfalcon-studio/stf-vue-select) - most flexible and customized select Vue2
*   [vue-select-image (⭐140)](https://github.com/mazipan/vue-select-image) - Vue 2 Component for selecting image from list
*   [@riophae/vue-treeselect (⭐2.5k)](https://github.com/riophae/vue-treeselect) - A multi-select component with nested options support for Vue.js.
*   [@k186/pd-select (⭐102)](https://github.com/k186/pd-select) - A mobile UI component like IOS picker for Vue 2.x,can be wheel pick what ever you defined.
*   [vue-dropdowns (⭐93)](https://github.com/mikerodham/vue-dropdowns) - A minimalistic and adaptable way to display select boxes if using objects for vue2.x
*   [v-cascade (⭐33)](https://github.com/zanseven007/v-cascade) - A lovely component of cascade selector with Vue 2.x (Support both of PC and Mobile)
*   [vue-multi-select (⭐95)](https://github.com/IneoO/vue-multi-select) - A custom component to make select/multiselect for Vue2.
*   [v-region (⭐838)](https://github.com/TerryZ/v-region) - A simple region selector, provide Chinese administrative division data.
...
*   [@myena/advanced-select (⭐16)](https://github.com/myENA/advanced-select) - Single/Multiple Select component with search, controls for (de)select all and a Bootstrap 3 theme
*   [@alfsnd/vue-bootstrap-select (⭐47)](https://github.com/Sandalf/vue-bootstrap-select) - Vue version of [bootstrap-select (⭐9.7k)](https://github.com/snapappointments/bootstrap-select/).
*   [@SamuelTrottier/vue-wheel-select (⭐9)](https://github.com/SamuelTrottier/vue-wheel-select) - A simple scrolling select component.
*   [vue-search-select (⭐347)](https://github.com/moreta/vue-search-select) - Searchable select components and semantic-ui's dropdown compatible.
*   [vue-gridmultiselect (⭐39)](https://github.com/ProticM/vue-gridmultiselect) - Simple multi-select component with items displayed in a table like UI
*   [vue-select-sides (⭐72)](https://github.com/juliorosseti/vue-select-sides) - A component for Vue.js to select double-sided data (2-sides).
*   [vue-slider-component (⭐2.3k)](https://github.com/NightCatSama/vue-slider-component) - Slider for vue1.x and vue2.x.
*   [vue-circle-slider (⭐213)](https://github.com/devstark-com/vue-circle-slider) - Circle slider component for vue2.x.
*   [vue-slide-bar (⭐154)](https://github.com/biigpongsatorn/vue-slide-bar) - Very simple vue slider bar component.
*   [textra (⭐31)](https://github.com/hosein2398/Textra) - Vue js add-on to slide text.
*   [vue-knob-control (⭐52)](https://github.com/kramer99/vue-knob-control) - A rotary knob control for Vue.js
*   [iv-slider (⭐8)](https://github.com/lycHub/v-slider) - Slider component for vue2.x.
*   [vue-histogram-slider (⭐109)](https://github.com/oguzhaninan/vue-histogram-slider) - Range slider with histogram for Vue.js
*   [xns-seek-bar (⭐3)](https://github.com/xinnks/xns-seek-bar) - A seekable progress plugin for Vue 2.x.
*   [vuedraggable (⭐18k)](https://github.com/SortableJS/Vue.Draggable) - Vue component allowing drag-and-drop sorting in sync with View-Model. Based on Sortable.js.
*   [vue-dragula (⭐361)](https://github.com/Astray-git/vue-dragula) - Drag and drop so simple it hurts.
*   [vue2-dragula (⭐207)](https://github.com/kristianmandrup/vue2-dragula) - A `vue-dragula` fork for `Vue2`, with a lot of improvements.
*   [awe-dnd (⭐756)](https://github.com/hilongjw/vue-dragging) - A sortable list directive with Vue.
*   [vue-draggable-resizable (⭐2.7k)](https://github.com/mauricius/vue-draggable-resizable) - Vue2 component for draggable and resizable elements.
*   [vddl (⭐400)](https://github.com/hejianxian/vddl) - Vue components for modifying lists with the HTML5 drag & drop API, supports VueJs versions 1 and 2.
*   [vue-drag-drop (⭐491)](https://github.com/cameronhimself/vue-drag-drop) - A minimal and lightweight wrapper for the HTML5 Drag and Drop API.
*   [vue-swing (⭐205)](https://github.com/goweiwen/vue-swing) - A swipeable cards interface, as seen in apps like Jelly and Tinder.
*   [vue-slicksort (⭐1.2k)](https://github.com/Jexordexan/vue-slicksort) - A dependency-free set of mixins for animated, touch-friendly, sortable lists
*   [draggable-vue-directive (⭐312)](https://github.com/IsraelZablianov/draggable-vue-directive) - A simple directive to handle drag and drop of any Vue component.
*   [vue-smooth-dnd (⭐1.5k)](https://github.com/kutlugsahin/vue-smooth-dnd) - Vue wrappers of smooth-dnd library. drag and drop, sortable library covering for many cases.
*   [vue-drag-resize (⭐1.7k)](https://github.com/kirillmurashov/vue-drag-resize) - A dependency-free Vue component for draggable and resizable elements with aspect ratio, reactive props etc
*   [vue-drag-it-dude (⭐75)](https://github.com/Esvalirion/vue-drag-it-dude) - Vue2 component, that allows you to drag object wherever you want.
*   [vue-draggable (⭐303)](https://github.com/Vivify-Ideas/vue-draggable) - Vue Drag and Drop library without any dependency. Simple and easy to use.
*   [vue-nestable (⭐308)](https://github.com/rhwilr/vue-nestable) - A simple drag & drop hierarchical list made as a vue component.
*   [vue-tinder (⭐186)](https://github.com/shanlh/vue-tinder) - Have your own Tinder and TanTan.
*   [vue-card-swipe (⭐26)](https://github.com/eshengsky/vue-card-swipe) - A touch slider for vue.js, support sliding in any direction to switch cards, compatible with PC and mobile.
*   [vue-drag-n-drop (⭐169)](https://github.com/smaharj1/vue-drag-and-drop-kanban) - A simple kanban board where the items can be dragged and dropped from the list on to the board.
*   [vue-instant (⭐415)](https://github.com/santiblanko/vue-instant) - Vue instant allows you to easily create custom search controls with auto suggestions for your vue 2 applications.
*   [v-autocomplete (⭐345)](https://github.com/paliari/v-autocomplete) - Autocomplete component for Vue.js
*   [vue-auto-complete (⭐137)](https://github.com/charliekassel/vuejs-autocomplete) - Autocomplete for Vue2. Works with objects or api calls.
*   [vue-autosuggest (⭐590)](https://github.com/Educents/vue-autosuggest) - WAI-ARIA complete Autosuggest component with full customization over rendering and styling.
*   [v-autosuggest (⭐10)](https://github.com/soraino/v-autosuggest) - A simple modular Vuejs component that autosuggest input from a dynamic or static data querying.
*   [autocomplete (⭐9)](https://github.com/ieski/AutoComplete) - Simple Autocomplete component for Vue.js 2.\*
*   [vue-infinite-autocomplete (⭐7)](https://github.com/Attrash-Islam/vue-infinite-autocomplete) - Vue infinite-autocomplete wrapper for Vue.js 2.\*
*   [vue-simple-suggest (⭐434)](https://github.com/KazanExpress/vue-simple-suggest) - Simple yet feature-rich autocomplete component for Vue.js
*   [v-suggest (⭐74)](https://github.com/TerryZ/v-suggest) - A Vue2 plugin for input content suggestions, support keyboard to quick pick.
*   [vue-bootstrap-typeahead (⭐209)](https://github.com/alexurquhart/vue-bootstrap-typeahead) - An typeahead/autocomplete component for Vue2 using Bootstrap 4 CSS.
*   [vue-email-dropdown (⭐28)](https://github.com/DannyFeliz/vue-email-dropdown) - An autocomplete for custom email domains.
*   [vue-input-tag (⭐542)](https://github.com/matiastucci/vue-input-tag) - Vue.js 2.0 Input Tag Component.
*   [v-distpicker (⭐958)](https://github.com/jcc/v-distpicker) A flexible, highly available district picker for picking provinces, cities and districts of China for Vue.js 2.x.
*   [vue-img-inputer (⭐562)](https://github.com/waynecz/vue-img-inputer) A graceful, highly customizable img type input for Vue 2
*   [vue-img-preview (⭐19)](https://github.com/dameety/vue-image-preview) An image input preview component in vue 2
*   [v-image (⭐37)](https://github.com/vinayakkulkarni/v-image) :camera: Tiny little component for input type=file (< 1kb, gzipped)
*   [@voerro/vue-tagsinput (⭐449)](https://github.com/AlexMordred/vue-tagsinput) A simple tags input Vue.js 2 component with typeahead/autocomplete
*   [vue-tag-selector (⭐14)](https://github.com/tomquinonero/vue-tag-selector) - Tag-like input. Light, customizable and handles REGEX validation!
*   [vue-input-text-to-tags (⭐3)](https://github.com/leepyng/vue-input-text-to-tags) - A input component that can create tags for the result display
*   [vue-color (⭐2.4k)](https://github.com/xiaokaike/vue-color) - Vue Color Pickers for Sketch, Photoshop, Chrome & more.
*   [vue-swatches (⭐546)](https://github.com/saintplay/vue-swatches) - Help the user picking beautiful colors!
*   [radial-color-picker (⭐80)](https://github.com/radial-color-picker/vue-color-picker) - Minimalistic color picker with a focus on size, accessibility and performance.
*   [vue-color-picker-board (⭐12)](https://github.com/shlomnissan/vue-color-picker-board) - Vue Color Picker component designed for humans!
*   [verte (⭐155)](https://github.com/baianat/verte) - A Complete Vue.js Color Picker Component.
*   [vue-switches (⭐205)](https://github.com/drewjbartlett/vue-switches) - An on/off switch component for Vue.js with theme support.
*   [vue-js-toggle-button (⭐903)](https://github.com/euvl/vue-js-toggle-button) - Vue.js 2.0+ toggle / switch button - simple, pretty, customizable.
*   [vue-checkbox-radio (⭐106)](https://github.com/mariomka/vue-checkbox-radio) - A Vue component to easily styling checkbox and radio inputs.
*   [vue-enhanced-check (⭐18)](https://github.com/Keiwen/vue-enhancedCheck) - Vue component to redesign/labelize checkbox/radio, including toggle/switch button.
*   [pretty-checkbox-vue (⭐259)](https://github.com/hamed-ehtesham/pretty-checkbox-vue) - Implementation of [pretty checkbox 3](https://lokesh-coder.github.io/pretty-checkbox/)(A pure CSS library to beautify checkbox and radio buttons) components for Vue.js 2.2+.
*   [vue2-collapse (⭐77)](https://github.com/roszpun/vue-collapse/) - Vue Collapse is a flexible content toggling plugin for the accordion lists or any other conditional content rendering.
*   [vue-badger-accordion (⭐27)](https://github.com/vanderb/vue-badger-accordion) - A wrapping Component for Badger Accordion for Vue.js 2.0+
*   [vue-loading-checkbox (⭐27)](https://github.com/Carrene/vue-loading-checkbox) - A highly customizable Vue.js checkbox UI component with loading state
*   [vue-rocker-switch (⭐31)](https://github.com/DannyFeliz/vue-rocker-switch) - A customizable rocker switch component for Vue.js.
*   [vue-toggle-btn (⭐42)](https://github.com/JonathanDn/vue-toggle-btn) - A Highly Customizable, easy-to-use elegant toggle/switch button component
*   [vue-tristate-checkbox (⭐5)](https://github.com/hartwork/vue-tristate-checkbox) - Cycling tristate checkbox that supports form submission
*   [vue-quill-editor (⭐7.2k)](https://github.com/surmon-china/vue-quill-editor) - Quill editor component for Vue2.
*   [vue-mobiledoc-editor (⭐73)](https://github.com/alidcastano/vue-mobiledoc-editor) - A mobiledoc editor component toolkit for Vuejs.
*   [vue2-medium-editor (⭐404)](https://github.com/FranzSkuffka/vue-medium-editor) - A MediumEditor component for Vue 2.
*   [vue-froala-wysiwyg (⭐596)](https://github.com/froala/vue-froala-wysiwyg) - Official VueJS plugin for Froala WYSIWIG HTML Editor.
*   [vue-at (⭐505)](https://github.com/fritx/vue-at) - At.js for Vue.
*   [vue-wysiwyg (⭐529)](https://github.com/chmln/vue-wysiwyg) Lightweight, fast & extensible WYSIWYG editor
*   [vue-trumbowyg (⭐232)](https://github.com/ankurk91/vue-trumbowyg) Vue.js component for [Trumbowyg](http://alex-d.github.io/Trumbowyg/) WYSIWYG editor
*   [vue-pell-editor (⭐34)](https://github.com/CinKon/vue-pell-editor) Vue.js component for [Pell](https://jaredreich.com/pell) WYSIWYG editor
*   [vue-tinymce-editor (⭐222)](https://github.com/dyonir/vue-tinymce-editor) Tinymce editor component for Vue2.
*   [vue-mce (⭐72)](https://github.com/Eazymov/vue-mce) - tinymce editor component for VueJS.
*   [Vue2-Editor (⭐2.4k)](https://github.com/davidroyer/vue2-editor) - HTML Editor using Vue.js and Quilljs
*   [vue-codemirror (⭐2.5k)](https://github.com/surmon-china/vue-codemirror) - A Codemirror component for Vue2.
*   [vue-easy-tinymce (⭐25)](https://github.com/m3esma/vue-easy-tinymce) - A simple and powerful package for easy usage of tinymce in Vue.js project.
*   [vue-highlightable-input (⭐174)](https://github.com/SyedWasiHaider/vue-highlightable-input) - Highlight and style text as you're typing
*   [vue-trix (⭐212)](https://github.com/hanhdt/vue-trix) - Simple and lightweight Trix rich-text editor for Vue.js
*   [tiptap (⭐17k)](https://github.com/heyscrumpy/tiptap) - A renderless and extendable rich-text editor for Vue.js
*   [toast-ui.vue-editor (⭐235)](https://github.com/nhnent/toast-ui.vue-editor) - Vue Wrapper for [TOAST UI Editor](http://ui.toast.com/tui-editor).
*   [ckeditor5-vue (⭐278)](https://github.com/ckeditor/ckeditor5-vue) - An official CKEditor 5 rich text editor component for Vue.js.
*   [yimo-vue-editor (⭐32)](https://github.com/yimogit/yimo-vue-editor) - A wangEditor2 component for Vue2.
*   [vue-mathlive (⭐96)](https://github.com/arnog/vue-mathlive) A MathLive math editor (mathfield) for Vue.hjs
*   [vue-editor-js (⭐282)](https://github.com/ChangJoo-Park/vue-editor-js) Next generation block styled editor. for Vue.js
*   [element-tiptap (⭐862)](https://github.com/Leecason/element-tiptap) A WYSIWYG rich-text editor using tiptap and Element UI for Vue.js
*   [@mycure/vue-wysiwyg (⭐42)](https://github.com/mycurelabs/vue-wysiwyg) - 34Kb lightweight wysiwyg editor with NO 3rd party plugin.
*   [vue-core-image-upload (⭐1.4k)](https://github.com/Vanthink-UED/vue-core-image-upload) - A vue plugin for image to crop and upload.
*   [vue-croppa (⭐958)](https://github.com/zhanziyang/vue-croppa) - A simple straightforward customizable lightweight mobile-friendly image cropper for Vue 2.0.
*   [vue-cropper (⭐3.5k)](https://github.com/xyxiao001/vue-cropper) - A picture clipping plugin for vue2.0
*   [toast-ui.vue-image-editor (⭐187)](https://github.com/nhnent/toast-ui.vue-image-editor) - Vue Wrapper for [TOAST UI Image Editor](http://ui.toast.com/tui-image-editor).
*   [vue-quick-cropper (⭐37)](https://github.com/duyanpeng/vue-quick-cropper) - Vue mobile avatar upload cropping plugin can choose cropping area and zoom.
*   [vue-croppie (⭐248)](https://github.com/jofftiquez/vue-croppie) - Yet another image cropper
*   [vue-slim-cropper (⭐37)](https://github.com/wannaxiao/vue-slim-cropper) - 💇 A simple and elegant mobile image crop upload component for Vue 2.x.
*   [vue-advanced-cropper (⭐616)](https://github.com/Norserium/vue-advanced-cropper) - An advanced cropper that gives you opportunity to create almost any cropper that you desire
*   [vue-anka-cropper (⭐18)](https://github.com/e-anka/vue-anka-cropper) - image cropper and uploader, rectangular and circular crop, customizable css
*   [vue-cloudinary (⭐25)](https://github.com/diegopamio/vue-cloudinary) - A vue (2.0) plugin that offers a reusable directive to get images from Cloudinary (<https://cloudinary.com>) with dynamic manipulation (resizing/cropping/effects/watermarking/scaling/formatting) and optimization (webp/png/auto quality/auto retina).
*   [img-Vuer (⭐260)](https://github.com/ssshooter/img-vuer) - An Mobile-First image viewer/gallery for Vue2
*   [vue-image-loader (⭐57)](https://github.com/kevindesousa/vue-image-loader) - A vue loader/progressive image plugin like Medium.
*   [vue-load-image (⭐61)](https://github.com/john015/vue-load-image) - display loader during image loading, as well as by display alternate content when the image fails to load.
*   [vue-image-painter (⭐26)](https://github.com/wannaxiao/vue-image-painter) - 🙋 Image magic animation drawing effect component for Vue 2.x.
*   [vue-cosha (⭐77)](https://github.com/kn0wn/vue-cosha) - 🎨 An easy to use vue directive that places a colourful shadow behind any image
*   [vue-clip (⭐221)](https://github.com/thetutlage/vue-clip) - Simple and hackable file uploader for VueJs. Supports Vue >= 2.1.
*   [vue-simple-upload (⭐142)](https://github.com/saivarunk/vue-simple-upload) - Simple File upload component for Vue.js.
*   [vue2-multi-uploader (⭐47)](https://github.com/updivision/vue2-multi-uploader) - A drag and drop multiple file uploader component that uses Vue.js v2 and Axios. Uploader shows file names, sizes and total size of files added. It also allows setting a minimum required number of files to upload.
*   [vue-dropzone (⭐2k)](https://github.com/rowanwins/vue-dropzone) - A Vue.js (vue2) component for Dropzone.js - a drag’n’drop file uploads utility with image previews.
*   [vue-transmit (⭐212)](https://github.com/alexsasharegan/vue-transmit) - A purely Vue.js drag & drop uploader component based on Dropzone.js for Vue 2.0
*   [vue-upload-component (⭐2.5k)](https://github.com/lian-yue/vue-upload-component) - Vue upload component, Multi-file upload, Upload directory, Drag upload, Drag the directory. Supports Vue >= 2.0
*   [vue-uploader (⭐1.7k)](https://github.com/simple-uploader/vue-uploader) - A Vue.js upload component powered by simple-uploader.js
*   [ic-firebase-uploader (⭐21)](https://github.com/InCuca/ic-firebase-uploader) - A clean multi-file upload component for Firebase storage.
*   [vuejs-uploader (⭐63)](https://github.com/charliekassel/vuejs-uploader) - A resumable multipart file uploader for HUGE file uploads.
*   [vue-filepond (⭐1.7k)](https://github.com/pqina/vue-filepond) - A Vue.js component for FilePond - a file upload library that can upload anything you throw at it.
*   [v-uploader (⭐229)](https://github.com/TerryZ/v-uploader) - A Vue2 plugin to make files upload simple and easier, you can drag files or select file in dialog to upload
*   [vue-context-menu (⭐295)](https://github.com/vmaimone/vue-context-menu) - A context menu component for vue js.
*   [vue-lil-context-menu (⭐14)](https://github.com/timwis/vue-lil-context-menu) - A flexible lil context menu component for Vue.
*   [vue-mouse-menu (⭐79)](https://github.com/zgj233/vue-mouse-menu) - A popup menu for vue 2.6+ with support for mobile.
*   [vue-context (⭐250)](https://github.com/rawilk/vue-context) - A simple but flexible context menu for vue js.
*   [vue-simple-context-menu (⭐200)](https://github.com/johndatserakis/vue-simple-context-menu) - Simple context-menu component built for Vue. Works well with both left and right clicks.
*   [@kiyoaki\_w/vue-context (⭐6)](https://github.com/Kiyoaki-w/Ki-vue-context) - A customizable context menu component built for Vue2, supporting fontawesome icons.
*   [@overcoder/vue-context-menu (⭐3)](https://github.com/MicroDroid/vue-context-menu) - Minimal context menus
*   [vue-gmaps (⭐117)](https://github.com/ridermansb/vue-gmaps) - Search places and address using Google Maps API.
*   [vuep (⭐877)](https://github.com/QingWei-Li/vuep) - A component for rendering Vue components with live editor and preview.
*   [vue-places (⭐108)](https://github.com/Gomah/vue-places) - Places component is based on places.js for Vue 2.x. Turn any input into an address autocomplete.
*   [vue-password-strength-meter (⭐544)](https://github.com/apertureless/vue-password-strength-meter) - Password strength meter based on zxcvbn in vue.js.
*   [vue-float-label (⭐177)](https://github.com/bkzl/vue-float-label) - Float label pattern for Vue.js.
*   [vue-longpress (⭐75)](https://github.com/javisperez/vuelongpress) - A VueJS (2.x) button component that requires you to keep pressing to confirm a given action.
*   [vue-google-autocomplete (⭐495)](https://github.com/olefirenko/vue-google-autocomplete) - A Vue.js (2.x) autosuggest component for the Google Maps Places API.
*   [vue-default-value (⭐17)](https://github.com/termosa/vue-default-value) - Vue.js 2.x directive to set a default value for editable elements with no affect to the model state
*   [vue-submit (⭐142)](https://github.com/NxtChg/pieces/tree/master/js/vue/vue-submit) - Simple implementation of Ladda ([1](http://lab.hakim.se/ladda/), [2](https://msurguy.github.io/ladda-bootstrap/)) in less than 90 lines of code with no dependencies.
*   [vue-rate (⭐212)](https://github.com/SinanMtl/vue-rate) - Rate component for Vue
*   [vuetify-google-autocomplete (⭐93)](https://github.com/MadimetjaShika/vuetify-google-autocomplete) - A Vuetify ready Vue.js (2.x) autosuggest component for the Google Maps Places API.
*   [vue-ripple-directive (⭐284)](https://github.com/PygmySlowLoris/vue-ripple-directive) - Material Ripple Effect as Vue Directive.
*   [vue-fab (⭐268)](https://github.com/PygmySlowLoris/vue-fab) - Vue Floating Action Button.
*   [vue-complexify (⭐11)](https://github.com/mazipan/vue-complexify) - Vuejs porting library from jquery.complexify.js.
*   [vue-mc (⭐627)](https://github.com/FiguredLimited/vue-mc) - Models and Collections for Vue.js
*   [vue-stars](https://www.tallent.us/vue-stars/) - Highly customizable rating control (using stars or other characters)
*   [vue-confirmation-button (⭐55)](https://github.com/imRohan/vue-confirmation-button) - Customizable confirmation button that requires users to read messages before performing an action
*   [vue-poll (⭐128)](https://github.com/ppietris/vue-poll) - A Vue.js component for voting
*   [vue-diagrams (⭐248)](https://github.com/gwenaelp/vue-diagrams) - Diagram component for vue.js, inspired by react-diagrams
*   [vue-easy-polls (⭐14)](https://github.com/updivision/vue-easy-polls) - A Vue.js component for creating polls, voting and showing results. It’s easy to implement and easy to customize.
*   [vue-m-button (⭐15)](https://github.com/mengdu/m-button) - A beautiful button component for vue.
*   [vue-long-click (⭐55)](https://github.com/ittus/vue-long-click) - Long click (long press) directive library for vue, support mobile and desktop.
*   [vue-ui-predicate (⭐128)](https://github.com/FGRibreau/ui-predicate/tree/master/packages/ui-predicate-vue) - A rules editor, generic filtering UI, predicates component for Vue JS.
*   [vue-mobile-detection (⭐66)](https://github.com/ajerez/vue-mobile-detection) - Vue.js prototype function `this.$isMobile()` that returns a Boolean value depending on whether or not the user is browsing with a mobile.
*   [vue-input-contenteditable (⭐19)](https://github.com/Cobertos/vue-input-contenteditable) - A Vue component wrapper for `contenteditable` with all the features you normally expect. Make beautiful inputs without the restrictions of `input[type='text']`.
*   [@utlime/vue-zoom (⭐2)](https://github.com/utlime/vue-zoom) - A Vue zoom component.
*   [vue-credit-card (⭐26)](https://github.com/fracto-team/vue-credit-card) - A Vue Component for Credit Card Input & Masking & Preview
*   [vue-simple-password-meter (⭐75)](https://github.com/miladd3/vue-simple-password-meter) - Lightweight password strength meter with no dependency
*   [vue-autosizer (⭐5)](https://github.com/hfalucas/vue-autosizer) - A light replacement for built-in `<textarea>` and `<input>` elements allowing them to automatically stretch to fit the content.
*   [vue-interactive-paycard (⭐15)](https://github.com/muhammederdem/vue-interactive-paycard) - A fantastic credit card form with smooth and sweet micro-interactions.
*   [vue-form-wizard (⭐1.1k)](https://github.com/cristijora/vue-form-wizard) - Tab based component which can replace classic bootstrap & jQuery form wizards
*   [vue-stepper (⭐356)](https://github.com/PygmySlowLoris/vue-stepper) - A simple stepper with simple actions such as next, back and end to perform simple forms.
*   [vue-stepper-component (⭐105)](https://github.com/adi518/vue-stepper-component) - A fully customizable Stepper component with Vuex support and Zero dependencies.
*   [vuecsv (⭐48)](https://github.com/ynishi/vuecsv) - A Simple CSV Downloader from json with option modal panel component.
*   [vue-easeljs (⭐88)](http://github.com/dankuck/vue-easeljs) - Data-driven control over an HTML5 canvas element.
*   [vue-canvas-effect (⭐120)](https://github.com/chenxuan0000/vue-canvas-effect) - A simple, canvas effect collection for Vue.js.
*   [vue-konva (⭐900)](https://github.com/rafaesc/vue-konva) - Vue & Canvas - JavaScript library for drawing complex canvas graphics using Vue.
*   [vue-html2canvas (⭐111)](https://github.com/mycure-inc/vue-html2canvas) - Vue mixin to capture html and convert it to an image using Html2Canvas.
*   [vue-canvas-nest (⭐155)](https://github.com/ZYSzys/vue-canvas-nest) - A Vue.js component for canvas-nest.
*   [vue-signature-pad (⭐384)](https://github.com/neighborhood999/vue-signature-pad) - 🖋 A Vue Signature Pad Component
*   [vg-editor (⭐196)](https://github.com/ChrisShen93/VGEditor) - A visual graph editor based on G6 and Vue, inspired by GGEditor
*   [vue-pencil.js (⭐9)](https://github.com/pencil-js/vue-pencil.js) - Build reactive 2D graphics scene in your Vue project.
*   [link-prevue (⭐227)](https://github.com/nivaldomartinez/link-prevue) - Flexible component for generate a link preview.

### Components & Libraries / UI Layout

*   [vue-waterfall (⭐2k)](https://github.com/MopTym/vue-waterfall) - A waterfall layout component for Vue.js.
*   [vueisotope (⭐345)](https://github.com/David-Desmaisons/Vue.Isotope) - Vue component for isotope filter & sort magical layouts.
*   [vue-grid-layout (⭐5.9k)](https://github.com/jbaysolutions/vue-grid-layout) - A draggable and resizable grid layout, for Vue.js.
*   [vue-drag-zone (⭐127)](https://github.com/surmon-china/vue-drag-zone) - Drag Zone component for Vue.js(2.x).
*   [vue-masonry (⭐593)](https://github.com/shershen08/vue-masonry) - Vue.js directive for masonry blocks layouting.
*   [vue-fraction-grid (⭐87)](https://github.com/bkzl/vue-fraction-grid) - Flexbox based responsive fraction grid system for Vue.js.
*   [vue-virtual-scroll-list (⭐3.8k)](https://github.com/tangbc/vue-virtual-scroll-list) - A vue (2.x) component support big data by using virtual scroll list.
*   [vue-virtual-scroller (⭐7.3k)](https://github.com/Akryum/vue-virtual-scroller) - Component to scroll a large amount of elements efficiently (Vue 2.x).
*   [vue-virtualscroll (⭐15)](https://github.com/ddgll/vue-virtualscroll) - \[Vue 2.x] component to virtual scroll things.
*   [vue-inview (⭐100)](https://github.com/rachmanzz/vue-inview) - \[Vue 2.x] Viewport, get notification when DOM element is entered or leave.
*   [dnd-grid (⭐308)](https://github.com/dattn/dnd-grid) - A vuejs grid with draggable and resizable boxes
*   [vue-extend-layout (⭐134)](https://github.com/ktquez/vue-extend-layout) - Extend the default layout or create custom layouts for the pages of your Vue.js SPA
*   [vue-masonry-css (⭐434)](https://github.com/paulcollett/vue-masonry-css) - Vue.js Masonry layout component powered by CSS, dependency free.
*   [vue-fullpage.js (⭐1.7k)](https://github.com/alvarotrigo/vue-fullpage.js) - Official fullPage.js component for Vue.js.
*   [vue-virtual-collection (⭐603)](https://github.com/starkwang/vue-virtual-collection) - Vue component for efficiently rendering large collection data.
*   [autoresponsive-vue (⭐139)](https://github.com/xudafeng/autoresponsive-vue) - Auto responsive grid layout library for Vue.
*   [VueFlex (⭐13)](https://github.com/SeregPie/VueFlex) - A flexbox grid system.
...
*   [vue-grid-styled (⭐17)](https://github.com/mattrothenberg/vue-grid-styled) - A lightweight set of functional grid components, ported from React's [grid-styled (⭐2.1k)](https://github.com/jxnblk/grid-styled/)
*   [simple-grid (⭐26)](https://github.com/anthinkingcoder/simple-grid) - Vue component for grid layout,support flex.
...
*   [vue-ads-layout (⭐29)](https://github.com/arnedesmedt/vue-ads-layout) - A small library of Vue components to quickly generate a responsive web application layout with toolbar, left/right drawers and a footer. All components can be positioned fixed or relative.
...
*   [vue-mock-layout (⭐8)](https://github.com/promosis/vue-mock-layout) - Easily mock the layout of your Vue apps.
...
*   [vue-grd (⭐43)](https://github.com/1000ch/vue-grd) - Simple, Light-weight and Flexible Vue.js component for grid layout.
*   [vue-masonry-component (⭐9)](https://github.com/Guillaume69/vue-masonry-component) - A Vue.js component wrapping masonry layout library.
*   [vue-smart-widget (⭐135)](https://github.com/xiaoluoboding/vue-smart-widget) - Smart widget is a flexible and extensible content container component for Vue.js 2.x.
*   [vue-colrow (⭐7)](https://github.com/phphe/vue-colrow) - Responsive grid layout components: Row, Col. Based on css flexbox. Support SSR, fixed or fraction width, auto grow Col.
*   [vue-diagonal (⭐4)](https://github.com/albertodeago/vue-diagonal) - Simple and light-weight component to create diagonal elements.
*   [vue-responsive-dash (⭐234)](https://github.com/bensladden/vue-responsive-dash) - A Responsive, Draggable & Resizable Dashboard (grid) made with vue and typescript.
*   [vue-masonry-wall (⭐184)](https://github.com/fuxingloh/vue-masonry-wall) - A pure vue responsive masonry layout without direct dom manipulation, ssr friendly and lazy loading.
*   [vue-horizontal-list (⭐174)](https://github.com/fuxingloh/vue-horizontal-list) - A pure vue responsive horizontal list layout with ssr support, mobile and touch friendly.

### Components & Libraries / Frameworks

*   [quasar-framework (⭐22k)](https://github.com/quasarframework/quasar) - Quasar Framework. Build responsive websites, hybrid mobile Apps and Electron apps using same code, with VueJs 2.
*   [vue-material (⭐9.7k)](https://github.com/vuematerial/vue-material) - Material design for Vue.js.
*   [vuetify (⭐35k)](https://github.com/vuetifyjs/vuetify) - Material Component Framework for Vue.js 2.
*   [muse-ui (⭐8.3k)](https://github.com/museui/muse-ui) - Material Component library for Vue.js 2.
*   [buefy (⭐9.3k)](https://github.com/rafaelpimpa/buefy) - Components based on Bulma framework.
*   [element-ui (⭐53k)](https://github.com/ElemeFE/element) - A Vue.js 2.0 UI Toolkit for Web.
*   [vue-bulma-components (⭐159)](https://github.com/vouill/vue-bulma-components) - Easily use bulma class syntax with vue components.
...
*   [zircle-ui (⭐907)](https://github.com/zircleUI/zircleUI) - A frontend library to develop zoomable user interfaces.
*   [Material Components Vue (⭐309)](https://github.com/matsp/material-components-vue) - wrapper around [material-components-web (⭐16k)](https://github.com/material-components/material-components-web) for Vue.js
*   [VueFace (⭐76)](https://github.com/sudheerj/vueface) - A Vue.js 2.0 UI Component library for Web
...
*   [N3-components (⭐1k)](https://github.com/N3-components/N3-components) - Beautiful Web Components built with Vue 2
*   [Shards Vue (⭐397)](https://github.com/designrevision/shards-vue) - ✨ Sleek & UI Components Library based on the Bootstrap 4 Framework.
*   [Fundamental Vue (⭐185)](https://github.com/SAP/fundamental-vue) - Components based on SAP Fiori Fundamentals.
*   [Framevuerk (⭐268)](https://github.com/framevuerk/framevuerk) - 🚀 Fast, Responsive, Without Dependencies, Both Direction Support and Configurable UI Framework based on Vue.js.
*   [@Carbon/vue (⭐497)](https://github.com/carbon-design-system/carbon-components-vue) - Carbon Design System components from the @carbon team.
*   [vue-awesome-mui (⭐312)](https://github.com/Wscats/vue-awesome-mui) - A Vue.js 2.0 MUI Component for Web
*   [MDBootstrap (⭐889)](https://github.com/mdbootstrap/Vue-Bootstrap-with-Material-Design) - Powerful UI toolkit based on the latest Bootstrap 4 and Vue 2.6.10, providing a set of slick, responsive page templates, layouts, components and widgets to rapidly build responsive, mobile-first websites and apps.
*   [vue-material-adapter (⭐97)](https://github.com/pgbross/vue-material-adapter) - Integration of Material Components for Vue.js which follows the best practices recommended by Google: Using Foundations and Adapters
*   [PrimeVue](https://primefaces.org/primevue) - The Most Complete UI Component Library for Vue
*   [CoreUI for Vue.js (⭐520)](https://github.com/coreui/coreui-vue) - CoreUI for Vue.js is a UI Component Library that offers a bunch of cross-browser, responsive, and lightweight Vue.js UI components.
*   [DaoStyle (⭐116)](https://github.com/DaoCloud/dao-style) - A high quality component library built on Vue.js.
*   [Chakra UI Vue (⭐1.6k)](https://github.com/chakra-ui/chakra-ui-vue) - ⚡ A lightweight & customizable component library to help you build accessible Vue applications and sites with speed.
*   [vux (⭐18k)](https://github.com/airyland/vux) - \[Chinese] Vue UI Components based on WeUI.
*   [vue-onsenui (⭐8.6k)](https://github.com/OnsenUI/OnsenUI) - Mobile app development framework and SDK using HTML5 and JavaScript. Create beautiful and performant cross-platform mobile apps. Based on Web Components, and provides bindings for Angular 1, 2, React and Vue.js.
...
*   [weex-eros (⭐144)](https://github.com/bmfe/eros-template) - \[Chinese] Eros is a app solution based on Weex and Vue, which enables you to use API of Vue, simple and quick development of small and medium app.
*   [mint-ui (⭐17k)](https://github.com/ElemeFE/mint-ui) - Mobile UI elements for Vue.js.
*   [vant (⭐20k)](https://github.com/youzan/vant) - A Vue.js 2.0 Mobile UI From YouZan.
...
*   [NutUI (⭐4.8k)](https://github.com/jdf2e/nutui/) - A Vue.js 2.0 UI Toolkit for Mobile Web
*   [vue-mdc (⭐1.2k)](https://github.com/posva/vue-mdc) - Material Components Web for Vue.js.
...
*   [vue-admin (⭐9.5k)](https://github.com/vue-bulma/vue-admin) - Vue Admin Panel Framework, Powered by Vue 2.0 and Bulma 0.3.
*   [vuikit (⭐1.5k)](https://github.com/vuikit/vuikit) - UIkit with all the power of Vue.
*   [wffranco/vue-strap (⭐341)](https://github.com/wffranco/vue-strap) - Bootstrap 3 components built with Vue.js 2
*   [jsmod-vue-pc (⭐73)](https://github.com/chaogao/jsmod-pc-vue) - Highly scalable web components for vue 2.0
*   [guilhermewaess/SemVue (⭐34)](https://github.com/guilhermewaess/SemVue) - Semantic-ui Modules implemented with Vue 2
*   [office-ui-fabric-vue (⭐275)](https://github.com/aidewoode/office-ui-fabric-vue) - Office UI Fabric implementation for Vue.js
*   [Semantic UI Vue (⭐938)](https://github.com/Semantic-UI-Vue/Semantic-UI-Vue) - Semantic UI integration for Vue
*   [vuesax (⭐5.5k)](https://github.com/lusaxweb/vuesax) - Frontend vue Components for Vue.js.
*   [Banshee (⭐88)](https://github.com/banshee-ui/banshee) - A mostly renderless Vue UI component and utility framework that ships with no CSS.
*   [vue-atlas (⭐185)](https://github.com/nvms/vue-atlas) - A library of beautiful Vue components.
*   [DevExtreme Vue Components (⭐241)](https://github.com/DevExpress/devextreme-vue) - 65+ responsive and feature-complete Vue UI components with customizable Material Design and Bootstrap compliant themes.
*   [jqwidgets](https://www.jqwidgets.com/vue/) - 70+ Vue.js 2.0 UI Components with Material Design themes.
*   [vue-uix (⭐15)](https://github.com/juijs/vue-uix) - UI collection for web page implementation in Vue.js
*   [vuedarkmode (⭐1.1k)](https://github.com/LeCoupa/vuedarkmode) - A Minimalist Dark Design System for Vue.js 🎨
...
*   [Vuent (⭐268)](https://github.com/arturmiz/vuent) - Vue.js components implementing Microsoft Fluent Design
*   [bpit/vue (⭐16)](https://github.com/dreambo8563/bpit-vue) - Vue components lib which is focused on effects
*   [vue-tailwind (⭐1.9k)](https://github.com/alfonsobries/vue-tailwind) - Vue components with customizable classes ready for TailwindCSS, but compatible with any framework.
*   [Equal UI (⭐855)](https://github.com/quatrochan/Equal) - Vue UI kit based on TypeScript 🧬
*   [slim-ui (⭐54)](https://github.com/mevinoth/slim-ui) - Minimal UI components based on Vue.js
*   [Vue Component Development Kit (⭐85)](https://github.com/christiankienle/cdk) - Unstyled, highly tested and flexible Vue components/mixins/plugins.
*   [iView Vue Admin (⭐107)](https://github.com/TonyLuo/iview-vue-admin) - iView Vue Admin / An admin portal template based on iView 2.x [Online Demo](https://tonyluo.github.io/iview-vue-admin)
*   [element Vue Admin (⭐78)](https://github.com/TonyLuo/element-vue-admin) - element Vue Admin / An admin portal template based on Element UI 2.x
*   [vue-element-admin (⭐79k)](https://github.com/PanJiaChen/vue-element-admin) - A magical vue admin based on Element UI 2.x [Online Demo](https://panjiachen.github.io/vue-element-admin/#/dashboard)
*   [D2 Admin (⭐12k)](https://github.com/d2-projects/d2-admin) - An elegant backstage template build by vue [Online Demo](https://d2admin.fairyever.com)
*   [rest-admin (⭐605)](https://github.com/wxs77577/rest-admin) - Restful Admin Panel Based on Vue and Bootstrap 4 [Online Demo](http://rest-admin.genyii.com)
*   [Shards Dashboard Lite Vue (⭐387)](https://github.com/DesignRevision/shards-dashboard-vue) - ✨ Modern admin template featuring dozens of custom components and templates.[Online Demo](https://designrevision.com/demo/shards-dashboard-lite-vue/blog-overview)
...
*   [element-admin (⭐37)](https://github.com/codetrial/element-admin) - A dead simple but powerful vue admin with Vue CLI 3 and element-ui.[Online Demo](https://element-admin.now.sh/)
*   [dashboard (⭐539)](https://github.com/zce/dashboard) - A dashboard scaffolding based on vue.js created by vuejs/vue-cli 4.x. [Online Demo](https://dashboard.zce.me)
*   [Nuxt.js (⭐41k)](https://github.com/nuxt/nuxt.js) - Versatile Vue.js Framework.
*   [Ream (⭐608)](https://github.com/ream/ream) - A minimalistic framework for building server-rendered and static websites.
*   [Universal vue (⭐128)](https://github.com/universal-vue/uvue) - Vue CLI plugin to create universal Vue applications with ease
*   [Factor Platform (⭐1.3k)](https://github.com/fiction-com/factor) - An extension-driven VueJS platform ([Factor.dev → Docs](https://factor.dev))
*   [Vapper](https://github.com/shuidi-fed/vapper) - A Vue-based server-side rendering framework.
*   [VuePress (⭐21k)](https://github.com/vuejs/vuepress) - Minimalistic Vue-powered static site generator.
*   [Peco (⭐213)](https://github.com/egojump/peco) - A static website generator for humans. **UNMAINTAINED**
*   [Gridsome (⭐8.4k)](https://github.com/gridsome/gridsome) - Build super fast, modern websites with Vue.js
*   [Servue (⭐57)](https://github.com/futureaus/servue) - Server-side rendering engine that renders vue files into html strings.

### Components & Libraries / UI Utilities

*   [vue-shortkey (⭐816)](https://github.com/iFgR/vue-shortkey) - Vue-ShortKey - plugin for Vue.js.
*   [vue-throttle-event (⭐20)](https://github.com/scaccogatto/vue-throttle-event) - Throttle events based on requestAnimationFrame.
*   [vue-waypoint (⭐447)](https://github.com/scaccogatto/vue-waypoint) - Waypoint component for Vue, this is the easiest way to trigger a function when you scroll.
*   [vue-clickaway (⭐967)](https://github.com/simplesmiler/vue-clickaway) - Reusable clickaway directive for reusable Vue.js components.
*   [vue-scrollfire (⭐26)](https://github.com/vue-comps/vue-scrollfire) - Fires an event on a specific scroll position.
*   [vue-resize-directive (⭐322)](https://github.com/David-Desmaisons/Vue.resize) - Vue directive to detect resize events with deboucing and throttling capacity.
*   [v-click-outside (⭐925)](https://github.com/ndelvalle/v-click-outside) - Vue directive to react on clicks outside of an element without stopping the event propagation.
*   [vue-outside-events (⭐56)](https://github.com/nchutchind/vue-outside-events) - Vue 2.x directive to help a specified element listen for specific events occurring outside of itself.
*   [vue-selectable (⭐69)](https://github.com/JSmith01/vue-selectable) - Vue 1.x/2.x directive to make items selectable by mouse.
*   [vue-click-helper (⭐9)](https://github.com/huangshuwei/vue-click-helper) - Vue2.x directive to handle click event and dblclick event on same element.
*   [v-hotkey (⭐711)](https://github.com/Dafrok/v-hotkey) - Vue 2.x directive for binding hotkeys to components.
*   [vue-resize (⭐460)](https://github.com/Akryum/vue-resize) - Vue 2.x component to detect DOM elements resizing (event based/no window\.onresize)
*   [vue-observe-visibility (⭐1.6k)](https://github.com/Akryum/vue-observe-visibility) - Vue 2.x directive using Intersection Observer API that detects if the element is visible (in the viewport and not hidden by CSS).
*   [v-dragged (⭐95)](https://github.com/zhanziyang/v-dragged) - Vue 2.x directive plugin for drag event detection.
*   [vue-esc (⭐36)](https://github.com/ianaya89/vue-esc) - Vue.js directive to add a document event listener on escape keyup.
*   [vue-global-events (⭐685)](https://github.com/shentao/vue-global-events/) – A component to handle global events (like shortcuts) using Vue’s event modifiers
*   [vue-edge-check (⭐31)](https://github.com/gu-fan/vue-edge-check/) – Check browser edge to prevent transition effect triggered oddly when swipe edge with `vue-router`
*   [vue-mutation-observer (⭐11)](https://github.com/PNKBizz/vue-mutation-observer) – A simple and tiny directive to observe changes in DOM use MutationObserver API
*   [vue-scroll-show (⭐10)](https://github.com/AlekseyPleshkov/vue-scroll-show) – Showing the element if the user reached it after scroll
*   [vue-tabevents (⭐33)](https://github.com/Almoullim/vue-tabevents) – Easy communication between other opened tabs
*   [vue-visibility-trigger (⭐5)](https://github.com/shwilliam/vue-visibility-trigger) - 👀 Declaratively trigger methods when scrolled into view
*   [v-click-outside-x (⭐86)](https://github.com/Xotic750/v-click-outside-x) - Vue V2 directive to react on click, touch, pointer or multiple events outside an element.
*   [vue-keypress (⭐60)](https://github.com/lupas/vue-keypress) - Global keypress event handler component for Vue.js applications.
*   [vue-pseudo-window (⭐30)](https://github.com/privatenumber/vue-pseudo-window) - 👻 Component to declaratively interface window/document in your Vue template
*   [vue-viewports (⭐75)](https://github.com/scaccogatto/vue-viewports) - Define your custom viewports and use them in your components.
*   [vue-responsive (⭐93)](https://github.com/reinerBa/Vue-Responsive): Vue.js(2.x) directive to hide/show HTML-elements with the Bootstrap 4, 3 or self defined breakpoints.
*   [vue-match-media (⭐37)](https://github.com/drenglish/vue-match-media) - Vue 2.x-compatible plugin that offers a consistent, semantic approach to making components media query-aware.
*   [vue-media-query-mixin (⭐27)](https://github.com/jofftiquez/vue-media-query-mixin) - Vue 2 media query mixin that can be used in both component js and component template. Compatible with bootstrap and vuetify viewports. `wXS` returns if screen width is xs, `wSM` returns true if screen width is sm, etc...
*   [vue-breakpoints (⭐188)](https://github.com/apertureless/vue-breakpoints) - Vue 2 minimal components to show and hide elements based on breakpoints. Inspired by Airbnb.
*   [vue-mq (⭐531)](https://github.com/AlexandreBonaventure/vue-mq) - Offer some useful tools to quickly setup responsive design with a semantic and mobile-first API (Vue 2.x)
*   [VueResizeSensor (⭐6)](https://github.com/SeregPie/VueResizeSensor) - A container that supports resize event.
*   [vue-breakpoint-component (⭐80)](https://github.com/adi518/vue-breakpoint-component) - A render-less component for
    composing CSS breakpoint state.
*   [fine-mq (⭐21)](https://github.com/nash403/fine-mq) - A fine API to manage media queries in JS with ease and first-class integration with VueJS as a plugin.
*   [vue-responsive-components (⭐204)](https://github.com/Kelin2025/vue-responsive-components) - Create responsive components with `ResizeObserver`.
*   [vue-screen-size (⭐40)](https://github.com/johndatserakis/vue-screen-size) - Get easy and reactive access to the width and height of your screen.
*   [vue-container-query-2 (⭐7)](https://github.com/Mehdi-Hp/vue-container-query-2#readme) - Smart vue plugin for working with css container query.
*   [vue-formly (⭐235)](https://github.com/formly-js/vue-formly) - JavaScript powered forms for Vue.js.
*   [vue-focus (⭐409)](https://github.com/simplesmiler/vue-focus) - A reusable focus directive for reusable Vue.js components.
*   [vue-form-generator (⭐2.9k)](https://github.com/icebob/vue-form-generator) - A schema-based form generator component for Vue.js.
*   [FormSchema Native](https://gitlab.com/formschema/native) - Generate a form using JSON Schema and Vue.js
*   [ic-formly (⭐10)](https://github.com/InCuca/ic-formly) - Simple form component powered by vue-formly.
*   [Form Builder (⭐119)](https://github.com/laravel-enso/formbuilder) - Json template based form builder, based on Vue and Laravel.
*   [vue-autofocus-directive (⭐35)](https://github.com/Botre/vue-autofocus-directive) - Vue autofocus directive.
*   [vue-awesome-form (⭐46)](https://github.com/fightingm/vue-awesome-form) - A vue.js component just like json-editor
*   [vue-form-components (⭐124)](https://github.com/antonreshetov/vue-form-components) - Clean & minimal vue form elements with validation
*   [v-ajax-form (⭐4)](https://github.com/hosokawat/v-ajax-form) - vue.js component plug-in to make Form tag compatible with ajax request
*   [Vue Formulate (⭐2.1k)](https://github.com/wearebraid/vue-formulate) - The easiest way to build forms with Vue. Validation, error handling, form generation, comprehensive documentation, and more.
*   [vee-validate (⭐9.3k)](https://github.com/logaretm/vee-validate) - Simple Vue.js input validation plugin.
*   [vue-rawmodel (⭐82)](https://github.com/xpepermint/vue-rawmodel) - RawModel.js plugin for Vue.js v2. Form validation has never been easier.
*   [vuelidate (⭐6.5k)](https://github.com/monterail/vuelidate) - Simple, lightweight model-based validation for Vue.js.
*   [simple-vue-validator (⭐296)](https://github.com/semisleep/simple-vue-validator) - A simple yet flexible validator library for vue.js.
*   [vue-vform (⭐16)](https://github.com/joseluisq/vue-vform) - Vue.js 2 form component that integrates jQuery Validation and Axios.
*   [vue-form (⭐618)](https://github.com/fergaldoyle/vue-form) - Comprehensive form validation for Vue.js.
*   [vuelidation (⭐37)](https://github.com/cj/vuelidation) - simple, powerful, vuejs validation.
*   [laravel-vue-validator (⭐32)](https://github.com/val-bubbleflat/laravel-vue-validator) - Display errors from laravel validation rules
*   [vue-daval (⭐30)](https://github.com/deulos/vue-daval) - Super vue data validator. Easiness, simplicity, accurate.
*   [willvalidate (⭐8)](https://github.com/gustavoSoriano/willvalidate) - Validation Forms for Vue.js.
*   [vue-isyourpasswordsafe (⭐36)](https://github.com/Pitu/vue-isyourpasswordsafe) - A small utility written in Vue that checks if the given password has been leaked against the Have I Been Pwned API.
*   [vue-form-send (⭐3)](https://github.com/AlekseyPleshkov/vue-form-send) - A Vue.js directive for sending data from form and primitive validation
...
*   [vform (⭐601)](https://github.com/cretueusebiu/vform) - A simple way to handle Laravel back-end validation in Vue.
*   [vue-laravel-errors (⭐12)](https://github.com/Sohaib-Sherif/vue-laravel-errors) - A Vue.JS plugin that adds a global mixin which can be used to fill an errors variable from a laravel error response and display it as an object or array, can also be used as a local mixin.
*   [vue-not-visible (⭐23)](https://github.com/PxyUp/vue-not-visible) - Vue directive for removing from dom (like v-if) element on screen smaller than breakpoints.
*   [vue-window-size (⭐118)](https://github.com/mya-ake/vue-window-size) - Provides reactivity window size properties.
*   [vue-responsive-text (⭐23)](https://github.com/shwilliam/vue-responsive-text) - ↔ Component that scales its child node in relation to its parent node's width
*   [VBar (⭐227)](https://github.com/luiguild/v-bar) - The virtual responsive cross-browser scrollbar component for Vue.js 2x.
...
*   [vue-detached-scrollbar (⭐6)](https://github.com/ozangulle/vue-detached-scrollbar) - A simple scrollbar that can be detached from the container it is scrolling.
*   [vuescroll (⭐1.2k)](https://github.com/YvesCoding/vuescroll) - A scrolling plugin based on Vue.js for uniforming the scrolling in PC and mobile.
*   [vue-simplebar (⭐9)](https://github.com/hfalucas/vue-simplebar) - Vue.js wrapper for simplebar plugin.
*   [smooth-vuebar (⭐30)](https://github.com/scaccogatto/smooth-vuebar) - Vue directive wrapper for smooth-scrollbar
*   [vue-scrollwatch (⭐59)](https://github.com/Desdesdesgo/vue-scrollwatch) - A light plugin detecting scroll event,customize callback when element enter viewport,expose 'scrollTo' api to scroll to specific element .Using vue directive.
*   [vue-router (⭐19k)](https://github.com/vuejs/vue-router) - The official router for Vue.js.
*   [vue-router-storage (⭐95)](https://github.com/ElderJames/vue-router-storage) - Router storage & resolve solution for Vue.js 2 & vue-router 2
*   [vue-tidyroutes (⭐52)](https://github.com/edgarnadal/vue-tidyroutes) - Decentralized vue-router routes definitions
*   [vue-error-page (⭐52)](https://github.com/raniesantos/vue-error-page) - Provides a wrapper for router-view that allows you to show error pages without changing the URL
*   [vue-router-sitemap (⭐111)](https://github.com/40818419/vue-router-sitemap) - Generate sitemap.xml by vue-router configuration
*   [vue-smart-route (⭐317)](https://github.com/f/vue-smart-route) - Smart route directive to make intelligent looking apps with Vue.js.
*   [vue-router-lite (⭐9)](https://github.com/ccqgithub/vue-router-lite) - A component-based, declarative router for Vue.js 2.
*   [vue-route-props (⭐1)](https://github.com/iendeavor/vue-route-props) - Automatically bind vue-router query to vm, APIs are mostly same as the Vue props.
*   [vue-pilot (⭐11)](https://github.com/jiangfengming/vue-pilot) - A Trie-based vue router with the ability of managing history.state.
*   [vue-lazyload (⭐7.7k)](https://github.com/hilongjw/vue-lazyload) - A Vue.js plugin for lazyload your Image or Component in your application.
*   [vue-lazy-background-images (⭐68)](https://github.com/darrynten/vue-lazy-background-images) - Lazy load background images for Vue 2.
*   [vue-progressive-image (⭐709)](https://github.com/MatteoGabriele/vue-progressive-image) - Vue progressive image loading plugin.
*   [vue-l-lazyload (⭐26)](https://github.com/lsycxyj/vue-l-lazyload) - A lazyload plugin for Vue.js v2.x+.
*   [vue-lazyload-img (⭐251)](https://github.com/JALBAA/vue-lazyload-img) - Especially optimized for mobile browser. support V2 & v1.
*   [vue-lazy-images (⭐60)](https://github.com/yyh1102/vue-lazyload-images) - A plugin of lazyload images for Vue 2.x.
*   [v-lazy-img (⭐25)](https://github.com/nkoehring/v-lazy-img) - Tiny (<0.6kb) directive for progressive image loading for Vue 2.
*   [vue-clazy-load (⭐108)](https://github.com/matheusgrieger/vue-clazy-load) - Lightweight transitionable image lazy loading component using IntersecionObserver for Vue 2.
*   [vue-lazy-this (⭐9)](https://github.com/thangman22/vue-lazy-this) - Lazyloading component using Intersection Observer API.
*   [v2-lazy-list (⭐31)](https://github.com/dwqs/v2-lazy-list/) - A simple lazy-load list component based Vue 2.x
*   [pimg (⭐98)](https://github.com/ooade/pimg) - A Simple Progressive Image Component used for lazy loading images.
*   [vue-tiny-lazyload-img (⭐91)](https://github.com/mazipan/vue-tiny-lazyload-img) - A small size Vue.js v.2+ directive for lazy loading images
*   [vue-lazy-youtube-video (⭐83)](https://github.com/3vilArthas/vue-lazy-youtube-video) - A simple Vue.js component for lazy loading YouTube videos.
*   [lazyload-vue (⭐29)](https://github.com/Kazap/lazyload-vue)- Vue Plugin for vanilla-lazyload.
*   [vue-paginate (⭐600)](https://github.com/TahaSh/vue-paginate) - A simple vue.js plugin to paginate data.
*   [vue-pagination-2 (⭐183)](https://github.com/matfish2/vue-pagination-2) - Vue.js 2 pagination component.
*   [vuejs-uib-pagination (⭐57)](https://github.com/sant123/vuejs-uib-pagination) - Best and complete pagination plugin for Vue.js. Inspired in Angular Bootstrap Pagination.
*   [vuejs-paginate (⭐761)](https://github.com/lokyoung/vuejs-paginate) - A Vue.js(v2.x+) component for creating pagination.
*   [vue-pagination-bootstrap (⭐25)](https://github.com/brunoseco/vue-pagination-bootstrap) - A Vue.js (1.x & 2.x) server-side paging component with a template based on Bootstrap
*   [laravel-vue-semantic-ui-pagination (⭐8)](https://github.com/vinayakkulkarni/laravel-vue-semantic-ui-pagination) - A Vue.js 2.x pagination used with Laravel & Semantic-UI.
*   [vue-paginate-al (⭐51)](https://github.com/alziqziq/vue-paginate-al) - Vue paginate with return your data.
*   [vue-tiny-pagination (⭐20)](https://github.com/coderdiaz/vue-tiny-pagination) - A Vue component for create a tiny pagination.
*   [laravel-vue-pagination (⭐679)](https://github.com/gilbitron/laravel-vue-pagination) - A Vue.js pagination component for Laravel paginators that works with Bootstrap.
*   [vue-lpage (⭐5)](https://github.com/Botre/vue-lpage) - Low-level Vue pagination component.
*   [v-page (⭐85)](https://github.com/TerryZ/v-page) - A simple pagination bar, including length Menu, i18n support, based on Vue2.x.
*   [vue-smart-pagination (⭐26)](https://github.com/grinmax/vue-smart-pagination) - Smart pagination of any data with a lot of nice settings.
*   [vue-paginatron (⭐11)](https://github.com/sbaidon/vue-paginatron) - Pagination component built with scoped-slot props for maximum flexibility.
*   [vue2-animate (⭐1.4k)](https://github.com/asika32764/vue2-animate) - A Vue.js 2.0 port of Animate.css. For use with Vue's built-in transitions.
*   [animated-vue (⭐222)](https://github.com/radical-dreamers/animated-vue) - A Vue.js 2.x plugin to easily use Animate.css animations as transitions. As easy as `<animated-tada>`!
*   [vue-lottie (⭐1.2k)](https://github.com/chenqingspring/vue-lottie) - A Vue.js 2.x plugin to render after effects animations based on bodymovin
*   [Vueg (⭐1k)](https://github.com/jaweii/vueg) - Make vue-router have a transition effect / 为 webApp 提供转场特效的开源 Vue 插件
*   [v-animate-css](https://jofftiquez.github.io/v-animate-css/) - The easiest to implement Vue 2 directive for Animate.css
*   [vue-mixin-tween (⭐25)](https://github.com/lukechinworth/vue-mixin-tween) - Mixin factory that adds tweened values to component context for animations
*   [v-odometer (⭐92)](https://github.com/JefferyHus/v-odometer) - Smoothly transitions numbers with ease. Use this library to give your application a smooth animation, only applicable on numbers.
*   [vue2-transitions (⭐785)](https://github.com/cristijora/vue2-transitions) ✨ Reusable Vue 2 transition components
*   [vue-overdrive (⭐681)](https://github.com/mattrothenberg/vue-overdrive) Super easy magic-move transitions for Vue apps 🎩
*   [animated-number-vue (⭐192)](https://github.com/Leocardoso94/animated-number-vue) Super easy way to animate numbers.
*   [vue-parent-change-transition (⭐27)](https://github.com/inamori/vue-parent-change-transition) Enable a child components to animate when it changes the parent.
*   [vue-smooth-reflow (⭐441)](https://github.com/guanzo/vue-smooth-reflow) Transition an elements reflow in response to data changes.
*   [VueTween (⭐22)](https://github.com/SeregPie/VueTween) Allows components to tween their properties.
*   [vue-slide-up-down (⭐195)](https://github.com/danieldiekmeier/vue-slide-up-down) Like jQuery's `slideUp` / `slideDown`, but for Vue!
*   [vue-animejs (⭐172)](https://github.com/BenAHammond/vue-anime) Simple `anime.js` directives for Vue.
*   [Eagle.js (⭐4.1k)](https://github.com/zulko/eagle.js/) Eagle.js is a web-based slideshow framework for Vue.js.
*   [vue-slide-up-down-component (⭐8)](https://github.com/k-okina/vue-slide-up-down-component) It is a simple interface but realizes very flexible and powerful slide animation, for Vue!
*   [femtoTween (⭐27)](https://github.com/pearofducks/femtoTween) A minimalistic (zero-dep, less than 1k) tweening library with first-class Vue support
*   [vue-sequential-entrance (⭐83)](https://github.com/deivthings/vue-sequential-entrance) Plugin for creating elegant sequential animation entrances with a list of elements of your page. Zero effort. Simple and lightweight
*   [vue-animate-scroll (⭐46)](https://github.com/mike-prince/vue-animate-scroll) Super lightweight way to add CSS animations to elements as they scroll into view.
*   [vue-svg-transition (⭐140)](https://github.com/kai-oswald/vue-svg-transition) Create 2-state, SVG-powered transitions
*   [vue-page-transition (⭐398)](https://github.com/Orlandster/vue-page-transition) Easy route / page transitions for Vue.js
*   [Vuenime (⭐34)](https://github.com/denisinvader/vuenime) A flexible Vue wrapper for Animejs
*   [vue-flipper (⭐32)](https://github.com/VitorLuizC/vue-flipper) - A component to flip children with a nice transition.
*   [v-number (⭐27)](https://github.com/maxflex/v-number/) Animated number transition library for Vue.js
*   [vue-kinesis (⭐1.3k)](https://github.com/Aminerman/vue-kinesis) A set of components to create interactive animations
*   [vue-head (⭐979)](https://github.com/ktquez/vue-head) - Manage the meta information of the head tag, a simple and easy way.
*   [vue-meta (⭐4k)](https://github.com/declandewet/vue-meta) - Manage page meta info in Vue 2.0 components. SSR + Streaming supported.
*   [vue-headful (⭐227)](https://github.com/troxler/vue-headful) - Set document `<title>` and meta tags from within your views.
*   [vue-simple-headful (⭐16)](https://github.com/VeryWow/vue-simple-headful) - Easily set meta-tags with vue.js - a simpler `vue-headful` alternative with TypeScript support.
*   [vue-dom-portal (⭐201)](https://github.com/calebroseland/vue-dom-portal) - An escape hatch for DOM Elements in Vue.js components.
*   [vue2-filters (⭐937)](https://github.com/freearhey/vue2-filters) - A collection of standard filters Vue 1.\_ adapted for use in Vue 2.\_.
*   [vue-morphling (⭐184)](https://github.com/jofftiquez/vue-morphling) - A collection of standard and custom filters for Vue 2.
*   [vue-trans (⭐15)](https://github.com/Trekels/vue-trans) - A simple filter to provide a similar way of translating to the Symfony trans.
*   [vue-string-filter (⭐38)](https://github.com/mazipan/vue-string-filter) - Lightweight Vue 2 String Manipulation Filter.
*   [vue-units (⭐18)](https://github.com/ERPedersen/vue-units) - A collection of handy unit conversion filters for use in Vue 2.
*   [vue-numeral-filter (⭐82)](https://github.com/lloydjatkinson/vue-numeral-filter) - A collection of filters that allows Numeral.js to be used inline in the template section of a component.
*   [vue-filter-date-format (⭐112)](https://github.com/eduardnikolenko/vue-filter-date-format) - Simple datetime filter for Vue 2.
*   [vue-filter-pluralize (⭐13)](https://github.com/eduardnikolenko/vue-filter-pluralize) - Simple pluralize filter for Vue 2.
*   [vue-filter-date-parse (⭐26)](https://github.com/eduardnikolenko/vue-filter-date-parse) - Simple parsing datetime filter for Vue 2.
*   [vue-svgicon (⭐894)](https://github.com/MMF-FE/vue-svgicon) - A tool to create svg icon components. (vue 2.x).
*   [vue-content-loading (⭐759)](https://github.com/LucasLeandro1204/vue-content-loading) - Vue component to easily build (or use presets) SVG loading cards Facebook like.
*   [vue-annotator (⭐76)](https://github.com/DrSensor/vue-annotator) - Annotate page using any SVG Element (`rect`, `polygon`, and many more, even HTML Element like `canvas` if wrapped in `foreignObject`)
*   [vue-svg-filler (⭐84)](https://github.com/biigpongsatorn/vue-svg-filler) - Vue component for custom your svg file 🖍 🎨 (vue 2.x).
*   [vue-resource-progressbar-interceptor (⭐63)](https://github.com/staskjs/vue-resource-progressbar-interceptor) - Interceptor that ties a progressbar to all requests, that it is clear that something is loading.
*   [vue-images-loaded (⭐146)](https://github.com/David-Desmaisons/Vue.ImagesLoaded) - Vue.js 2.0 directive to detect images loading.
*   [vue-visible (⭐31)](https://github.com/javisperez/vue-visible) - A v-visible directive for VueJS (2.x), like v-show but for visibility.
*   [vue-resize-sensor (⭐76)](https://github.com/FranckFreiburger/vue-resize-sensor) - Component to detect container resizing (event-based)
*   [v-blur (⭐184)](https://github.com/ndelvalle/v-blur) - Vue directive to blur an element dynamically
*   [vue-async-methods (⭐66)](https://github.com/mokkabonna/vue-async-methods) - Helper utilities for promise based methods
*   [vue-openseadragon (⭐26)](https://github.com/braceslab/vue-openseadragon) - OpenSeaDragon component for Vue.js (zoom and pan)
*   [vue-match-heights (⭐53)](https://github.com/samturrell/vue-match-heights) - Directive to set heights of elements to be the same.
*   [vue-conditional-attrs (⭐5)](https://github.com/FL3NKEY/vue-conditional-attrs) - A Vue.js component for conditional rendering attributes and directives
*   [vue-cbsc (⭐6)](https://github.com/arthurvasconcelos/vue-cbsc) - A Vue.js 2.x component for programmatically blender, shader and convert colors.
*   [vue-spatialnavigation (⭐78)](https://github.com/twcapps/vue-spatialnavigation) - Vue directive (Vue.js 2.x) for spatial navigation (keyboard navigation)
*   [vue-lifecycle (⭐10)](https://github.com/FL3NKEY/vue-lifecycle) - A Vue.js lifecycle directives.
*   [v-ripple-directive (⭐3)](https://github.com/andrewvasilchuk/v-ripple-directive) - Vue.js directive for ripple effect.
*   [vue-material-design-ripple (⭐30)](https://github.com/partyka1/vue-material-design-ripple) - Add material design ripple to any element. Use any ripple color you want. No performance issues. Mobile friendly. No dependencies. It just works.
*   [vue-vr (⭐444)](https://github.com/imudin/vue-vr) - A framework for building VR applications with Vue
    based on [threejs](https://threejs.org/) and [Panolens](https://pchen66.github.io/Panolens/), inspired by [react-vr (⭐8.7k)](https://github.com/facebook/react-vr)

### Components & Libraries / Utilities

*   [vue-underscore (⭐18)](https://github.com/HKskn/vue-underscore) - simple vue plugin to implement underscore
*   [vue-lazy-calc (⭐8)](https://github.com/dreambo8563/vue-lazy-calc) - A simple calculation plugin in lazy && chaining way with strong typed.
*   [vue-loadable (⭐24)](https://github.com/VitorLuizC/vue-loadable) - A plugin to improve loading state control with pretty simple methods, decorators and helpers.
*   [vue-composable (⭐1k)](https://github.com/pikax/vue-composable) - Vue composition-api composable components. i18n, validation, pagination, fetch, etc. +30 variable composable functions.
*   [vue-typed (⭐103)](https://github.com/vue-typed/vue-typed) - Sets of ECMAScript / Typescript decorators that helps you write Vue component easily.
*   [vue-typescript (⭐362)](https://github.com/itsFrank/vue-typescript) - Typescript decorators to make vue feel more typescripty.
*   [vue-property-decorator (⭐5.4k)](https://github.com/kaorun343/vue-property-decorator) - Vue.js and Property Decorator.
*   [vue-typescript-component (⭐26)](https://github.com/locoslab/vue-typescript-component) - Decorators to use TypeScript classes as Vue.js 2.0 components.
*   [vue-typescript-import-dts (⭐28)](https://github.com/locoslab/vue-typescript-import-dts) - TypeScript declaration file that allows using 'import' with .vue files.
*   [vue-ts-loader (⭐88)](https://github.com/HerringtonDarkholme/vue-ts-loader) - Type-check your script in your vue-loader.
*   [vue-mixin-decorator (⭐57)](https://github.com/justrhysism/vue-mixin-decorator) - Typescript decorator for strongly typed Mixins.
*   [vue-ts-component-generator (⭐5)](https://github.com/frogbob/vue-ts-component-generator) - A simple cli tool for generating vue typescript components.
*   [vuex-module-decorators (⭐1.8k)](https://github.com/championswimmer/vuex-module-decorators) - Typescript/ES7 Decorators to make Vuex modules a breeze
*   [vuex-class-modules (⭐193)](https://github.com/gertqin/vuex-class-modules) - Introduce a simple type-safe class style syntax for your vuex modules, inspired by vue-class-component.
*   [vue-corator (⭐33)](https://github.com/joon610/vue-corator) - Vue typescript decorator utils
*   [vuedts (⭐20)](https://github.com/kahirokunn/vuedts) - Generate TypeScript declaration files for .vue files.
*   [vue-resource (⭐10k)](https://github.com/pagekit/vue-resource) - The HTTP client for Vue.js.
*   [vue-async-computed (⭐1.1k)](https://github.com/foxbenjaminfox/vue-async-computed) - Async computed properties for Vue.js.
*   [vue-jsonp (⭐140)](https://github.com/LancerComet/vue-jsonp) - A tiny library for handling JSONP request.
*   [v-model (⭐56)](https://github.com/huanleguang/v-model) - V-Model is a model plugin for Vue.js, like ng-resource.
*   [vue-resource-mock (⭐29)](https://github.com/noru/vue-resource-mock) - A helper to mock your http response, based on vue-resource's interceptor.
*   [vue-async-data-2 (⭐33)](https://github.com/kamijin-fanta/vue-async-data) - Async data loading plugin for Vue.js.
*   [vue-fast-axios (⭐43)](https://github.com/leonardovilarinho/vue-fast-axios) - Make requests with validations in a simple and beautiful way.
*   [vue-async-properties (⭐38)](https://github.com/blainehansen/vue-async-properties) - An `asyncData` and `asyncComputed` plugin with support for debouncing, transforming results, error handlers, loading/pending flags, lazy/eager requests.
*   [vue-axios-plugin (⭐55)](https://github.com/yugasun/vue-axios-plugin) - A plugin that combines axios with Vuejs, making http request more easier.
*   [vue-api-query (⭐1.6k)](https://github.com/robsontenorio/vue-api-query) - Elegant and simple way to build requests for REST API.
*   [vue-apis (⭐27)](https://github.com/ChangedenCZD/vue-apis) - A vue plug-in integrated with axios that chain-builds API instances. Available from the context of a vue instance (eg: this.$apis.apiName()).
*   [vue-i18n (⭐6.8k)](https://github.com/kazupon/vue-i18n) - Internationalization plugin for Vue.js.
*   [vue-translate-plugin (⭐82)](https://github.com/javisperez/vuetranslate) - VueJS plugin for translations.
*   [vuex-i18n (⭐668)](https://github.com/dkfbasel/vuex-i18n) - Localization plugin for vue.js 2.0 using vuex as store.
*   [vue-gettext (⭐275)](https://github.com/Polyconseil/vue-gettext) - Translate your Vue.js applications with gettext.
*   [vue-i18n (⭐40)](https://github.com/MattyRad/vue-i18n) - A small plugin for implementing translations in Vue.js.
*   [vue-multilanguage (⭐176)](https://github.com/leonardovilarinho/vue-multilanguage) - Support many languages in Vue.js 2.
*   [vue-ts-locale (⭐35)](https://github.com/twcapps/vue-ts-locale) - A plugin for implementing translations using Intl in Vue.js 2 with typescript support.
*   [vue-i18next (⭐177)](https://github.com/panter/vue-i18next) - A i18next wrapper to support translations in Vue.js 2.
*   [vue-polyglot (⭐44)](https://github.com/guillaumevincent/vue-polyglot) - Basic translation plugin for Vue.js 2 with async loading.
*   [v-localize (⭐31)](https://github.com/neetjn/v-localize) - Simple localization plugin for
    the amazing Vue.js.
*   [vue-simple-i18n (⭐32)](https://github.com/ClassicOldSong/vue-simple-i18n) - Probably the thinnest library to end all Vue i18n solutions within 1kb
*   [template-string-i18n (⭐4)](https://github.com/cutsin/template-string-i18n) - I18n using template strings with auto save/load translate documents.
*   [vue-translations (⭐15)](https://github.com/owl1n/vue-translations) - Translate your vuejs application easy with it.
*   [vue-i18n-filter (⭐16)](https://github.com/chiaweilee/vue-i18n-filter) - Vue filter extend for Vue-i18n, simply using `{{ hello world | t }}`.
*   [vue-translation-manager (⭐27)](https://github.com/cyon/vue-translation-manager) - Interactively find and translate strings in your Vue.js application. Works well with vue-18n and vuex-i18n.
*   [vue-t9n (⭐6)](https://github.com/Ni55aN/vue-t9n) - Simplest way to translate your applications
*   [vue-simple-inline-translation (⭐8)](https://github.com/alidrus/vue-simple-inline-translation) - A Vue component that simplifies the way text is translated: by translating it inline.
*   [vue-i18n-extract (⭐216)](https://github.com/pixari/vue-i18n-extract) - Manage vue-i18n localization with static analysis. Make reports about missing and unused i18n entries.
*   [vscode-vue-i18n-ally (⭐2.5k)](https://github.com/antfu/vue-i18n-ally) - VSCode extension for better Vue-i18n experiences.
*   [vue-events (⭐239)](https://github.com/cklmercer/vue-events) - Simple event handling for Vue.js.
*   [vue-event-handler (⭐14)](https://github.com/sandeepk01/vue-event-handler) - Event handling plugin for VueJS.
*   [vue-event-manager (⭐83)](https://github.com/pagekit/vue-event-manager) - The global event manager for Vue.js.
*   [vue-geb (⭐41)](https://github.com/vouill/vue-geb) - A global event bus using Observables.
*   [vue-bus (⭐50)](https://github.com/fffixed/vue-bus) - Tiny simple central event bus plugin for Vue.js 2.
*   [vue-simple-events (⭐9)](https://github.com/VeryWow/vue-simple-events) - Yet another event management plugin, but WITHOUT Vue instance
*   [vue-option-events (⭐6)](https://github.com/Cweili/vue-option-events) - Bring Vue.js 1 events option and $emit to Vue.js 2.
*   [vue-emit (⭐21)](https://github.com/denisinvader/vue-emit) - A helper function to emit events from functional components.
*   [vue-plugin-events (⭐5)](https://github.com/nolde/vue-plugin-events) - Simple global event bus for Vue.js applications with automatic subscription control.
*   [vue-localstorage (⭐670)](https://github.com/pinguinjkeke/vue-local-storage) - Vue.js localStorage plugin with types support.
*   [vue-ls (⭐535)](https://github.com/RobinCK/vue-ls) - Vue plugin for work with LocalStorage from Vue context.
*   [vue-pouch (⭐165)](https://github.com/qurateinc/vue-pouch) - Live and reactive bindings for PouchDB. Persist data in IndexedDB and sync with CouchDB.
*   [vue-idb (⭐79)](https://github.com/ddgll/vue-idb) - Lists and huge lists management with IndexedDB (Dexie.js) only or automatically created and extendible vuex modules
*   [vue-browserstore (⭐8)](https://github.com/gvost/vue-browserstore) - Browser storage wrapper.
*   [VueStorage (⭐54)](https://github.com/SeregPie/VueStorage) - Allows components to save and load their data across browser sessions.
*   [vue-web-storage (⭐85)](https://github.com/ankurk91/vue-web-storage) Another Vue.js plugin for localStorage and sessionStorage
*   [vue-universal-cookies (⭐28)](https://github.com/S64/vue-universal-cookies) Isomorphic cookies plugin for Vue.js / Nuxt.js supports Browser, Express, http (node).
*   [vue2-storage (⭐115)](https://github.com/yarkovaleksei/vue2-storage) Browser storage for Vue.js app
*   [vue-warehouse (⭐170)](https://github.com/bazzite/vue-warehouse) A Cross-browser storage for Vue.js and Nuxt.js, with plugins support and easy extensibility based on Store.js.
*   [vuex (⭐28k)](https://github.com/vuejs/vuex) - Centralized State Management for Vue.js.
*   [vue-sync (⭐67)](https://github.com/buhrmi/vue-sync) - Synchronize Vue State with the Browser URL, Server Backend, and other endpoints.
*   [vuelm (⭐36)](https://github.com/keuller/vuelm) - Lightweight state management inspired by Elm architecture.
*   [vuez (⭐42)](https://github.com/markselby9/vuez) - A simple but powerful State Management for Vue.js, with only 2 APIs.
*   [vuet (⭐428)](https://github.com/medevicex/vuet) - Vue.js state management model for Agile Development
*   [vue-assign-model (⭐5)](https://github.com/midnightSuyama/vue-assign-model) - Automatically assign elements value to model for Vue.js.
*   [vue-stash (⭐407)](https://github.com/cklmercer/vue-stash) - Easily share reactive data between your Vue components.
*   [vue-model (⭐865)](https://github.com/aarondfrancis/vue-model) - Model component for Vue.js
*   [tuex (⭐33)](https://github.com/Raiondesu/Tuex) - A mostly reasonable alternative to Vuex.
*   [revuejs (⭐24)](https://github.com/dwqs/revuejs) - A tiny, light and handy state management for vuejs 2, writing less verbose code.
*   [lue (⭐12)](https://github.com/dwqs/lue) - Vue and vuex based library, writing less verbose code.
*   [vuex-lite](https://github.com/rayraegah/vuex-lite) - A 1KB Vuex with just state and mutations.
*   [vue-shared (⭐11)](https://github.com/raizam/vue-shared) - A light and simple alternative to vuex
*   [vuex-module-generator (⭐90)](https://github.com/abdullah/vuex-module-generator) - It allows you to create a vuex module easily.
...
*   [effector (⭐3.9k)](https://github.com/zerobias/effector) — Fast and powerful reactive state manager. Effector lets you write simple, fast and type safe code and manage reactive state with ease.
...
*   [universal-model-vue (⭐25)](https://github.com/universal-model/universal-model-vue) - Unified state management for Vue (and also for Angular/React/Svelte)
*   [vue-states (⭐150)](https://github.com/sumcumo/vue-states) - State management system for Vue with same API as Vue components
*   [vuedeux (⭐70)](https://github.com/Vuedeux/vuedeux) - Binding Solutions for Vue & Redux.
    *   [redux-store-mixin (⭐2)](https://github.com/kolesoffac/redux-store-mixin) - Mixin for integrate action creators in methods of vue-component
    *   [vue-redux-prepare-props (⭐1)](https://github.com/kolesoffac/vue-redux-prepare-props) - Helper for use props of *Redux* with *Vue.js* using *Vuex* and *Vuedeux*
*   [vuejs-redux (⭐57)](https://github.com/titouancreach/vuejs-redux) - High order component facilities for Vue and Redux.
*   [vuex-coolstory (⭐23)](https://github.com/niklv/vuex-coolstory) - Plugin for vuex to run redux-saga.
*   [movue (⭐58)](https://github.com/nighca/movue) - Mobx integration for Vue.js.
*   [vue-mobx (⭐111)](https://github.com/dwqs/vue-mobx) - Mobx binding for Vuejs 2.x.
...
*   [casl-vue (⭐4.3k)](https://github.com/stalniy/casl/tree/master/packages/casl-vue) - Restricts what resources a given user is allowed to access
*   [vue-google-api (⭐36)](https://github.com/vertcitron/vue-google-api) - A wrapper for easy integration of the Google's APIs client in any vue.js 2 project, based on promises, with built-in Oauth2 "Sign In with Google" facilities.
...
*   [vue-google-signin-button (⭐288)](https://github.com/phanan/vue-google-signin-button) - A simple Vue plugin to include a Google sign-in button into your web app
*   [vue-facebook-signin-button (⭐135)](https://github.com/phanan/vue-facebook-signin-button) - A simple plugin to include a custom Facebook sign-in button into your web app
*   [vue-auth-href (⭐16)](https://github.com/nachodd/vue-auth-href) - A VueJS directive for downloading files that are under a protected route schema
*   [vue-msal (⭐108)](https://github.com/mvertopoulos/vue-msal) - Vue plugin for using Microsoft Authentication Library (MSAL)
*   [vuex-persistedstate (⭐5.7k)](https://github.com/robinvdvleuten/vuex-persistedstate) - Persist Vuex state with localStorage.
*   [vuex-plugin-jsdata (⭐20)](https://github.com/AlexandreBonaventure/vuex-jsdata-plugin) - A plugin for syncing Vuex store with js-data.
*   [vuex-local (⭐65)](https://github.com/ktsn/vuex-local) - Local state management within Vuex.
*   [vuex-action (⭐27)](https://github.com/varHarrie/vuex-action) - Utilities for vuex to easily create and manage actions.
*   [vuex-rest-api (⭐382)](https://github.com/christianmalek/vuex-rest-api) - A Helper utility to simplify the usage of REST APIs with Vuex. Based on axios.
*   [vuex-cache (⭐511)](https://github.com/superwf/vuex-cache) - A Vuex plugin utility to cache action those will make remote request.
*   [vuex-persist (⭐1.6k)](https://github.com/championswimmer/vuex-persist) - A Typescript-ready Vuex plugin to help save the store to localStorage or any custom Storage (that you can configure).
*   [vuex-local-state (⭐18)](https://github.com/biluochun/vuex-localState) - Add 'localState/sessionState' options to vuex. Keep the Vuex state with localStorage.
*   [vuex-action-reload (⭐3)](https://github.com/chlab/vuex-action-reload) - A vuex plugin that reloads actions when a condition is met.
*   [vuejs-storage (⭐120)](https://github.com/maple3142/vuejs-storage) - Vue.js and vuex plugin to persistence data with localStorage/sessionStorage.
*   [vuex-orm (⭐2.4k)](https://github.com/vuex-orm/vuex-orm) - The Vuex plugin to enable Object-Relational Mapping access to the Vuex Store.
*   [vuex-async-module (⭐15)](https://github.com/liqueflies/vuex-async-module) - Reduce async boilerplate code generating Vuex modules. Compatible with Vue 2.x.
*   [vuex-iframe-sync (⭐99)](https://github.com/L-Chris/vuex-iframe-sync) - Vuex state synchronization between iframe/window.
*   [vuex-aspect](https://gitlab.com/frissdiegurke/vuex-aspect) - Bind remote data of any kind to the vuex store.
*   [vuex-map-fields (⭐1.4k)](https://github.com/maoberlehner/vuex-map-fields) - Enable two-way data binding for form fields.
*   [vuex-search (⭐158)](https://github.com/AlbertLucianto/vuex-search) - Vuex binding for client-side search with indexers and Web Workers.
...
*   [vuex-loading (⭐3)](https://github.com/anthinkingcoder/vuex-loading) - Simplify vuex loading state management
*   [vuex-module-builder (⭐6)](https://github.com/oncebot/vuex-module-builder) - Vuex module builder is a wrapper for writing vuex stores efficiently with some common methods built-in.
*   [vuex-pagination (⭐108)](https://github.com/cyon/vuex-pagination) - Easily work with paginated resources in your Vue/Vuex application. Works well with most of the Vue pagination components.
...
*   [vuex-listener (⭐8)](https://github.com/TimurKiyivinski/vuex-listener) - A global Vuex action and mutation listener plugin
*   [jsonapi-vuex (⭐144)](https://github.com/mrichar1/jsonapi-vuex) - Use a JSONAPI api with a Vuex store, with client-side restructuring/normalization of records.
*   [vuexi (⭐5)](https://github.com/mikefaraponov/vuexi) - provides utilities to simplify async actions and state management
*   [stfalcon-vuex-loading-plugin (⭐3)](https://github.com/stfalcon-studio/stfalcon-vuex-loading-plugin) - the easiest way to handle loading state of vuex
*   [Vue Rest Resource](https://github.com/ProReNata/VueRestResource) - Rest HTTP resource management for Vue.js and Vuex projects.
*   [Vuex Stateshot (⭐13)](https://github.com/xiaoluoboding/vuex-stateshot) - 💾 A State Snapshot plugin on Actions/Mutations for Vuex3.1+.
*   [vuex-loopback (⭐7)](https://github.com/mikeevstropov/vuex-loopback) - Vuex module factory and Vue components for Loopback.
*   [vuex-state-snapshot (⭐1)](https://github.com/dezull/vuex-state-snapshot) - A Vuex plugin to take state snapshot on mutation.
*   [vuex-awesome-async (⭐3)](https://github.com/Schoolmouv-team/vuex-awesome-async) - It wraps Vuex stores to easily manage async requests (loading, error and cache state).
*   [vuex-factories (⭐5)](https://github.com/Goldziher/vuex-factories) - Factory functions to generate vuex actions and mutations.
*   [vuex-hooks (⭐12)](https://github.com/Goldziher/vuex-hooks) - Typescript enabled vuex composition-api hooks.
*   [vuex-basement (⭐65)](https://github.com/RashadSaleh/vuex-basement) - Vuex state persistence and synchronization between tabs/windows.
*   [vuex-shared-mutations (⭐566)](https://github.com/xanf/vuex-shared-mutations) - Share vuex mutations between tabs/windows.
*   [vuex-multi-tab-state (⭐154)](https://github.com/gabrielmbmb/vuex-multi-tab-state) - Share and synchronize status between multiple tabs with this plugin for Vuex.
*   [vue-apollo (⭐5.7k)](https://github.com/Akryum/vue-apollo) - Apollo/GraphQL integration for VueJS.
*   [vue-relay (⭐119)](https://github.com/ntkme/vue-relay) - A framework for building GraphQL-driven Vue.js applications.
*   [vuex-orm-apollo (⭐229)](https://github.com/vuex-orm/vuex-orm-apollo) - Apollo/GraphQL integration for Vuex-ORM.
*   [vuency (⭐73)](https://github.com/alidcastano/vuency) - Concurrency management for Vue.js.
*   [vue-types (⭐466)](https://github.com/dwightjack/vue-types) - Vue Prop Types definitions.
*   [vue-factory (⭐29)](https://github.com/ye-will/vue-factory) - A simple factory/provider extension for Vue.js, like services in Angular.
*   [eslint-plugin-vue (⭐3.9k)](https://github.com/vuejs/eslint-plugin-vue) - Eslint plugin for Vue.js projects.
*   [vue-decorators](https://github.com/partyka95/vue-decorators) - Decorators for Vue.js (beta).
*   [vue-computed-helpers (⭐289)](https://github.com/michalsnik/vue-computed-helpers) - Computed helpers for Vue.js apps
*   [vert (⭐21)](https://github.com/LancerComet/Vert-Core) - Library to build Vue applications in OOP.
*   [vue-slot-checker (⭐14)](https://github.com/mya-ake/vue-slot-checker) - Provide the function to check slot like checking props.
*   [vue-bem-cn (⭐124)](https://github.com/c01nd01r/vue-bem-cn) - Simple BEM class name generator for Vue.JS.
*   [vue-css (⭐142)](https://github.com/NxtChg/pieces/tree/master/js/vue/vue-css) - Vue.js plugin that allows you to bundle CSS with your components.
*   [vue-mods-names (⭐23)](https://github.com/RGRU/vue-mods-names) - Adding modificators to class names for all components in app.
*   [vue-styler (⭐4)](https://github.com/mrtone/vue-styler) - Simple, performant styler for vue.
*   [vue-css-modules (⭐38)](https://github.com/fjc0k/vue-css-modules) - Seamless mapping of class names to CSS Modules inside of Vue components.
*   [vue-simple-bem (⭐16)](https://github.com/mlturner88/vue-simple-bem) - Directive with succint syntax for adding BEM class names to elements.
*   [fela-vue (⭐7)](https://github.com/houd1ni/fela-vue) - CSS-IN-JS mixin for Vue designed for flexibility yet team-oriented.
*   [j-vue (⭐6)](https://github.com/LongTengDao/j-vue/)
*   [vue-spinners-css (⭐52)](https://github.com/JoshK2/vue-spinners-css) - Collection of pure CSS vue spinners components, css spinners for ajax or loading animation based on loading.io.
*   [vue-css-doodle (⭐10)](https://github.com/LuXDAmore/vue-css-doodle) - Porting of css-doodle, a web component for drawing patterns with CSS.
*   [vue-script2 (⭐174)](https://github.com/taoeffect/vue-script2) - Standardized, designer-friendly script tag behavior for your Single Page App.
*   [vue-loader (⭐4.9k)](https://github.com/vuejs/vue-loader) - Webpack loader for Vue.js components.
*   [vueify (⭐1.2k)](https://github.com/vuejs/vueify) - Browserify transform for single-file Vue components.
*   [vue-compiler (⭐8)](https://github.com/paulpflug/vue-compiler) - A simple cli wrapper around the vue-component-compiler.
*   [vue-brunch (⭐78)](https://github.com/nblackburn/vue-brunch) - Adds support to Brunch for pre-compiling single file Vue components.
*   [poi (⭐5.3k)](https://github.com/egoist/poi) - Start writing an app with a single .js file, Poi could handle all the development setups for you, no more configuration hell.
*   [http-vue-loader (⭐1.4k)](https://github.com/FranckFreiburger/http-vue-loader) - Load .vue files directly from your html/js without node.js environment nor build step.
*   [vue-jsx-hot-loader (⭐41)](https://github.com/skyrpex/vue-jsx-hot-loader) - Enable HMR for Vue.js components with JSX render functions.
*   [VueInBrowserLoader (⭐7)](https://github.com/SeregPie/VueInBrowserLoader) - Loads a .vue file from the given URL and compiles it to a component directly in the browser.
*   [vue-separate-files-webpack-loader (⭐12)](https://github.com/NetCZ/vue-separate-files-webpack-loader) - Webpack loader for separated Vue components parts
*   [vue-svg-loader (⭐608)](https://github.com/visualfanatic/vue-svg-loader) - webpack loader that lets you use SVG files as Vue components
*   [vue-registrar (⭐17)](https://github.com/AmirrezaNasiri/vue-registrar) - ☘️ A package that dynamically registers your components and vuex modules - Makes your code a lot readable!
*   [vue-navigation (⭐997)](https://github.com/zack24q/vue-navigation) - A page navigation library, record routes and cache pages, like native app navigation. 一个页面导航库，记录路由并缓存页面，像原生 APP 导航一样。
*   [vue-acl (⭐383)](https://github.com/leonardovilarinho/vue-acl) - Access Control List for VueJS 2.
*   [vue-breadcrumbs (⭐148)](https://github.com/samturrell/vue-breadcrumbs) - Implements simple breadcrumb functionality with vue-router for both Vue 1.x and Vue 2.x.
*   [vue-2-breadcrumbs (⭐96)](https://github.com/Scrum/vue-2-breadcrumbs) - breadcrumb together with vue-router for Vue 2.x. and Bootstrap 4
*   [vs-crumbs (⭐142)](https://github.com/NxtChg/pieces/tree/master/js/vue/vs-crumbs) - Vue breadcrumbs in 40 lines of code that allows nested paths without child views.
*   [vue-nav (⭐63)](https://github.com/nearspears/vue-nav) - Page navigation manager, support all navigation function of native mobile app. 页面导航管理器，支持手机原生应用的所有导航功能。
*   [vue-2-crumbs (⭐36)](https://github.com/Suruat/vue-2-crumbs) - Breadcrumbs plugin for Vue.js 2 framework that allows to select parent route in route meta object with no need of sub-routing. Also allows using dynamic data.
*   [vue-pesdk (⭐26)](https://github.com/imgly/pesdk-wrapper-vuejs) Vue.js wrapper for the PhotoEditorSDK
*   [vue-resolve (⭐11)](https://github.com/javisperez/vue-resolve)
    Resolve routes data before entering / rendering the component for that route.
*   [vue-page-stack (⭐583)](https://github.com/hezhongfeng/vue-page-stack) - Routing and navigation for your Vue SPA. Vue 单页应用导航管理器
*   [stfalcon-vue-di (⭐10)](https://github.com/stfalcon-studio/stfalcon-vue-di) - ⭐️ Lightweight DI for vue components️ ❤️
*   [vue-backbone (⭐43)](https://github.com/mikeapr4/vue-backbone) - Vue.js Plugin to facilitate Backbone integration.
*   [vue2-migration-helper (⭐25)](https://github.com/mubaidr/vue2-migration-helper) - Transforms Vue.js SFCs to composition api syntax.
*   [vue-socket.io (⭐3.9k)](https://github.com/MetinSeylan/Vue-Socket.io) - Socket.io implementation for vuejs.
*   [vue-websocket (⭐532)](https://github.com/icebob/vue-websocket) - Simple websocket (socket.io) plugin for Vue.js.
*   [vue-echo (⭐232)](https://github.com/happyDemon/vue-echo) - Integrates Laravel Echo into Vue, allows for easy registration of socket events.
*   [vue-socket-cluster (⭐15)](https://github.com/nigeltiany/vue-socket-cluster) - Web Sockets for vue with uws(Micro web sockets) through socket cluster
*   [vue-native-websocket (⭐918)](https://github.com/nathantsoi/vue-native-websocket) - Native websocket implementation for Vuejs 2 and Vuex
*   [vue-socket.io-extended (⭐627)](https://github.com/probil/vue-socket.io-extended) - Socket.io bindings for Vue.js and Vuex

### Components & Libraries / Integrations

*   [vue-disqus (⭐251)](https://github.com/ktquez/vue-disqus) - Vue component to integrate Disqus comments in your application, with support for SPA.
*   [vue-youtube-embed (⭐419)](https://github.com/kaorun343/vue-youtube-embed) - Vue.js and YouTube.
*   [vue-add-to-calendar (⭐133)](https://github.com/nicolasbeauvais/vue-add-to-calendar) - A Vue.js component that provides "Add to Calendar" functionality, works with Vue 2.X.
*   [Vue + Meteor (⭐896)](https://github.com/Akryum/vue-meteor) - Vue first-class integration in Meteor.
*   [av-ts (⭐220)](https://github.com/HerringtonDarkholme/av-ts) - A modern, type-safe, idiomatic Vue binding library.
*   [Neutronium (⭐1.3k)](https://github.com/NeutroniumCore/Neutronium) - Build .NET desktop applications using HTML, CSS and javascript.
*   [vue-typescript-jest (⭐16)](https://github.com/locoslab/vue-typescript-jest) - Jest preprocessor.js for Vue.js components (supporting html, pug, and babel) and TypeScript.
*   [vue-jest-utils (⭐48)](https://github.com/locoslab/vue-jest-utils) - Utilities for testing Vue.js components using Jest.
*   [vue-custom-element (⭐1.9k)](https://github.com/karol-f/vue-custom-element) - Vue Custom Element - Custom Elements for Vue.js.
*   [vue-cordova (⭐332)](https://github.com/kartsims/vue-cordova) - Vue.js plugin for Cordova.
*   [vue-wamp (⭐48)](https://github.com/lajosbencz/vue-wamp) - AutobahnJS wrapper library fo Vue.js.
*   [express-vue (⭐1.3k)](https://github.com/danmademe/express-vue) - Vue rendering engine for Express.js. Use .Vue files as templates using res.render().
*   [vue-grecaptcha (⭐27)](https://github.com/drozdzynski/vue-grecaptcha) - Google reCAPTCHA for VueJS 2
*   [vue-recaptcha (⭐752)](https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
*   [require-vuejs (⭐146)](https://github.com/edgardleal/require-vuejs) - RequireJS plugin to async and dynamic load and parse .vue components.
...
*   [vuejs/vuefire (⭐3.3k)](https://github.com/vuejs/vuefire) - Official Firebase Integration for VueJS
*   [vuefire (⭐4)](https://github.com/nigeltiany/vuefire) - Firebase for VueJS and Vuex
*   [vue-runkit (⭐7)](https://github.com/maple3142/vue-runkit) - RunKit Embed for Vue.js
*   [vue-youtube (⭐325)](https://github.com/anteriovieira/vue-youtube) - Provides a simple layer for you to use your imagination while over the [YouTube IFrame Player API](https://developers.google.com/youtube/iframe_api_reference). (Compatible with SSR)
*   [vue-introjs (⭐298)](https://github.com/alex-oleshkevich/vue-introjs) - Integrates intro.js step-by-step guide and feature introduction with Vue.js <http://introjs.com/>.
*   [vue-loopback (⭐52)](https://github.com/InCuca/vue-loopback) - Loopback and Vue application template
*   [vue-laroute (⭐23)](https://github.com/samturrell/vue-laroute) - Integrate Laravel routes into your VueJS application using laroute.
*   [vue-raven (⭐91)](https://github.com/anteriovieira/vue-raven) - Automatically reports uncaught JavaScript exceptions triggered from vue component.
*   [vue-fixer (⭐1)](https://github.com/eperedo/vue-fixer) - A simple vue component for the [fixer API](https://fixer.io).
*   [amazon-cognito-vuex-module](https://github.com/Botre/amazon-cognito-vuex-module) - Vuex module for Amazon Cognito.
*   [vue-web3 (⭐63)](https://github.com/morrislaptop/vue-web3) - Web3 blockchain bindings for Vue.js (inspired by Vuefire and Drizzle)
*   [sbt-vuefy (⭐60)](https://github.com/GIVESocialMovement/sbt-vuefy) - Vue.js integration for Playframework
*   [loopback-vue-starter (⭐20)](https://github.com/ivandov/loopback-vue-starter) - LoopBack and Vue starter template with easy plugin management through `vue-cli` and `vue ui`.
*   [vue.py](https://stefanhoelzl.github.io/vue.py/) - Write Vue.js Components in Python
*   [vue-facebook-login-component (⭐192)](https://github.com/adi518/vue-facebook-login-component) - A fully customizable component for integrating Facebook login.
*   [vue-programmatic-invisible-google-recaptcha (⭐28)](https://github.com/promosis/vue-programmatic-invisible-google-recaptcha) - A simple invisible Google reCAPTCHA component focused solely on programmatic invocation.
*   [vbuild (⭐241)](https://github.com/manatlan/vbuild) - Its main purpose is to let you use components (.vue files) in your vuejs app, without a full nodejs stack. Since 0.6 versions : you can create [your component in pure python (⭐241)](https://github.com/manatlan/vbuild/blob/master/doc/PyComponent.md) !
*   [feathers-vuex (⭐449)](https://github.com/feathers-plus/feathers-vuex) - is a first class integration of the Feathers Client and Vuex. It implements many Redux best practices under the hood, eliminates a lot of boilerplate code, and still allows you to easily customize the Vuex store.
*   [vue-nocaptcha (⭐11)](https://github.com/chiaweilee/vue-nocaptcha) - Aliyun noCAPTCHA component for Vue.js
*   [ionic-vue (⭐273)](https://github.com/ModusCreateOrg/ionic-vue) - Vue.js integration for Ionic v4
*   [vue-0xcert (⭐334)](https://github.com/0xcert/framework/tree/master/packages/0xcert-vue-plugin) - Vue.js integration for 0xcert Framework - an open-source library that provides tools for building powerful decentralized applications
*   [vue-zdog (⭐50)](https://github.com/AlexandreBonaventure/vue-zdog) - Vue wrapper for zDog - a minimalist 3D engine for the browser
*   [vue-unleash (⭐15)](https://github.com/crishellco/vue-unleash) - A Vue plugin for the [Unleash](https://unleash.github.io/) open-source feature flag platform
*   [vue-cli-plugin-modular-router (⭐2)](https://github.com/PureConstructs/vue-cli-plugin-modular-router) - Vue CLI Plugin to create modular route files
*   [vue-cli-plugin-docker-nginx (⭐11)](https://github.com/truefalse10/vue-cli-plugin-docker-nginx) - Vue CLI Plugin to add a docker deployment using a minimal nginx server
*   [vue-cli-plugin-codeceptjs-puppeteer (⭐14)](https://github.com/codecept-js/vue-cli-plugin-codeceptjs-puppeteer) - installs CodeceptJS & Puppeteer for supercharged end 2 end testing 🙋
*   [vue-ua (⭐215)](https://github.com/ScreamZ/vue-analytics) - Google Universal Analytics support in Vue.js.
*   [vue-analytics (⭐1.8k)](https://github.com/MatteoGabriele/vue-analytics) - Vue plugin for Google Analytics.
*   [vue-gtm (⭐238)](https://github.com/mib200/vue-gtm) - Vue plugin for Google Tag Manager
*   [vue-gtag (⭐705)](https://github.com/MatteoGabriele/vue-gtag) - Global Site Tag plugin for Vue
*   [vue-ya-metrica (⭐6)](https://github.com/shershen08/vue-ya-metrica) - Vue plugin for Yandex.Metrica

### Components & Libraries / Dev Tools

*   [vue-dev-server (⭐20)](https://github.com/paulpflug/vue-dev-server) - A small development server for building `vue` components.
...
*   [vue-dummy (⭐119)](https://github.com/paulcollett/vue-dummy) - Placeholder Text and Dummy Images as a simple `v-dummy` directive.
*   [Bit (⭐16k)](https://github.com/teambit/bit) - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
*   [ComponentFixture (⭐50)](https://github.com/David-Desmaisons/ComponentFixture) - is a component design to develop and test other components, automatically binding their props.
*   [vue-cli-template-dev-server (⭐2)](https://github.com/eliranmal/vue-cli-template-dev-server) - A development server for building vue-cli custom templates.
*   [vue-codemods (⭐23)](https://github.com/SergioCrisostomo/vue-codemods) - Collection of codemod scripts that help update and refactor Vue and JavaScript files.
*   [codesandbox](https://codesandbox.io/s/vue-vue) - An online IDE and prototyping tool for rapid Vue development.
*   [Vue.js devtools (⭐23k)](https://github.com/vuejs/vue-devtools) - Chrome devtools extension for debugging Vue.js applications.
*   [DejaVue (⭐785)](https://github.com/MiCottOn/DejaVue) - Visualization and debugging tool built for Vue.js.
*   [vue-clicky (⭐111)](https://github.com/Herteby/vue-clicky) - Right click any component to show info about it in the console.
*   [vuejs-logger (⭐243)](https://github.com/justinkames/vuejs-logger) - Provides customizable logging functionality for Vue.js.
*   [vue-inspector (⭐262)](https://github.com/calirojas506/vue-inspector) - Vue.js Inspector for Mobile Devices
*   [Vue Performance Devtool (⭐533)](https://github.com/vue-perf-devtool/vue-perf-devtool) - Vue Performance Devtool is a browser extension for inspecting the performance of Vue Components
*   [VueSource (⭐40)](https://github.com/davestewart/vue-source) - Global Vue mixin which identifies components in source code by adding HTML comments
*   [NW-Vue-DevTools (⭐14)](https://github.com/TheJaredWilcurt/nw-vue-devtools) - DevDependency for adding Vue DevTools into NW\.js
*   [vue-markdown-loader (⭐702)](https://github.com/QingWei-Li/vue-markdown-loader) - Convert Markdown file to Vue Component.
*   [vue-styleguide-generator (⭐123)](https://github.com/shershen08/vue-styleguide-generator) - React inspired style guide generator for Vue.js.
...
*   [vue-styleguidist (⭐2.3k)](https://github.com/vue-styleguidist/vue-styleguidist) - A style guide generator for Vue components with a living style guide.
*   [vue-elucidate (⭐36)](https://github.com/mattrothenberg/vue-elucidate) - A component that generates beautiful documentation for your living styleguide / design system.
*   [vue-md-loader (⭐111)](https://github.com/wxsms/vue-md-loader) - Markdown files to ALIVE Vue components.
...
*   [jsdoc-vue-component (⭐11)](https://github.com/ccqgithub/jsdoc-vue-component) - A jsodc3 plugin that extract vue SFC info(name, props, events...) to document.
*   [jsdoc-vuedoc (⭐19)](https://github.com/ccqgithub/jsdoc-vuedoc) - A jsdoc3 plugin use `@vuedoc/md`.
*   [vue-storybook (⭐151)](https://github.com/mattrothenberg/vue-storybook) – Add `<story>` blocks to your Vue single file components for tighter integration of Vue + [Storybook (⭐75k)](https://github.com/storybooks/storybook)
*   [vue-patterns (⭐2.9k)](https://github.com/learn-vuejs/vue-patterns) - Useful Vue patterns, techniques, tips and tricks and helpful curated links.
*   [vuese (⭐1.6k)](https://github.com/vuese/vuese) - One-stop solution for vue component documentation.
*   [vue-dotmd-loader (⭐10)](https://github.com/mengdu/vue-dotmd-loader) - A webpack loader for loader markdown file transform to vue file.
*   [vuenit (⭐36)](https://github.com/jackmellis/vuenit) - Utilities for testing Vue components and directives.
*   [vue-unit (⭐213)](https://github.com/wrseward/vue-unit) - A library for Vue.js that makes it easier to create and unit test components.
*   [vue-a2b (⭐83)](https://github.com/fromAtoB/vue-a2b) - A library for Split Testing with Vue.js (A/B Testing). Highly configurable and tiny (1.2k gzipped).
*   [vue-test-utils (⭐3.5k)](https://github.com/vuejs/vue-test-utils) - Official utilities for testing Vue components.
*   [vue-test-actions (⭐9)](https://github.com/biigpongsatorn/vue-test-actions) - Unit testing Vuex actions with Jest mocks.
*   [jest-vue-matcher (⭐8)](https://github.com/14nrv/jest-vue-matcher) - Additional jest matchers for vue
*   [vue-hubble (⭐10)](https://github.com/crishellco/vue-hubble) - A better way to select elements for UI testing in Vue.
*   [Vue Testing Library (⭐906)](https://github.com/testing-library/vue-testing-library) - Simple and complete testing utilities that encourage good testing practices. Based on DOM Testing Library and built upon the official Vue Test Utils.
*   [jest-serializer-vue-tjw (⭐28)](https://github.com/tjw-lint/jest-serializer-vue-tjw) - Improved formatting of Jest Snapshots
*   [vuex-test-utils (⭐1)](https://github.com/Incognitus-Io/vuex-test-utils) - Unit testing Vux with chai.
*   [vue-node (⭐61)](https://github.com/knpwrs/vue-node) - Load vue components in node.
*   [language-vue@atom.io (⭐148)](https://github.com/hedefalk/atom-vue) - Vue component file syntax for Atom.
*   [vue-snippets@atom.io](https://github.com/ealves-pt/atom-vue-snippets) - Atom snippets for Vue component files.
*   [vue-autocompile@atom.io (⭐6)](https://github.com/paulpflug/vue-autocompile) - Auto compile vue file on save.
*   [lint-sass-vue@atom.io (⭐19)](https://github.com/fsblemos/lint-sass-vue) - Atom.io package to lint Sass/SCSS in `.vue` files.
*   [vuejs2-snippets@atom.io (⭐19)](https://github.com/CorentinAndre/Vuejs-snippets) - Atom snippets for javascript and components, including lifecycle hooks, directives, properties, vuex, vue-router, vue-i18n support.
*   [vue2-autocomplete@atom.io](https://github.com/ealves-pt/atom-vue2-autocomplete) - Vue.js 2.0+ autocomplete for Atom.
*   [Vue Syntax Highlight (⭐1.5k)](https://github.com/vuejs/vue-syntax-highlight) - Sublime Text syntax highlighting for single-file Vue components.
*   [VUEFormatter (⭐26)](https://github.com/baixuexiyang/VUEFormatter) - Sublime Text code format
*   [Vue Next Formatter (⭐14)](https://github.com/luozhihua/sublime-vue-formatter) - Sublime Text Vue formatter, Supported ES5/6/7, Less/Sass and Pug/Html template.
*   [Vim Vue (⭐1.3k)](https://github.com/posva/vim-vue) - Syntax Highlight for Vue.js components.
*   [vim-vue-plugin (⭐160)](https://github.com/leafOfTree/vim-vue-plugin) - Vim syntax and indent plugin for .vue files.
*   [Vetur (⭐5.6k)](https://github.com/octref/vetur) - Vue tooling for VSCode.
*   [Vue VSCode Snippets (⭐1.2k)](https://github.com/sdras/vue-vscode-snippets) - Snippets that will supercharge your Vue workflow.
*   [VuePack (⭐62)](https://github.com/madskristensen/VuePack) - Contains HTML Intellisense and code snippets for the Vue.js JavaScript library.
*   [Brackets Vue (⭐40)](https://github.com/pandao/brackets-vue) - Brackets extension for Vue.js.
*   [Vue.js support for WebStorm (⭐1.9k)](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs), IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
*   [Vue Mode (⭐303)](https://github.com/CodeFalling/vue-mode) - Emacs major mode for vue.js.
*   [Kate Syntax Files (⭐53)](https://github.com/mtorromeo/kate-syntax-files) - Syntax files (modified or original) for katepart (kate, kwrite, kdevelop).

### Components & Libraries / Scaffold

*   [vue-cli (⭐29k)](https://github.com/vuejs/vue-cli) - Simple CLI for scaffolding Vue.js projects.
*   [Vue-Django (⭐524)](https://github.com/NdagiStanley/vue-django) - A boilerplate to set you up in bringing the awesomeness of VueJS into a Django (Python) app.
*   [python-vuejs (⭐39)](https://github.com/cstrap/python-vuejs) - Gluing Python web frameworks and Vue.js with a set of scripts. Basically a `vue-cli` wrapper.
*   [generator-vue-plugin (⭐29)](https://github.com/jeneser/generator-vue-plugin) - Yeoman generator generating vue plugin.
*   [vue-seed (⭐23)](https://github.com/dulin666/vue-seed) - vue-seed is minimal seed for those looking to get up-and-running with Vue
*   [nuxt-seed (⭐9)](https://github.com/dulin666/nuxt-seed) - nuxt-seed is minimal seed for those looking to get up-and-running with Vue and Nuxt
*   [rails\_vue\_melt (⭐16)](https://github.com/midnightSuyama/rails_vue_melt) - Rails view with webpack=vue optimizer.
*   [vue-starter (⭐54)](https://github.com/rohitkrai03/vue-starter) - A Vue.js starter kit that lets you focus on more programming and less configuration.
*   [vuejs-wordpress-theme-starter (⭐1.5k)](https://github.com/EvanAgee/vuejs-wordpress-theme-starter) - A WordPress theme with the guts ripped out and replaced with Vue
*   [Cordovue (⭐70)](https://github.com/TheMushrr00m/cordovue) - A sample Apache Cordova application using Vue.
*   **[iBiu (⭐144)](https://github.com/bobiscool/iBiu)** A visual CLI for scaffolding large Vue projects in 2 seconds.
*   [wp-vue (⭐445)](https://github.com/alexmacarthur/wp-vue) - A simple Vue blog template that displays posts from a WordPress REST API endpoint.
*   [vue-cli-template-nativescript (⭐8)](https://github.com/julon/vue-cli-template-nativescript) - Template for starting new nativescript+vue projects with rollup+babel+eslint
...
*   [vue-vuex-typescript-webpack-seed (⭐35)](https://github.com/IsraelZablianov/vue-vuex-typescript-webpack-seed) - A seed project with Vue, Vuex, Typescript, Scss & Webpack with hot reloading
*   [VueCharged Template (⭐17)](https://github.com/mrboomer/vuecharged-template) - A highly opinionated, feature-first Vue 2 template with CLI scaffolding. Uses Vue 2, Vuex, Vue Router and Vue I18n.
*   [Huncwot (⭐674)](https://github.com/zaiste/huncwot) - Vue.js boilerplate with Node.js for building modern JavaScript applications with « batteries included » approach.
*   [wemake-vue-template (⭐719)](https://github.com/wemake-services/wemake-vue-template) - Bleeding edge vue template focused on code quality and developer happiness. Featuring: nuxt, flow, and jest.
*   [Awesome Vue Boilerplate (⭐61)](https://github.com/NarHakobyan/awesome-vue-boilerplate) - 😍 Awesome Vue, 🥰 Vuex, Vuex-pathify, element-ui, tailwindcss
...
*   [Mevn-CLI (⭐783)](https://github.com/madlabsinc/mevn-cli) - Light speed setup for MEVN stack based apps.
...
*   [Vuejs Firebase CRUD Starter with Auth (⭐17)](https://github.com/Timtech4u/vuejs-firebase-cruder)
*   [vue-enterprise-boilerplate (⭐7.6k)](https://github.com/chrisvfritz/vue-enterprise-boilerplate) - An ever-evolving, very opinionated architecture and dev environment for new Vue SPA projects using Vue CLI 3.
...
*   [Bourgeon (⭐64)](https://github.com/rayfranco/bourgeon) - Bourgeon is an opinionated-featured VueJS 2.0 setup for Webpack.
*   [Vue Settler (⭐20)](https://github.com/weavingbird/vue-settler) - An opinionated Vue 2.0 SPA Starter.
*   [vue-multiple-pages (⭐1.1k)](https://github.com/Plortinus/vue-multiple-pages) - A modern Vue.js multiple pages starter which uses Vue 2, Webpack2, and Element-UI
*   [vue-typescript-boilerplate (⭐57)](https://github.com/twcapps/vue-typescript-boilerplate) - A Vue.js typescript SPA starter with Vue 2, Vue Typed, Vuex, Vue Router and localization
*   [vue-tachyons-template (⭐12)](https://github.com/colorful-tones/vue-tachyons-template) - A Vue 2 project starter template w/ Tachyons, Webpack, and ESLint
*   [Vuets (⭐24)](https://github.com/AkiraLaine/Vuets) - A Vue, TypeScript ready boilerplate using class-style components, vue plugin options, webpack & vue-cli.
*   [MMF-FE/vue-typescript (⭐89)](https://github.com/MMF-FE/vue-typescript) - A vue2.x typescript template.
*   [vue-ts-amd (⭐14)](https://github.com/Micene09/vue-ts-amd) - A full-featured Vue.js 2 boilerplate using AMD pattern (RequireJS) and Typescript.
...
*   [vue-cli-template-library (⭐61)](https://github.com/julon/vue-cli-template-library) - Template for developing open-source vue.js libraries with Rollup + Jest + Babel + Storybook + TravisCI + SemanticRelease.
*   [vue-cli-template-github-pages (⭐6)](https://github.com/julon/vue-cli-template-github-pages) - A full-featured Webpack + vue-loader setup for Github Pages Deployment with travisCI.
*   [vue-webpack-chrome-extension-template (⭐108)](https://github.com/ALiangLiang/vue-webpack-chrome-extension-template) - Template for quick creation of Chrome extension on Vuejs hot reloading when developing.
...
*   [SPA Starter Kit (⭐915)](https://github.com/codecasts/spa-starter-kit) - A highly opinionated starter kit for building Single Page Applications with Laravel and Vue.js.
*   [neutrino-preset-vue-static (⭐16)](https://github.com/shyiko/neutrino-preset-vue-static) - A minimalistic starter kit for building static sites using Vue.js.
*   [Vueniverse (⭐337)](https://github.com/rlindskog/vueniverse) - A fully featured, universal Vue template for user-based applications, powered by Nuxt.js and Express.
*   [vue-preload (⭐15)](https://github.com/shershen08/vue-preload) - A plugin Vue for adding `<link rel="preload"` capabilities
*   [Vuetober (⭐248)](https://github.com/scottbedard/oc-vuetober-theme) - Single page apps with Laravel, Vue.js, and October CMS.
*   [vue-server-demo (⭐9)](https://github.com/fritx/vue-server-demo) - Writing koa server in Vue.
*   [vue-apollo-connector-kit (⭐114)](https://github.com/ecerroni/apollo-connector-kit) - JWT authentication with 2 different strategies (localStorage and httpOnly cookies). Authorization using custom directives (apollo).
*   [isomor-vue-app (⭐19)](https://github.com/apiel/isomor#getting-started-with-vue) - Setup a working environment with Vue and isomor, to unify the frontend and the backend by generating automatically the API.
*   [Electron Vue (⭐15k)](https://github.com/SimulatedGREG/electron-vue) - An Electron & Vue.js quick start boilerplate with vue-cli scaffolding, common Vue plugins, electron-packager/electron-builder, unit/e2e testing, vue-devtools, and webpack.
*   [VuePack (⭐2.5k)](https://github.com/egoist/vuepack) - A modern starter which uses Vue 2, Vuex, Vue-router and Webpack 2 (and even Electron).
*   [vuelectron (⭐2)](https://github.com/rachmanzz/vuelectron) - electronjs starter kits for vue.
*   [vue-design (⭐754)](https://github.com/L-Chris/vue-design) - the best website visualization builder with Vue and Electron.
*   [dapp (⭐8)](https://github.com/fritx/dapp) - Boilerplate for stack of Vue/Parcel/Electron.
*   [vue-electron-template (⭐311)](https://github.com/mubaidr/vue-electron-template) - An Electron & Vue.js boilerplate with Hot-reloading enabled and common Vue plugins, dev and build scripts configured using webpack-4
*   [vue-generator (⭐124)](https://github.com/hjeti/vue-generator) - A CLI generator for Vue components, views and store modules.
*   [vue-component-generator (⭐13)](https://github.com/lakb248/vue-component-generator) - A generator for vue component, supports Vue1.X and Vue2.X.
*   [rapydml\_cmp (⭐4)](https://github.com/valq7711/rapydml_cmp) - Vue-component pythonic generator, built on top of RapydML & RapydScript.
*   [vue-authoring-template (⭐14)](https://github.com/DrSensor/vue-authoring-template) - Template for authoring also publishing Vue component and their use case in story-scenario (storybook) format in easy way.
*   [vue-generate-component-typescript (⭐6)](https://github.com/Kamar-Meddah/vue-generate-component-typescript) - A typescript code generator for vue, it can generate components, directives, filters.

### Components & Libraries / Runtime

*   [blessed-vue (⭐384)](https://github.com/lyonlai/blessed-vue) - A VueJS runtime to let you write command line UI in Vue Edit

### Components & Libraries / Prerendering

*   [react-snap (⭐4.8k)](https://github.com/stereobooster/react-snap) - A zero-configuration static pre-renderer for SPA
*   [prerender-plugin (⭐14)](https://github.com/mubaidr/prerender-plugin) - A Node.js/ webpack plugin to prerender static HTML in a single-page application (SPA).
*   [vue-prerender (⭐22)](https://github.com/eldarc/vue-prerender) - A Vue.js tailored plugin which implements three strategies for prerendering Vue.js pages using headless chrome.
*   [Rendora (⭐1.9k)](https://github.com/rendora/rendora) - dynamic SSR (server-side rendering) using headless Chrome to effortlessly solve the SEO problem for modern javascript websites
*   [pre-vue (⭐29)](https://github.com/mtlynch/pre-vue) - A boilerplate Vue + Nuxt project that offers built-in support for OpenGraph tags, Google Analytics, a sitemap, and robots.txt.
*   [vue-genesis (⭐515)](https://github.com/fmfe/genesis) - 🔥Micro front end, micro service and lightweight solution based on Vue SSR🔥
    <!-- md-parser-end -->
    <br/>
    <br/>
    <br/>
...
*   [vue-dynamic-marquee (⭐115)](https://github.com/YishaiBerg/vue-dynamic-marquee) - Marquee component, fully responsive to changes on the fly.
...
*   [DataFormsJS (⭐151)](https://github.com/dataformsjs/dataformsjs) - A minimal routing and web service framework that uses Vue as a templating engine.
...
*   [Vue Org Chart (⭐284)](https://github.com/Hoogkamer/vue-org-chart) - Manage and publish your interactive organization chart (orgchart), free and no webserver required.
...
*   [Vue Crossword (⭐56)](https://github.com/Piterden/vue-crossword) - A Vue.js based crossword puzzle builder and filler front-end application. Built with [CodeSandbox](https://codesandbox.io/s/github/Piterden/vue-crossword/tree/master/).
...
*   [Feature Requests (Laravel + Vue Combo) (⭐21)](https://github.com/haydenbbickerton/feature-requests-app) by [haydenbbickerton](https://github.com/haydenbbickerton)
...
*   [Strong Together (⭐90)](https://github.com/websemantics/strong-together) - A starter project to build single page Vue.js apps as stand-alone or for Laravel / Laravel Spark projects, based on Browserify and Semantic-ui) by [WebSemantics](https://github.com/websemantics)
*   [vuetest: an ad admin web with user auth, bootstrap ui, uploader, WYSIWYG editor in iframe (⭐21)](https://github.com/sjerrys/vuetest)
...
*   [Vuexpresso (⭐406)](https://github.com/Ethaan/vuexpresso) - A boilerplate using VueX, Vue-Router, Vue-Apollo, webpack, GraphQL, Apollo-client, express and mongo
*   [Vue.js with Sails.js example project (⭐300)](https://github.com/ndabAP/vue-sails-example) - This project is for those who are new to single-page applications and want to learn through a real example.
...
*   [vue-xplan (⭐267)](https://github.com/JackGit/xplan/) A rotating earth demo page created with Vue and three.js
...
*   [todo-mvc-webpack (⭐7)](https://github.com/voluntadpear/todomvc-vue-webpack) by [voluntapear](https://github.com/voluntadpear) TodoMVC implementation on Vue 2 using the webpack-basic template with examples showing vuex, vue-router, central event bus and VueFire.
...
*   [Cinemateka (⭐11)](https://github.com/Piterden/cinemateka) - An example of SPA made with Vue v1 & Laravel 5. Film & events schedule. Russian comments.
...
*   [Vuejs Shopping Cart (⭐323)](https://github.com/ittus/vuejs-firebase-shopping-cart) - Shopping cart example using Vuejs and Firebase
...
*   [vuex-examples (⭐252)](https://github.com/ooade/vuex-examples) - Simple Examples on using Vuex to build Real World Apps
*   [vue-vuex-todomvc (⭐44)](https://github.com/bahmutov/vue-vuex-todomvc) - Example TodoMVC Vue.js app with Vuex store and server backend via REST and full set of E2E tests using [Cypress.io](https://www.cypress.io/) test runner.
...
*   [Retrospectify (⭐106)](https://github.com/pepf/retrospectify) - A simple tool for doing collaborative retrospectives in agile teams.
...
*   [Hotel (⭐9.8k)](https://github.com/typicode/hotel) - Start your dev servers from your browser and get local domains in seconds.
*   [Surfbird (⭐326)](https://github.com/surfbirdapp/surfbird) - A Twitter client written with modern web technologies.
*   [Approach0 (⭐312)](https://github.com/approach0/search-engine) - A math-aware search engine.
...
*   [Tomato5 (⭐242)](https://github.com/zhangxin840/tomato5) - Real-time collaboration tool, it combines Pomodoro Technique with a team status share board.
...
*   [Lulumi-browser (⭐408)](https://github.com/qazbnm456/lulumi-browser) - Lulumi-browser is a light weight browser coded with Vue.js 2 and Electron.
...
*   [Stacer (⭐8k)](https://github.com/oguzhaninan/Stacer) - Linux System Optimizer and Monitoring
...
*   [nativescript-vue (⭐4.9k)](https://github.com/rigor789/nativescript-vue) - A Vue.js implementation of the NativeScript renderer.
*   [piper (⭐246)](https://github.com/fireyy/piper) - A drag-and-drop mobile website builder base on Vue.
*   [mmf-blog-vue2 (⭐237)](https://github.com/lincenying/mmf-blog-vue2) - A blog based on Vue2(Vue-router, Vuex) and Webpack2.
*   [Media Manager (⭐244)](https://github.com/iutbay/mm) - Web File Manager.
...
*   [JSON Schema Editor (⭐223)](https://github.com/tangram-js/json-schema-editor) - An intuitive editor for JSON schema. Develop with Vue.js 2 and Firebase.
...
*   [vue-draggable-cal (⭐85)](https://github.com/liloow/vue-draggableCal) - Not your ordinary datepicker. A Vuejs draggable date selector with a fresh responsive design, mobile ready and 0 dependencies, 17kb gzipped.
*   [vue-vanilla-datetime-picker (⭐32)](https://github.com/Shchepotin/vue-vanilla-datetime-picker) - Datetime picker for Vue.
*   [vue2-daterange-picker (⭐309)](https://github.com/Innologica/vue2-daterange-picker/blob/master/README.md) - Vue2 date range picker based on bootstrap-daterangepicker (no jQuery dependency)
...
*   [app-framework (⭐647)](https://github.com/scriptPilot/app-framework) - IOS and Android Apps with HTML & JavaScript - develop, build and deploy - free and open source.
...
*   [vue-chat-scroll (⭐553)](https://github.com/theomessin/vue-chat-scroll) - Automatic scroll-to-bottom directive for Vue.js 2.0.
...
*   [@owumaro/vue-date-range-picker (⭐30)](https://github.com/Owumaro/vue-date-range-picker) - A vue component using Bootstrap 4 styles for date range selection
...
*   [chrome-ribbon-reminder (⭐13)](https://github.com/johndatserakis/chrome-ribbon-reminder) - A Chrome extension written using Vue and Async/Await. Uses a popup display and changes badge counts.
...
*   [vue-skip-to (⭐70)](https://github.com/vue-a11y/vue-skip-to) - It helps people who only use the keyboard to jump to what matters most.
*   [vue-axe (⭐174)](https://github.com/vue-a11y/vue-axe) - Accessibility auditing for Vue.js applications.
...
*   [vue-focus-lock (⭐132)](https://github.com/theKashey/vue-focus-lock) - It is a trap! A lock for a Focus. A11y util for scoping a focus.
...
*   [vue-swal (⭐188)](https://github.com/anteriovieira/vue-swal) - A small wrapper for integrating SweetAlert to Vuejs. (Compatible with SSR)
...
*   [LeafPlayer (⭐145)](https://github.com/paulschwoerer/leafplayer) - A simple and fast, privately hosted music streaming server.
...
*   [vue-jalaali-datepicker (⭐14)](https://github.com/pepour/vue-jalaali-datepicker) - Jalaali calendar and datepicker for vue.js 2.
