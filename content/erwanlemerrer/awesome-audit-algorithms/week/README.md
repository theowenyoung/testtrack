# Track Awesome Audit Algorithms Updates Weekly

A curated list of algorithms and papers for auditing black-box algorithms.

[🏠 Home](/README.md) · [🔍 Search](https://test.trackawesomelist.com/search/) · [🔥 Feed](https://test.trackawesomelist.com/erwanlemerrer/awesome-audit-algorithms/week/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 erwanlemerrer/awesome-audit-algorithms](https://github.com/erwanlemerrer/awesome-audit-algorithms/blob/main/README.md) · ⭐ 48 · 🏷️ Theory
