# Track Awesome Devenv Updates Weekly

A curated list of awesome tools, resources and workflow tips making an awesome development environment.

[🏠 Home](/README.md) · [🔍 Search](https://test.trackawesomelist.com/search/) · [🔥 Feed](https://test.trackawesomelist.com/jondot/awesome-devenv/week/rss.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 jondot/awesome-devenv](https://github.com/jondot/awesome-devenv/blob/master/README.md) · ⭐ 2.4K · 🏷️ Development Environment
