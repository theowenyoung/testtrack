...
[🏠 Home](/README.md) · [🔍 Search](https://test.trackawesomelist.com/search/) · [🔥 Feed](https://test.trackawesomelist.com/avelino/awesome-go/week/feed.xml) · [📮 Subscribe](https://trackawesomelist.us17.list-manage.com/subscribe?u=d2f0117aa829c83a63ec63c2f&id=36a103854c) · [😺 avelino/awesome-go](https://github.com/avelino/awesome-go/blob/main/README.md) · ⭐ 90K · 🏷️ Programming Languages
...
*   [authboss (⭐3.2k)](https://github.com/volatiletech/authboss) - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
*   [go-guardian (⭐407)](https://github.com/shaj13/go-guardian) - Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token, and Certificate based authentication.
*   [gosession (⭐11)](http://github.com/Kwynto/gosession) - This is quick session for net/http in GoLang. This package is perhaps the best implementation of the session mechanism, or at least it tries to become one.
*   [jeff (⭐242)](https://github.com/abraithwaite/jeff) - Simple, flexible, secure, and idiomatic web session management with pluggable backends.
*   [jwt (⭐569)](https://github.com/cristalhq/jwt) - Safe, simple, and fast JSON Web Tokens for Go.
...
*   [permissions2 (⭐467)](https://github.com/xyproto/permissions2) - Library for keeping track of users, login states, and permissions. Uses secure cookies and bcrypt.
...
*   [aurora (⭐1.2k)](https://github.com/logrusorgru/aurora) - ANSI terminal colors that support fmt.Printf/Sprintf.
*   [simpletable (⭐392)](https://github.com/alexeyco/simpletable) - Simple tables in a terminal with Go.
*   [uilive (⭐1.5k)](https://github.com/gosuri/uilive) - Library for updating terminal output in real time.

### Standard CLI

*   [acmd (⭐62)](https://github.com/cristalhq/acmd) - Simple, useful, and opinionated CLI package in Go.
*   [command-chain (⭐33)](https://github.com/rainu/go-command-chain) - A go library for configure and run command chains - such as pipelining in unix shells.
...
*   [countries (⭐67)](https://github.com/pioz/countries) - All you need when you are working with countries in Go.
...
*   [copygen (⭐190)](https://github.com/switchupcb/copygen) - Generate type-to-type and type-based code without reflection.
...
*   [kong (⭐1.1k)](https://github.com/alecthomas/kong) - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).

### Caches

*   [go-cache (⭐80)](https://github.com/viney-shih/go-cache) - A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern.
...
*   [libschema (⭐4)](https://github.com/muir/libschema) - Define your migrations separately in each library.  Migrations for open source libraries.  MySQL & PostgreSQL.
...
*   [ach (⭐337)](https://github.com/moov-io/ach) - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
*   [fullproxy (⭐39)](https://github.com/shoriwe/fullproxy) - A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols.

### HTTP Clients

*   [go-zoox/fetch (⭐19)](https://github.com/go-zoox/fetch) - A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API.

### Regular Expressions

*   [rex (⭐120)](https://github.com/hedhyw/rex) - Regular expressions builder.
...
*   [countries (⭐189)](https://github.com/biter777/countries) - Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standards.
...
*   [abbreviate (⭐189)](https://github.com/dnnrly/abbreviate) - abbreviate is a tool turning long strings in to shorter ones with configurable separators, for example to embed branch names in to deployment stack IDs.
...
*   [Dagu (⭐458)](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
*   [GoLobby/Config (⭐295)](https://github.com/golobby/config) - GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language.
...
*   [goradd/maps (⭐12)](https://github.com/goradd/maps) - Go 1.18+ generic map interface for maps; safe maps; ordered maps; ordered, safe maps; etc.
...
*   [go-tuple (⭐37)](https://github.com/barweiss/go-tuple) - Generic tuple implementation for Go 1.18+.
...
*   [sqlc (⭐6.5k)](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
*   [nject (⭐19)](https://github.com/muir/nject) - A type safe, reflective framework for libraries, tests, http endpoints, and service startup.
...
*   [Coraza (⭐734)](https://github.com/corazawaf/coraza) - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.

### Utilities

*   [pointer (⭐31)](https://github.com/xorcare/pointer) - Package pointer contains helper routines for simplifying the creation of optional fields of basic type.
...
*   [whatlanggo (⭐565)](https://github.com/abadojack/whatlanggo) - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).

### Morphological Analyzers

*   [snowball (⭐33)](https://github.com/goodsign/snowball) - Snowball stemmer port (cgo wrapper) for Go. Provides word stem extraction functionality [Snowball native](http://snowball.tartarus.org/).
...
*   [slug (⭐877)](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
*   [Slugify (⭐32)](https://github.com/avelino/slugify) - Go slugify application that handles string.

### Tokenizers

*   [gojieba (⭐2k)](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba (⭐29k)](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
*   [prose (⭐2.9k)](https://github.com/jdkato/prose) - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only.
...
*   [gotext (⭐356)](https://github.com/leonelquinteros/gotext) - GNU gettext utilities for Go.
...
*   [iuliia-go (⭐32)](https://github.com/mehanizm/iuliia-go) - Transliterate Cyrillic → Latin in every possible way.
...
*   [enca (⭐12)](https://github.com/endeveit/enca) - Minimal cgo bindings for [libenca](https://cihar.com/software/enca/), which detects character encodings.
*   [go-unidecode (⭐96)](https://github.com/mozillazg/go-unidecode) - ASCII transliterations of Unicode text.
*   [gounidecode (⭐76)](https://github.com/fiam/gounidecode) - Unicode transliterator (also known as unidecode) for Go.

### Networking

*   [gldap (⭐77)](https://github.com/jimlambrt/gldap) - gldap provides an ldap server implementation and you provide handlers for its ldap operations.

### Formatters

*   [address (⭐55)](https://github.com/bojanz/address) - Handles address representation, validation and formatting.
...
*   [go-humanize (⭐3.3k)](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.
*   [gotabulate (⭐291)](https://github.com/bndr/gotabulate) - Easily pretty-print your tabular data with Go.
*   [textwrap (⭐3)](https://github.com/isbm/textwrap) - Wraps text at end of lines. Implementation of `textwrap` module from Python.

### Markup Languages

*   [bafi (⭐66)](https://github.com/mmalcek/bafi) - Universal JSON, BSON, YAML, XML translator to ANY format using templates.
...
*   [goq (⭐219)](https://github.com/andrewstuart/goq) - Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery).
*   [html-to-markdown (⭐403)](https://github.com/JohannesKaufmann/html-to-markdown) - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
*   [htmlquery (⭐527)](https://github.com/antchfx/htmlquery) - An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression.
*   [mxj (⭐528)](https://github.com/clbanning/mxj) - Encode / decode XML as JSON or map\[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages.
...
*   [commonregex (⭐835)](https://github.com/mingrammer/commonregex) - A collection of common regular expressions for Go.
...
*   [editorconfig-core-go (⭐108)](https://github.com/editorconfig/editorconfig-core-go) - Editorconfig file parser and manipulator for Go.
*   [go-nmea (⭐185)](https://github.com/adrianmo/go-nmea) - NMEA parser library for the Go language.
*   [go-vcard (⭐81)](https://github.com/emersion/go-vcard) - Parse and format vCard.
*   [gofeed (⭐2k)](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.
*   [gographviz (⭐497)](https://github.com/awalterschulze/gographviz) - Parses the Graphviz DOT language.
...
*   [normalize (⭐32)](https://github.com/avito-tech/normalize) - Sanitize, normalize and compare fuzzy text.
*   [omniparser (⭐511)](https://github.com/jf-tech/omniparser) - A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema.
...
*   [sh (⭐5.1k)](https://github.com/mvdan/sh) - Shell parser and formatter.
*   [when (⭐1.2k)](https://github.com/olebedev/when) - Natural EN and RU language date/time parser with pluggable rules.
*   [xj2go (⭐28)](https://github.com/stackerzzq/xj2go) - Convert xml or json to go struct.

### Regular Expressions

*   [genex (⭐67)](https://github.com/alixaxel/genex) - Count and expand Regular Expressions into all matching Strings.
*   [go-wildcard (⭐17)](https://github.com/IGLOU-EU/go-wildcard) - Simple and lightweight wildcard pattern matching.
*   [goregen (⭐78)](https://github.com/zach-klippenstein/goregen) - Library for generating random strings from regular expressions.
*   [regroup (⭐123)](https://github.com/oriser/regroup) - Match regex expression named groups into go struct using struct tags and automatic parsing.
...
*   [dataflowkit (⭐548)](https://github.com/slotix/dataflowkit) - Web scraping Framework to turn websites into structured data.
...
*   [gospider (⭐179)](https://github.com/zhshch2002/gospider) - A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot (⭐209)](https://github.com/zhshch2002/goribot)
...
*   [xurls (⭐969)](https://github.com/mvdan/xurls) - Extract urls from text.
...
*   [go-runewidth (⭐491)](https://github.com/mattn/go-runewidth) - Functions to get fixed width of the character or string.
...
*   [pagoda (⭐510)](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
*   [sessions (⭐68)](https://github.com/adam-hanna/sessions) - Dead simple, highly performant, highly customizable sessions service for go http servers.
...
*   [go-sunrise (⭐59)](https://github.com/nathan-osman/go-sunrise) - Calculate the sunrise and sunset times for a given location.
...
*   [golua (⭐598)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
...
*   [notify (⭐765)](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.
...
*   [pool (⭐700)](https://github.com/go-playground/pool) - Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation.
...
*   [noodlog (⭐41)](https://github.com/gyozatech/noodlog) - Parametrized JSON logging library which lets you obfuscate sensitive data and marshal any kind of content. No more printed pointers instead of values, nor escape chars for the JSON strings.
...
*   [spew (⭐5.3k)](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.
...
*   [tail (⭐2.4k)](https://github.com/hpcloud/tail) - Go package striving to emulate the features of the BSD tail program.
...
*   [zerolog (⭐7.1k)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
*   [CloudForest (⭐718)](https://github.com/ryanbressler/CloudForest) - Fast, flexible, multi-threaded ensembles of decision trees for machine learning in pure Go.
*   [ddt (⭐20)](https://github.com/sgrodriguez/ddt) - Dynamic decision tree, create trees defining customizable rules.
*   [eaopt (⭐813)](https://github.com/MaxHalford/eaopt) - An evolutionary optimization library.
*   [evoli (⭐25)](https://github.com/khezen/evoli) - Genetic Algorithm and Particle Swarm Optimization library.
*   [fonet (⭐70)](https://github.com/Fontinalis/fonet) - A Deep Neural Network library written in Go.
*   [go-cluster (⭐35)](https://github.com/e-XpertSolutions/go-cluster) - Go implementation of the k-modes and k-prototypes clustering algorithms.
*   [go-deep (⭐391)](https://github.com/patrikeh/go-deep) - A feature-rich neural network library in Go.
...
*   [gobrain (⭐526)](https://github.com/goml/gobrain) - Neural Networks written in go.
*   [godist (⭐35)](https://github.com/e-dard/godist) - Various probability distributions, and associated methods.
*   [goga (⭐170)](https://github.com/tomcraven/goga) - Genetic algorithm library for Go.
...
*   [gonet (⭐76)](https://github.com/dathoangnd/gonet) - Neural Network for Go.
*   [Goptuna (⭐223)](https://github.com/c-bata/goptuna) - Bayesian optimization framework for black-box functions written in Go. Everything will be optimized.
...
*   [m2cgen (⭐2.2k)](https://github.com/BayesWitnesses/m2cgen) - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
*   [onnx-go (⭐433)](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
*   [amqp (⭐560)](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
*   [Asynq (⭐4.5k)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
*   [Bus (⭐278)](https://github.com/mustafaturan/bus) - Minimalist message bus implementation for internal communication.
*   [Centrifugo (⭐6.5k)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
*   [Chanify (⭐934)](https://github.com/chanify/chanify) - A push notification server send message to your iOS devices.
...
*   [Confluent Kafka Golang Client (⭐3.6k)](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
*   [dbus (⭐767)](https://github.com/godbus/dbus) - Native Go bindings for D-Bus.
...
*   [emitter (⭐439)](https://github.com/olebedev/emitter) - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
*   [event (⭐48)](https://github.com/agoalofalife/event) - Implementation of the pattern observer.
...
*   [Glue (⭐406)](https://github.com/desertbit/glue) - Robust Go and Javascript Socket Library (Alternative to Socket.io).
*   [go-mq (⭐79)](https://github.com/cheshir/go-mq) - RabbitMQ client with declarative configuration.
*   [go-notify (⭐62)](https://github.com/TheCreeper/go-notify) - Native implementation of the freedesktop notification spec.
...
*   [Gollum (⭐924)](https://github.com/trivago/gollum) - A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations.
...
*   [gorush (⭐6.6k)](https://github.com/appleboy/gorush) - Push notification server using [APNs2 (⭐2.7k)](https://github.com/sideshow/apns2) and google [GCM (⭐104)](https://github.com/google/go-gcm).
...
*   [machinery (⭐6.5k)](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.
...
*   [messagebus (⭐234)](https://github.com/vardius/message-bus) - messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD.
...
*   [oplog (⭐113)](https://github.com/dailymotion/oplog) - Generic oplog/replication system for REST APIs.
*   [pubsub (⭐386)](https://github.com/tuxychandru/pubsub) - Simple pubsub package for go.
*   [rabbus (⭐94)](https://github.com/rafaeljesus/rabbus) - A tiny wrapper over amqp exchanges and queues.
*   [rabtap (⭐226)](https://github.com/jandelgado/rabtap) - RabbitMQ swiss army knife cli app.
...
*   [redisqueue (⭐92)](https://github.com/robinjoseph08/redisqueue) - redisqueue provides a producer and consumer of a queue that uses Redis streams.
...
*   [Uniqush-Push (⭐1.4k)](https://github.com/uniqush/uniqush-push) - Redis backed unified push service for server-side notifications to mobile devices.
...
*   [xlsx (⭐154)](https://github.com/plandem/xlsx) - Fast and safe way to read/update your existing Microsoft Excel files in Go programs.

### Dependency Injection

*   [alice (⭐51)](https://github.com/magic003/alice) - Additive dependency injection container for Golang.
*   [di (⭐165)](https://github.com/goava/di) - A dependency injection container for go programming language.
*   [dig (⭐2.8k)](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
*   [dingo (⭐142)](https://github.com/i-love-flamingo/dingo) - A dependency injection toolkit for Go, based on Guice.
...
*   [goioc/di (⭐212)](https://github.com/goioc/di) - Spring-inspired Dependency Injection Container.
*   [google/wire (⭐9.3k)](https://github.com/google/wire) - Automated Initialization in Go.
...
*   [cookiecutter-golang (⭐551)](https://github.com/lacion/cookiecutter-golang) - A Go application boilerplate template for quick starting projects following production best practices.
*   [go-sample (⭐111)](https://github.com/zitryss/go-sample) - A sample layout for Go application projects with the real code.
*   [go-starter (⭐261)](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
*   [go-todo-backend (⭐176)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
*   [golang-standards/project-layout (⭐35k)](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue (⭐35k)](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
*   [golang-templates/seed (⭐338)](https://github.com/golang-templates/seed) - Go application GitHub repository template.
...
*   [scaffold (⭐129)](https://github.com/catchplay/scaffold) - Scaffold generates a starter Go project layout. Lets you focus on business logic implemented.
...
*   [gobeam/Stringy (⭐148)](https://github.com/gobeam/Stringy) - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
*   [strutil (⭐187)](https://github.com/ozgio/strutil) - String utilities.
*   [sttr (⭐424)](https://github.com/abhimanyu003/sttr) - cross-platform, cli app to perform various operations on string.
...
*   [antch (⭐240)](https://github.com/antchfx/antch) - A fast, powerful and extensible web crawling & scraping framework.
...
*   [avgRating (⭐12)](https://github.com/kirillDanshin/avgRating) - Calculate average score and rating based on Wilson Score Equation.
...
*   [basexx (⭐3)](https://github.com/bobg/basexx) - Convert to, from, and between digit strings in various number bases.
*   [battery (⭐211)](https://github.com/distatus/battery) - Cross-platform, normalized battery information library.
*   [bitio (⭐201)](https://github.com/icza/bitio) - Highly optimized bit-level Reader and Writer for Go.
...
*   [captcha (⭐121)](https://github.com/steambap/captcha) - Package captcha provides an easy to use, unopinionated API for captcha generation.
...
*   [gatus (⭐3k)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
*   [go-unarr (⭐206)](https://github.com/gen2brain/go-unarr) - Decompression library for RAR, TAR, ZIP and 7z archives.
...
*   [gopsutil (⭐8.3k)](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
*   [gountries (⭐362)](https://github.com/pariz/gountries) - Package that exposes country and subdivision data.
*   [gtree (⭐74)](https://github.com/ddddddO/gtree) - Provide CLI and Package for tree output and directories creation from Markdown or programmatically.
*   [health (⭐624)](https://github.com/alexliesenfeld/health) - A simple and flexible health check library for Go.
*   [health (⭐436)](https://github.com/dimiro1/health) - Easy to use, extensible health check library.
*   [healthcheck (⭐236)](https://github.com/etherlabsio/healthcheck) - An opinionated and concurrent health-check HTTP handler for RESTful services.
...
*   [lk (⭐258)](https://github.com/hyperboloide/lk) - A simple licensing library for golang.
*   [llvm (⭐970)](https://github.com/llir/llvm) - Library for interacting with LLVM IR in pure Go.
...
*   [persian (⭐67)](https://github.com/mavihq/persian) - Some utilities for Persian language in go.
...
*   [shortid (⭐810)](https://github.com/teris-io/shortid) - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
*   [shoutrrr (⭐471)](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
*   [stateless (⭐494)](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
*   [turtle (⭐139)](https://github.com/hackebrot/turtle) - Emojis for Go.
*   [url-shortener (⭐38)](https://github.com/pantrif/url-shortener) - A modern, powerful, and robust URL shortener microservice with mysql support.
...
*   [kagome (⭐685)](https://github.com/ikawaha/kagome) - JP morphological analyzer written in pure Go.
...
*   [nlp (⭐379)](https://github.com/Shixzie/nlp) - Extract values from strings and fill your structs with nlp.
*   [nlp (⭐377)](https://github.com/james-bowman/nlp) - Go Natural Language Processing library supporting LSA (Latent Semantic Analysis).
...
*   [RAKE.go (⭐97)](https://github.com/afjoseph/RAKE.Go) - Go port of the Rapid Automatic Keyword Extraction Algorithm (RAKE).

### Tokenizers

*   [segment (⭐71)](https://github.com/blevesearch/segment) - Go library for performing Unicode Text Segmentation as described in [Unicode Standard Annex #29](https://www.unicode.org/reports/tr29/)
...
*   [arp (⭐297)](https://github.com/mdlayher/arp) - Package arp implements the ARP protocol, as described in RFC 826.
*   [buffstreams (⭐251)](https://github.com/stabbycutyou/buffstreams) - Streaming protocolbuffer data over TCP made easy.
*   [canopus (⭐148)](https://github.com/zubairhamed/canopus) - CoAP Client/Server implementation (RFC 7252).
*   [cidranger (⭐751)](https://github.com/yl2chen/cidranger) - Fast IP to CIDR lookup for Go.
...
*   [dnsmonster (⭐210)](https://github.com/mosajjal/dnsmonster) - Passive DNS Capture/Monitoring Framework.
*   [easytcp (⭐497)](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
*   [ether (⭐78)](https://github.com/songgao/ether) - Cross-platform Go package for sending and receiving ethernet frames.
*   [ethernet (⭐246)](https://github.com/mdlayher/ethernet) - Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags.
...
*   [ftpserverlib (⭐333)](https://github.com/fclairamb/ftpserverlib) - Fully featured FTP server library.
...
*   [gmqtt (⭐750)](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
*   [gnet (⭐7k)](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
*   [go-stun (⭐530)](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).
...
*   [gopcap (⭐460)](https://github.com/akrennmair/gopcap) - Go wrapper for libpcap.
...
*   [gosnmp (⭐907)](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions.
...
*   [lhttp (⭐676)](https://github.com/fanux/lhttp) - Powerful websocket framework, build your IM server more easily.
...
*   [mdns (⭐909)](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang.
*   [mqttPaho](https://eclipse.org/paho/clients/golang/) - The Paho Go Client provides an MQTT client library for connection to MQTT brokers via TCP, TLS or WebSockets.
*   [nbio (⭐948)](https://github.com/lesismal/nbio) - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
*   [netpoll (⭐3.1k)](https://github.com/cloudwego/netpoll) - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
*   [peerdiscovery (⭐559)](https://github.com/schollz/peerdiscovery) - Pure Go library for cross-platform local peer discovery using UDP multicast.
...
*   [quic-go (⭐7.4k)](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
...
*   [ssh (⭐2.7k)](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).
...
*   [vssh (⭐870)](https://github.com/yahoo/vssh) - Go library for building network and server automation over SSH protocol.
*   [water (⭐1.5k)](https://github.com/songgao/water) - Simple TUN/TAP library.
*   [webrtc (⭐10k)](https://github.com/pions/webrtc) - A pure Go implementation of the WebRTC API.
*   [winrm (⭐383)](https://github.com/masterzen/winrm) - Go WinRM client to remotely execute commands on Windows machines.
*   [xtcp (⭐135)](https://github.com/xfxdev/xtcp) - TCP Server Framework with simultaneous full duplex communication, graceful shutdown, and custom protocol.

### HTTP Clients

*   [gentleman (⭐972)](https://github.com/h2non/gentleman) - Full-featured plugin-driven HTTP client library.
*   [go-http-client (⭐42)](https://github.com/bozd4g/go-http-client) - Make http calls simply and easily.
*   [go-req (⭐16)](https://github.com/wenerme/go-req) - Declarative golang HTTP client.
*   [go-retryablehttp (⭐1.3k)](https://github.com/hashicorp/go-retryablehttp) - Retryable HTTP client in Go.
...
*   [httpretry (⭐25)](https://github.com/ybbus/httpretry) - Enriches the default go HTTP client with retry functionality.
*   [pester (⭐598)](https://github.com/sethgrid/pester) - Go HTTP client calls with retries, backoff, and concurrency.
*   [request (⭐217)](https://github.com/monaco-io/request) - HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency.
*   [requests (⭐428)](https://github.com/carlmjohnson/requests) - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
...
*   [gl (⭐939)](https://github.com/go-gl/gl) - Go bindings for OpenGL (generated via glow).
...
*   [go-sqlbuilder (⭐856)](https://github.com/huandu/go-sqlbuilder) - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
*   [reform (⭐1.3k)](https://github.com/go-reform/reform) - Better ORM for Go, based on non-empty interfaces and code generation.
*   [rel (⭐589)](https://github.com/go-rel/rel) - Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API.
...
*   [modgv (⭐441)](https://github.com/lucasepe/modgv) - Converts 'go mod graph' output into Graphviz's DOT language.
*   [mvn-golang (⭐145)](https://github.com/raydac/mvn-golang) - plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure.
...
*   [pixie (⭐3.9k)](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
*   [profile (⭐1.8k)](https://github.com/pkg/profile) - Simple profiling support package for Go.
*   [statsviz (⭐2.4k)](https://github.com/arl/statsviz) - Live visualization of your Go application runtime statistics.
...
*   [dasel (⭐3.7k)](https://github.com/tomwright/dasel) - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
*   [gojsonq (⭐1.9k)](https://github.com/thedevsaddam/gojsonq) - A simple Go package to Query over JSON Data.
...
*   [graphql-go (⭐8.8k)](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
...
*   [rql (⭐264)](https://github.com/a8m/rql) - Resource Query Language for REST API.
...
*   [straf (⭐33)](https://github.com/SonicRoshan/straf) - Easily Convert Golang structs to GraphQL objects.

### Resource Embedding

*   [debme (⭐22)](https://github.com/leaanthony/debme) - Create an `embed.FS` from an existing `embed.FS` subdirectory.
*   [esc (⭐627)](https://github.com/mjibson/esc) - Embeds files into Go programs and provides http.FileSystem interfaces to them.
*   [fileb0x (⭐618)](https://github.com/UnnoTed/fileb0x) - Simple tool to embed files in go with focus on "customization" and ease to use.
...
*   [vfsgen (⭐948)](https://github.com/shurcooL/vfsgen) - Generates a vfsdata.go file that statically implements the given virtual filesystem.

### Science and Data Analysis

*   [assocentity (⭐10)](https://github.com/ndabAP/assocentity) - Package assocentity returns the average distance from words to a given entity.
*   [bradleyterry (⭐7)](https://github.com/seanhagen/bradleyterry) - Provides a Bradley-Terry Model for pairwise comparisons.
*   [calendarheatmap (⭐363)](https://github.com/nikolaydubina/calendarheatmap) - Calendar heatmap in plain Go inspired by Github contribution activity.
*   [chart (⭐743)](https://github.com/vdobler/chart) - Simple Chart Plotting library for Go. Supports many graphs types.
...
*   [go-dsp (⭐796)](https://github.com/mjibson/go-dsp) - Digital Signal Processing for Go.
...
*   [gohistogram (⭐166)](https://github.com/VividCortex/gohistogram) - Approximate histograms for data streams.
*   [gonum (⭐6.1k)](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
*   [gonum/plot (⭐2.3k)](https://github.com/gonum/plot) - gonum/plot provides an API for building and drawing plots in Go.
*   [goraph (⭐697)](https://github.com/gyuho/goraph) - Pure Go graph theory library(data structure, algorithm visualization).
...
*   [graph (⭐584)](https://github.com/yourbasic/graph) - Library of basic graph algorithms.
...
*   [orb (⭐589)](https://github.com/paulmach/orb) - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
*   [pagerank (⭐79)](https://github.com/alixaxel/pagerank) - Weighted PageRank algorithm implemented in Go.
...
*   [stats (⭐2.5k)](https://github.com/montanaflynn/stats) - Statistics package with common functions missing from the Golang standard library.
...
*   [CertMagic (⭐4.2k)](https://github.com/caddyserver/certmagic) - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
*   [dongle (⭐285)](https://github.com/golang-module/dongle) - A simple, semantic and developer-friendly golang package for encoding\&decoding and encryption\&decryption.
...
*   [go-generate-password (⭐46)](https://github.com/m1/go-generate-password) - Password generator that can be used on the cli or as a library.
*   [go-htpasswd (⭐27)](https://github.com/tg123/go-htpasswd) - Apache htpasswd Parser for Go.
*   [go-password-validator (⭐357)](https://github.com/lane-c-wagner/go-password-validator) - Password validator based on raw cryptographic entropy values.
*   [go-yara (⭐275)](https://github.com/hillu/go-yara) - Go Bindings for [YARA (⭐129)](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".
...
*   [lego (⭐5.6k)](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
*   [optimus-go (⭐322)](https://github.com/pjebs/optimus-go) - ID hashing and Obfuscation using Knuth's Algorithm.
...
*   [ssh-vault (⭐357)](https://github.com/ssh-vault/ssh-vault) - encrypt/decrypt using ssh keys.
...
*   [bel (⭐29)](https://github.com/32leaves/bel) - Generate TypeScript interfaces from Go structs/interfaces. Useful for JSON RPC.
*   [binstruct (⭐61)](https://github.com/ghostiam/binstruct) - Golang binary decoder for mapping data into the structure.
*   [cbor (⭐497)](https://github.com/fxamacker/cbor) - Small, safe, and easy CBOR encoding and decoding library.
*   [colfer (⭐678)](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.
*   [csvutil (⭐759)](https://github.com/jszwec/csvutil) - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
*   [elastic (⭐18)](https://github.com/epiclabs-io/elastic) - Convert slices, maps or any other unknown value across different types at run-time, no matter what.
...
*   [gogoprotobuf (⭐5.4k)](https://github.com/gogo/protobuf) - Protocol Buffers for Go with Gadgets.
*   [goprotobuf (⭐8.7k)](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
*   [jsoniter (⭐11k)](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".
*   [mapstructure (⭐6.2k)](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
*   [Easegress (⭐4.8k)](https://github.com/megaease/easegress) - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
*   [etcd (⭐42k)](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.
*   [Euterpe (⭐440)](https://github.com/ironsmile/euterpe) - Self-hosted music streaming server with built-in web UI and REST API.
...
*   [go-feature-flag (⭐536)](https://github.com/thomaspoignant/go-feature-flag) - A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it.
*   [go-proxy-cache (⭐67)](https://github.com/fabiocicerchia/go-proxy-cache) - Simple Reverse Proxy with Caching, written in Go, using Redis.
*   [jackal (⭐1.3k)](https://github.com/ortuman/jackal) - An XMPP server written in Go.
...
*   [protoxy (⭐26)](https://github.com/camgraff/protoxy) - A proxy server that converts JSON request bodies to Protocol Buffers.
*   [psql-streamer (⭐44)](https://github.com/blind-oracle/psql-streamer) - Stream database events from PostgreSQL to Kafka.
...
*   [RoadRunner (⭐6.8k)](https://github.com/spiral/roadrunner) - High-performance PHP application server, load-balancer and process manager.
*   [SFTPGo (⭐4.9k)](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
*   [machine (⭐114)](https://github.com/whitaker-io/machine) - Go library for writing and generating stream workers with built in metrics and traceability.
*   [stream (⭐69)](https://github.com/youthlin/stream) - Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce...

### Template Engines

*   [ego (⭐537)](https://github.com/benbjohnson/ego) - Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled.
...
*   [fasttemplate (⭐640)](https://github.com/valyala/fasttemplate) - Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/).
...
*   [goview (⭐306)](https://github.com/foolin/goview) - Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application.
*   [jet (⭐961)](https://github.com/CloudyKit/jet) - Jet template engine.
*   [liquid (⭐178)](https://github.com/osteele/liquid) - Go implementation of Shopify Liquid templates.
*   [maroto (⭐818)](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
*   [raymond (⭐497)](https://github.com/aymerick/raymond) - Complete handlebars implementation in Go.
*   [Razor (⭐799)](https://github.com/sipin/gorazor) - Razor view engine for Golang.
...
*   [sprig (⭐3.2k)](https://github.com/Masterminds/sprig) - Useful template functions for Go templates.
...
*   Testing Frameworks
    ...
    *   [assert (⭐48)](https://github.com/go-playground/assert) - Basic Assertion Library used along side native go testing, with building blocks for custom assertions.
    *   [badio (⭐10)](https://github.com/cavaliercoder/badio) - Extensions to Go's `testing/iotest` package.
    *   [baloo (⭐742)](https://github.com/h2non/baloo) - Expressive and versatile end-to-end HTTP API testing made easy.
    *   [be (⭐21)](https://github.com/carlmjohnson/be) - The minimalist generic test assertion library.
    *   [biff (⭐12)](https://github.com/fulldump/biff) - Bifurcation testing framework, BDD compatible.
    *   [charlatan (⭐198)](https://github.com/percolate/charlatan) - Tool to generate fake interface implementations for tests.
    *   [commander (⭐204)](https://github.com/SimonBaeumer/commander) - Tool for testing cli applications on windows, linux and osx.
    ...
    *   [fixenv (⭐7)](https://github.com/rekby/fixenv) - Fixture manage engine, inspired by pytest fixtures.
    ...
    *   [gnomock (⭐959)](https://github.com/orlangure/gnomock) - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
    *   [go-carpet (⭐230)](https://github.com/msoap/go-carpet) - Tool for viewing test coverage in terminal.
    *   [go-cmp (⭐3.2k)](https://github.com/google/go-cmp) - Package for comparing Go values in tests.
    *   [go-hit (⭐144)](https://github.com/Eun/go-hit) - Hit is an http integration test framework written in golang.
    *   [go-mutesting (⭐557)](https://github.com/zimmski/go-mutesting) - Mutation testing for Go source code.
    ...
    *   [go-snaps (⭐28)](http://github.com/gkampitakis/go-snaps) - Jest-like snapshot testing in Golang.
    *   [go-testdeep (⭐322)](https://github.com/maxatome/go-testdeep) - Extremely flexible golang deep comparison, extends the go testing package.
    ...
    *   [go-vcr (⭐958)](https://github.com/dnaeon/go-vcr) - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
    *   [goblin (⭐867)](https://github.com/franela/goblin) - Mocha like testing framework fo Go.
    *   [goc (⭐581)](https://github.com/qiniu/goc) - Goc is a comprehensive coverage testing system for The Go Programming Language.
    ...
    *   [gocrest (⭐84)](https://github.com/corbym/gocrest) - Composable hamcrest-like matchers for Go assertions.
    *   [godog (⭐1.8k)](https://github.com/cucumber/godog) - Cucumber BDD framework for Go.
    *   [gofight (⭐427)](https://github.com/appleboy/gofight) - API Handler Testing for Golang Router framework.
    *   [gogiven (⭐14)](https://github.com/corbym/gogiven) - YATSPEC-like BDD testing framework for Go.
    *   [gomatch (⭐43)](https://github.com/jfilipczyk/gomatch) - library created for testing JSON against patterns.
    *   [gomega](https://onsi.github.io/gomega/) - Rspec like matcher/assertion library.
    *   [Gont (⭐14)](https://github.com/stv0g/gont) - Go network testing toolkit for testing building complex network topologies using Linux namespaces.
    ...
    *   [got (⭐256)](https://github.com/ysmood/got) - An enjoyable golang test framework.
    *   [gotest.tools (⭐360)](https://github.com/gotestyourself/gotest.tools) - A collection of packages to augment the go testing package and support common patterns.
    ...
    *   [jsonassert (⭐94)](https://github.com/kinbiko/jsonassert) - Package for verifying that your JSON payloads are serialized correctly.
    ...
    *   [schema (⭐18)](https://github.com/jgroeneveld/schema) - Quick and easy expression matching for JSON schemas used in requests and responses.
    *   [stop-and-go (⭐6)](https://github.com/elgohr/stop-and-go) - Testing helper for concurrency.
    *   [testcase (⭐101)](https://github.com/adamluzsi/testcase) - Idiomatic testing framework for Behavior Driven Development.
    *   [testfixtures (⭐866)](https://github.com/go-testfixtures/testfixtures) - A helper for Rails' like test fixtures to test database applications.
    ...
    *   [testza (⭐401)](https://github.com/MarvinJWendt/testza) - Full-featured test framework with nice colorized output.
    ...
    *   [wstest (⭐95)](https://github.com/posener/wstest) - Websocket client for unit-testing a websocket http.Handler.
*   Mock
    *   [counterfeiter (⭐729)](https://github.com/maxbrunsfeld/counterfeiter) - Tool for generating self-contained mock objects.
    ...
    *   [go-localstack (⭐56)](https://github.com/elgohr/go-localstack) - Tool for using localstack in AWS testing.
    *   [go-sqlmock (⭐4.8k)](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
    *   [go-txdb (⭐487)](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.
    *   [gock (⭐1.7k)](https://github.com/h2non/gock) - Versatile HTTP mocking made easy.
    *   [gomock (⭐8.1k)](https://github.com/golang/mock) - Mocking framework for the Go programming language.
    *   [govcr (⭐132)](https://github.com/seborama/govcr) - HTTP mock for Golang: record and replay HTTP interactions for offline testing.
    ...
    *   [minimock (⭐468)](https://github.com/gojuno/minimock) - Mock generator for Go interfaces.
    ...
    *   [mooncake (⭐14)](https://github.com/GuilhermeCaruso/mooncake) - A simple way to generate mocks for multiple purposes
...
*   Fuzzing and delta-debugging/reducing/shrinking.
    ...
    *   [Tavor (⭐238)](https://github.com/zimmski/tavor) - Generic fuzzing and delta-debugging framework.
*   Selenium and browser control tools.
    *   [cdp (⭐641)](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
    ...
    *   [ggr (⭐287)](https://github.com/aerokube/ggr) - a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs.
    *   [playwright-go (⭐985)](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
    *   [rod (⭐2.9k)](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
...
*   Fail injection
    *   [failpoint (⭐741)](https://github.com/pingcap/failpoint) - An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.
...
*   [aws-sdk-go (⭐7.9k)](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.
...
*   [discordgo (⭐3.4k)](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
...
*   [go-here (⭐11)](https://github.com/abdullahselek/go-here) - Go client library around the HERE location based APIs.
...
*   [go-lark (⭐116)](https://github.com/go-lark/lark) - An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform.
...
*   [go-openproject (⭐11)](https://github.com/manuelbcd/go-openproject) - Go client library for interacting with [OpenProject](https://docs.openproject.org/api/) API.
*   [go-postman-collection (⭐54)](https://github.com/rbretecher/go-postman-collection) - Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia).
...
*   [go-twitch (⭐22)](https://github.com/knspriggs/go-twitch) - Go client for interacting with the Twitch v3 API.
*   [go-twitter (⭐1.5k)](https://github.com/dghubble/go-twitter) - Go client library for the Twitter v1.1 APIs.
*   [go-unsplash (⭐68)](https://github.com/hbagdi/go-unsplash) - Go client library for the [Unsplash.com](https://unsplash.com) API.
*   [go-xkcd (⭐47)](https://github.com/nishanths/go-xkcd) - Go client for the xkcd API.
...
*   [golang-tmdb (⭐60)](https://github.com/cyruzin/golang-tmdb) - Golang wrapper for The Movie Database API v3.
...
*   [lark (⭐237)](https://github.com/chyroc/lark) - [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback.
*   [lastpass-go (⭐30)](https://github.com/ansd/lastpass-go) - Go client library for the [LastPass](https://www.lastpass.com/) API.
...
*   [minio-go (⭐1.7k)](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.
...
*   [paypal (⭐533)](https://github.com/logpacker/PayPal-Go-SDK) - Wrapper for PayPal payment API.
*   [playlyfe (⭐2)](https://github.com/playlyfe/playlyfe-go-sdk) - The Playlyfe Rest API Go SDK.
*   [pushover (⭐127)](https://github.com/gregdel/pushover) - Go wrapper for the Pushover API.
...
*   [twitter-scraper (⭐261)](https://github.com/n0madic/twitter-scraper) - Scrape the Twitter Frontend API without authentication and limits.
*   [uptimerobot (⭐51)](https://github.com/bitfield/uptimerobot) - Go wrapper and command-line client for the Uptime Robot v2 API.
*   [vl-go (⭐2)](https://github.com/verifid/vl-go) - Go client library around the VerifID identity verification layer API.
*   [webhooks (⭐782)](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
*   [wit-go (⭐131)](https://github.com/wit-ai/wit-go) - Go client for wit.ai HTTP API.
...
*   [backscanner (⭐39)](https://github.com/icza/backscanner) - A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward.
...
*   [changie (⭐393)](https://github.com/miniscruff/changie) - Automated changelog tool for preparing releases with lots of customization options.
...
*   [clipboard (⭐282)](https://github.com/golang-design/clipboard) - 📋 cross-platform clipboard package in Go.
*   [clockwork (⭐416)](https://github.com/jonboulle/clockwork) - A simple fake clock for golang.
*   [cmd (⭐113)](https://github.com/SimonBaeumer/cmd) - Library for executing shell commands on osx, windows and linux.
*   [command (⭐14)](https://github.com/txgruppi/command) - Command pattern for Go with thread safe serial and parallel dispatcher.
*   [copy (⭐27)](https://github.com/gotidy/copy) - Package for fast copying structs of different types.
...
*   [cryptgo (⭐122)](https://github.com/Gituser143/cryptgo) - Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time!
...
*   [cvt (⭐28)](https://github.com/shockerli/cvt) - Easy and safe convert any value to another type.
*   [dbt (⭐49)](https://github.com/nikogura/dbt) - A framework for running self-updating signed binaries from a central, trusted repository.
*   [Death (⭐184)](https://github.com/vrecan/death) - Managing go application shutdown with signals.
*   [Deepcopier (⭐394)](https://github.com/ulule/deepcopier) - Simple struct copying for Go.
*   [delve (⭐531)](https://github.com/derekparker/delve) - Go debugger.
...
*   [filter (⭐99)](https://github.com/gookit/filter) - provide filtering, sanitizing, and conversion of Go data.
...
*   [git-time-metric (⭐912)](https://github.com/git-time-metric/gtm) - Simple, seamless, lightweight time tracking for Git.
*   [go-actuator (⭐10)](https://github.com/sinhashubham95/go-actuator) - Production ready features for Go based web frameworks.
*   [go-astitodo (⭐59)](https://github.com/asticode/go-astitodo) - Parse TODOs in your GO code.
...
*   [go-convert (⭐17)](https://github.com/Eun/go-convert) - Package go-convert enables you to convert a value into another type.
...
*   [go-funk (⭐3.9k)](https://github.com/thoas/go-funk) - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
*   [go-httpheader (⭐41)](https://github.com/mozillazg/go-httpheader) - Go library for encoding structs into Header fields.
*   [go-lock (⭐81)](https://github.com/viney-shih/go-lock) - go-lock is a lock library implementing read-write mutex and read-write trylock without starvation.
*   [go-pkg (⭐7)](https://github.com/chenquan/go-pkg) - A go toolkit.
*   [go-problemdetails (⭐14)](https://github.com/mvmaasakkers/go-problemdetails) - Go package for working with Problem Details.
...
*   [go-sitemap-generator (⭐186)](https://github.com/ikeikeikeike/go-sitemap-generator) - XML Sitemap generator written in Go.
*   [go-trigger (⭐229)](https://github.com/sadlil/go-trigger) - Go-lang global event triggerer, Register Events with an id and trigger the event from anywhere from your project.
...
*   [goback (⭐46)](https://github.com/carlescere/goback) - Go simple exponential backoff package.
*   [goctx (⭐3)](https://github.com/zerosnake0/goctx) - Get your context value with high performance.
*   [godaemon (⭐489)](https://github.com/VividCortex/godaemon) - Utility to write daemons.
...
*   [golog (⭐58)](https://github.com/mlimaloureiro/golog) - Easy and lightweight CLI tool to time track your tasks.
...
*   [gotenv (⭐237)](https://github.com/subosito/gotenv) - Load environment variables from `.env` or any `io.Reader` in Go.
*   [goval (⭐91)](https://github.com/maja42/goval) - Evaluate arbitrary expressions in Go.
*   [gpath (⭐39)](https://github.com/tenntenn/gpath) - Library to simplify access struct fields with Go's expression in reflection.
*   [grofer (⭐223)](https://github.com/pesos/grofer) - A system and resource monitoring tool written in Golang!
...
*   [handy (⭐69)](https://github.com/miguelpragier/handy) - Many utilities and helpers like string handlers/formatters and validators.
*   [hostctl (⭐812)](https://github.com/guumaster/hostctl) - A CLI tool to manage /etc/hosts with easy commands.
...
*   [immortal (⭐753)](https://github.com/immortal/immortal) - \*nix cross-platform (OS agnostic) supervisor.
*   [intrinsic (⭐45)](https://github.com/mengzhuo/intrinsic) - Use x86 SIMD without writing any assembly code.
*   [jump (⭐1.4k)](https://github.com/gsamokovarov/jump) - Jump helps you navigate faster by learning your habits.
...
*   [limiters (⭐105)](https://github.com/mennanov/limiters) - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
*   [lrserver (⭐122)](https://github.com/jaschaephraim/lrserver) - LiveReload server for Go.
*   [mani (⭐320)](https://github.com/alajmo/mani) - CLI tool to help you manage multiple repositories.
...
*   [mimemagic (⭐80)](https://github.com/zRedShift/mimemagic) - Pure Go ultra performant MIME sniffing library/utility.
*   [mimesniffer (⭐25)](https://github.com/aofei/mimesniffer) - A MIME type sniffer for Go.
*   [mimetype (⭐857)](https://github.com/gabriel-vasile/mimetype) - Package for MIME type detection based on magic numbers.
...
*   [nostromo (⭐120)](https://github.com/pokanop/nostromo) - CLI for building powerful aliases.
*   [okrun (⭐16)](https://github.com/xta/okrun) - go run error steamroller.
*   [olaf (⭐4)](https://github.com/btnguyen2k/olaf) - Twitter Snowflake implemented in Go.
...
*   [pattern-match (⭐189)](https://github.com/alexpantyukhin/go-pattern-match) - Pattern matching libray.
*   [peco (⭐7.1k)](https://github.com/peco/peco) - Simplistic interactive filtering tool.
...
*   [ptr (⭐18)](https://github.com/gotidy/ptr) - Package that provide functions for simplified creation of pointers from constants of basic types.
...
*   [retry (⭐328)](https://github.com/kamilsk/retry) - The most advanced functional mechanism to perform actions repetitively until successful.
*   [retry (⭐8)](https://github.com/percolate/retry) - A simple but highly configurable retry package for Go.
*   [retry (⭐58)](https://github.com/thedevsaddam/retry) - Simple and easy retry mechanism package for Go.
*   [retry (⭐12)](https://github.com/shafreeck/retry) - A pretty simple library to ensure your work to be done.
*   [retry-go (⭐44)](https://github.com/rafaeljesus/retry-go) - Retrying made simple and easy for golang.
...
*   [scan (⭐309)](https://github.com/blockloop/scan) - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
*   [scany (⭐748)](https://github.com/georgysavva/scany) - Library for scanning data from a database into Go structs and more.
*   [serve (⭐282)](https://github.com/syntaqx/serve) - A static http server anywhere you need.
*   [set (⭐40)](https://github.com/nofeaturesonlybugs/set) - Performant and flexible struct mapping and loose type conversion.
*   [shutdown (⭐38)](https://github.com/ztrue/shutdown) - App shutdown hooks for `os.Signal` handling.
...
*   [sorty (⭐109)](https://github.com/jfcg/sorty) - Fast Concurrent / Parallel Sorting.
...
*   [sshman (⭐38)](https://github.com/shoobyban/sshman) - SSH Manager for authorized\_keys files on multiple remote servers.
...
*   [throttle (⭐29)](https://github.com/yudppp/throttle) - Throttle is an object that will perform exactly one action per duration.
...
*   [toolbox (⭐183)](https://github.com/viant/toolbox) - Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer.
...
*   [util (⭐259)](https://github.com/shomali11/util) - Collection of useful utility functions. (strings, concurrency, manipulations, ...).
...
*   [uuid (⭐3.9k)](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
*   [wuid (⭐475)](https://github.com/edwingeng/wuid) - An extremely fast unique number generator, 10-135 times faster than UUID.
*   [xid (⭐3k)](https://github.com/rs/xid) - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
*   [ozzo-validation (⭐2.9k)](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
*   [terraform-validator (⭐79)](https://github.com/thazelart/terraform-validator) - A norms and conventions validator for Terraform.
*   [validate (⭐792)](https://github.com/gookit/validate) - Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.
...
*   [froggit-go (⭐20)](https://github.com/jfrog/froggit-go) - Froggit-Go is a Go library, allowing to perform actions on VCS providers.
...
*   [githooks (⭐51)](https://github.com/gabyx/githooks) - Per-repo and shared Git hooks with version control and auto update.
...
*   [libvlc-go (⭐320)](https://github.com/adrg/libvlc-go) - Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
*   [m3u8 (⭐968)](https://github.com/grafov/m3u8) - Parser and generator library of M3U8 playlists for Apple HLS.
*   [v4l (⭐70)](https://github.com/korandiz/v4l) - Video capture library for Linux, written in Go.

### Web Frameworks

*   [aah](https://aahframework.org) - Scalable, performant, rapid development Web framework for Go.
*   [Aero (⭐502)](https://github.com/aerogo/aero) - High-performance web framework for Go, reaches top scores in Lighthouse.
*   [Air (⭐418)](https://github.com/aofei/air) - An ideally refined web framework for Go.
...
*   [Flamingo (⭐320)](https://github.com/i-love-flamingo/flamingo) - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
*   [Flamingo Commerce (⭐367)](https://github.com/i-love-flamingo/flamingo-commerce) - Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications.
*   [Gearbox (⭐677)](https://github.com/abahmed/gearbox) - A web framework written in Go with a focus on high performance and memory optimization.
...
*   [Ginrpc (⭐238)](https://github.com/xxjwxc/ginrpc) - Gin parameter automatic binding tool,gin rpc tools.
...
*   [rk-boot (⭐311)](https://github.com/rookie-ninja/rk-boot) - A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily.
*   [rux (⭐83)](https://github.com/gookit/rux) - Simple and fast web framework for build golang HTTP applications.
*   [tango (⭐835)](https://github.com/lunny/tango) - Micro & pluggable web framework for Go.
*   [tigertonic (⭐1k)](https://github.com/rcrowley/go-tigertonic) - Go framework for building JSON web services inspired by Dropwizard.
*   [uAdmin (⭐210)](https://github.com/uadmin/uadmin) - Fully featured web framework for Golang, inspired by Django.
...
*   [WebGo (⭐260)](https://github.com/bnkamalesh/webgo) - A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc).
...
*   [go-fault (⭐466)](https://github.com/github/go-fault) - Fault injection middleware for Go.
*   [go-server-timing (⭐841)](https://github.com/mitchellh/go-server-timing) - Add/parse Server-Timing header.
*   [Limiter (⭐1.6k)](https://github.com/ulule/limiter) - Dead simple rate limit middleware for Go.
*   [ln-paywall (⭐129)](https://github.com/philippgille/ln-paywall) - Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin).
...
*   [rk-grpc (⭐51)](https://github.com/rookie-ninja/rk-grpc) - Middleware for gRPC with logging, metrics, auth, tracing etc.
*   [Tollbooth (⭐2.3k)](https://github.com/didip/tollbooth) - Rate limit HTTP request handler.
*   [XFF (⭐93)](https://github.com/sebest/xff) - Handle `X-Forwarded-For` header and friends.
...
*   [renderer (⭐246)](https://github.com/thedevsaddam/renderer) - Simple, lightweight and faster response (JSON, JSONP, XML, YAML, HTML, File) rendering package for Go.
...
*   [chi (⭐12k)](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
*   [Goji (⭐911)](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.
...
*   [httptreemux (⭐562)](https://github.com/dimfeld/httptreemux) - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.
...
*   [ngamux (⭐54)](https://github.com/ngamux/ngamux) - Simple HTTP router for Go.
...
*   [pure (⭐130)](https://github.com/go-playground/pure) - Is a lightweight HTTP router that sticks to the std "net/http" implementation.
...
*   [xujiajun/gorouter (⭐530)](https://github.com/xujiajun/gorouter) - A simple and fast HTTP router for Go.

### WebAssembly / Libraries for creating HTTP middlewares

*   [dom (⭐463)](https://github.com/dennwc/dom) - DOM library.
*   [go-canvas (⭐177)](https://github.com/markfarnan/go-canvas) - Library to use HTML5 Canvas, with all drawing within go code.
...
*   [vert (⭐76)](https://github.com/norunners/vert) - Interop between Go and JS values.
*   [wasmbrowsertest (⭐132)](https://github.com/agnivade/wasmbrowsertest) - Run Go WASM tests in your browser.
*   [webapi (⭐125)](https://github.com/gowebapi/webapi) - Bindings for DOM and HTML generated from WebIDL.

### Windows / Libraries for creating HTTP middlewares

*   [d3d9 (⭐133)](https://github.com/gonutz/d3d9) - Go bindings for Direct3D9.
*   [go-ole (⭐914)](https://github.com/go-ole/go-ole) - Win32 OLE implementation for golang.
...
*   [XML-Comp (⭐18)](https://github.com/xml-comp/xml-comp) - Simple command line XML comparer that generates diffs of folders, files and tags.
...
*   [xpath (⭐516)](https://github.com/antchfx/xpath) - XPath package for Go.
*   [xquery (⭐156)](https://github.com/antchfx/xquery) - XQuery lets you extract data from HTML/XML documents using XPath expression.
*   [zek (⭐603)](https://github.com/miku/zek) - Generate a Go struct from XML.

### Zero Trust / Libraries for creating HTTP middlewares

*   [Cosign (⭐2.6k)](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
*   [in-toto (⭐66)](https://github.com/in-toto/in-toto-golang) - Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation.
*   [Spiffe-Vault (⭐45)](https://github.com/philips-labs/spiffe-vault) - Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication.
...
*   [ChainJacking (⭐29)](https://github.com/Checkmarx/chainjacking) - Find which of your Go lang direct GitHub dependencies is susceptible to ChainJacking attack.
*   [dupl (⭐298)](https://github.com/mibk/dupl) - Tool for code clone detection.
...
*   [go-cleanarch (⭐625)](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
*   [go-mod-outdated (⭐602)](https://github.com/psampaz/go-mod-outdated) - An easy way to find outdated dependencies of your Go projects.
*   [go-outdated (⭐44)](https://github.com/firstrow/go-outdated) - Console application that displays outdated packages.
*   [goast-viewer (⭐661)](https://github.com/yuroyoro/goast-viewer) - Web based Golang AST visualizer.
...
*   [golines (⭐483)](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
*   [GoLint (⭐4k)](https://github.com/golang/lint) - Golint is a linter for Go source code.
*   [GoPlantUML (⭐1.1k)](https://github.com/jfeliu007/goplantuml) - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
*   [tickgit (⭐285)](https://github.com/augmentable-dev/tickgit) - CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author.
*   [todocheck (⭐391)](https://github.com/preslavmihaylov/todocheck) - Static code analyser which links TODO comments in code with issues in your issue tracker.
*   [unconvert (⭐340)](https://github.com/mdempsky/unconvert) - Remove unnecessary type conversions from Go source.
...
*   [coc-go language server extension for Vim/Neovim (⭐495)](https://github.com/josa42/coc-go) - This plugin adds [gopls (⭐6.5k)](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim.
...
*   [goimports-reviser (⭐210)](https://github.com/incu6us/goimports-reviser) - Formatting tool for imports.
...
*   [theia-go-extension (⭐17)](https://github.com/theia-ide/theia-go-extension) - Go language support for the Theia IDE.
...
*   [Watch (⭐197)](https://github.com/eaburns/Watch) - Runs a command in an acme win on file changes.

### Go Generate Tools / Libraries for creating HTTP middlewares

*   [generic (⭐44)](https://github.com/usk81/generic) - flexible data type for Go.
*   [genny (⭐1.7k)](https://github.com/cheekybits/genny) - Elegant generics for Go.
*   [gocontracts (⭐88)](https://github.com/Parquery/gocontracts) - brings design-by-contract to Go by synchronizing the code with the documentation.
...
*   [xgen (⭐191)](https://github.com/xuri/xgen) - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.

### Go Tools / Libraries for creating HTTP middlewares

*   [colorgo (⭐111)](https://github.com/songgao/colorgo) - Wrapper around `go` command for colorized `go build` output.
*   [depth (⭐795)](https://github.com/KyleBanks/depth) - Visualize dependency trees of any package by analyzing imports.
...
*   [go-callvis (⭐4.4k)](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
...
*   [godbg (⭐186)](https://github.com/tylerwince/godbg) - Implementation of Rusts `dbg!` macro for quick and easy debugging during development.
...
*   [richgo (⭐736)](https://github.com/kyoh86/richgo) - Enrich `go test` outputs with text decorations.
*   [roumon (⭐121)](https://github.com/becheran/roumon) - Monitor current state of all active goroutines via a command line interface.
*   [rts (⭐235)](https://github.com/galeone/rts) - RTS: response to struct. Generates Go structs from server responses.
*   [typex (⭐153)](https://github.com/dtgorski/typex) - Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration.

### DevOps Tools / Libraries for creating HTTP middlewares

*   [aptly (⭐7)](https://github.com/smira/aptly) - aptly is a Debian repository management tool.
*   [aurora (⭐568)](https://github.com/xuri/aurora) - Cross-platform web-based Beanstalkd queue server console.
*   [awsenv (⭐30)](https://github.com/soniah/awsenv) - Small binary that loads Amazon (AWS) environment variables for a profile.
*   [Balerter (⭐277)](https://github.com/balerter/balerter) - A self-hosted script-based alerting manager.
...
*   [cassowary (⭐620)](https://github.com/rogerwelin/cassowary) - Modern cross-platform HTTP load-testing tool written in Go.
*   [Ddosify (⭐5k)](https://github.com/ddosify/ddosify) - High-performance load testing tool, written in Golang.
...
*   [Dockerfile-Generator (⭐137)](https://github.com/ozankasikci/dockerfile-generator) - A go library and an executable that produces valid Dockerfiles using various input channels.
...
*   [easyssh-proxy (⭐262)](https://github.com/appleboy/easyssh-proxy) - Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`.
...
*   [go-furnace (⭐93)](https://github.com/go-furnace/go-furnace) - Hosting solution written in Go. Deploy your Application with ease on AWS, GCP or DigitalOcean.
...
*   [godbg (⭐226)](https://github.com/sirnewton01/godbg) - Web-based gdb front-end application.
...
*   [Hey (⭐14k)](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
*   [httpref (⭐25)](https://github.com/dnnrly/httpref) - httpref is a handy CLI reference for HTTP methods, status codes, headers, and TCP and UDP ports.
*   [jcli (⭐338)](https://github.com/jenkins-zh/jenkins-cli) - Jenkins CLI allows you manage your Jenkins as an easy way.
*   [kala (⭐1.9k)](https://github.com/ajvb/kala) - Simplistic, modern, and performant job scheduler.
*   [kcli (⭐186)](https://github.com/cswank/kcli) - Command line tool for inspecting kafka topics/partitions/messages.
*   [kool (⭐614)](https://github.com/kool-dev/kool) - Command line tool for managing Docker environments as an easy way.
*   [kubernetes (⭐93k)](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
*   [kwatch (⭐685)](https://github.com/abahmed/kwatch) - Monitor & detect crashes in your Kubernetes(K8s) cluster instantly.
...
*   [manssh (⭐272)](https://github.com/xwjdsh/manssh) - manssh is a command line tool for managing your ssh alias config easily.
...
*   [Pewpew (⭐359)](https://github.com/bengadbois/pewpew) - Flexible HTTP command line stress tester.
...
*   [s3-proxy (⭐138)](https://github.com/oxyno-zeta/s3-proxy) - S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth).
...
*   [s5cmd (⭐1.3k)](https://github.com/peak/s5cmd) - Blazing fast S3 and local filesystem execution tool.
*   [Scaleway-cli (⭐782)](https://github.com/scaleway/scaleway-cli) - Manage BareMetal Servers from Command Line (as easily as with Docker).
*   [script (⭐3k)](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
*   [skm (⭐832)](https://github.com/TimothyYe/skm) - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!
...
*   [terraform-provider-openapi (⭐219)](https://github.com/dikhan/terraform-provider-openapi) - Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed.
*   [traefik (⭐40k)](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
*   [trubka (⭐327)](https://github.com/xitonix/trubka) - A CLI tool to manage and troubleshoot Apache Kafka clusters with the ability of generically publishing/consuming protocol buffer and plain text events to/from Kafka.
*   [uTask (⭐767)](https://github.com/ovh/utask) - Automation engine that models and executes business processes declared in yaml.
*   [Vegeta (⭐20k)](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
*   [webhook (⭐8.3k)](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
*   [blocky (⭐1.9k)](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
*   [Cherry (⭐284)](https://github.com/rafael-santiago/cherry) - Tiny webchat server in Go.
...
*   [crawley (⭐99)](https://github.com/s0rg/crawley) - Web scraper/crawler for cli.
...
*   [gocc (⭐541)](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.
...
*   [Guora (⭐609)](https://github.com/meloalright/guora) - A self-hosted Quora like web application written in Go.
*   [hoofli (⭐4)](https://github.com/dnnrly/hoofli) - Generate PlantUML diagrams from Chrome or Firefox network inspections.
*   [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
*   [ide (⭐354)](https://github.com/thestrukture/ide) - Browser accessible IDE. Designed for Go with Go.
*   [ipe (⭐358)](https://github.com/dimiro1/ipe) - Open source Pusher server implementation compatible with Pusher client libraries written in GO.
*   [joincap (⭐177)](https://github.com/assafmo/joincap) - Command-line utility for merging multiple pcap files together.
...
*   [mockingjay (⭐522)](https://github.com/quii/mockingjay-server) - Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests.
...
*   [Neo-cowsay (⭐230)](https://github.com/Code-Hex/Neo-cowsay) - 🐮 cowsay is reborn. for a New Era.
*   [nes (⭐5.1k)](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
*   [Orbit (⭐173)](https://github.com/gulien/orbit) - A simple tool for running commands and generating files from templates.
*   [peg (⭐876)](https://github.com/pointlander/peg) - Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.
...
*   [tcpdog (⭐210)](https://github.com/mehrdadrad/tcpdog) - eBPF based TCP observability.
*   [tcpprobe (⭐329)](https://github.com/mehrdadrad/tcpprobe) - TCP tool for network performance and path monitoring, including socket statistics.
*   [term-quiz (⭐23)](https://github.com/crazcalm/term-quiz) - Quizzes for your terminal.
*   [toxiproxy (⭐8.6k)](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
*   [tsuru](https://tsuru.io/) - Extensible and open source Platform as a Service software.
*   [vaku (⭐138)](https://github.com/lingrino/vaku) - CLI & API for folder-based functions in Vault like copy, move, and search.
*   [vFlow (⭐929)](https://github.com/VerizonDigital/vflow) - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector.
...
*   [go-json-benchmark (⭐7)](https://github.com/zerosnake0/go-json-benchmark) - Go JSON benchmark.
...
*   [golang-sql-benchmark (⭐61)](https://github.com/tyler-smith/golang-sql-benchmark) - Collection of benchmarks for popular Go database/SQL utilities.
...
*   [speedtest-resize (⭐223)](https://github.com/fawick/speedtest-resize) - Compare various Image resize algorithms for the Go language.
...
*   [Go-gopher-Vector (⭐56)](https://github.com/keygx/Go-gopher-Vector) - Go gopher Vector Data \[.ai, .svg].
*   [gopher-logos (⭐106)](https://github.com/GolangUA/gopher-logos) - adorable gopher logos.
*   [gopher-stickers (⭐543)](https://github.com/tenntenn/gopher-stickers)
...
*   [gophers (⭐2.9k)](https://github.com/egonelbre/gophers) - Free gophers.
*   [gophers (⭐57)](https://github.com/rogeralsing/gophers) - random gopher graphics.
*   [gophers (⭐106)](https://github.com/sillecelik/go-gopher) - Gopher amigurumi toy pattern.
*   [gophers (⭐18)](https://github.com/scraly/gophers) - Gophers by Aurélie Vache.
...
*   [bahlo/go-styleguide (⭐1.3k)](https://github.com/bahlo/go-styleguide)
...
*   [Magnetico (⭐2.8k)](https://github.com/boramalper/magnetico/wiki/magnetico-Design-Specification)
*   [Sourcegraph](https://about.sourcegraph.com/handbook/engineering/go_style_guide)
*   [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
*   [Trybe (⭐311)](https://github.com/betrybe/playbook-go/blob/main/README_EN.md)
...
*   [Awesome Golang Workshops (⭐475)](https://github.com/amit-davidson/awesome-golang-workshops) - A curated list of awesome golang workshops.
...
*   [awesome-awesomeness (⭐29k)](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
...
*   [Go Projects (⭐105k)](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
...
*   [Go Cheat Sheet (⭐7k)](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
...
*   [go-clean-template (⭐3.7k)](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
*   [go-patterns (⭐20k)](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
*   [goapp (⭐531)](https://github.com/bnkamalesh/goapp) - An opinionated guideline to structure & develop a Go web application/service.
