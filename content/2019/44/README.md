...
## [2. Mind Expanding Books](/content/hackerkid/Mind-Expanding-Books/week/README.md)
...
## [5. Awesome Pyramid](/content/uralbash/awesome-pyramid/week/README.md)

### Email

*   [pyramid\_mailgun (⭐2)](https://github.com/evannook/pyramid_mailgun) - Mailgun integration for Pyramid framework.

## [6. Awesome Diversity](/content/folkswhocode/awesome-diversity/week/README.md)
...
## [15. Awesome Creative Tech Events](/content/danvoyce/awesome-creative-tech-events/week/README.md)
...
## [45. Awesome Salesforce](/content/mailtoharshit/awesome-salesforce/week/README.md)
...
## [50. Awesome Clean Tech](/content/nglgzz/awesome-clean-tech/week/README.md)
...
## [54. Awesome Ember](/content/ember-community-russia/awesome-ember/week/README.md)
...
## [56. Awesome Preact](/content/preactjs/awesome-preact/week/README.md)
...
## [59. Awesome Neuroscience](/content/analyticalmonk/awesome-neuroscience/week/README.md)
...
*   [Swiftstraints (⭐119)](https://github.com/Skyvive/Swiftstraints) - Auto Layout In Swift Made Easy.
...
*   [Evergreen (⭐72)](https://github.com/nilsleiffischer/Evergreen) - Most natural Swift logging.
...
*   [BigInt (⭐698)](https://github.com/attaswift/BigInt) - Arbitrary-precision arithmetic in pure Swift.
...
*   [VectorMath (⭐340)](https://github.com/nicklockwood/VectorMath) - A Swift library for Mac and iOS that implements common 2D and 3D vector and matrix functions, useful for games or vector-based graphics.
*   [Expression (⭐733)](https://github.com/nicklockwood/Expression) - A Mac and iOS library for evaluating numeric expressions at runtime.
...
*   [NumericAnnex (⭐68)](https://github.com/xwu/NumericAnnex) - NumericAnnex supplements the numeric facilities provided in the Swift standard library.

### Audio

*   [AudioBus](https://developer.audiob.us/) - Add Next Generation Live App-to-App Audio Routing.
*   [AudioKit (⭐9.4k)](https://github.com/audiokit/AudioKit) - A powerful toolkit for synthesizing, processing, and analyzing sounds.
*   [EZAudio (⭐4.9k)](https://github.com/syedhali/EZAudio) - An iOS/macOS audio visualization framework built upon Core Audio useful for anyone doing real-time, low-latency audio processing and visualizations.
*   [novocaine (⭐2.2k)](https://github.com/alexbw/novocaine) - Painless high-performance audio on iOS and macOS.
...
*   [Cephalopod (⭐108)](https://github.com/evgenyneu/Cephalopod) - A sound fader for AVAudioPlayer written in Swift.
*   [Chirp (⭐309)](https://github.com/trifl/Chirp) - The easiest way to prepare, play, and remove sounds in your Swift app!
*   [Beethoven (⭐718)](https://github.com/vadymmarkov/Beethoven) - An audio processing Swift library for pitch detection of musical signals.
*   [AudioPlayerSwift (⭐258)](https://github.com/tbaranes/AudioPlayerSwift) - AudioPlayer is a simple class for playing audio in iOS, macOS and tvOS apps.
*   [AudioPlayer (⭐671)](https://github.com/delannoyk/AudioPlayer) - AudioPlayer is syntax and feature sugar over AVPlayer. It plays your audio files (local & remote).
*   [TuningFork (⭐417)](https://github.com/comyar/TuningFork) - Simple Tuner for iOS.
*   [MusicKit (⭐591)](https://github.com/benzguo/MusicKit) - A framework for composing and transforming music in Swift.
...
*   [IQAudioRecorderController (⭐638)](https://github.com/hackiftekhar/IQAudioRecorderController) - A drop-in universal library allows to record audio within the app with a nice User Interface.
*   [TheAmazingAudioEngine2 (⭐520)](https://github.com/TheAmazingAudioEngine/TheAmazingAudioEngine2) - The Amazing Audio Engine is a sophisticated framework for iOS audio applications, built so you don't have to.
*   [InteractivePlayerView (⭐272)](https://github.com/AhmettKeskin/InteractivePlayerView) - Custom iOS music player view.
*   [ESTMusicIndicator (⭐464)](https://github.com/Aufree/ESTMusicIndicator) - Cool Animated music indicator view written in Swift.
*   [QuietModemKit (⭐443)](https://github.com/quiet/QuietModemKit) - iOS framework for the Quiet Modem (data over sound).
...
*   [BPMAnalyser (⭐68)](https://github.com/Luccifer/BPM-Analyser) - Fast and simple instrument to get the BPM rate from your audio-files.
*   [PandoraPlayer (⭐1.1k)](https://github.com/AppliKeySolutions/PandoraPlayer) - A lightweight music player for iOS, based on AudioKit.
*   [SonogramView (⭐65)](https://github.com/Luccifer/SonogramView) - Audio visualisation of song.
*   [AudioIndicatorBars (⭐284)](https://github.com/LeonardoCardoso/AudioIndicatorBars) - AIB indicates for your app users which audio is playing. Just like the Podcasts app.
*   [Porcupine (⭐2.8k)](https://github.com/Picovoice/Porcupine) - On-device wake word detection engine for macOS, iOS, and watchOS, powered by deep learning.
*   [Voice Overlay (⭐485)](https://github.com/algolia/voice-overlay-ios) - An overlay that gets your user’s voice permission and input as text in a customizable UI.
*   [ModernAVPlayer (⭐257)](https://github.com/noreasonprojects/ModernAVPlayer) - Persistence player to resume playback after bad network connection even in background mode, manage headphone interactions, system interruptions, now playing informations and remote commands.

### GIF

*   [YLGIFImage (⭐1.8k)](https://github.com/liyong03/YLGIFImage) - Async GIF image decoder and Image viewer supporting play GIF images. It just use very less memory.
*   [FLAnimatedImage (⭐7.8k)](https://github.com/Flipboard/FLAnimatedImage) - Performant animated GIF engine for iOS.
*   [gifu (⭐2.8k)](https://github.com/kaishin/gifu) - Highly performant animated GIF support for iOS in Swift.
*   [AnimatedGIFImageSerialization (⭐1.1k)](https://github.com/mattt/AnimatedGIFImageSerialization) - Complete Animated GIF Support for iOS, with Functions, NSJSONSerialization-style Class, and (Optional) UIImage Swizzling
*   [XAnimatedImage (⭐561)](https://github.com/khaledmtaha/XAnimatedImage) - XAnimatedImage is a performant animated GIF engine for iOS written in Swift based on FLAnimatedImage
...
*   [YYImage (⭐1.7k)](https://github.com/ibireme/YYImage) - Image framework for iOS to display/encode/decode animated WebP, APNG, GIF, and more.
*   [AImage (⭐1k)](https://github.com/wangjwchn/AImage) - A animated GIF\&APNG engine for iOS in Swift with low memory & cpu usage.Optimized for Multi-Image case.
...
*   [GPU Image (⭐20k)](https://github.com/BradLarson/GPUImage) - An open source iOS framework for GPU-based image and video processing.
*   [UIImage DSP (⭐372)](https://github.com/gdawg/uiimage-dsp) - iOS UIImage processing functions using the vDSP/Accelerate framework for speed.
*   [AsyncImageView (⭐915)](https://github.com/nicklockwood/AsyncImageView) - Simple extension of UIImageView for loading and displaying images asynchronously without lock up the UI.
*   [SDWebImage (⭐24k)](https://github.com/SDWebImage/SDWebImage) - Asynchronous image downloader with cache support with an UIImageView category.
*   [DFImageManager (⭐1.2k)](https://github.com/kean/DFImageManager) - Modern framework for fetching images from various sources. Zero config yet immense customization and extensibility. Uses NSURLSession.
*   [MapleBacon (⭐336)](https://github.com/JanGorman/MapleBacon) - An image download and caching library for iOS written in Swift.
*   [NYTPhotoViewer (⭐2.8k)](https://github.com/NYTimes/NYTPhotoViewer) - Slideshow and image viewer.
*   [IDMPhotoBrowser (⭐2.7k)](https://github.com/thiagoperes/IDMPhotoBrowser) - Photo Browser / Viewer.
*   [Concorde (⭐1.4k)](https://github.com/contentful-labs/Concorde/) - Download and decode progressive JPEGs.
*   [TOCropViewController (⭐4.4k)](https://github.com/TimOliver/TOCropViewController) - A view controller that allows users to crop UIImage objects.
*   [YXTMotionView (⭐78)](https://github.com/hanton/YXTMotionView) - A custom image view that implements device motion scrolling.
*   [PINRemoteImage (⭐4k)](https://github.com/pinterest/PINRemoteImage) - A thread safe, performant, feature rich image fetcher.
*   [SABlurImageView (⭐553)](https://github.com/marty-suzuki/SABlurImageView) - Easily Adding Animated Blur/Unblur Effects To An Image.
*   [FastImageCache (⭐8.2k)](https://github.com/path/FastImageCache) - iOS library for quickly displaying images while scrolling.
*   [BKAsciiImage (⭐427)](https://github.com/bkoc/BKAsciiImage) - Convert UIImage to ASCII art.
*   [AlamofireImage (⭐3.8k)](https://github.com/Alamofire/AlamofireImage) - An image component library for Alamofire.
*   [Nuke (⭐6.9k)](https://github.com/kean/Nuke) - Image loading, processing, caching and preheating.
...
*   [Ody (⭐46)](https://github.com/josejuanqm/Ody) - Ody is an easy to use random image generator built with Swift, Perfect for placeholders.
*   [Banana (⭐17)](https://github.com/gauravkatoch007/banana) - Image slider with very simple interface.
*   [JDSwiftAvatarProgress (⭐86)](https://github.com/JellyDevelopment/JDSwiftAvatarProgress) - Easy customizable avatar image asynchronously with progress bar animated.
*   [Kingfisher (⭐21k)](https://github.com/onevcat/Kingfisher) - A lightweight and pure Swift implemented library for downloading and caching image from the web.
*   [EBPhotoPages (⭐1.7k)](https://github.com/EddyBorja/EBPhotoPages) - A photo gallery for iOS with a modern feature set. Similar features as the Facebook photo browser.
*   [UIImageView-BetterFace-Swift (⭐470)](https://github.com/croath/UIImageView-BetterFace-Swift) - The Swift version of [https://github.com/croath/UIImageView-BetterFace (⭐779)](https://github.com/croath/UIImageView-BetterFace)
*   [KFSwiftImageLoader (⭐341)](https://github.com/kiavashfaisali/KFSwiftImageLoader) - An extremely high-performance, lightweight, and energy-efficient pure Swift async web image loader with memory and disk caching for iOS and Apple Watch.
*   [Toucan (⭐2.4k)](https://github.com/gavinbunney/Toucan) - Fabulous Image Processing in Swift.
*   [ImageLoaderSwift (⭐292)](https://github.com/hirohisa/ImageLoaderSwift) - A lightweight and fast image loader for iOS written in Swift.
*   [ImageScout (⭐957)](https://github.com/kaishin/ImageScout) - A Swift implementation of fastimage. Supports PNG, GIF, and JPEG.
...
*   [Agrume (⭐582)](https://github.com/JanGorman/Agrume) - A lemony fresh iOS image viewer written in Swift.
*   [PASImageView (⭐174)](https://github.com/abiaad/PASImageView) - Rounded async imageview downloader lightly cached and written in Swift.
*   [Navi (⭐114)](https://github.com/nixzhu/Navi) - Focus on avatar caching.
*   [SwiftPhotoGallery (⭐268)](https://github.com/justinvallely/SwiftPhotoGallery) - Simple, fullscreen image gallery with tap, swipe, and pinch gestures.
*   [MetalAcc (⭐258)](https://github.com/wangjwchn/MetalAcc) - GPU-based Media processing library using Metal written in Swift.
*   [MWPhotoBrowser (⭐8.8k)](https://github.com/mwaterfall/MWPhotoBrowser) - A simple iOS photo and video browser with grid view, captions and selections.
*   [UIImageColors (⭐3.1k)](https://github.com/jathu/UIImageColors) - iTunes style color fetcher for UIImage.
*   [CDFlipView (⭐99)](https://github.com/jibeex/CDFlipView) - A view that takes a set of images, make transition from one to another by using flipping effects.
...
*   [TGLParallaxCarousel (⭐439)](https://github.com/taglia3/TGLParallaxCarousel) - A lightweight 3D Linear Carousel with parallax effect.
*   [ImageButter (⭐396)](https://github.com/dollarshaveclub/ImageButter) - Makes dealing with images buttery smooth.
...
*   [APKenBurnsView (⭐96)](https://github.com/Alterplay/APKenBurnsView) - Ken Burns effect with face recognition!
*   [Moa (⭐330)](https://github.com/evgenyneu/moa) - An image download extension of the image view for iOS, tvOS and macOS.
*   [JMCMarchingAnts (⭐141)](https://github.com/izotx/JMCMarchingAnts) - Library that lets you add marching ants (animated) selection to the edges of the images.
*   [ImageViewer (⭐2.4k)](https://github.com/Krisiacik/ImageViewer) - An image viewer à la Twitter.
*   [FaceAware (⭐3k)](https://github.com/BeauNouvelle/FaceAware) - An extension that gives UIImageView the ability to focus on faces within an image when using AspectFill.
...
*   [ShinpuruImage (⭐100)](https://github.com/FlexMonkey/ShinpuruImage) - Syntactic Sugar for Accelerate/vImage and Core Image Filters.
*   [ImagePickerSheetController (⭐1.5k)](https://github.com/lbrndnr/ImagePickerSheetController) - ImagePickerSheetController is like the custom photo action sheet in iMessage just without the glitches.
*   [ComplimentaryGradientView (⭐723)](https://github.com/gkye/ComplimentaryGradientView) - Create complementary gradients generated from dominant and prominent colors in supplied image. Inspired by Grade.js.
*   [ImageSlideshow (⭐1.7k)](https://github.com/zvonicek/ImageSlideshow) - Swift image slideshow with circular scrolling, timer and full screen viewer.
*   [Imaginary (⭐596)](https://github.com/hyperoslo/Imaginary) - Remote images, as easy as one, two, three.
*   [PPAssetsActionController (⭐72)](https://github.com/pantuspavel/PPAssetsActionController) - Highly customizable Action Sheet Controller with Assets Preview.
*   [Vulcan (⭐294)](https://github.com/jinSasaki/Vulcan) - Multi image downloader with priority in Swift.
*   [FacebookImagePicker (⭐228)](https://github.com/floriangbh/FacebookImagePicker) - Facebook album photo picker written in Swift.
...
*   [CTPanoramaView (⭐996)](https://github.com/scihant/CTPanoramaView) - Displays spherical or cylindrical panoramas or 360-photos with touch or motion based control options.
...
*   [FlexibleImage (⭐810)](https://github.com/kawoou/FlexibleImage) - A simple way to play with image!
*   [TLPhotoPicker (⭐1.8k)](https://github.com/tilltue/TLPhotoPicker) - Multiple phassets picker for iOS lib. like a facebook.
*   [YapImageManager (⭐72)](https://github.com/yapstudios/YapImageManager) - A high-performance image downloader written in Swift, powered by YapDatabase.
*   [PhotoEditorSDK](https://photoeditorsdk.com/) - A fully customizable photo editor for your app.
*   [SimpleImageViewer (⭐419)](https://github.com/aFrogleap/SimpleImageViewer) - A snappy image viewer with zoom and interactive dismissal transition.
*   [AZImagePreview (⭐24)](https://github.com/Minitour/AZImagePreview) - A framework that makes image viewing easy.
*   [FaceCropper (⭐487)](https://github.com/KimDarren/FaceCropper) - Crop faces, inside of your image, with iOS 11 Vision api.
*   [Paparazzo (⭐749)](https://github.com/avito-tech/Paparazzo) - Custom iOS camera and photo picker with editing capabilities.
*   [ZImageCropper (⭐217)](https://github.com/ZaidPathan/ZImageCropper) - A Swift  project to crop image in any shape.
*   [InitialsImageView (⭐214)](https://github.com/bachonk/InitialsImageView) - An UIImageView extension that generates letter initials as a placeholder for user profile images, with a randomized background color.
*   [DTPhotoViewerController (⭐276)](https://github.com/tungvoduc/DTPhotoViewerController) - A fully customizable photo viewer ViewController, inspired by Facebook photo viewer.
*   [LetterAvatarKit (⭐214)](https://github.com/vpeschenkov/LetterAvatarKit) - A UIImage extension that generates letter-based avatars written in Swift.
...
*   [MetalPetal (⭐1.5k)](https://github.com/MetalPetal/MetalPetal) - A GPU-accelerated image/video processing framework based on [Metal](https://developer.apple.com/metal/).
*   [ShadowImageView (⭐793)](https://github.com/olddonkey/ShadowImageView) - ShadowImageView is a iOS 10 Apple Music style image view, help you create elegent image with shadow.
*   [Avatar (⭐23)](https://github.com/wvabrinskas/Avatar) - Generate random user Avatar images using CoreGraphics and QuartzCore.
*   [Serrata (⭐325)](https://github.com/horitaku46/Serrata) - Slide image viewer library similar to Twitter and LINE.
*   [StyleArt (⭐220)](https://github.com/ileafsolutions/StyleArt) - Style Art library process images using COREML with a set of pre trained machine learning models and convert them to Art style.
*   [greedo-layout-for-ios (⭐830)](https://github.com/500px/greedo-layout-for-ios) - Full aspect ratio grid layout for iOS.
*   [ImageDetect (⭐296)](https://github.com/Feghal/ImageDetect) - Detect and crop faces, barcodes and texts inside of your image, with iOS 11 Vision api.
*   [THTiledImageView (⭐29)](https://github.com/TileImageTeamiOS/THTiledImageView) - Provide ultra-high-quality images through tiling techniques.
...
*   [ATGMediaBrowser (⭐197)](https://github.com/altayer-digital/ATGMediaBrowser) - Image slide-show viewer with multiple predefined transition styles, and ability to create new transitions with ease.
*   [Pixel (⭐2.8k)](https://github.com/muukii/Pixel) - An image editor and engine using CoreImage.
*   [OnlyPictures (⭐671)](https://github.com/KiranJasvanee/OnlyPictures) - A simple and flexible way to add source of overlapping circular pictures.
*   [SFSafeSymbols (⭐1.2k)](https://github.com/piknotech/SFSafeSymbols) - Safely access Apple's SF Symbols using static typing.

### Media Processing

*   [SwiftOCR (⭐4.5k)](https://github.com/garnele007/SwiftOCR) - Fast and simple OCR library written in Swift.
*   [QR Code Scanner](https://www.appcoda.com/qr-code-ios-programming-tutorial/) - QR Code implementation.
*   [QRCode (⭐723)](https://github.com/aschuch/QRCode) - A QRCode generator written in Swift.
*   [EFQRCode (⭐4.3k)](https://github.com/EFPrefix/EFQRCode) - A better way to operate two-dimensional code in Swift.
*   [NSFWDetector (⭐1.5k)](https://github.com/lovoo/NSFWDetector) - A NSFW (aka porn) detector with CoreML.
...
*   [PDFGenerator (⭐710)](https://github.com/sgr-ksmt/PDFGenerator) - A simple Generator of PDF in Swift. Generate PDF from view(s) or image(s).
*   [SimplePDF (⭐238)](https://github.com/nRewik/SimplePDF) - Create a simple PDF effortlessly.
*   [SwiftPDFGenerator (⭐15)](https://github.com/kayoslab/SwiftPDFGenerator) - PDF generator using UIViews; Swift Version of 'UIView 2 PDF'.
*   [PSPDFKit](https://pspdfkit.com/) - Render PDF, add/edit annotations, fill forms, add/edit pages, view/create digital signatures.
*   [TPPDF (⭐572)](https://github.com/Techprimate/TPPDF) - Generate PDF using commands and automatic layout.
*   [FastPdfKit (⭐1.2k)](https://github.com/mobfarm/FastPdfKit) - A Static Library to be embedded on iOS applications to display pdf documents derived from Fast PDF.
*   [UIImagePlusPDF (⭐34)](https://github.com/DimaMishchenko/UIImagePlusPDF) - UIImage extensions to simply use PDF files.
...
*   [StreamingKit (⭐2.3k)](https://github.com/tumtumtum/StreamingKit) - A fast and extensible gapless AudioPlayer/AudioStreamer for macOS and iOS.
*   [Jukebox (⭐543)](https://github.com/teodorpatras/Jukebox) - Player for streaming local and remote audio files. Written in Swift.
...
*   [Airstream (⭐373)](https://github.com/qasim/Airstream) - A framework for streaming audio between Apple devices using AirPlay.
*   [OTAcceleratorCore (⭐30)](https://github.com/opentok/accelerator-core-ios) - A painless way to integrate audio/video(screen sharing) to any iOS applications via Tokbox.

### Messaging

*   [XMPPFramework (⭐5.9k)](https://github.com/robbiehanson/XMPPFramework) - An XMPP Framework in Objective-C for Mac and iOS.
*   [Chatto (⭐4.4k)](https://github.com/badoo/Chatto) - A lightweight framework to build chat applications, made in Swift.
*   [MessageKit (⭐5.3k)](https://github.com/MessageKit/MessageKit) - Eventually, a Swift re-write of JSQMessagesViewController.
*   [Messenger (⭐4.4k)](https://github.com/relatedcode/Messenger) - This is a native iOS Messenger app, making realtime chat conversations and audio calls with full offline support.
...
*   [chat-sdk-ios (⭐873)](https://github.com/chat-sdk/chat-sdk-ios) - Chat SDK iOS - Open Source Mobile Messenger.
...
*   [SwiftyMessenger (⭐57)](https://github.com/abdullahselek/SwiftyMessenger) - Swift toolkit for passing messages between iOS apps and extensions.
*   [Messenger Chat with Firebase (⭐559)](https://github.com/instamobile/messenger-iOS-chat-swift-firestore) - Swift messaging chat app with Firebase Firestore integration.
*   [SwiftKafka (⭐52)](https://github.com/IBM-Swift/SwiftKafka) - Swift SDK for Apache Kafka by IBM.

### Networking

*   [AFNetworking (⭐33k)](https://github.com/AFNetworking/AFNetworking) - A delightful iOS and macOS networking framework.
*   [RestKit (⭐10k)](https://github.com/RestKit/RestKit) - RestKit is an Objective-C framework for iOS that aims to make interacting with RESTful web services simple, fast and fun.
*   [FSNetworking (⭐386)](https://github.com/foursquare/FSNetworking) - Foursquare iOS networking library.
*   [ASIHTTPRequest (⭐5.8k)](https://github.com/pokeb/asi-http-request) - Easy to use CFNetwork wrapper for HTTP requests, Objective-C, macOS and iPhone.
*   [Overcoat (⭐1.1k)](https://github.com/Overcoat/Overcoat) - Small but powerful library that makes creating REST clients simple and fun.
*   [ROADFramework (⭐53)](https://github.com/epam/road-ios-framework) - Attributed-oriented approach for interacting with web services. The framework has built-in json and xml serialization for requests and responses and can be easily extensible.
*   [Alamofire (⭐38k)](https://github.com/Alamofire/Alamofire) - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
*   [Transporter (⭐449)](https://github.com/nghialv/Transporter) - A tiny library makes uploading and downloading easier.
*   [CDZPinger (⭐48)](https://github.com/cdzombak/CDZPinger) - Easy-to-use ICMP Ping.
...
*   [CocoaAsyncSocket (⭐12k)](https://github.com/robbiehanson/CocoaAsyncSocket) - Asynchronous socket networking library for Mac and iOS.
*   [Siesta (⭐2.2k)](https://github.com/bustoutsolutions/siesta) - Elegant abstraction for RESTful resources that untangles stateful messes. An alternative to callback- and delegate-based networking.
*   [Reachability.swift (⭐7.7k)](https://github.com/ashleymills/Reachability.swift) - Replacement for Apple's Reachability re-written in Swift with closures.
*   [OctopusKit (⭐3)](https://github.com/icoco/OctopusKit) - A simplicity but graceful solution for invoke RESTful web service APIs.
*   [Moya (⭐14k)](https://github.com/Moya/Moya) - Network abstraction layer written in Swift.
*   [TWRDownloadManager (⭐406)](https://github.com/chasseurmic/TWRDownloadManager) - A modern download manager based on NSURLSession to deal with asynchronous downloading, management and persistence of multiple files.
*   [HappyDns (⭐471)](https://github.com/qiniu/happy-dns-objc) - A Dns library, support custom dns server, dnspod httpdns. Only support A record.
*   [Bridge (⭐89)](https://github.com/BridgeNetworking/Bridge) - A simple extensible typed networking library. Intercept and process/alter requests and responses easily.
*   [TRON (⭐526)](https://github.com/MLSDev/TRON) - Lightweight network abstraction layer, written on top of Alamofire.
*   [EVCloudKitDao (⭐631)](https://github.com/evermeer/EVCloudKitDao) - Simplified access to Apple's CloudKit.
*   [EVURLCache (⭐294)](https://github.com/evermeer/EVURLCache) - a NSURLCache subclass for handling all web requests that use NSURLRequest.
*   [ResponseDetective (⭐1.9k)](https://github.com/netguru/ResponseDetective) - Sherlock Holmes of the networking layer.
*   [Pitaya (⭐846)](https://github.com/johnlui/Pitaya) - A Swift HTTP / HTTPS networking library just incidentally execute on machines.
*   [Just (⭐1.4k)](https://github.com/dduan/Just) - Swift HTTP for Humans.
*   [agent](https://github.com/hallas/agent) - Minimalistic Swift HTTP request agent for iOS and macOS.
*   [Reach (⭐459)](https://github.com/Isuru-Nanayakkara/Reach) - A simple class to check for internet connection availability in Swift.
*   [SwiftHTTP (⭐1.9k)](https://github.com/daltoniam/SwiftHTTP) - Thin wrapper around NSURLSession in swift. Simplifies HTTP requests.
*   [Netdiag (⭐136)](https://github.com/qiniu/iOS-netdiag) - A network diagnosis library. Support Ping/TcpPing/Rtmp/TraceRoute/DNS/external IP/external DNS.
*   [AFNetworkingHelper (⭐16)](https://github.com/betacraft/AFNetworkingHelper) - A custom wrapper over AFNetworking library that we use inside RC extensively.
...
*   [NetworkKit (⭐29)](https://github.com/imex94/NetworkKit) - Lightweight Networking and Parsing framework made for iOS, Mac, WatchOS and tvOS.
...
*   [SPTDataLoader (⭐622)](https://github.com/spotify/SPTDataLoader) - The HTTP library used by the Spotify iOS client.
...
*   [SOAPEngine (⭐477)](https://github.com/priore/SOAPEngine) - This generic SOAP client allows you to access web services using a your iOS app, macOS app and AppleTV app.
*   [Swish (⭐370)](https://github.com/thoughtbot/Swish) - Nothing but Net(working).
...
*   [MMLanScan (⭐460)](https://github.com/mavris/MMLanScan) - An iOS LAN Network Scanner library.
*   [Domainer (⭐6)](https://github.com/FelixLinBH/Domainer) - Manage multi-domain url auto mapping ip address table.
*   [Restofire (⭐381)](https://github.com/Restofire/Restofire) - Restofire is a protocol oriented network abstraction layer in swift that is built on top of Alamofire to use services in a declartive way.
*   [AFNetworking+RetryPolicy (⭐208)](https://github.com/kubatruhlar/AFNetworking-RetryPolicy) - An objective-c category that adds the ability to set the retry logic for requests made with AFNetworking.
*   [SwiftyZeroMQ (⭐60)](https://github.com/azawawi/SwiftyZeroMQ) - ZeroMQ Swift Bindings for iOS, macOS, tvOS and watchOS.
*   [Nikka (⭐28)](https://github.com/stremsdoerfer/Nikka) - A super simple Networking wrapper that supports many JSON libraries, Futures and Rx.
*   [XMNetworking (⭐981)](https://github.com/kangzubin/XMNetworking) - A lightweight but powerful network library with simplified and expressive syntax based on AFNetworking.
*   [Merhaba (⭐66)](https://github.com/abdullahselek/Merhaba) - Bonjour networking for discovery and connection between iOS, macOS and tvOS devices.
*   [DBNetworkStack (⭐33)](https://github.com/dbsystel/DBNetworkStack) - Resource-oritented networking which is typesafe, extendable, composeable and makes testing a lot easier.
*   [EFInternetIndicator (⭐132)](https://github.com/ezefranca/EFInternetIndicator) - A little swift Internet error status indicator using ReachabilitySwift.
*   [AFNetworking-Synchronous (⭐159)](https://github.com/paulmelnikow/AFNetworking-Synchronous) - Synchronous requests for AFNetworking 1.x, 2.x, and 3.x.
...
*   [NetClient (⭐123)](https://github.com/intelygenz/NetClient-iOS) - Versatile HTTP networking library written in Swift 3.
...
*   [Reactor (⭐186)](https://github.com/RuiAAPeres/Reactor) - Powering your RAC architecture.
*   [SWNetworking (⭐7)](https://github.com/isamankumara/skywite) - Powerful high-level iOS, macOS and tvOS networking library. from the creator of SWNetworking.
*   [Digger (⭐541)](https://github.com/cornerAnt/Digger) - Digger is a lightweight download framework that requires only one line of code to complete the file download task.
*   [Ciao (⭐54)](https://github.com/AlTavares/Ciao) - Publish and discover services using mDNS(Bonjour, Zeroconf).
*   [Bamboots (⭐440)](https://github.com/mmoaay/Bamboots) - Bamboots is a network request framework based on Alamofire, aiming at making network request easier for business development.
*   [SolarNetwork (⭐101)](https://github.com/ThreeGayHub/SolarNetwork) - Elegant network abstraction layer in Swift.
*   [FGRoute (⭐131)](https://github.com/Feghal/FGRoute) - An easy-to-use library that helps developers to get wifi ssid, router and device ip addresses.
*   [RxRestClient (⭐15)](https://github.com/stdevteam/RxRestClient) - Simple REST Client based on RxSwift and Alamofire.
*   [TermiNetwork (⭐84)](https://github.com/billp/TermiNetwork) - A networking library written with Swift 4.0 that supports multi-environment configuration, routing and automatic deserialization.
...
*   [RMHttp (⭐6)](https://github.com/rogermolas/RMHttp) - Lightweight REST library for iOS and watchOS.
...
*   [MHNetwork (⭐18)](https://github.com/emadhegab/MHNetwork) - Protocol Oriented Network Layer Aim to avoid having bloated singleton NetworkManager.
*   [ThunderRequest (⭐15)](https://github.com/3sidedcube/ThunderRequest) - A simple URLSession wrapper with a generic protocol based request body approach and easy deserialisation of responses.
...
*   [Squid (⭐69)](https://github.com/borchero/Squid) - Declarative and reactive networking framework based on Combine and providing means for HTTP requests, transparent pagination, and WebSocket communication.

### Email

*   [Mail Core 2 (⭐2.4k)](https://github.com/MailCore/mailcore2) - MailCore 2 provide a simple and asynchronous API to work with e-mail protocols IMAP, POP and SMTP.
*   [Postal (⭐640)](https://github.com/snipsco/Postal) - A swift framework providing simple access to common email providers.

### Representations

*   [apollo-ios (⭐3.5k)](https://github.com/apollographql/apollo-ios) - A GraphQL client for iOS.
*   [JSONRPCKit (⭐178)](https://github.com/bricklife/JSONRPCKit) - A JSON-RPC 2.0 library.
*   [protobuf-swift (⭐931)](https://github.com/alexeyxo/protobuf-swift) - Google ProtocolBuffers for Apple Swift
*   [swift-protobuf (⭐4k)](https://github.com/apple/swift-protobuf) - Plugin and runtime library for using protobuf with Swift.

### Push Notifications

*   [Orbiter (⭐673)](https://github.com/mattt/Orbiter) - Push Notification Registration for iOS.
*   [PEM (⭐36k)](https://github.com/fastlane/fastlane/tree/master/pem) - Automatically generate and renew your push notification profiles.
*   [Knuff (⭐5.1k)](https://github.com/KnuffApp/Knuff) - The debug application for Apple Push Notification Service (APNS).
*   [FBNotifications (⭐497)](https://github.com/facebook/FBNotifications) - Facebook Analytics In-App Notifications Framework.
*   [NWPusher (⭐6.2k)](https://github.com/noodlewerk/NWPusher) - macOS and iOS application and framework to play with the Apple Push Notification service (APNs).
*   [SimulatorRemoteNotifications (⭐1.4k)](https://github.com/acoomans/SimulatorRemoteNotifications) - Library to send mock remote notifications to the iOS simulator.
...
*   [Pushkin (⭐255)](https://github.com/Nordeus/pushkin) - Free and open-source.
*   [Pusher](https://pusher.com/beams) - Free and unlimited.
*   [Swrve](https://www.swrve.com)

### Local Notifications

*   [DLLocalNotifications (⭐206)](https://github.com/d7laungani/DLLocalNotifications) -  Easily create Local Notifications in swift - Wrapper of UserNotifications Framework.

### Objective-C Runtime

*   [Lumos (⭐135)](https://github.com/sushinoya/lumos) - A light Swift wrapper around Objective-C Runtime.
*   [Swizzlean (⭐104)](https://github.com/rbaumbach/Swizzlean) - An Objective-C Swizzle Helper Class.

### Optimization

*   [Unreachable (⭐102)](https://github.com/nvzqz/Unreachable) - Unreachable code path optimization hint for Swift.

### CSV

*   [CSwiftV (⭐166)](https://github.com/Daniel1of1/CSwiftV) - A csv parser written in swift conforming to rfc4180.
*   [CSV.swift (⭐589)](https://github.com/yaslab/CSV.swift) - CSV reading and writing library written in Swift.

### JSON

*   [Mantle (⭐11k)](https://github.com/Mantle/Mantle) - Model framework for Cocoa and Cocoa Touch.
*   [Groot (⭐534)](https://github.com/gonzalezreal/Groot) - Convert JSON dictionaries and arrays to and from Core Data managed objects.
*   [PropertyMapper (⭐1.1k)](https://github.com/krzysztofzablocki/PropertyMapper) - Data mapping and validation with minimal amount of code.
*   [JSONModel (⭐6.8k)](https://github.com/JSONModel/JSONModel) - Magical Data Modeling Framework for JSON. Create rapidly powerful, atomic and smart data model classes.
*   [SwiftyJSON (⭐22k)](https://github.com/SwiftyJSON/SwiftyJSON) - The better way to deal with JSON data in Swift.
*   [FastEasyMapping (⭐556)](https://github.com/Yalantis/FastEasyMapping) - Serialize & deserialize JSON fast.
...
*   [SwiftyJSONAccelerator (⭐919)](https://github.com/insanoid/SwiftyJSONAccelerator) - Generate Swift 5 model files from JSON with Codeable support.
...
*   [Arrow 🏹 (⭐376)](https://github.com/freshOS/Arrow) - Elegant JSON Parsing in Swift.
*   [JSONExport (⭐4.7k)](https://github.com/Ahmed-Ali/JSONExport) - JSONExport is a desktop application for macOS which enables you to export JSON objects as model classes with their associated constructors, utility methods, setters and getters in your favorite language.
*   [Elevate (⭐612)](https://github.com/Nike-Inc/Elevate) - Elevate is a JSON parsing framework that leverages Swift to make parsing simple, reliable and composable.
*   [MJExtension (⭐8.5k)](https://github.com/CoderMJLee/MJExtension) - A fast, convenient and nonintrusive conversion between JSON and model. Your model class don't need to extend another base class. You don't need to modify any model file.
*   [AlamofireObjectMapper (⭐2.6k)](https://github.com/tristanhimmelman/AlamofireObjectMapper) - An Alamofire extension which converts JSON response data into swift objects using ObjectMapper.
*   [JAYSON (⭐250)](https://github.com/muukii/JAYSON) - Strict and Scalable JSON library.
*   [HandyJSON (⭐4k)](https://github.com/alibaba/handyjson) - A handy swift JSON-object serialization/deserialization library for Swift.
*   [Marshal (⭐696)](https://github.com/utahiosmac/Marshal) - Marshaling the typeless wild west of \[String: Any] (Protocol based).
*   [Motis (⭐249)](https://github.com/mobilejazz/Motis) - Easy JSON to NSObject mapping using Cocoa's key value coding (KVC).
...
*   [Serpent (⭐287)](https://github.com/nodes-ios/Serpent) - A protocol to serialize Swift structs and classes for encoding and decoding.
*   [FlatBuffersSwift (⭐566)](https://github.com/mzaks/FlatBuffersSwift) - This project brings FlatBuffers (an efficient cross platform serialization library) to Swift.
*   [CodableAlamofire (⭐749)](https://github.com/Otbivnoe/CodableAlamofire) - An extension for Alamofire that converts JSON data into Decodable objects (Swift 4).
...
*   [Himotoki (⭐796)](https://github.com/ikesyo/Himotoki) - A type-safe JSON decoding library purely written in Swift.
...
*   [Mappable (⭐27)](https://github.com/leavez/Mappable) - lightweight and powerful JSON object mapping library, specially optimized for immutable properties.

### XML & HTML

*   [AEXML (⭐966)](https://github.com/tadija/AEXML) - Simple and lightweight XML parser written in Swift.
*   [Ji (⭐824)](https://github.com/honghaoz/Ji) - XML/HTML parser for Swift.
*   [Ono (⭐2.6k)](https://github.com/mattt/Ono) - A sensible way to deal with XML & HTML for iOS & macOS.
*   [Fuzi (⭐979)](https://github.com/cezheng/Fuzi) - A fast & lightweight XML & HTML parser in Swift with XPath & CSS support.
*   [Kanna (⭐2.3k)](https://github.com/tid-kijyun/Kanna)  - Kanna(鉋) is an XML/HTML parser for macOS/iOS.
*   [SwiftyXMLParser (⭐520)](https://github.com/yahoojapan/SwiftyXMLParser) - Simple XML Parser implemented in Swift.
*   [HTMLKit (⭐228)](https://github.com/iabudiab/HTMLKit) - An Objective-C framework for your everyday HTML needs.
...
*   [XMLCoder (⭐635)](https://github.com/MaxDesiatov/XMLCoder) - Encoder & Decoder for XML using Swift's `Codable` protocols.
...
*   [Erik (⭐532)](https://github.com/phimage/Erik) - Erik is an headless browser based on WebKit. An headless browser allow to run functional tests, to access and manipulate webpages using javascript.
...
*   [AcknowledgementsPlist (⭐74)](https://github.com/cats-oss/AcknowledgementsPlist) - AcknowledgementsPlist manages the licenses of libraries that depend on your iOS app.
*   [CoreXLSX (⭐674)](https://github.com/MaxDesiatov/CoreXLSX) - Excel spreadsheet (XLSX) format support in pure Swift.

### Passbook

*   [passbook (⭐233)](https://github.com/frozon/passbook) - Passbook gem let's you create pkpass for passbook iOS 6+.
*   [Dubai (⭐325)](https://github.com/nomad/dubai) - Generate and Preview Passbook Passes.
...
*   [Venmo (⭐168)](https://github.com/venmo/venmo-ios-sdk) Make and accept payments in your iOS app via Venmo.
...
*   [PatronKit (⭐364)](https://github.com/MosheBerman/PatronKit) - A framework to add patronage to your apps.
*   [SwiftyStoreKit (⭐6.1k)](https://github.com/bizz84/SwiftyStoreKit) - Lightweight In App Purchases Swift framework for iOS 8.0+ and macOS 9.0+
...
*   [monza (⭐156)](https://github.com/gabrielgarza/monza) - Ruby Gem for Rails - Easy iTunes In-App Purchase Receipt validation, including auto-renewable subscriptions.
*   [PayPal (⭐973)](https://github.com/paypal/PayPal-iOS-SDK) - Accept payments in your iOS app via PayPal.
*   [card.io-iOS-SDK (⭐2.3k)](https://github.com/card-io/card.io-iOS-SDK) - card.io provides fast, easy credit card scanning in mobile apps.
*   [SwiftLuhn (⭐135)](https://github.com/MaxKramer/SwiftLuhn) - Debit/Credit card validation port of the Luhn Algorithm in Swift.
*   [ObjectiveLuhn (⭐126)](https://github.com/MaxKramer/ObjectiveLuhn) - Luhn Credit Card Validation Algorithm.
*   [RMStore (⭐2.4k)](https://github.com/robotmedia/RMStore) - A lightweight iOS library for In-App Purchases.
*   [MFCard (⭐359)](https://github.com/MobileFirstInc/MFCard) - Easily integrate Credit Card payments in iOS App / Customisable Card UI.
*   [TPInAppReceipt (⭐503)](https://github.com/tikhop/TPInAppReceipt) - Reading and Validating In App Store Receipt.
*   [iCard (⭐334)](https://github.com/eliakorkmaz/iCard) - Bank Card Generator with Swift using SnapKit DSL.
...
*   [TipJarViewController (⭐79)](https://github.com/lionheart/TipJarViewController) - Easy, drop-in tip jar for iOS apps.
*   [FramesIos (⭐42)](https://github.com/checkout/frames-ios) - Payment Form UI and Utilities in Swift.
*   [YRPayment (⭐176)](https://github.com/yassram/YRPayment) - Better payment user experience library with cool animation in Swift.

### Permissions

*   [Proposer (⭐854)](https://github.com/nixzhu/Proposer) - Make permission request easier (Supports Camera, Photos, Microphone, Contacts, Location).
*   [ISHPermissionKit (⭐618)](https://github.com/iosphere/ISHPermissionKit) - A unified way for iOS apps to request user permissions.
...
*   [PAPermissions (⭐694)](https://github.com/pascalbros/PAPermissions) - A unified API to ask for permissions on iOS.
*   [AREK (⭐955)](https://github.com/ennioma/arek) - AREK is a clean and easy to use wrapper over any kind of iOS permission.

### Reactive Programming

*   [RxSwift (⭐23k)](https://github.com/ReactiveX/RxSwift) - Reactive Programming in Swift.
*   [RxOptional (⭐8)](https://github.com/thanegill/RxOptional) - RxSwift extensions for Swift optionals and "Occupiable" types.
*   [ReactiveTask (⭐132)](https://github.com/Carthage/ReactiveTask) - Flexible, stream-based abstraction for launching processes.
...
*   [RxPermission (⭐231)](https://github.com/sunshinejr/RxPermission) - RxSwift bindings for Permissions API in iOS.
*   [RxAlamofire (⭐1.5k)](https://github.com/RxSwiftCommunity/RxAlamofire) - RxSwift wrapper around the elegant HTTP networking in Swift Alamofire.
*   [RxRealm (⭐1.1k)](https://github.com/RxSwiftCommunity/RxRealm) - Rx wrapper for Realm's collection types.
*   [RxMultipeer (⭐69)](https://github.com/RxSwiftCommunity/RxMultipeer) - A testable RxSwift wrapper around MultipeerConnectivity.
*   [RxBluetoothKit (⭐1.3k)](https://github.com/Polidea/RxBluetoothKit) - iOS & macOS Bluetooth library for RxSwift.
*   [RxGesture (⭐1.3k)](https://github.com/RxSwiftCommunity/RxGesture) - RxSwift reactive wrapper for view gestures.
*   [NSObject-Rx (⭐619)](https://github.com/RxSwiftCommunity/NSObject-Rx) - Handy RxSwift extensions on NSObject, including rx\_disposeBag.
*   [RxCoreData (⭐164)](https://github.com/RxSwiftCommunity/RxCoreData) - RxSwift extensions for Core Data.
*   [RxAutomaton (⭐718)](https://github.com/inamiy/RxAutomaton) - RxSwift + State Machine, inspired by Redux and Elm.
*   [ReactiveArray (⭐53)](https://github.com/Wolox/ReactiveArray) - An array class implemented in Swift that can be observed using ReactiveCocoa's Signals.
*   [Interstellar (⭐1.1k)](https://github.com/JensRavens/Interstellar) - Simple and lightweight Functional Reactive Coding in Swift for the rest of us.
*   [ReduxSwift (⭐38)](https://github.com/lsunsi/ReduxSwift) - Predictable state container for Swift apps too.
*   [Aftermath (⭐70)](https://github.com/hyperoslo/Aftermath) - Stateless message-driven micro-framework in Swift.
*   [RxKeyboard (⭐1.4k)](https://github.com/RxSwiftCommunity/RxKeyboard) - Reactive Keyboard in iOS.
*   [JASONETTE-iOS (⭐5.3k)](https://github.com/Jasonette/JASONETTE-iOS) - Native App over HTTP. Create your own native iOS app with nothing but JSON.
*   [ReactiveSwift (⭐2.9k)](https://github.com/ReactiveCocoa/ReactiveSwift) - Streams of values over time by ReactiveCocoa group.
*   [Listenable (⭐8)](https://github.com/msaps/Listenable) - Swift object that provides an observable platform.
...
*   [Snail (⭐180)](https://github.com/UrbanCompass/Snail) - An observables framework for Swift.
...
*   [Observable (⭐365)](https://github.com/roberthein/Observable) - The easiest way to observe values in Swift.
...
*   [VueFlux (⭐324)](https://github.com/ra1028/VueFlux) - Unidirectional Data Flow State Management Architecture for Swift - Inspired by Vuex and Flux.
...
*   [RxReduce (⭐125)](https://github.com/RxSwiftCommunity/RxReduce) - Lightweight framework that ease the implementation of a state container pattern in a Reactive Programming compliant way.
*   [RxCoordinator (⭐1.9k)](https://github.com/quickbirdstudios/XCoordinator) -  Powerful navigation library for iOS based on the coordinator pattern.
...
*   [CwlSignal (⭐305)](https://github.com/mattgallagher/CwlSignal) A Swift framework for reactive programming.
...
*   [Bindy (⭐24)](https://github.com/MaximKotliar/Bindy) - Simple, lightweight swift bindings with KVO support and easy to read syntax.
...
*   [Render (⭐2.2k)](https://github.com/alexdrone/Render) - Swift and UIKit a la React.
*   [Katana (⭐2.2k)](https://github.com/BendingSpoons/katana-swift) - Swift apps a la React and Redux.
*   [TemplateKit (⭐159)](https://github.com/mcudich/TemplateKit) - React-inspired framework for building component-based user interfaces in Swift.
*   [CoreEvents (⭐6)](https://github.com/surfstudio/CoreEvents) - Simple library with C#-like events.
*   [Tokamak (⭐3)](https://github.com/MaxDesiatov/Tokamak) - React-like framework providing a declarative API for building native UI components with easy to use one-way data binding.

### Reflection

*   [Reflection (⭐600)](https://github.com/Zewo/Reflection) - Reflection provides an API for advanced reflection at runtime including dynamic construction of types.
...
*   [JSONNeverDie (⭐455)](https://github.com/johnlui/JSONNeverDie) - Auto reflection tool from JSON to Model, user friendly JSON encoder / decoder, aims to never die.
*   [SwiftKVC (⭐136)](https://github.com/bradhilton/SwiftKVC) - Key-Value Coding (KVC) for native Swift classes and structs.
*   [Runtime (⭐953)](https://github.com/wickwirew/Runtime) - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.

### Regex

*   [Regex (⭐609)](https://github.com/sharplet/Regex) - A Swift µframework providing an NSRegularExpression-backed Regex type.
*   [SwiftRegex (⭐112)](https://github.com/kasei/SwiftRegex) - Perl-like Regex =\~ operator for Swift.
*   [PySwiftyRegex (⭐232)](https://github.com/cezheng/PySwiftyRegex) - Easily deal with Regex in Swift in a Pythonic way.
*   [Regex (⭐327)](https://github.com/crossroadlabs/Regex) - Regular expressions for swift.
*   [Regex (⭐67)](https://github.com/brynbellomy/Regex) - Regex class for Swift. Wraps NSRegularExpression.

### Official

*   [Spotify (⭐508)](https://github.com/spotify/ios-sdk) Spotify iOS SDK.
*   [SpotifyLogin (⭐342)](https://github.com/spotify/SpotifyLogin) Spotify SDK Login in Swift.
*   [Facebook (⭐7.2k)](https://github.com/facebook/facebook-ios-sdk) Facebook iOS SDK.
*   [Google Analytics](https://developers.google.com/analytics/devguides/collection/ios/v3/) Google Analytics SDK for iOS.
*   [Paypal iOS SDK (⭐973)](https://github.com/paypal/PayPal-iOS-SDK) The PayPal Mobile SDKs enable native apps to easily accept PayPal and credit card payments.
*   [Pocket (⭐230)](https://github.com/Pocket/Pocket-ObjC-SDK) SDK for saving stuff to Pocket.
*   [Tumblr (⭐421)](https://github.com/tumblr/TMTumblrSDK) Library for easily integrating Tumblr data into your iOS or macOS application.
*   [Evernote (⭐256)](https://github.com/evernote/evernote-cloud-sdk-ios) Evernote SDK for iOS.
*   [Box (⭐107)](https://github.com/box/box-ios-sdk) iOS + macOS SDK for the Box API.
*   [OneDrive (⭐98)](https://github.com/OneDrive/onedrive-sdk-ios) Live SDK for iOS.
*   [Stripe (⭐1.7k)](https://github.com/stripe/stripe-ios) Stripe bindings for iOS and macOS.
*   [Venmo](#payments)
*   [AWS (⭐1.6k)](https://github.com/aws-amplify/aws-sdk-ios) Amazon Web Services Mobile SDK for iOS.
*   [Zendesk (⭐114)](https://github.com/zendesk/zendesk_sdk_ios) Zendesk Mobile SDK for iOS.
*   [Dropbox](https://www.dropbox.com/lp/developers) SDKs for Drop-ins and Dropbox Core API.
*   [ResearchKit (⭐5.5k)](https://github.com/ResearchKit/ResearchKit) ResearchKit is an open source software framework that makes it easy to create apps for medical research or for other research projects.
...
*   [Azure (⭐81)](https://github.com/Azure/azure-storage-ios) - Client library for accessing Azure Storage on an iOS device.
*   [1Password (⭐2.6k)](https://github.com/AgileBits/onepassword-app-extension) - 1Password Extension for iOS Apps.
*   [CareKit (⭐2.2k)](https://github.com/carekit-apple/CareKit) - CareKit is an open source software framework for creating apps that help people better understand and manage their health. By Apple.
*   [Shopify (⭐404)](https://github.com/Shopify/mobile-buy-sdk-ios) - Shopify’s Mobile Buy SDK makes it simple to sell physical products inside your mobile app.
*   [Pinterest](https://github.com/pinterest/ios-pdk) - Pinterest iOS SDK.
*   [playkit-ios (⭐76)](https://github.com/kaltura/playkit-ios) - PlayKit: Kaltura Player SDK for iOS.
*   [algoliasearch-client-swift (⭐189)](https://github.com/algolia/algoliasearch-client-swift) - Algolia Search API Client for Swift.
*   [twitter-kit-ios (⭐670)](https://github.com/twitter-archive/twitter-kit-ios) - Twitter Kit is a native SDK to include Twitter content inside mobile apps.
*   [rides-ios-sdk (⭐341)](https://github.com/uber/rides-ios-sdk) - Uber Rides iOS SDK (beta).

### Unofficial

*   [STTwitter (⭐1k)](https://github.com/nst/STTwitter) A stable, mature and comprehensive Objective-C library for Twitter REST API 1.1.
*   [FHSTwitterEngine (⭐213)](https://github.com/natesymer/FHSTwitterEngine) Twitter API for Cocoa developers.
...
*   [InstagramKit (⭐953)](https://github.com/shyambhat/InstagramKit) - Instagram iOS SDK.
*   [DribbbleSDK (⭐74)](https://github.com/agilie/dribbble-ios-sdk) - Dribbble iOS SDK.
*   [objectiveflickr (⭐715)](https://github.com/lukhnos/objectiveflickr) - ObjectiveFlickr, a Flickr API framework for Objective-C.
*   [Easy Social (⭐125)](https://github.com/pjebs/EasySocial) - Twitter & Facebook Integration.
*   [das-quadrat (⭐171)](https://github.com/Constantine-Fry/das-quadrat) - A Swift wrapper for Foursquare API. iOS and macOS.
*   [SocialLib (⭐13)](https://github.com/darkcl/SocialLib) - SocialLib handles sharing message to multiple social media.
*   [PokemonKit (⭐105)](https://github.com/ContinuousLearning/PokemonKit) - Pokeapi wrapper, written in Swift.
*   [TJDropbox (⭐60)](https://github.com/timonus/TJDropbox) - A Dropbox v2 client library written in Objective-C
*   [GitHub.swift (⭐180)](https://github.com/onmyway133/github.swift) - :octocat: Unofficial GitHub API client in Swift
...
*   [Medium SDK - Swift (⭐11)](https://github.com/96-problems/medium-sdk-swift) - Unofficial Medium API SDK in Swift with sample project.
*   [Swifter (⭐2.4k)](https://github.com/mattdonnelly/Swifter) - :bird: A Twitter framework for iOS & macOS written in Swift.
*   [SlackKit (⭐1k)](https://github.com/pvzig/SlackKit) - a Slack client library for iOS and macOS written in Swift.
*   [RandomUserSwift (⭐95)](https://github.com/dingwilson/RandomUserSwift) - Swift Framework to Generate Random Users - An Unofficial SDK for randomuser.me.
*   [PPEventRegistryAPI (⭐8)](https://github.com/pantuspavel/PPEventRegistryAPI/) - Swift 3 Framework for Event Registry API (eventregistry.org).
*   [UnsplashKit (⭐186)](https://github.com/modo-studio/UnsplashKit) - Swift client for Unsplash.
*   [Swiftly Salesforce (⭐129)](https://github.com/mike4aday/SwiftlySalesforce) - An easy-to-use framework for building iOS apps that integrate with Salesforce, using Swift and promises.
*   [Spartan (⭐108)](https://github.com/Daltron/Spartan) - An Elegant Spotify Web API Library Written in Swift for iOS and macOS.
...
*   [BittrexApiKit (⭐8)](https://github.com/saeid/BittrexApiKit) - Simple and complete Swift wrapper for Bittrex Exchange API.
*   [SwiftyVK (⭐260)](https://github.com/SwiftyVK/SwiftyVK) Library for easy interact with VK social network API written in Swift.
*   [ARKKit (⭐19)](https://github.com/sleepdefic1t/ARKKit) - ARK Ecosystem Cryptocurrency API Framework for iOS & macOS, written purely in Swift 4.0.
*   [SwiftInstagram (⭐580)](https://github.com/AnderGoig/SwiftInstagram) - Swift Client for Instagram API.
...
*   [Mothership (⭐73)](https://github.com/thecb4/MotherShip) - Tunes Connect Library inspired by FastLane.
*   [SwiftFlyer (⭐38)](https://github.com/rinov/SwiftFlyer) - An API wrapper for bitFlyer that supports all providing API.
*   [waterwheel.swift (⭐414)](https://github.com/kylebrowning/waterwheel.swift) - The Waterwheel Swift SDK provides classes to natively connect iOS, macOS, tvOS, and watchOS applications to Drupal 7 and 8.
*   [ForecastIO (⭐163)](https://github.com/sxg/ForecastIO) - A Swift library for the Forecast.io Dark Sky API.
*   [JamfKit (⭐40)](https://github.com/ethenyl/JamfKit) - A JSS communication framework written in Swift.

### Security

*   [cocoapods-keys (⭐1.5k)](https://github.com/orta/cocoapods-keys) - A key value store for storing environment and application keys.
*   [simple-touch (⭐116)](https://github.com/simple-machines/simple-touch) - Very simple swift wrapper for Biometric Authentication Services (Touch ID) on iOS.
*   [SwiftPasscodeLock (⭐679)](https://github.com/yankodimitrov/SwiftPasscodeLock) - An iOS passcode lock with TouchID authentication written in Swift.
*   [Smile-Lock (⭐607)](https://github.com/recruit-lifestyle/Smile-Lock) - A library for make a beautiful Passcode Lock View.
*   [zxcvbn-ios (⭐219)](https://github.com/dropbox/zxcvbn-ios) - A realistic password strength estimator.
*   [TPObfuscatedString (⭐18)](https://github.com/Techprimate/TPObfuscatedString) - Simple String obfuscation using core Swift.
*   [LTHPasscodeViewController (⭐626)](https://github.com/rolandleth/LTHPasscodeViewController) - An iOS passcode lockscreen replica (from Settings), with TouchID and simple (variable length) / complex support.
*   [iOS-App-Security-Class (⭐74)](https://github.com/karek314/iOS-App-Security-Class) - Simple class to check if iOS app has been cracked, being debugged or enriched with custom dylib and as well detect jailbroken environment.
*   [BiometricAuth (⭐29)](https://github.com/vasilenkoigor/BiometricAuth) - Simple framework for biometric authentication (via TouchID) in your application.
*   [SAPinViewController (⭐21)](https://github.com/siavashalipour/SAPinViewController) - Simple and easy to use default iOS PIN screen. This simple library allows you to draw a fully customisable PIN screen same as the iOS default PIN view. My inspiration to create this library was form THPinViewController, however SAPinViewController is completely implemented in Swift. Also the main purpose of creating this library was to have simple, easy to use and fully customisable PIN screen.
*   [TOPasscodeViewController (⭐380)](https://github.com/timoliver/TOPasscodeViewController) - A modal passcode input and validation view controller for iOS.
*   [BiometricAuthentication (⭐801)](https://github.com/rushisangani/BiometricAuthentication) - Use Apple FaceID or TouchID authentication in your app using BiometricAuthentication.
*   [KKPinCodeTextField (⭐66)](https://github.com/kolesa-team/ios_pinCodeTextField) - A customizable verification code textField for phone verification codes, passwords etc.
...
*   [AESCrypt-ObjC (⭐782)](https://github.com/Gurpartap/AESCrypt-ObjC) - A simple and opinionated AES encrypt / decrypt Objective-C class that just works.
*   [IDZSwiftCommonCrypto (⭐469)](https://github.com/iosdevzone/IDZSwiftCommonCrypto) - A wrapper for Apple's Common Crypto library written in Swift.
*   [Arcane (⭐281)](https://github.com/onmyway133/Arcane) - Lightweight wrapper around CommonCrypto in Swift.
*   [SwiftMD5 (⭐11)](https://github.com/mpurland/SwiftMD5) - A pure Swift implementation of MD5.
*   [SwiftHash (⭐203)](https://github.com/onmyway133/SwiftHash) - Hash in Swift.
*   [SweetHMAC (⭐37)](https://github.com/jancassio/SweetHMAC) - A tiny and easy to use Swift class to encrypt strings using HMAC algorithms.
*   [SwCrypt (⭐691)](https://github.com/soyersoyer/SwCrypt) - RSA public/private key generation, RSA, AES encryption/decryption, RSA sign/verify in Swift with CommonCrypto in iOS and macOS.
*   [SwiftSSL](https://github.com/SwiftP2P/SwiftSSL) - An Elegant crypto toolkit in Swift.
*   [SwiftyRSA (⭐1.1k)](https://github.com/TakeScoop/SwiftyRSA) - RSA public/private key encryption in Swift.
*   [EnigmaKit (⭐112)](https://github.com/mikaoj/EnigmaKit) - Enigma encryption in Swift.
*   [Themis (⭐1.6k)](https://github.com/cossacklabs/themis) - High-level crypto library, providing basic asymmetric encryption, secure messaging with forward secrecy and secure data storage, supports iOS/macOS, Android and different server side platforms.
*   [Obfuscator-iOS (⭐596)](https://github.com/pjebs/Obfuscator-iOS) - Secure your app by obfuscating all the hard-coded security-sensitive strings.
*   [swift-sodium (⭐476)](https://github.com/jedisct1/swift-sodium) - Safe and easy to use crypto for iOS.
...
*   [SCrypto (⭐39)](https://github.com/sgl0v/SCrypto) - Elegant Swift interface to access the CommonCrypto routines.
*   [SipHash (⭐261)](https://github.com/attaswift/SipHash) - Simple and secure hashing in Swift with the SipHash algorithm.
*   [RNCryptor (⭐3.3k)](https://github.com/RNCryptor/RNCryptor) - CCCryptor (AES encryption) wrappers for iOS and Mac in Swift. -- For ObjC, see RNCryptor/RNCryptor-objc.
*   [CatCrypto (⭐62)](https://github.com/ImKcat/CatCrypto) - An easy way for hashing and encryption.
*   [SecureEnclaveCrypto (⭐273)](https://github.com/trailofbits/SecureEnclaveCrypto) - Demonstration library for using the Secure Enclave on iOS.
*   [RSASwiftGenerator (⭐21)](https://github.com/4taras4/RSASwiftGenerator) - Util for generation RSA keys on your client and save to keychain or cover into Data.
*   [Virgil Security Objective-C/Swift Crypto Library (⭐31)](https://github.com/VirgilSecurity/virgil-crypto-x) - A high-level cryptographic library that allows to perform all necessary operations for securely storing and transferring data.
*   [JOSESwift (⭐157)](https://github.com/airsidemobile/JOSESwift) - A framework for the JOSE standards JWS, JWE, and JWK written in Swift.

### Keychain

*   [UICKeyChainStore (⭐3.1k)](https://github.com/kishikawakatsumi/UICKeyChainStore) - UICKeyChainStore is a simple wrapper for Keychain on iOS.
*   [Valet (⭐3.8k)](https://github.com/square/Valet) - Securely store data in the iOS or macOS Keychain without knowing a thing about how the Keychain works.
*   [Locksmith (⭐2.9k)](https://github.com/matthewpalmer/Locksmith) - A powerful, protocol-oriented library for working with the keychain in Swift.
*   [KeychainAccess (⭐7.1k)](https://github.com/kishikawakatsumi/KeychainAccess) - Simple Swift wrapper for Keychain that works on iOS and macOS.
*   [Keychains (⭐71)](https://github.com/hyperoslo/Keychains) - Because you should care... about the security... of your shit.
*   [Lockbox (⭐858)](https://github.com/granoff/Lockbox) - Objective-C utility class for storing data securely in the key chain.
*   [SAMKeychain (⭐5.4k)](https://github.com/soffes/SAMKeychain) - Simple Objective-C wrapper for the keychain that works on Mac and iOS.
*   [SwiftKeychainWrapper (⭐1.5k)](https://github.com/jrendel/SwiftKeychainWrapper) - A simple wrapper for the iOS Keychain to allow you to use it in a similar fashion to User Defaults.
*   [SwiftyKeychainKit (⭐17)](https://github.com/andriyslyusar/SwiftyKeychainKit) - Keychain wrapper with the benefits of static typing and convenient syntax, support for primitive types, Codable, NSCoding.
...
*   [swift-http (⭐451)](https://github.com/huytd/swift-http) - HTTP Implementation for Swift on Linux and macOS.
*   [Trevi (⭐46)](https://github.com/Yoseob/Trevi) - libuv base Swift web HTTP server framework.
*   [Express (⭐851)](https://github.com/crossroadlabs/Express) - Swift Express is a simple, yet unopinionated web application server written in Swift.
*   [Taylor (⭐926)](https://github.com/izqui/Taylor) - A lightweight library for writing HTTP web servers with Swift.
*   [Frank (⭐377)](https://github.com/kylef-archive/Frank) - Frank is a DSL for quickly writing web applications in Swift.
*   [Kitura (⭐7.6k)](https://github.com/IBM-Swift/Kitura) - A Swift Web Framework and HTTP Server.
*   [Swifton (⭐2k)](https://github.com/sauliusgrigaitis/Swifton) - A Ruby on Rails inspired Web Framework for Swift that runs on Linux and macOS.
*   [Dynamo (⭐68)](https://github.com/johnno1962/Dynamo) - High Performance (nearly)100% Swift Web server supporting dynamic content.
*   [Redis (⭐452)](https://github.com/vapor/redis) - Pure-Swift Redis client implemented from the original protocol spec. macOS + Linux compatible.
*   [NetworkObjects (⭐258)](https://github.com/colemancda/NetworkObjects) - Swift backend / server framework (Pure Swift, Supports Linux).
*   [Noze.io](http://noze.io) - Evented I/O streams a.k.a. Node.js for Swift.
*   [Lightning (⭐316)](https://github.com/skylab-inc/Lightning) - A Swift Multiplatform Web and Networking Framework.
*   [SwiftGD (⭐418)](https://github.com/twostraws/swiftgd) - A simple Swift wrapper for libgd.
*   [Jobs (⭐289)](https://github.com/BrettRToomey/Jobs) - A job system for Swift backends.
*   [ApacheExpress (⭐173)](https://github.com/ApacheExpress/ApacheExpress) - Write Apache Modules in Swift!
*   [GCDWebServer (⭐6.2k)](https://github.com/swisspol/GCDWebServer) - Lightweight GCD based HTTP server for macOS & iOS (includes web based uploader & WebDAV server).
*   [Embassy (⭐531)](https://github.com/envoy/Embassy) - Super lightweight async HTTP server library in pure Swift runs in iOS / MacOS / Linux.
...
*   [Twitter Text Obj (⭐2.8k)](https://github.com/twitter/twitter-text) - An Objective-C implementation of Twitter's text processing library.
*   [Nimbus (⭐6.5k)](https://github.com/jverkoey/nimbus) - Nimbus is a toolkit for experienced iOS software designers.
*   [NSStringEmojize (⭐643)](https://github.com/diy/nsstringemojize) - A category on NSString to convert Emoji Cheat Sheet codes to their equivalent Unicode characters.
*   [MMMarkdown (⭐1.2k)](https://github.com/mdiep/MMMarkdown) - An Objective-C static library for converting Markdown to HTML.
*   [DTCoreText (⭐6.2k)](https://github.com/Cocoanetics/DTCoreText) - Methods to allow using HTML code with CoreText.
*   [DTRichTextEditor (⭐346)](https://github.com/Cocoanetics/DTRichTextEditor) - A rich-text editor for iOS.
*   [NBEmojiSearchView (⭐85)](https://github.com/neerajbaid/NBEmojiSearchView) - A searchable emoji dropdown view.
*   [Pluralize.swift (⭐191)](https://github.com/joshualat/Pluralize.swift) - Great Swift String Pluralize Extension.
...
*   [Money (⭐933)](https://github.com/danthorpe/Money) - Swift value types for working with money & currency.
*   [PhoneNumberKit (⭐4.6k)](https://github.com/marmelroy/PhoneNumberKit) - A Swift framework for parsing, formatting and validating international phone numbers. Inspired by Google's libphonenumber.
*   [YYText (⭐8.8k)](https://github.com/ibireme/YYText) - Powerful text framework for iOS to display and edit rich text.
*   [Format (⭐1.2k)](https://github.com/marmelroy/Format) - A Swift Formatter Kit.
*   [Tribute (⭐63)](https://github.com/zats/Tribute) - Programmatic creation of NSAttributedString doesn't have to be a pain.
*   [EmojiKit (⭐91)](https://github.com/dasmer/EmojiKit) - Effortless emoji-querying in Swift.
*   [Roman (⭐36)](https://github.com/nvzqz/Roman) - Seamless Roman numeral conversion in Swift.
*   [ZSSRichTextEditor (⭐3.7k)](https://github.com/nnhubbard/ZSSRichTextEditor) - A beautiful rich text WYSIWYG editor for iOS with a syntax highlighted source view.
*   [pangu.Objective-C (⭐110)](https://github.com/Cee/pangu.objective-c) - Paranoid text spacing in Objective-C.
*   [SwiftString (⭐1.6k)](https://github.com/amayne/SwiftString) - A comprehensive, lightweight string extension for Swift.
*   [Marklight (⭐525)](https://github.com/macteo/Marklight) - Markdown syntax highlighter for iOS.
*   [MarkdownTextView (⭐675)](https://github.com/indragiek/MarkdownTextView) - Rich Markdown editing control for iOS.
*   [TextAttributes (⭐2.2k)](https://github.com/delba/TextAttributes) - An easier way to compose attributed strings.
*   [Reductio (⭐435)](https://github.com/fdzsergio/Reductio) - Automatic summarizer text in Swift.
*   [SmarkDown (⭐67)](https://github.com/SwiftStudies/SmarkDown) - A Pure Swift implementation of the markdown mark-up language.
*   [SwiftyMarkdown (⭐1.4k)](https://github.com/SimonFairbairn/SwiftyMarkdown) - Converts Markdown files and strings into NSAttributedString.
*   [SZMentions (⭐11)](https://github.com/szweier/SZMentions) - Library to help handle mentions.
*   [SZMentionsSwift (⭐121)](https://github.com/szweier/SZMentionsSwift) - Library to help handle mentions.
*   [Heimdall (⭐391)](https://github.com/henrinormak/Heimdall) - Heimdall is a wrapper around the Security framework for simple encryption/decryption operations.
...
*   [Smile (⭐474)](https://github.com/onmyway133/Smile) Emoji in Swift.
...
*   [FormatterKit (⭐10)](https://github.com/mattt/FormatterKit) - `stringWithFormat:` for the sophisticated hacker set.
*   [BonMot (⭐3.3k)](https://github.com/Rightpoint/BonMot) - Beautiful, easy attributed strings in Swift.
*   [SwiftValidators (⭐239)](https://github.com/gkaimakas/SwiftValidators) - String validation for iOS developed in Swift. Inspired by [validator.js](https://www.npmjs.com/package/validator).
*   [StringStylizer (⭐73)](https://github.com/kazuhiro4949/StringStylizer) - Type strict builder class for NSAttributedString.
...
*   [MarkdownKit (⭐676)](https://github.com/bmoliveira/MarkdownKit) - A simple and customizable Markdown Parser for Swift.
...
*   [ISO8859 (⭐17)](https://github.com/Cosmo/ISO8859) - Convert ISO8859 1-16 Encoded Text to String in Swift. Supports iOS, tvOS, watchOS and macOS.
*   [Emojica (⭐99)](https://github.com/xoudini/emojica) - Replace standard emoji in strings with a custom emoji set, such as [Twemoji (⭐15k)](https://github.com/twitter/twemoji) or [EmojiOne (⭐4.5k)](https://github.com/joypixels/emojione).
*   [SwiftRichString (⭐2.8k)](https://github.com/malcommac/SwiftRichString) - Elegant & Painless Attributed Strings Management Library in Swift.
...
*   [AttributedTextView (⭐427)](https://github.com/evermeer/AttributedTextView) - Easiest way to create an attributed UITextView with support for multiple links (including hashtags and mentions).
*   [StyleDecorator (⭐15)](https://github.com/dimpiax/StyleDecorator) - Design string simply by linking attributes to needed parts.
*   [Mustard (⭐693)](https://github.com/mathewsanders/Mustard) - Mustard is a Swift library for tokenizing strings when splitting by whitespace doesn't cut it.
...
*   [Atributika (⭐1.1k)](https://github.com/psharanda/Atributika) - Easily build NSAttributedString by detecting and styling HTML-like tags, hashtags, mentions, RegExp or NSDataDetector patterns.
*   [Guitar (⭐659)](https://github.com/ArtSabintsev/Guitar) - A Cross-Platform String Library Written in Swift.
...
*   [Marky Mark (⭐285)](https://github.com/m2mobi/Marky-Mark) - Highly customizable Markdown parsing and native rendering in Swift.
...
*   [fuse-swift (⭐863)](https://github.com/krisk/fuse-swift) - A lightweight fuzzy-search library, with zero dependencies.
*   [EFMarkdown (⭐374)](https://github.com/EFPrefix/EFMarkdown) - A lightweight Markdown library for iOS.
*   [Croc (⭐127)](https://github.com/jkalash/croc) - A lightweight Swift library for Emoji parsing and querying.

### Font

*   [FontBlaster (⭐1.1k)](https://github.com/ArtSabintsev/FontBlaster) - Programmatically load custom fonts into your iOS app.
*   [GoogleMaterialIconFont (⭐144)](https://github.com/kitasuke/GoogleMaterialIconFont) - Google Material Design Icons for Swift and ObjC project.
*   [ios-fontawesome (⭐1.8k)](https://github.com/alexdrone/ios-fontawesome) - NSString+FontAwesome.
*   [FontAwesome.swift (⭐1.5k)](https://github.com/thii/FontAwesome.swift) - Use FontAwesome in your Swift projects.
*   [SwiftFontName (⭐113)](https://github.com/morizotter/SwiftFontName) - OS font complements library. Localized font supported.
*   [SwiftIconFont (⭐1.1k)](https://github.com/0x73/SwiftIconFont) - Icons fonts for iOS (FontAwesome, Iconic, Ionicon, Octicon, Themify, MapIcon, MaterialIcon).
...
*   [Iconic (⭐1.6k)](https://github.com/home-assistant/Iconic) - Auto-generated icon font library for iOS, watchOS and tvOS.
*   [GoogleMaterialDesignIcons (⭐365)](https://github.com/dekatotoro/GoogleMaterialDesignIcons) - Google Material Design Icons Font for iOS.
*   [OcticonsKit (⭐52)](https://github.com/keitaoouchi/OcticonsKit) - Use Octicons as UIImage / UIFont in your projects with Swifty manners.
*   [IoniconsKit (⭐313)](https://github.com/keitaoouchi/IoniconsKit) - Use Ionicons as UIImage / UIFont in your projects with Swifty manners.
...
*   [SwiftIcons (⭐778)](https://github.com/ranesr/SwiftIcons) - A library for using different font icons: dripicons, emoji, font awesome, icofont, ionicons, linear icons, map icons, material icons, open iconic, state, weather. It supports UIImage, UIImageView, UILabel, UIButton, UISegmentedControl, UITabBarItem, UISlider, UIBarButtonItem, UIViewController, UITextfield, UIStepper.
*   [Font-Awesome-Swift (⭐747)](https://github.com/Vaberer/Font-Awesome-Swift) - Font Awesome swift library for iOS.
*   [JQSwiftIcon (⭐6)](https://github.com/josejuanqm/JQSwiftIcon) - Icon Fonts on iOS using string interpolation written in Swift.
*   [Money (⭐884)](https://github.com/Flight-School/Money) - A precise, type-safe representation of a monetary amount in a given currency.

### TDD / BDD

*   [Kiwi (⭐4.1k)](https://github.com/kiwi-bdd/Kiwi) - A behavior-driven development library for iOS development.
*   [Specta (⭐2.3k)](https://github.com/specta/specta) - A light-weight TDD / BDD framework for Objective-C & Cocoa.
*   [Quick (⭐9.5k)](https://github.com/Quick/Quick) - A behavior-driven development framework for Swift and Objective-C.
*   [XcodeCoverage (⭐853)](https://github.com/jonreid/XcodeCoverage) - Code coverage for Xcode projects.
*   [OHHTTPStubs (⭐4.9k)](https://github.com/AliSoftware/OHHTTPStubs) - Stub your network requests easily! Test your apps with fake network data and custom response time, response code and headers!
*   [Dixie (⭐192)](https://github.com/Skyscanner/Dixie) - Dixie is an open source Objective-C testing framework for altering object behaviours.
*   [gh-unit (⭐1.9k)](https://github.com/gh-unit/gh-unit) - Test Framework for Objective-C.
*   [Nimble (⭐4.5k)](https://github.com/Quick/Nimble) - A Matcher Framework for Swift and Objective-C
*   [Sleipnir (⭐844)](https://github.com/railsware/Sleipnir) - BDD-style framework for Swift.
*   [SwiftCheck (⭐1.4k)](https://github.com/typelift/SwiftCheck) - QuickCheck for Swift.
*   [Spry (⭐327)](https://github.com/Quick/Spry) - A Mac and iOS Playgrounds Unit Testing library based on Nimble.
*   [swift-corelibs-xctest (⭐1k)](https://github.com/apple/swift-corelibs-xctest) - The XCTest Project, A Swift core library for providing unit test support.
*   [PlaygroundTDD (⭐317)](https://github.com/WhiskerzAB/PlaygroundTDD) - Small library to easily run your tests directly within a Playground.

### A/B Testing

*   [Switchboard (⭐288)](https://github.com/KeepSafe/Switchboard) - Switchboard - easy and super light weight A/B testing for your mobile iPhone or android app. This mobile A/B testing framework allows you with minimal servers to run large amounts of mobile users.
*   [SkyLab (⭐794)](https://github.com/mattt/SkyLab) - Multivariate & A/B Testing for iOS and Mac.
...
*   [robotframework-appiumlibrary (⭐321)](https://github.com/serhatbolsu/robotframework-appiumlibrary) - AppiumLibrary is an appium testing library for RobotFramework.
*   [Cucumber](https://cucumber.io/) - Behavior driver development for iOS.
*   [Kif (⭐6.1k)](https://github.com/kif-framework/KIF) - An iOS Functional Testing Framework.
*   [Subliminal (⭐763)](https://github.com/inkling/Subliminal) - An understated approach to iOS integration testing.
...
*   [Remote (⭐777)](https://github.com/johnno1962/Remote) - Control your iPhone from inside Xcode for end-to-end testing.
*   [LayoutTest-iOS (⭐564)](https://github.com/linkedin/LayoutTest-iOS) - Write unit tests which test the layout of a view in multiple configurations.
*   [EarlGrey (⭐5.4k)](https://github.com/google/EarlGrey) - :tea: iOS UI Automation Test Framework.
*   [UI Testing Cheat Sheet (⭐2.1k)](https://github.com/joemasilotti/UI-Testing-Cheat-Sheet) - How do I test this with UI Testing?
*   [Bluepill (⭐3.1k)](https://github.com/linkedin/bluepill) - Bluepill is a reliable iOS testing tool that runs UI tests using multiple simulators on a single machine.
...
*   [TouchVisualizer (⭐848)](https://github.com/morizotter/TouchVisualizer) - Lightweight touch visualization library in Swift. A single line of code and visualize your touches!
*   [UITestHelper (⭐56)](https://github.com/evermeer/UITestHelper) - UITest helper library for creating readable and maintainable tests.
...
*   [Fakery (⭐1.6k)](https://github.com/vadymmarkov/Fakery) - Swift fake data generator.
*   [DVR (⭐649)](https://github.com/venmo/DVR) - Network testing for Swift.
*   [Cuckoo (⭐1.5k)](https://github.com/Brightify/Cuckoo) - First boilerplate-free mocking framework for Swift.
*   [Vinyl (⭐271)](https://github.com/Velhotes/Vinyl) - Network testing à la VCR in Swift.
*   [Mockit (⭐118)](https://github.com/sabirvirtuoso/Mockit) - A simple mocking framework for Swift, inspired by the famous Mockito for Java.
*   [Cribble (⭐273)](https://github.com/maxsokolov/Cribble) - Swifty tool for visual testing iPhone and iPad apps.
*   [second\_curtain (⭐129)](https://github.com/ashfurrow/second_curtain) - Upload failing iOS snapshot tests cases to S3.
*   [trainer (⭐246)](https://github.com/fastlane-community/trainer) - Convert xcodebuild plist files to JUnit reports.
*   [Buildasaur (⭐772)](https://github.com/buildasaurs/Buildasaur) - Automatic testing of your Pull Requests on GitHub and BitBucket using Xcode Server. Keep your team productive and safe. Get up and running in minutes.
*   [Kakapo (⭐764)](https://github.com/devlucky/Kakapo) - Dynamically Mock server behaviors and responses in Swift.
*   [AcceptanceMark (⭐64)](https://github.com/bizz84/AcceptanceMark) Tool to auto-generate Xcode tests classes from Markdown tables.
*   [MetovaTestKit (⭐23)](https://github.com/metova/MetovaTestKit) - A collection of testing utilities to turn crashing test suites into failing test suites.
*   [MirrorDiffKit (⭐178)](https://github.com/Kuniwak/MirrorDiffKit) - Pretty diff between any structs or classes.
...
*   [XCTestExtensions (⭐21)](https://github.com/shindyu/XCTestExtensions) - XCTestExtensions is a Swift extension that provides convenient assertions for writing Unit Test.
*   [Mockingjay (⭐1.5k)](https://github.com/kylef/Mockingjay) - An elegant library for stubbing HTTP requests with ease in Swift.
*   [PinpointKit (⭐1.1k)](https://github.com/Lickability/PinpointKit) - Let your testers and users send feedback with annotated screenshots and logs using a simple gesture.
*   [iOS Snapshot Test Case (⭐1.6k)](https://github.com/uber/ios-snapshot-test-case) — Snapshot test your UIViews and CALayers on iOS and tvOS.

### UI

*   [Motif (⭐883)](https://github.com/erichoracek/Motif) - A lightweight and customizable JSON stylesheet framework for iOS.
*   [Texture (⭐7.6k)](https://github.com/TextureGroup/Texture) - Smooth asynchronous user interfaces for iOS apps.
*   [GaugeKit (⭐1k)](https://github.com/skywinder/GaugeKit) - Customizable gauges. Easy reproduce Apple's style gauges.
*   [iCarousel (⭐12k)](https://github.com/nicklockwood/iCarousel) - A simple, highly customisable, data-driven 3D carousel for iOS and Mac OS.
...
*   [RKNotificationHub (⭐3.1k)](https://github.com/cwRichardKim/RKNotificationHub) - Make any UIView a full fledged notification center.
*   [phone-number-picker (⭐142)](https://github.com/hughbe/phone-number-picker) - A simple and easy to use view controller enabling you to enter a phone number with a country code similar to WhatsApp written in Swift.
*   [BEMCheckBox (⭐2.6k)](https://github.com/Boris-Em/BEMCheckBox#sample-app) - Tasteful Checkbox for iOS.
*   [MPParallaxView (⭐1.7k)](https://github.com/DroidsOnRoids/MPParallaxView) - Apple TV Parallax effect in Swift.
*   [Splitflap (⭐1.1k)](https://github.com/yannickl/Splitflap) - A simple split-flap display for your Swift applications.
*   [EZSwipeController (⭐844)](https://github.com/goktugyil/EZSwipeController) - UIPageViewController like Snapchat/Tinder/iOS Main Pages.
*   [Curry (⭐47)](https://github.com/devinross/curry) - Curry is a framework built to enhance and compliment Foundation and UIKit.
*   [Pages (⭐502)](https://github.com/hyperoslo/Pages) - UIPageViewController made simple.
*   [BAFluidView (⭐1.4k)](https://github.com/antiguab/BAFluidView) - UIView that simulates a 2D view of a fluid in motion.
*   [WZDraggableSwitchHeaderView (⭐559)](https://github.com/wongzigii/WZDraggableSwitchHeaderView) - Showing status for switching between viewControllers.
*   [SCTrelloNavigation (⭐805)](https://github.com/SergioChan/SCTrelloNavigation) - An iOS native implementation of a Trello Animated Navagation.
*   [Spots (⭐18)](https://github.com/hyperoslo/Spots) - Spots is a view controller framework that makes your setup and future development blazingly fast.
*   [AZExpandableIconListView (⭐289)](https://github.com/Azuritul/AZExpandableIconListView) - An expandable/collapsible view component written in Swift.
*   [FlourishUI (⭐225)](https://github.com/thinkclay/FlourishUI) - A highly configurable and out-of-the-box-pretty UI library.
*   [Navigation Stack (⭐2.3k)](https://github.com/Ramotion/navigation-stack) - Navigation Stack is a stack-modeled navigation controller.
*   [UIView-draggable (⭐438)](https://github.com/andreamazz/UIView-draggable) - UIView category that adds dragging capabilities.
*   [EPSignature (⭐801)](https://github.com/ipraba/EPSignature) - Signature component for iOS in Swift.
*   [EVFaceTracker (⭐257)](https://github.com/evermeer/EVFaceTracker) - Calculate the distance and angle of your device with regards to your face.
...
*   [MEVHorizontalContacts (⭐360)](https://github.com/manuelescrig/MEVHorizontalContacts) - An iOS UICollectionViewLayout subclass to show a list of contacts with configurable expandable menu items.
...
*   [JDFlipNumberView (⭐748)](https://github.com/calimarkus/JDFlipNumberView) - Representing analog flip numbers like airport/trainstation displays.
*   [DCKit (⭐141)](https://github.com/agordeev/DCKit) - Set of iOS controls, which have useful IBInspectable properties. Written on Swift.
*   [BackgroundVideoiOS (⭐563)](https://github.com/Guzlan/BackgroundVideoiOS) - A swift and objective-C object that lets you add a background video to iOS views.
*   [NightNight (⭐780)](https://github.com/Draveness/NightNight) - Elegant way to integrate night mode to swift projects.
*   [SwiftTheme (⭐2.4k)](https://github.com/wxxsw/SwiftTheme) - Powerful theme/skin manager for iOS.
*   [FDStackView (⭐2.5k)](https://github.com/forkingdog/FDStackView) - Use UIStackView directly in iOS.
...
*   [DistancePicker (⭐119)](https://github.com/qmathe/DistancePicker) - Custom control to select a distance with a pan gesture, written in Swift.
...
*   [PageController (⭐404)](https://github.com/hirohisa/PageController) - Infinite paging controller, scrolling through contents and title bar scrolls with a delay.
*   [StatusProvider (⭐885)](https://github.com/mariohahn/StatusProvider) - Protocol to handle initial Loadings, Empty Views and Error Handling in a ViewController & views.
*   [StackLayout (⭐76)](https://github.com/bridger/StackLayout) - An alternative to UIStackView for common Auto Layout patterns.
*   [NightView (⭐162)](https://github.com/Boris-Em/NightView) - Dazzling Nights on iOS.
*   [SwiftVideoBackground (⭐331)](https://github.com/dingwilson/SwiftVideoBackground) - Easy to Use UIView subclass for implementing a video background.
*   [ConfettiView (⭐233)](https://github.com/OrRon/ConfettiView) - Confetti View lets you create a magnificent confetti view in your app.
*   [BouncyPageViewController (⭐843)](https://github.com/BohdanOrlov/BouncyPageViewController) - Page view controller with bounce effect.
*   [LTHRadioButton (⭐367)](https://github.com/rolandleth/LTHRadioButton) - A radio button with a pretty fill animation.
*   [Macaw-Examples (⭐346)](https://github.com/exyte/Macaw-Examples) - Various usages of the Macaw library.
*   [Reactions (⭐582)](https://github.com/yannickl/Reactions) - Fully customizable Facebook reactions control.
*   [Newly (⭐197)](https://github.com/dhirajjadhao/Newly) - Newly is a drop in solution to add Twitter/Facebook/Linkedin-style new updates/tweets/posts available button.
*   [CardStackController (⭐527)](https://github.com/jobandtalent/CardStackController) - iOS custom controller used in Jobandtalent app to present new view controllers as cards.
*   [Material Components (⭐4.6k)](https://github.com/material-components/material-components-ios) - Google developed UI components that help developers execute Material Design.
*   [FAQView (⭐466)](https://github.com/mukeshthawani/FAQView) - An easy to use FAQ view for iOS written in Swift.
*   [LMArticleViewController (⭐7)](https://github.com/lucamozza/LMArticleViewController) - UIViewController subclass to beautifully present news articles and blog posts.
*   [FSPagerView (⭐6.6k)](https://github.com/WenchaoD/FSPagerView) - FSPagerView is an elegant Screen Slide Library. It is extremely helpful for making Banner、Product Show、Welcome/Guide Pages、Screen/ViewController Sliders.
*   [ElongationPreview (⭐886)](https://github.com/Ramotion/elongation-preview) - ElongationPreview is an elegant push-pop style view controller with 3D-Touch support and gestures.
*   [Pageboy (⭐1.8k)](https://github.com/uias/Pageboy) - A simple, highly informative page view controller.
*   [IGColorPicker (⭐268)](https://github.com/iGenius-Srl/IGColorPicker) - A customizable color picker for iOS in Swift.
*   [KPActionSheet (⭐7)](https://github.com/khuong291/KPActionSheet) -  A replacement of default action sheet, but has very simple usage.
*   [SegmentedProgressBar (⭐435)](https://github.com/D-32/SegmentedProgressBar) - Snapchat / Instagram Stories style animated indicator.
*   [Magnetic (⭐1.4k)](https://github.com/efremidze/Magnetic) - SpriteKit Floating Bubble Picker (inspired by Apple Music).
*   [AmazingBubbles (⭐63)](https://github.com/GlebRadchenko/AmazingBubbles) - Apple Music like Bubble Picker using Dynamic Animation.
*   [Haptica (⭐690)](https://github.com/efremidze/Haptica) - Easy Haptic Feedback Generator.
*   [GDCheckbox (⭐23)](https://github.com/saeid/GDCheckbox) - An easy to use custom checkbox/radio button component for iOS, with support of IBDesign Inspector.
*   [HamsterUIKit (⭐30)](https://github.com/Howardw3/HamsterUIKit) - A simple and elegant UIKit(Chart) for iOS.
*   [AZEmptyState (⭐88)](https://github.com/Minitour/AZEmptyState) - A UIControl subclass that makes it easy to create empty states.
*   [URWeatherView (⭐446)](https://github.com/jegumhon/URWeatherView) - Show the weather effects onto view.
...
*   [Overlay (⭐52)](https://github.com/TintPoint/Overlay) - Overlay is a flexible UI framework designed for Swift. It allows you to write CSS like Swift code.
...
*   [NotchToolkit (⭐55)](https://github.com/AFathi/NotchToolkit) - A framework for iOS that allow developers use the iPhone X notch in creative ways.
...
*   [Mixin (⭐45)](https://github.com/oney/Mixin) - React.js like Mixin. More powerful Protocol-Oriented Programming.
*   [Shiny (⭐763)](https://github.com/efremidze/Shiny) - Iridescent Effect View (inspired by Apple Pay Cash).
*   [StackViewController (⭐866)](https://github.com/seedco/StackViewController) - A controller that uses a UIStackView and view controller composition to display content in a list.
...
*   [SwViewCapture (⭐594)](https://github.com/startry/SwViewCapture) - A nice iOS View Capture Swift Library which can capture all content.
*   [HGRippleRadarView (⭐349)](https://github.com/HamzaGhazouani/HGRippleRadarView) - A beautiful radar view to show nearby items (users, restaurants, ...) with ripple animation, fully customizable.
*   [GDGauge (⭐73)](https://github.com/saeid/GDGauge) - Full Customizable, Beautiful, Easy to use gauge view Edit.
...
*   [ApplyStyleKit (⭐201)](https://github.com/shindyu/ApplyStyleKit) - Elegant apply style, using Swift Method Chain.
*   [OverlayContainer (⭐1k)](https://github.com/applidium/OverlayContainer) - A library to develop overlay based interfaces, such as the one presented in the iOS 12 Apple Maps or Stocks apps.
...
*   [UI Fabric by Microsoft (⭐583)](https://github.com/OfficeDev/ui-fabric-ios) - UI framework based on [Fluent Design System](https://www.microsoft.com/design/fluent/#/ios) by Microsoft.

### Activity Indicator

*   [NVActivityIndicatorView (⭐10k)](https://github.com/ninjaprox/NVActivityIndicatorView) - Collection of nice loading animations.
*   [RPLoadingAnimation (⭐196)](https://github.com/naoyashiga/RPLoadingAnimation) - Loading animations by using Swift CALayer.
*   [LiquidLoader (⭐1.3k)](https://github.com/yoavlt/LiquidLoader) - Spinner loader components with liquid animation.
*   [iOS-CircleProgressView (⭐512)](https://github.com/CardinalNow/iOS-CircleProgressView) - This control will allow a user to use code instantiated or interface builder to create and render a circle progress view.
*   [iOS Circle Progress Bar (⭐424)](https://github.com/Eclair/CircleProgressBar) - iOS Circle Progress Bar.
...
*   [STLoadingGroup (⭐440)](https://github.com/saitjr/STLoadingGroup) - loading views.
*   [ALThreeCircleSpinner (⭐41)](https://github.com/AlexLittlejohn/ALThreeCircleSpinner) - A pulsing spinner view written in swift.
*   [MHRadialProgressView (⭐77)](https://github.com/mehfuzh/MHRadialProgressView) - iOS radial animated progress view.
*   [Loader (⭐104)](https://github.com/Ekhoo/Loader) - Amazing animated switch activity indicator written in swift.
*   [MBProgressHUD (⭐16k)](https://github.com/jdg/MBProgressHUD) - Drop-in class for displays a translucent HUD with an indicator and/or labels while work is being done in a background thread.
*   [SVProgressHUD (⭐12k)](https://github.com/SVProgressHUD/SVProgressHUD) - A clean and lightweight progress HUD for your iOS app.
...
*   [BigBrother (⭐445)](https://github.com/marcelofabri/BigBrother) - Automatically sets the network activity indicator for any performed request.
*   [AlamofireNetworkActivityIndicator (⭐707)](https://github.com/Alamofire/AlamofireNetworkActivityIndicator) - Controls the visibility of the network activity indicator on iOS using Alamofire.
*   [KDCircularProgress (⭐1.1k)](https://github.com/kaandedeoglu/KDCircularProgress) - A circular progress view with gradients written in Swift.
*   [DACircularProgress (⭐2.4k)](https://github.com/danielamitay/DACircularProgress) - DACircularProgress is a UIView subclass with circular UIProgressView properties.
*   [KYNavigationProgress (⭐246)](https://github.com/ykyouhei/KYNavigationProgress) - Simple extension of UINavigationController to display progress on the UINavigationBar.
*   [GearRefreshControl (⭐619)](https://github.com/andreamazz/GearRefreshControl) - A custom animation for the UIRefreshControl.
*   [NJKWebViewProgress (⭐3.9k)](https://github.com/ninjinkun/NJKWebViewProgress) - A progress interface library for UIWebView. You can implement progress bar for your in-app browser using this module.
*   [MKRingProgressView (⭐1.4k)](https://github.com/maxkonovalov/MKRingProgressView) - A beautiful ring/circular progress view similar to Activity app on Apple Watch, written in Swift.
*   [Hexacon (⭐336)](https://github.com/gautier-gdx/Hexacon) - A new way to display content in your app like the Apple Watch SpringBoard, written in Swift.
*   [ParticlesLoadingView (⭐953)](https://github.com/BalestraPatrick/ParticlesLoadingView) - A customizable SpriteKit particles animation on the border of a view.
*   [RPCircularProgress (⭐250)](https://github.com/iwasrobbed/RPCircularProgress) - (Swift) Circular progress UIView subclass with UIProgressView properties.
*   [MBCircularProgressBar (⭐974)](https://github.com/MatiBot/MBCircularProgressBar) -  A circular, animatable & highly customizable progress bar, editable from the Interface Builder using IBDesignable.
*   [WSProgressHUD (⭐584)](https://github.com/devSC/WSProgressHUD) - This is a beautiful hud view for iPhone & iPad.
*   [DBMetaballLoading (⭐72)](https://github.com/dabing1022/DBMetaballLoading) - A metaball loading written in Swift.
*   [FillableLoaders (⭐2.1k)](https://github.com/polqf/FillableLoaders) - Completely customizable progress based loaders drawn using custom CGPaths written in Swift.
*   [VHUD (⭐138)](https://github.com/xxxAIRINxxx/VHUD) Simple HUD.
*   [SwiftSpinner (⭐2.1k)](https://github.com/icanzilb/SwiftSpinner) - A beautiful activity indicator and modal alert written in Swift using blur effects, translucency, flat and bold design.
*   [SnapTimer (⭐275)](https://github.com/andresinaka/SnapTimer) - Implementation of Snapchat's stories timer.
*   [LLSpinner (⭐36)](https://github.com/alephao/LLSpinner) - An easy way to create a full screen activity indicator.
...
*   [FlexibleSteppedProgressBar (⭐539)](https://github.com/amratab/FlexibleSteppedProgressBar) - A beautiful easily customisable stepped progress bar.
*   [GradientLoadingBar (⭐765)](https://github.com/fxm90/GradientLoadingBar) - An animated gradient loading bar.
*   [DSGradientProgressView (⭐445)](https://github.com/DholStudio/DSGradientProgressView) - A simple and customizable animated progress bar written in Swift.
*   [GradientProgressBar (⭐475)](https://github.com/fxm90/GradientProgressBar) - A gradient progress bar (UIProgressView).
...
*   [DottedProgressBar (⭐41)](https://github.com/nikola9core/DottedProgressBar) - Simple and customizable animated progress bar with dots for iOS.
*   [RSLoadingView (⭐410)](https://github.com/roytornado/RSLoadingView) - Awesome loading animations using 3D engine written with Swift.
*   [SendIndicator (⭐64)](https://github.com/LeonardoCardoso/SendIndicator) - Yet another task indicator.
...
*   [BPBlockActivityIndicator (⭐43)](https://github.com/ppth0608/BPBlockActivityIndicator) - A simple and awesome Loading Activity Indicator(with funny block animation) for your iOS app.
*   [JDBreaksLoading (⭐154)](https://github.com/jamesdouble/JDBreaksLoading) - You can easily start up a little breaking game indicator by one line.
...
*   [Windless (⭐938)](https://github.com/Interactive-Studio/Windless) - Windless makes it easy to implement invisible layout loading view.
*   [Skeleton (⭐666)](https://github.com/gonzalonunez/Skeleton) - An easy way to create sliding CAGradientLayer animations! Works great for creating skeleton screens for loading content.
*   [StatusBarOverlay (⭐159)](https://github.com/IdleHandsApps/StatusBarOverlay) - Automatically show/hide a "No Internet Connection" bar when your app loses/gains connection. It supports apps which hide the status bar and "The Notch".
*   [RetroProgress (⭐16)](https://github.com/hyperoslo/RetroProgress) - Retro looking progress bar straight from the 90s.
*   [LinearProgressBar (⭐162)](https://github.com/Recouse/LinearProgressBar) - Material Linear Progress Bar for your iOS apps.
*   [MKProgress (⭐124)](https://github.com/kamirana4/MKProgress) - A lightweight ProgressHUD written in Swift. Looks similar to /MBProgressHUD/SVProgressHUD/KVNProgressHUD.
*   [RHPlaceholder (⭐237)](https://github.com/robertherdzik/RHPlaceholder) - Simple library which give you possibility to add Facebook like loading state for your views.
*   [IHProgressHUD (⭐199)](https://github.com/Swiftify-Corp/IHProgressHUD) - Simple HUD, thread safe, supports iOS, tvOS and App Extensions.

### Animation

*   [Pop (⭐20k)](https://github.com/facebook/pop) - An extensible iOS and macOS animation library, useful for physics-based interactions.
*   [AnimationEngine (⭐1.1k)](https://github.com/intuit/AnimationEngine) - Easily build advanced custom animations on iOS.
*   [RZTransitions (⭐1.9k)](https://github.com/Rightpoint/RZTransitions) - A library of custom iOS View Controller Animations and Interactions.
*   [DCAnimationKit (⭐797)](https://github.com/daltoniam/DCAnimationKit) - A collection of animations for iOS. Simple, just add water animations.
*   [Spring (⭐14k)](https://github.com/MengTo/Spring) - A library to simplify iOS animations in Swift.
*   [Fluent (⭐300)](https://github.com/matthewcheok/Fluent) - Swift animation made easy.
*   [Cheetah (⭐590)](https://github.com/suguru/Cheetah) - Easy animation library on iOS.
*   [Pop By Example (⭐183)](https://github.com/hossamghareeb/Facebook-POP-Tutorial) - A project tutorial in how to use Pop animation framework by example.
*   [AppAnimations](http://www.appanimations.com) - Collection of iOS animations to inspire your next project.
*   [EasyAnimation (⭐2.9k)](https://github.com/icanzilb/EasyAnimation) - A Swift library to take the power of UIView\.animateWithDuration() to a whole new level - layers, springs, chain-able animations, and mixing view/layer animations together.
...
*   [DaisyChain (⭐30)](https://github.com/alikaragoz/DaisyChain) - Easy animation chaining.
*   [PulsingHalo (⭐1.8k)](https://github.com/shu223/PulsingHalo) - iOS Component for creating a pulsing animation.
*   [DKChainableAnimationKit (⭐1.9k)](https://github.com/Draveness/DKChainableAnimationKit) - Chainable animations in Swift.
*   [JDAnimationKit (⭐610)](https://github.com/JellyDevelopment/JDAnimationKit) - Animate easy and with less code with Swift.
*   [Advance (⭐4.5k)](https://github.com/timdonnelly/Advance) - A powerful animation framework for iOS.
*   [UIView-Shake (⭐498)](https://github.com/andreamazz/UIView-Shake) - UIView category that adds shake animation.
*   [Walker (⭐151)](https://github.com/RamonGilabert/Walker) - A new animation engine for your app.
*   [Morgan (⭐97)](https://github.com/RamonGilabert/Morgan) - An animation set for your app.
*   [MagicMove (⭐15)](https://github.com/patrickreynolds/MagicMove) - Keynote-style Magic Move transition animations.
*   [Shimmer (⭐9.4k)](https://github.com/facebook/Shimmer) - An easy way to add a simple, shimmering effect to any view in an iOS app.
*   [SAConfettiView (⭐1.5k)](https://github.com/sudeepag/SAConfettiView) - Confetti! Who doesn't like confetti?
*   [CCMRadarView (⭐183)](https://github.com/cacmartinez/CCMRadarView) - CCMRadarView uses the IBDesignable tools to make an easy customizable radar view with animation.
*   [Pulsator (⭐1.3k)](https://github.com/shu223/Pulsator) - Pulse animation for iOS.
*   [Interpolate (⭐1.8k)](https://github.com/marmelroy/Interpolate) - Swift interpolation for gesture-driven animations.
*   [ADPuzzleAnimation (⭐125)](https://github.com/Antondomashnev/ADPuzzleAnimation) - Custom animation for UIView inspired by Fabric - Answers animation.
*   [Wave (⭐125)](https://github.com/onmyway133/Wave) - :ocean: Declarative chainable animations in Swift.
*   [Stellar (⭐2.9k)](https://github.com/AugustRush/Stellar) - A fantastic Physical animation library for swift.
*   [MotionMachine (⭐383)](https://github.com/poetmountain/MotionMachine) - A powerful, elegant, and modular animation library for Swift.
*   [JRMFloatingAnimation (⭐230)](https://github.com/carleihar/JRMFloatingAnimation) - An Objective-C animation library used to create floating image views.
*   [AHKBendableView (⭐591)](https://github.com/fastred/AHKBendableView) - UIView subclass that bends its edges when its position changes.
...
*   [WXWaveView (⭐347)](https://github.com/WelkinXie/WXWaveView) - Add a pretty water wave to your view.
*   [Twinkle (⭐599)](https://github.com/piemonte/Twinkle) - Swift and easy way to make elements in your iOS and tvOS app twinkle.
*   [MotionBlur (⭐1.5k)](https://github.com/fastred/MotionBlur) - MotionBlur allows you to add motion blur effect to iOS animations.
*   [RippleEffectView (⭐315)](https://github.com/alsedi/RippleEffectView) - RippleEffectView - A Neat Rippling View Effect.
*   [SwiftyAnimate (⭐196)](https://github.com/rchatham/SwiftyAnimate) - Composable animations in Swift.
...
*   [Lottie (⭐23k)](https://github.com/airbnb/lottie-ios) - An iOS library for a real time rendering of native vector animations from Adobe After Effects.
*   [anim (⭐555)](https://github.com/onurersel/anim) - An animation library for iOS with custom easings and easy to follow API.
*   [AnimatedCollectionViewLayout (⭐4.4k)](https://github.com/KelvinJin/AnimatedCollectionViewLayout) - A UICollectionViewLayout subclass that adds custom transitions/animations to the UICollectionView.
*   [Dance (⭐647)](https://github.com/saoudrizwan/Dance) - A radical & elegant animation library built for iOS.
*   [AKVideoImageView (⭐125)](https://github.com/numen31337/AKVideoImageView) - UIImageView subclass which allows you to display a looped video as a background.
*   [Spruce iOS Animation Library (⭐3.3k)](https://github.com/willowtreeapps/spruce-ios) - Swift library for choreographing animations on the screen.
*   [CircularRevealKit (⭐24)](https://github.com/T-Pro/CircularRevealKit) - UI framework that implements the material design's reveal effect.
*   [TweenKit (⭐1.3k)](https://github.com/SteveBarnegren/TweenKit) - Animation library for iOS in Swift.
*   [Water (⭐381)](https://github.com/KrisYu/Water) - Simple calculation to render cheap water effects.
...
*   [Bubble (⭐217)](https://github.com/goldmoment/Bubble) - Fruit Animation.
*   [Gemini (⭐3k)](https://github.com/shoheiyokoyama/Gemini) - Gemini is rich scroll based animation framework for iOS, written in Swift.
*   [WaterDrops (⭐401)](https://github.com/LeFal/WaterDrops) - Simple water drops animation for iOS in Swift.
*   [ViewAnimator (⭐6.8k)](https://github.com/marcosgriselli/ViewAnimator) - ViewAnimator brings your UI to life with just one line.
*   [Ease (⭐1.3k)](https://github.com/roberthein/Ease) - Animate everything with Ease.
*   [Kinieta (⭐44)](https://github.com/mmick66/kinieta) - An Animation Engine with Custom Bezier Easing, an Intuitive API and perfect Color Intepolation.
*   [LSAnimator (⭐1.6k)](https://github.com/Lision/LSAnimator) - Easy to Read and Write Multi-chain Animations Kit in Objective-C and Swift.
*   [YetAnotherAnimationLibrary (⭐509)](https://github.com/lkzhao/YetAnotherAnimationLibrary) - Designed for gesture-driven animations. Fast, simple, & extensible!
*   [Anima (⭐510)](https://github.com/satoshin21/Anima) - Anima is chainable Layer-Based Animation library for Swift4.
*   [MotionAnimation (⭐145)](https://github.com/lkzhao/MotionAnimation) - Lightweight animation library for UIKit.
*   [AGInterfaceInteraction (⭐158)](https://github.com/agilie/AGInterfaceInteraction) - library performs interaction with UI interface.
*   [PMTween (⭐348)](https://github.com/poetmountain/PMTween) - An elegant and flexible tweening library for iOS.
...
*   [fireworks (⭐321)](https://github.com/tomkowz/fireworks) - Fireworks effect for UIView
*   [Disintegrate (⭐66)](https://github.com/dbukowski/Disintegrate) - Disintegration animation inspired by THAT thing Thanos did at the end of Avengers: Infinity War.
*   [Wobbly (⭐150)](https://github.com/sagaya/wobbly) - Wobbly is a Library of predefined, easy to use iOS animations.
...
*   [BlurryModalSegue (⭐925)](https://github.com/Citrrus/BlurryModalSegue) - A custom modal segue for providing a blurred overlay effect.
*   [DAExpandAnimation (⭐578)](https://github.com/ifitdoesntwork/DAExpandAnimation) - A custom modal transition that presents a controller with an expanding effect while sliding out the presenter remnants.
*   [BubbleTransition (⭐3.3k)](https://github.com/andreamazz/BubbleTransition) - A custom modal transition that presents and dismiss a controller with an expanding bubble effect.
*   [RPModalGestureTransition (⭐90)](https://github.com/naoyashiga/RPModalGestureTransition) - You can dismiss modal by using gesture.
*   [RMPZoomTransitionAnimator (⭐1.7k)](https://github.com/recruit-mp/RMPZoomTransitionAnimator) - A custom zooming transition animation for UIViewController.
*   [ElasticTransition (⭐2.2k)](https://github.com/lkzhao/ElasticTransition) - A UIKit custom transition that simulates an elastic drag. Written in Swift.
*   [ElasticTransition-ObjC (⭐396)](https://github.com/taglia3/ElasticTransition-ObjC) - A UIKit custom transition that simulates an elastic drag.This is the Objective-C Version of Elastic Transition written in Swift by lkzhao.
*   [ZFDragableModalTransition (⭐2.5k)](https://github.com/zoonooz/ZFDragableModalTransition) - Custom animation transition for present modal view controller.
*   [ZOZolaZoomTransition (⭐904)](https://github.com/NewAmsterdamLabs/ZOZolaZoomTransition) - Zoom transition that animates the entire view hierarchy. Used extensively in the Zola iOS application.
*   [JTMaterialTransition (⭐964)](https://github.com/jonathantribouharet/JTMaterialTransition) - An iOS transition for controllers based on material design.
*   [AnimatedTransitionGallery (⭐2.5k)](https://github.com/shu223/AnimatedTransitionGallery) - Collection of iOS 7 custom animated transitions using UIViewControllerAnimatedTransitioning protocol.
*   [TransitionTreasury (⭐2.1k)](https://github.com/DianQK/TransitionTreasury) - Easier way to push your viewController.
*   [Presenter (⭐14)](https://github.com/muukii/Presenter) - Screen transition with safe and clean code.
*   [Kaeru (⭐509)](https://github.com/bannzai/Kaeru) - Switch viewcontroller like iOS task manager.
*   [View2ViewTransition (⭐852)](https://github.com/naru-jpn/View2ViewTransition) - Custom interactive view controller transition from one view to another view.
*   [AZTransitions (⭐418)](https://github.com/azimin/AZTransitions) - API to make great custom transitions in one method.
*   [Motion (⭐1.7k)](https://github.com/CosmicMind/Motion) - Seamless animations and transitions in Swift.
*   [PresenterKit (⭐560)](https://github.com/jessesquires/PresenterKit) - Swifty view controller presentation for iOS.
...
*   [Gagat (⭐883)](https://github.com/Boerworz/Gagat) - A delightful way to transition between visual styles in your iOS applications.
*   [DeckTransition (⭐2.2k)](https://github.com/HarshilShah/DeckTransition) - A library to recreate the iOS Apple Music now playing transition.
*   [AlertTransition (⭐571)](https://github.com/loopeer/AlertTransition) - AlertTransition is a extensible library for making view controller transitions, especially for alert transitions.
*   [SemiModalViewController (⭐78)](https://github.com/muyexi/SemiModalViewController) - Present view / view controller as bottom-half modal.
...
*   [AppstoreTransition (⭐540)](https://github.com/appssemble/appstore-card-transition) - Simulates the appstore card animation transition.

### Alert & Action Sheet

*   [SweetAlert (⭐2k)](https://github.com/codestergit/SweetAlert-iOS) - Live animated Alert View for iOS written in Swift.
*   [NYAlertViewController (⭐609)](https://github.com/nealyoung/NYAlertViewController) - Highly configurable iOS Alert Views with custom content views.
*   [SCLAlertView-Swift (⭐5.2k)](https://github.com/vikmeup/SCLAlertView-Swift) - Beautiful animated Alert View, written in Swift.
*   [TTGSnackbar (⭐603)](https://github.com/zekunyan/TTGSnackbar) - Show simple message and action button on the bottom of the screen with multi kinds of animation.
...
*   [HDNotificationView (⭐356)](https://github.com/nhdang103/HDNotificationView) - Emulates the native Notification Banner UI for any alert.
...
*   [TKSwarmAlert (⭐578)](https://github.com/entotsu/TKSwarmAlert) - Animated alert library like Swarm app.
*   [SimpleAlert (⭐396)](https://github.com/KyoheiG3/SimpleAlert) - Customizable simple Alert and simple ActionSheet for Swift.
*   [Hokusai (⭐428)](https://github.com/ytakzk/Hokusai) - A Swift library to provide a bouncy action sheet.
*   [SwiftNotice (⭐835)](https://github.com/johnlui/SwiftNotice) - SwiftNotice is a GUI library for displaying various popups (HUD) written in pure Swift, fits any scrollview.
*   [SwiftOverlays (⭐628)](https://github.com/peterprokop/SwiftOverlays) - SwiftOverlays is a Swift GUI library for displaying various popups and notifications.
*   [SwiftyDrop (⭐691)](https://github.com/morizotter/SwiftyDrop) - SwiftyDrop is a lightweight pure Swift simple and beautiful dropdown message.
*   [LKAlertController (⭐97)](https://github.com/Lightningkite/LKAlertController) - An easy to use UIAlertController builder for swift.
...
*   [CustomizableActionSheet (⭐191)](https://github.com/beryu/CustomizableActionSheet) - Action sheet allows including your custom views and buttons.
*   [Toast-Swift (⭐3.2k)](https://github.com/scalessec/Toast-Swift) - A Swift extension that adds toast notifications to the UIView object class.
...
*   [JLToast (⭐1.6k)](https://github.com/devxoul/Toaster) - Toast for iOS with very simple interface.
...
*   [Dodo (⭐870)](https://github.com/evgenyneu/Dodo) - A message bar for iOS written in Swift.
*   [MaterialActionSheetController (⭐103)](https://github.com/ntnhon/MaterialActionSheetController) - A Google like action sheet for iOS written in Swift.
*   [SwiftMessages (⭐6.7k)](https://github.com/SwiftKickMobile/SwiftMessages) - A very flexible message bar for iOS written in Swift.
*   [FCAlertView (⭐114)](https://github.com/krispenney/FCAlertView) - A Flat Customizable AlertView for iOS. (Swift).
*   [FCAlertView (⭐793)](https://github.com/nimati/FCAlertView) - A Flat Customizable AlertView for iOS. (Objective-C).
...
*   [RMActionController (⭐544)](https://github.com/CooperRS/RMActionController) - Present any UIView in an UIAlertController like manner.
*   [RMDateSelectionViewController (⭐1.1k)](https://github.com/CooperRS/RMDateSelectionViewController) - Select a date using UIDatePicker in a UIAlertController like fashion.
*   [RMPickerViewController (⭐383)](https://github.com/CooperRS/RMPickerViewController) - Select something using UIPickerView in a UIAlertController like fashion.
...
*   [Malert (⭐479)](https://github.com/vitormesquita/Malert) - Malert is a simple, easy and custom iOS UIAlertView written in Swift.
*   [RAlertView (⭐71)](https://github.com/roycms/AlertView) - AlertView, iOS popup window, A pop-up framework, Can be simple and convenient to join your project.
*   [NoticeBar (⭐235)](https://github.com/qiuncheng/NoticeBar) - A simple NoticeBar written by Swift 3, similar with QQ notice view.
*   [LIHAlert (⭐36)](https://github.com/Lasithih/LIHAlert) - Advance animated banner alerts for iOS.
*   [BPStatusBarAlert (⭐131)](https://github.com/ppth0608/BPStatusBarAlert) - A simple alerts that appear on the status bar and below navigation bar(like Facebook).
...
*   [Alertift (⭐286)](https://github.com/sgr-ksmt/Alertift) - Swifty, modern UIAlertController wrapper.
...
*   [BulletinBoard (⭐5.2k)](https://github.com/alexaubry/BulletinBoard) - Generate and Display Bottom Card Interfaces on iOS
...
*   [Alerts & Pickers (⭐5.4k)](https://github.com/dillidon/alerts-and-pickers) - Advanced usage of native UIAlertController with TextField, DatePicker, PickerView, TableView and CollectionView.
*   [RMessage (⭐406)](https://github.com/donileo/RMessage) - A crisp in-app notification/message banner built in ObjC.
*   [InAppNotify (⭐437)](https://github.com/lucabecchetti/InAppNotify) - Swift library to manage in-app notification in swift language, like WhatsApp, Telegram, Frind, etc.
*   [FloatingActionSheetController (⭐140)](https://github.com/ra1028/FloatingActionSheetController) - FloatingActionSheetController is a cool design ActionSheetController library written in Swift.
*   [TOActionSheet (⭐173)](https://github.com/TimOliver/TOActionSheet) - A custom-designed reimplementation of the UIActionSheet control for iOS
*   [XLActionController (⭐3.3k)](https://github.com/xmartlabs/XLActionController) - Fully customizable and extensible action sheet controller written in Swift.
*   [PopMenu (⭐1.4k)](https://github.com/CaliCastle/PopMenu) - A cool and customizable popup style action sheet 😎
*   [NotchyAlert (⭐69)](https://github.com/TheAbstractDev/NotchyAlert) - Use the iPhone X notch space to display creative alerts.
*   [Sheet (⭐320)](https://github.com/ParkGwangBeom/Sheet) - SHEET helps you easily create a wide variety of action sheets with navigation features used in the Flipboard App
...
*   [MIBadgeButton (⭐343)](https://github.com/mustafaibrahim989/MIBadgeButton-Swift) - Notification badge for UIButtons.
*   [EasyNotificationBadge (⭐213)](https://github.com/Minitour/EasyNotificationBadge) - UIView extension that adds a notification badge. \[e]
*   [swift-badge (⭐383)](https://github.com/evgenyneu/swift-badge) - Badge view for iOS written in swift
...
*   [SSBouncyButton (⭐311)](https://github.com/StyleShare/SSBouncyButton) - iOS7-style bouncy button UI component.
*   [DOFavoriteButton (⭐3.6k)](https://github.com/okmr-d/DOFavoriteButton) - Cute Animated Button written in Swift.
*   [VBFPopFlatButton (⭐3.1k)](https://github.com/victorBaro/VBFPopFlatButton) - Flat button with 9 different states animated using Facebook POP.
*   [HTPressableButton (⭐858)](https://github.com/Famolus/HTPressableButton) - Flat design pressable button.
*   [LiquidFloatingActionButton (⭐3.8k)](https://github.com/yoavlt/LiquidFloatingActionButton) - Material Design Floating Action Button in liquid state
*   [JTFadingInfoView (⭐129)](https://github.com/JunichiT/JTFadingInfoView) - An UIButton-based view with fade in/out animation features.
*   [Floaty (⭐1.5k)](https://github.com/kciter/Floaty) - :heart: Floating Action Button for iOS
*   [TVButton (⭐1.2k)](https://github.com/marmelroy/TVButton) - Recreating the cool parallax icons from Apple TV as iOS UIButtons (in Swift).
*   [SwiftyButton (⭐543)](https://github.com/TakeScoop/SwiftyButton) - Simple and customizable button in Swift
*   [AnimatablePlayButton (⭐77)](https://github.com/suzuki-0000/AnimatablePlayButton) - Animated Play and Pause Button using CALayer, CAKeyframeAnimation.
*   [gbkui-button-progress-view (⭐541)](https://github.com/Guidebook/gbkui-button-progress-view) - Inspired by Apple’s download progress buttons in the App Store.
*   [ZFRippleButton (⭐1.4k)](https://github.com/zoonooz/ZFRippleButton) - Custom UIButton effect inspired by Google Material Design
*   [JOEmojiableBtn (⭐305)](https://github.com/lojals/JOEmojiableBtn) - Emoji selector like Facebook Reactions.
*   [EMEmojiableBtn (⭐80)](https://github.com/Eke/EMEmojiableBtn) - Option selector that works similar to Reactions by fb. Objective-c version.
*   [WYMaterialButton (⭐76)](https://github.com/Yu-w/WYMaterialButton) - Interactive and fully animated Material Design button for iOS developers.
*   [DynamicButton (⭐1.2k)](https://github.com/yannickl/DynamicButton) - Yet another animated flat buttons in Swift
*   [OnOffButton (⭐418)](https://github.com/rakaramos/OnOffButton) - Custom On/Off Animated UIButton, written in Swift. By Creativedash
*   [WCLShineButton (⭐1.4k)](https://github.com/imwcl/WCLShineButton) - This is a UI lib for iOS. Effects like shining.
*   [EasySocialButton (⭐161)](https://github.com/Minitour/EasySocialButton) - An easy way to create beautiful social authentication buttons.
*   [NFDownloadButton (⭐432)](https://github.com/LeonardoCardoso/NFDownloadButton) - Revamped Download Button.
...
*   [JSButton (⭐12)](https://github.com/jogendra/JSButton) - A fully customisable swift subclass on UIButton which allows you to create beautiful buttons without writing any line of code.
*   [TransitionButton (⭐1.3k)](https://github.com/AladinWay/TransitionButton) - UIButton sublass for loading and transition animation
*   [ButtonProgressBar-iOS (⭐563)](https://github.com/thePsguy/ButtonProgressBar-iOS) - A small and flexible UIButton subclass with animated loading progress, and completion animation.
*   [SpicyButton (⭐2)](https://github.com/lukecrum/SpicyButton) - Full-featured IBDesignable UIButton class
...
*   [TORoundedButton (⭐480)](https://github.com/TimOliver/TORoundedButton) - A high-performance button control with rounded corners.

### Calendar

*   [CVCalendar (⭐3.5k)](https://github.com/CVCalendar/CVCalendar) - A custom visual calendar for iOS 8+ written in Swift (2.0).
*   [RSDayFlow (⭐844)](https://github.com/ruslanskorb/RSDayFlow) - iOS 7+ Calendar with Infinite Scrolling.
*   [NWCalendarView (⭐60)](https://github.com/nbwar/NWCalendarView) - An availability calendar implementation for iOS
*   [GLCalendarView (⭐861)](https://github.com/Glow-Inc/GLCalendarView) - A fully customizable calendar view acting as a date range picker
*   [JTCalendar (⭐2.8k)](https://github.com/jonathantribouharet/JTCalendar) - A customizable calendar view for iOS.
*   [JTAppleCalendar (⭐7.3k)](https://github.com/patchthecode/JTAppleCalendar) - The Unofficial Swift Apple Calendar Library. View. Control. for iOS & tvOS
*   [Daysquare (⭐701)](https://github.com/unixzii/Daysquare) - An elegant calendar control for iOS.
*   [ASCalendar (⭐192)](https://github.com/scamps88/ASCalendar) - A calendar control for iOS written in swift with mvvm pattern
*   [Calendar (⭐689)](https://github.com/jumartin/Calendar) - A set of views and controllers for displaying and scheduling events on iOS
*   [Koyomi (⭐737)](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component in Swift
*   [DateTimePicker (⭐1.8k)](https://github.com/itsmeichigo/DateTimePicker) - A nicer iOS UI component for picking date and time
*   [RCalendarPicker (⭐131)](https://github.com/roycms/RCalendarPicker) - RCalendarPicker A date picker control.
...
*   [KDCalendarView (⭐516)](https://github.com/mmick66/CalendarView) - A calendar component for iOS written in Swift 4.0. It features both vertical and horizontal layout (and scrolling) and the display of native calendar events.
*   [CalendarPopUp (⭐185)](https://github.com/orazz/CalendarPopUp) - CalendarPopUp - JTAppleCalendar library.
*   [ios\_calendar (⭐158)](https://github.com/maximbilan/Calendar-iOS)  - It's lightweight and simple control with supporting Locale and CalendarIdentifier. There're samples for iPhone and iPad, and also with using a popover. With supporting Persian calendar
...
*   [MDCSwipeToChoose (⭐2.6k)](https://github.com/modocache/MDCSwipeToChoose) - Swipe to "like" or "dislike" any view, just like Tinder.app. Build a flashcard app, a photo viewer, and more, in minutes, not hours!
*   [TisprCardStack (⭐850)](https://github.com/tispr/tispr-card-stack) - Library that allows to have cards UI.
*   [CardAnimation (⭐1.2k)](https://github.com/seedante/CardAnimation) - Card flip animation by pan gesture.
*   [Koloda (⭐5.1k)](https://github.com/Yalantis/Koloda) - KolodaView is a class designed to simplify the implementation of Tinder like cards on iOS.
*   [KVCardSelectionVC (⭐23)](https://github.com/kunalverma25/KVCardSelectionVC) - Awesome looking Dial like card selection ViewController.
*   [DMSwipeCards (⭐249)](https://github.com/D-32/DMSwipeCards) - Tinder like card stack that supports lazy loading and generics
*   [TimelineCards (⭐426)](https://github.com/vladaverin24/TimelineCards) - Presenting timelines as cards, single or bundled in scrollable feed!.
*   [Cards (⭐4.1k)](https://github.com/PaoloCuscela/Cards) - Awesome iOS 11 AppStore's Card Views.
*   [MMCardView (⭐558)](https://github.com/MillmanY/MMCardView) - Custom CollectionView like Wallet App
*   [CardsLayout (⭐782)](https://github.com/filletofish/CardsLayout) - Nice card-designed custom collection view layout.
*   [CardParts (⭐2.4k)](https://github.com/intuit/CardParts) - A reactive, card-based UI framework built on UIKit.
*   [VerticalCardSwiper (⭐1.1k)](https://github.com/JoniVR/VerticalCardSwiper) - A marriage between the Shazam Discover UI and Tinder, built with UICollectionView in Swift.

### Form & Settings

*   [Form (⭐32)](https://github.com/hyperoslo/Form) - The most flexible and powerful way to build a form on iOS
*   [XLForm (⭐5.8k)](https://github.com/xmartlabs/XLForm) - XLForm is the most flexible and powerful iOS library to create dynamic table-view forms. Fully compatible with Swift & Obj-C.
...
*   [Former (⭐1.3k)](https://github.com/ra1028/Former) - Former is a fully customizable Swift2 library for easy creating UITableView based form.
*   [SwiftForms (⭐1.3k)](https://github.com/ortuman/SwiftForms) - A small and lightweight library written in Swift that allows you to easily create forms.
*   [Formalist (⭐159)](https://github.com/seedco/Formalist) - Declarative form building framework for iOS
...
*   [GenericPasswordRow (⭐177)](https://github.com/EurekaCommunity/GenericPasswordRow) - A row for Eureka to implement password validations.
...
*   [ValidationToolkit (⭐40)](https://github.com/nsagora/validation-toolkit) - Lightweight framework for input validation written in Swift.
...
*   [LTMorphingLabel (⭐7.8k)](https://github.com/lexrus/LTMorphingLabel) - Graceful morphing effects for UILabel written in Swift.
...
*   [TOMSMorphingLabel (⭐1.9k)](https://github.com/tomknig/TOMSMorphingLabel) - Configurable morphing transitions between text values of a label.
*   [THLabel (⭐652)](https://github.com/tobihagemann/THLabel) - UILabel subclass, which additionally allows shadow blur, inner shadow, stroke text and fill gradient.
*   [RQShineLabel (⭐2k)](https://github.com/zipme/RQShineLabel) - Secret app like text animation
*   [ZCAnimatedLabel (⭐2.3k)](https://github.com/overboming/ZCAnimatedLabel) - UILabel replacement with fine-grain appear/disappear animation
*   [TriLabelView (⭐166)](https://github.com/mukeshthawani/TriLabelView) - A triangle shaped corner label view for iOS written in Swift.
*   [Preloader.Ophiuchus (⭐885)](https://github.com/Yalantis/Preloader.Ophiuchus) - Custom Label to apply animations on whole text or letters.
*   [MTLLinkLabel (⭐74)](https://github.com/recruit-mtl/MTLLinkLabel) - MTLLinkLabel is linkable UILabel. Written in Swift.
*   [UICountingLabel (⭐1.9k)](https://github.com/dataxpress/UICountingLabel/) - Adds animated counting support to UILabel.
*   [SlidingText (⭐53)](https://github.com/dnKaratzas/SlidingText) -  Swift UIView for sliding text with page indicator.
*   [NumericAnimatedLabel (⭐28)](https://github.com/javalnanda/NumericAnimatedLabel/) -  Swift UIView for showing numeric label with incremental and decremental step animation while changing value. Useful for scenarios like displaying currency.
*   [JSLabel (⭐6)](https://github.com/jogendra/JSLabel) -  A simple designable subclass on UILabel with extra IBDesignable and Blinking features.
*   [AnimatedMaskLabel (⭐18)](https://github.com/jogendra/AnimatedMaskLabel) -  Animated Mask Label is a nice gradient animated label. This is an easy way to add a shimmering effect to any view in your app.
*   [STULabel (⭐94)](https://github.com/stephan-tolksdorf/STULabel) -  A label view that's faster than UILabel and supports asynchronous rendering, links with UIDragInteraction, very flexible text truncation, Auto Layout, UIAccessibility and more.

### Login

*   [LFLoginController (⭐153)](https://github.com/awesome-labs/LFLoginController) - Customizable login screen, written in Swift.
...
*   [Cely (⭐163)](https://github.com/cely-tools/Cely) - Plug-n-Play login framework written in Swift.

### Menu

*   [ENSwiftSideMenu (⭐1.8k)](https://github.com/evnaz/ENSwiftSideMenu) - A simple side menu for iOS 7/8 written in Swift.
*   [RESideMenu (⭐7.2k)](https://github.com/romaonthego/RESideMenu) - iOS 7/8 style side menu with parallax effect inspired by Dribbble shots.
*   [SSASideMenu (⭐600)](https://github.com/SSA111/SSASideMenu) - A Swift implementation of RESideMenu. A iOS 7/8 style side menu with parallax effect.
*   [RadialMenu (⭐296)](https://github.com/bradjasper/radialmenu) - RadialMenu is a custom control for providing a touch context menu (like iMessage recording in iOS 8) built with Swift & POP
*   [cariocamenu (⭐779)](https://github.com/arn00s/cariocamenu) - The fastest zero-tap iOS menu.
*   [VLDContextSheet (⭐173)](https://github.com/vangelov/VLDContextSheet) - Context menu similar to the one in the Pinterest iOS app
*   [GuillotineMenu (⭐2.9k)](https://github.com/Yalantis/GuillotineMenu) - Our Guillotine Menu Transitioning Animation implemented in Swift reminds a bit of a notorious killing machine.
...
*   [LLSlideMenu (⭐589)](https://github.com/lilei644/LLSlideMenu) - This is a spring slide menu for iOS apps
...
*   [MenuItemKit (⭐838)](https://github.com/cxa/MenuItemKit) - UIMenuItem with image and block(closure)
...
*   [AZDropdownMenu (⭐193)](https://github.com/Azuritul/AZDropdownMenu) - An easy to use dropdown menu that supports images.
*   [CircleMenu (⭐3.4k)](https://github.com/Ramotion/circle-menu) - An animated, multi-option menu button.
*   [SlideMenuControllerSwift (⭐3.3k)](https://github.com/dekatotoro/SlideMenuControllerSwift) - iOS Slide Menu View based on Google+, iQON, Feedly, Ameba iOS app. It is written in pure Swift.
*   [SideMenu (⭐5.4k)](https://github.com/jonkykong/SideMenu) - Simple side menu control in Swift inspired by Facebook. Right and Left sides. Lots of customization and animation options. Can be implemented in Storyboard with no code.
*   [CategorySliderView (⭐354)](https://github.com/cemolcay/CategorySliderView) - slider view for choosing categories. add any UIView type as category item view. Fully customisable
*   [MKDropdownMenu (⭐527)](https://github.com/maxkonovalov/MKDropdownMenu) - A Dropdown Menu for iOS with many customizable parameters to suit any needs.
*   [ExpandingMenu (⭐454)](https://github.com/monoqlo/ExpandingMenu) - ExpandingMenu is menu button for iOS written in Swift.
*   [PageMenu (⭐5.2k)](https://github.com/PageMenu/PageMenu) - A paging menu controller built from other view controllers placed inside a scroll view (like Spotify, Windows Phone, Instagram)
*   [XXXRoundMenuButton (⭐383)](https://github.com/zsy78191/XXXRoundMenuButton) - A simple circle style menu.
*   [IGCMenu (⭐137)](https://github.com/sunilsharma08/IGCMenu) - Grid and Circular menu with animation.Easy to customise.
*   [EEJSelectMenu (⭐23)](https://github.com/eejahromi/EEJSelectMenu) - Single selection menu with cool animations, responsive with all screen sizes.
*   [IGLDropDownMenu (⭐1.2k)](https://github.com/bestwnh/IGLDropDownMenu) - An iOS drop down menu with pretty animation and easy to customize.
*   [Side-Menu.iOS (⭐2.7k)](https://github.com/Yalantis/Side-Menu.iOS) - Animated side menu with customizable UI
*   [PopMenu (⭐897)](https://github.com/xhzengAIB/PopMenu) - PopMenu is pop animation menu inspired by Sina weibo / NetEase app.
*   [FlowingMenu (⭐972)](https://github.com/yannickl/FlowingMenu) - Interactive view transition to display menus with flowing and bouncing effects in Swift
*   [Persei (⭐3.4k)](https://github.com/Yalantis/Persei) - Animated top menu for UITableView / UICollectionView / UIScrollView written in Swift
*   [DropDown (⭐2.3k)](https://github.com/AssistoLab/DropDown) - A Material Design drop down for iOS
*   [KYGooeyMenu (⭐1.9k)](https://github.com/KittenYang/KYGooeyMenu) - A not bad gooey effects menu.
*   [SideMenuController (⭐1.2k)](https://github.com/teodorpatras/SideMenuController) - A side menu controller written in Swift
*   [Context-Menu.iOS (⭐1.8k)](https://github.com/Yalantis/Context-Menu.iOS) - You can easily add awesome animated context menu to your app.
*   [ViewDeck (⭐5.4k)](https://github.com/ViewDeck/ViewDeck) - An implementation of the sliding functionality found in the Path 2.0 or Facebook iOS apps.
*   [FrostedSidebar (⭐430)](https://github.com/edekhayser/FrostedSidebar) - Hamburger Menu using Swift and iOS 8 API's
*   [VHBoomMenuButton (⭐577)](https://github.com/Nightonke/VHBoomMenuButton) - A menu which can ... BOOM!
*   [DropDownMenuKit (⭐252)](https://github.com/qmathe/DropDownMenuKit) - A simple, modular and highly customizable UIKit menu, that can be attached to the navigation bar or toolbar, written in Swift.
*   [RevealMenuController (⭐21)](https://github.com/anatoliyv/RevealMenuController) - Expandable item groups, custom position and appearance animation. Similar to ActionSheet style.
*   [RHSideButtons (⭐166)](https://github.com/robertherdzik/RHSideButtons) - Library provides easy to implement variation of Android (Material Design) Floating Action Button for iOS. You can use it as your app small side menu.
*   [Swift-CircleMenu (⭐123)](https://github.com/hu55a1n1/Swift-CircleMenu) - Rotating circle menu written in Swift 3.
*   [AKSideMenu (⭐280)](https://github.com/dogo/AKSideMenu) - Beautiful iOS side menu library with parallax effect.
*   [InteractiveSideMenu (⭐703)](https://github.com/handsomecode/InteractiveSideMenu) - Customizable iOS Interactive Side Menu written in Swift 3.
...
*   [AirBar (⭐623)](https://github.com/uptechteam/AirBar) - UIScrollView driven expandable menu written in Swift 3.
*   [FAPanels (⭐849)](https://github.com/fahidattique55/FAPanels) - FAPanels for transition
...
*   [DTPagerController (⭐291)](https://github.com/tungvoduc/DTPagerController) - A fully customizable container view controller to display set of ViewControllers in horizontal scroller
*   [PagingKit (⭐1.3k)](https://github.com/kazuhiro4949/PagingKit) - PagingKit provides customizable menu UI It has more flexible layout and design than the other libraries.
*   [Dropdowns (⭐307)](https://github.com/onmyway133/Dropdowns) - 💧 Dropdown in Swift
*   [Parchment (⭐3k)](https://github.com/rechsteiner/Parchment) - A paging view controller with a highly customizable menu. Built on UICollectionView, with support for custom layouts and infinite data sources.
*   [ContextMenu (⭐968)](https://github.com/GitHawkApp/ContextMenu) - An iOS context menu UI inspired by Things 3.
...
*   [HidingNavigationBar (⭐1k)](https://github.com/tristanhimmelman/HidingNavigationBar) - Easily hide and show a view controller's navigation bar (and tab bar) as a user scrolls
...
*   [LTNavigationBar (⭐4.5k)](https://github.com/ltebean/LTNavigationBar) - UINavigationBar Category which allows you to change its appearance dynamically
*   [BusyNavigationBar (⭐991)](https://github.com/gmertk/BusyNavigationBar) - A UINavigationBar extension to show loading effects
...
*   [RainbowNavigation (⭐789)](https://github.com/DanisFabric/RainbowNavigation) - An easy way to change backgroundColor of UINavigationBar when Push & Pop
*   [TONavigationBar (⭐246)](https://github.com/TimOliver/TONavigationBar) - A simple subclass that adds the ability to set the navigation bar background to 'clear' and gradually transition it visibly back in, similar to the effect in the iOS Music app.

### PickerView

*   [ActionSheetPicker-3.0 (⭐3.4k)](https://github.com/skywinder/ActionSheetPicker-3.0/) - Quickly reproduce the dropdown UIPickerView / ActionSheet functionality on iOS.
*   [PickerView (⭐480)](https://github.com/filipealva/PickerView) - A customizable alternative to UIPickerView in Swift.
*   [DatePickerDialog (⭐530)](https://github.com/squimer/DatePickerDialog-iOS-Swift) - Date picker dialog for iOS
*   [CZPicker (⭐527)](https://github.com/chenzeyu/CZPicker) - A picker view shown as a popup for iOS.
*   [AIDatePickerController (⭐90)](https://github.com/alikaragoz/AIDatePickerController) - :date: UIDatePicker modally presented with iOS 7 custom transitions.
*   [CountryPicker (⭐203)](https://github.com/4taras4/CountryCode) - :date: UIPickerView with Country names flags and phoneCodes
*   [McPicker (⭐206)](https://github.com/kmcgill88/McPicker-iOS) - A customizable, closure driven UIPickerView drop-in solution with animations that is rotation ready.
...
*   [ADDatePicker (⭐165)](https://github.com/abhiperry/ADDatePicker) - A fully customizable iOS Horizontal PickerView library, written in pure swift.
*   [SKCountryPicker (⭐237)](https://github.com/SURYAKANTSHARMA/CountryPicker) - A simple, customizable Country picker for picking country or dialing code.

### Popup

*   [MMPopupView (⭐2.1k)](https://github.com/adad184/MMPopupView) - Pop-up based view(e.g. alert sheet), can easily customize.
*   [STPopup (⭐2.6k)](https://github.com/kevin0571/STPopup) - STPopup provides a UINavigationController in popup style, for both iPhone and iPad.
*   [NMPopUpView (⭐194)](https://github.com/psy2k/NMPopUpView) - Simple iOS class for showing nice popup windows. Swift and Objective-C versions available.
*   [PopupController (⭐339)](https://github.com/daisuke310vvv/PopupController) - A customizable controller for showing temporary popup view.
*   [SubscriptionPrompt (⭐236)](https://github.com/binchik/SubscriptionPrompt) - Subscription View Controller like the Tinder uses
*   [Presentr (⭐2.9k)](https://github.com/IcaliaLabs/Presentr) - Wrapper for custom ViewController presentations in iOS 8+
*   [PopupDialog (⭐3.8k)](https://github.com/Orderella/PopupDialog) - A simple, customizable popup dialog for iOS written in Swift. Replaces UIAlertControllers alert style.
*   [SelectionDialog (⭐117)](https://github.com/kciter/SelectionDialog) - Simple selection dialog.
*   [AZDialogViewController (⭐768)](https://github.com/Minitour/AZDialogViewController) - A highly customizable alert dialog controller that mimics Snapchat's alert dialog.
*   [MIBlurPopup (⭐603)](https://github.com/MarioIannotta/MIBlurPopup) - MIBlurPopup let you create amazing popups with a blurred background.
*   [LNPopupController (⭐2.9k)](https://github.com/LeoNatan/LNPopupController) - a framework for presenting view controllers as popups of other view controllers, much like the Apple Music and Podcasts apps.
*   [PopupWindow (⭐416)](https://github.com/shin8484/PopupWindow) - PopupWindow is a simple Popup using another UIWindow in Swift.
...
*   [SwiftEntryKit (⭐6k)](https://github.com/huri000/SwiftEntryKit) - A highly customizable popups, alerts and banners presenter for iOS. It offers various presets and is written in pure Swift.
*   [FFPopup (⭐823)](https://github.com/JonyFang/FFPopup) - ⛩FFPopup is a lightweight library for presenting custom views as a popup.
...
*   [GradientCircularProgress (⭐522)](https://github.com/keygx/GradientCircularProgress) - Customizable progress indicator library in Swift.

### Pull to Refresh

*   [DGElasticPullToRefresh (⭐3.7k)](https://github.com/gontovnik/DGElasticPullToRefresh) - Elastic pull to refresh for iOS developed in Swift
*   [PullToBounce (⭐1.9k)](https://github.com/entotsu/PullToBounce) - Animated "Pull To Refresh" Library for UIScrollView.
*   [SVPullToRefresh (⭐4.9k)](https://github.com/samvermette/SVPullToRefresh) - Give pull-to-refresh & infinite scrolling to any UIScrollView with 1 line of code. <http://samvermette.com/314>
*   [UzysAnimatedGifPullToRefresh (⭐1.4k)](https://github.com/uzysjung/UzysAnimatedGifPullToRefresh) - Add PullToRefresh using animated GIF to any scrollView with just simple code
*   [PullToRefreshCoreText (⭐313)](https://github.com/cemolcay/PullToRefreshCoreText) - PullToRefresh extension for all UIScrollView type classes with animated text drawing style
*   [BOZPongRefreshControl (⭐886)](https://github.com/boztalay/BOZPongRefreshControl) - A pull-down-to-refresh control for iOS that plays pong, originally created for the MHacks III iOS app
*   [CBStoreHouseRefreshControl (⭐4k)](https://github.com/coolbeet/CBStoreHouseRefreshControl) - Fully customizable pull-to-refresh control inspired by Storehouse iOS app
*   [SurfingRefreshControl (⭐55)](https://github.com/peiweichen/SurfingRefreshControl) - Inspired by CBStoreHouseRefreshControl.Customizable pull-to-refresh control,written in pure Swift
*   [mntpulltoreact (⭐779)](https://github.com/mentionapp/mntpulltoreact) - One gesture, many actions. An evolution of Pull to Refresh.
*   [ADChromePullToRefresh (⭐264)](https://github.com/Antondomashnev/ADChromePullToRefresh) - Chrome iOS app style pull to refresh with multiple actions.
...
*   [HTPullToRefresh (⭐43)](https://github.com/hoang-tran/HTPullToRefresh) - Easily add vertical and horizontal pull to refresh to any UIScrollView. Can also add multiple pull-to-refesh views at once.
*   [PullToRefreshSwift (⭐534)](https://github.com/dekatotoro/PullToRefreshSwift) - iOS Simple Cool PullToRefresh Library. It is written in pure swift.
...
*   [ReplaceAnimation (⭐957)](https://github.com/fruitcoder/ReplaceAnimation) - Pull-to-refresh animation in UICollectionView with a sticky header flow layout, written in Swift
...
*   [RainyRefreshControl (⭐679)](https://github.com/Onix-Systems/RainyRefreshControl) - Simple refresh control for iOS inspired by [concept](https://dribbble.com/shots/2242263--1-Pull-to-refresh-Freebie-Weather-Concept).
*   [ESPullToRefresh (⭐1.7k)](https://github.com/eggswift/pull-to-refresh) - Customisable pull-to-refresh, including nice animation on the top
*   [CRRefresh (⭐943)](https://github.com/CRAnimation/CRRefresh) - An easy way to use pull-to-refresh.
...
*   [Cosmos (⭐2k)](https://github.com/evgenyneu/Cosmos) - A star rating control for iOS / Swift
*   [HCSStarRatingView (⭐1.3k)](https://github.com/hsousa/HCSStarRatingView) - Simple star rating view for iOS written in Objective-C
*   [MBRateApp (⭐49)](https://github.com/MatiBot/MBRateApp) - A groovy app rate stars screen for iOS written in Swift
*   [RPInteraction (⭐27)](https://github.com/nbolatov/RPInteraction) - Review page interaction - handy and pretty way to ask for review.

### ScrollView

*   [ScrollingFollowView (⭐184)](https://github.com/ktanaka117/ScrollingFollowView) - ScrollingFollowView is a simple view which follows UIScrollView scrolling.
...
*   [PullToDismiss (⭐479)](https://github.com/sgr-ksmt/PullToDismiss) - You can dismiss modal viewcontroller by pulling scrollview or navigationbar in Swift.
...
*   [CrownControl (⭐95)](https://github.com/huri000/CrownControl) - Inspired by the Apple Watch Digital Crown, CrownControl is a tiny accessory view that enables scrolling through scrollable content without lifting your thumb.
*   [SegementSlide (⭐1.2k)](https://github.com/Jiar/SegementSlide) - Multi-tier UIScrollView nested scrolling solution.

### Segmented Control

*   [BetterSegmentedControl (⭐2k)](https://github.com/gmarm/BetterSegmentedControl) - An easy to use, customizable replacement for UISegmentedControl & UISwitch.
*   [LUNSegmentedControl (⭐346)](https://github.com/Stormotion-Mobile/LUNSegmentedControl) - Customizable segmented control with interactive animation.
*   [AKASegmentedControl (⭐389)](https://github.com/alikaragoz/AKASegmentedControl) - :chocolate\_bar: Fully customizable Segmented Control for iOS.
*   [TwicketSegmentedControl (⭐1.7k)](https://github.com/twicketapp/TwicketSegmentedControl) - Custom UISegmentedControl replacement for iOS, written in Swift.
*   [SJFluidSegmentedControl (⭐893)](https://github.com/sasojadrovski/SJFluidSegmentedControl) - A segmented control with custom appearance and interactive animations. Written in Swift 3.0.
...
*   [MultiSelectSegmentedControl (⭐278)](https://github.com/yonat/MultiSelectSegmentedControl) - adds Multiple-Selection to the standard `UISegmentedControl`.
*   [DynamicMaskSegmentSwitch (⭐309)](https://github.com/KittenYang/DynamicMaskSegmentSwitch) - A segment switcher with dynamic text mask effect
*   [PinterestSegment (⭐669)](https://github.com/TBXark/PinterestSegment) - A Pinterest-like segment control with masking animation.
...
*   [VolumeControl (⭐81)](https://github.com/12Rockets/VolumeControl) - Custom volume control for iPhone featuring a well-designed round slider.
*   [WESlider (⭐89)](https://github.com/Ekhoo/WESlider) - Simple and light weight slider with chapter management
*   [IntervalSlider (⭐65)](https://github.com/shushutochako/IntervalSlider) - IntervalSlider is a slider library like ReutersTV app. written in pure swift.
*   [RangeSlider (⭐303)](https://github.com/warchimede/RangeSlider) - A simple range slider made in Swift
*   [CircleSlider (⭐142)](https://github.com/shushutochako/CircleSlider) - CircleSlider is a Circular slider library. written in pure Swift.
*   [MARKRangeSlider (⭐181)](https://github.com/vadymmarkov/MARKRangeSlider) - A custom reusable slider control with 2 thumbs (range slider).
*   [ASValueTrackingSlider (⭐1.8k)](https://github.com/alskipp/ASValueTrackingSlider) - A UISlider subclass that displays the slider value in a popup view
*   [TTRangeSlider (⭐953)](https://github.com/TomThorpe/TTRangeSlider) - A slider, similar in style to UISlider, but which allows you to pick a minimum and maximum range.
*   [MMSegmentSlider (⭐48)](https://github.com/MedvedevMax/MMSegmentSlider) - Customizable animated slider for iOS.
*   [StepSlider (⭐513)](https://github.com/spromicky/StepSlider) - StepSlider its custom implementation of slider such as UISlider for preset integer values.
*   [JDSlider (⭐84)](https://github.com/JellyDevelopment/JDSlider) - An iOS Slider written in Swift.
*   [SnappingSlider (⭐576)](https://github.com/rehatkathuria/SnappingSlider) - A beautiful slider control for iOS built purely upon Swift
*   [MTCircularSlider (⭐130)](https://github.com/EranBoudjnah/MTCircularSlider) - A feature-rich circular slider control.
...
*   [RangeSeekSlider (⭐631)](https://github.com/WorldDownTown/RangeSeekSlider) - A customizable range slider for iOS.
*   [SectionedSlider (⭐357)](https://github.com/LeonardoCardoso/SectionedSlider) - Control Center Slider.
*   [MultiSlider (⭐308)](https://github.com/yonat/MultiSlider) - UISlider clone with multiple thumbs and values, optional snap intervals, optional value labels.
*   [AGCircularPicker (⭐612)](https://github.com/agilie/AGCircularPicker) - AGCircularPicker is helpful component for creating a controller aimed to manage any calculated parameter.
...
*   [CBZSplashView (⭐1.5k)](https://github.com/callumboddy/CBZSplashView) - Twitter style Splash Screen View. Grows to reveal the Initial view behind.
*   [SKSplashView (⭐476)](https://github.com/sachinkesiraju/SKSplashView) - Create custom animated splash views similar to the ones in the Twitter, Uber and Ping iOS app.
*   [RevealingSplashView (⭐1.2k)](https://github.com/PiXeL16/RevealingSplashView) - A Splash view that animates and reveals its content, inspired by Twitter splash

### Status Bar

*   [Bartinter (⭐1.7k)](https://github.com/MaximKotliar/Bartinter) - Status bar tint depending on content behind, updates dynamically.

### Stepper

*   [PFStepper (⭐25)](https://github.com/PerfectFreeze/PFStepper) - May be the most elegant stepper you have ever had!
*   [ValueStepper (⭐352)](https://github.com/BalestraPatrick/ValueStepper) - A Stepper object that displays its value.
*   [GMStepper (⭐913)](https://github.com/gmertk/GMStepper) - A stepper with a sliding label in the middle.
*   [barceloneta (⭐69)](https://github.com/arn00s/barceloneta) - The right way to increment/decrement values with a simple gesture on iOS.
*   [SnappingStepper (⭐426)](https://github.com/yannickl/SnappingStepper) - An elegant alternative to the UIStepper written in Swift
...
*   [AnimatedSwitch (⭐248)](https://github.com/alsedi/AnimatedSwitch) - UISwitch which paints over the parent view with the color in Swift.
*   [ViralSwitch (⭐337)](https://github.com/andreamazz/ViralSwitch) - A UISwitch that infects its superview with its tint color.
*   [JTMaterialSwitch (⭐318)](https://github.com/JunichiT/JTMaterialSwitch) - A customizable switch UI with ripple effect and bounce animations, inspired from Google's Material Design.
*   [TKSwitcherCollection (⭐902)](https://github.com/TBXark/TKSwitcherCollection) - An animate switch collection
*   [SevenSwitch (⭐779)](https://github.com/bvogelzang/SevenSwitch) - iOS7 style drop in replacement for UISwitch.
*   [PMZSwitch (⭐116)](https://github.com/kovpas/PMZSwitch) - Yet another animated toggle
*   [Switcher (⭐204)](https://github.com/knn90/Switcher) - Swift - Custom UISwitcher with animation when change status
*   [RAMPaperSwitch (⭐2.9k)](https://github.com/Ramotion/paper-switch) - RAMPaperSwitch is a Swift module which paints over the parent view when the switch is turned on.
*   [AIFlatSwitch (⭐959)](https://github.com/cocoatoucher/AIFlatSwitch) - A flat component alternative to UISwitch on iOS
*   [Switch (⭐146)](https://github.com/T-Pham/Switch) - An iOS switch control implemented in Swift with full Interface Builder support.

### Tab Bar

*   [ESTabBarController (⭐122)](https://github.com/ezescaruli/ESTabBarController) - A tab bar controller for iOS that allows highlighting buttons and setting custom actions to them.
*   [GooeyTabbar (⭐929)](https://github.com/KittenYang/GooeyTabbar) - A gooey effect tabbar
...
*   [adaptive-tab-bar (⭐2k)](https://github.com/Ramotion/adaptive-tab-bar) - AdaptiveController is a 'Progressive Reduction' Swift module for adding custom states to Native or Custom iOS UI elements
*   [Pager (⭐234)](https://github.com/lucoceano/Pager) - Easily create sliding tabs with Pager
...
*   [TabDrawer (⭐503)](https://github.com/winslowdibona/TabDrawer) - Customizable TabBar UI element that allows you to run a block of code upon TabBarItem selection, written in Swift
*   [SwipeViewController (⭐654)](https://github.com/fortmarek/SwipeViewController) - SwipeViewController is a Swift modification of RKSwipeBetweenViewControllers - navigate between pages / ViewControllers
*   [ColorMatchTabs (⭐1.4k)](https://github.com/Yalantis/ColorMatchTabs) - Interesting way to display tabs
*   [BATabBarController (⭐1k)](https://github.com/antiguab/BATabBarController) - A TabBarController with a unique animation for selection
*   [ScrollPager (⭐512)](https://github.com/aryaxt/ScrollPager) - A scroll pager that displays a list of tabs (segments) and manages paging between given views
*   [Segmentio (⭐2.4k)](https://github.com/Yalantis/Segmentio) - Animated top/bottom segmented control written in Swift.
*   [KYWheelTabController (⭐121)](https://github.com/ykyouhei/KYWheelTabController) - KYWheelTabController is a subclass of UITabBarController.It displays the circular menu instead of UITabBar.
*   [SuperBadges (⭐55)](https://github.com/odedharth/SuperBadges) - Add emojis and colored dots as badges for your Tab Bar buttons
*   [AZTabBarController (⭐330)](https://github.com/Minitour/AZTabBarController) - A custom tab bar controller for iOS written in Swift 3.0
*   [MiniTabBar (⭐155)](https://github.com/D-32/MiniTabBar) - A clean simple alternative to the UITabBar
*   [SwipeableTabBarController (⭐1.3k)](https://github.com/marcosgriselli/SwipeableTabBarController) - UITabBarController with swipe interaction between its tabs.
*   [SMSwipeableTabView (⭐57)](https://github.com/smahajan28/SMSwipeableTabView) - Swipeable Views with Tabs (Like Android SwipeView With Tabs Layout)
*   [Tabman (⭐2.4k)](https://github.com/uias/Tabman) - A powerful paging view controller with indicator bar for iOS.
*   [WormTabStrip (⭐167)](https://github.com/EzimetYusup/WormTabStrip) Beatiful ViewPager For iOS written in Swift  (inspired by Android [SmartTabLayout (⭐7k)](https://github.com/ogaclejapan/SmartTabLayout))
*   [SSCustomTabMenu (⭐81)](https://github.com/simformsolutions/SSCustomTabMenu) Simple customizable iOS bottom menu with Tabbar.
*   [SmoothTab (⭐105)](https://github.com/yervandsar/SmoothTab) - Smooth customizable tabs for iOS apps.
*   [ExpandedTabBar (⭐255)](https://github.com/yervandsar/ExpandedTabBar) - Very creative designed solution for "more" items in UITabBarController

### Table View / Collection View / Table View

*   [MGSwipeTableCell (⭐6.9k)](https://github.com/MortimerGoro/MGSwipeTableCell) - UITableViewCell subclass that allows to display swippable buttons with a variety of transitions.
...
*   [ConfigurableTableViewController (⭐270)](https://github.com/fastred/ConfigurableTableViewController) - Typed, yet Flexible Table View Controller <https://holko.pl/2016/01/05/typed-table-view-controller/>
*   [Lightning-Table (⭐28)](https://github.com/electrickangaroo/Lightning-Table) - A declarative api for working with UITableView.
*   [Static (⭐1.3k)](https://github.com/venmo/Static) - Simple static table views for iOS in Swift.
*   [AMWaveTransition (⭐2.4k)](https://github.com/andreamazz/AMWaveTransition) - Custom transition between viewcontrollers holding tableviews.
*   [SWTableViewCell (⭐7.2k)](https://github.com/CEWendel/SWTableViewCell) - An easy-to-use UITableViewCell subclass that implements a swippable content view which exposes utility buttons (similar to iOS 7 Mail Application)
*   [ZYThumbnailTableView (⭐950)](https://github.com/liuzhiyi1992/ZYThumbnailTableView) - a TableView have thumbnail cell only, and you can use gesture let it expands other expansionView, all diy
*   [BWSwipeRevealCell (⭐67)](https://github.com/bitwit/BWSwipeRevealCell) - A Swift library for swipeable table cells
*   [preview-transition (⭐2.1k)](https://github.com/Ramotion/preview-transition) - PreviewTransition is a simple preview gallery controller
*   [QuickTableViewController (⭐520)](https://github.com/bcylin/QuickTableViewController) - A simple way to create a UITableView for settings in Swift.
*   [TableKit (⭐696)](https://github.com/maxsokolov/TableKit) - Type-safe declarative table views with Swift
*   [VBPiledView (⭐167)](https://github.com/v-braun/VBPiledView) - Simple and beautiful stacked UIView to use as a replacement for an UITableView, UIImageView or as a menu
*   [VTMagic (⭐1.8k)](https://github.com/tianzhuo112/VTMagic) - VTMagic is a page container library for iOS.
*   [MCSwipeTableViewCell (⭐3k)](https://github.com/alikaragoz/MCSwipeTableViewCell) - :point\_up\_2: Convenient UITableViewCell subclass that implements a swippable content to trigger actions (similar to the Mailbox app).
*   [MYTableViewIndex (⭐519)](https://github.com/mindz-eye/MYTableViewIndex) - A pixel perfect replacement for UITableView section index, written in Swift
*   [ios-dragable-table-cells (⭐49)](https://github.com/palmin/ios-dragable-table-cells) - Support for drag-n-drop of UITableViewCells in a navigation hierarchy of view controllers. You drag cells by tapping and holding them.
*   [Bohr (⭐1.3k)](https://github.com/DavdRoman/Bohr) - Bohr allows you to set up a settings screen for your app with three principles in mind: ease, customization and extensibility.
*   [SwiftReorder (⭐374)](https://github.com/adamshin/SwiftReorder) - Add drag-and-drop reordering to any table view with just a few lines of code. Robust, lightweight, and completely customizable. \[e]
*   [HoverConversion (⭐166)](https://github.com/marty-suzuki/HoverConversion) - HoverConversion realized vertical paging with UITableView. UIViewController will be paging when reaching top or bottom of UITableView contentOffset.
*   [TableViewDragger (⭐514)](https://github.com/KyoheiG3/TableViewDragger) - A cells of UITableView can be rearranged by drag and drop.
...
*   [CascadingTableDelegate (⭐922)](https://github.com/edopelawi/CascadingTableDelegate) - A no-nonsense way to write cleaner UITableViewDelegate and UITableViewDataSource in Swift.
*   [TimelineTableViewCell (⭐1.3k)](https://github.com/kf99916/TimelineTableViewCell) - Simple timeline view implemented by UITableViewCell written in Swift 3.0.
...
*   [TORoundedTableView (⭐161)](https://github.com/TimOliver/TORoundedTableView) - A subclass of UITableView that styles it like Settings.app on iPad
*   [TableFlip (⭐555)](https://github.com/mergesort/TableFlip) - A simpler way to do cool UITableView animations! (╯°□°）╯︵ ┻━┻
...
*   [SwipeCellKit (⭐5.9k)](https://github.com/SwipeCellKit/SwipeCellKit) - Swipeable UITableViewCell based on the stock Mail.app, implemented in Swift.
...
*   [SAInboxViewController (⭐298)](https://github.com/marty-suzuki/SAInboxViewController) - UIViewController subclass inspired by "Inbox by google" animated transitioning.
*   [StaticTableViewController (⭐26)](https://github.com/muyexi/StaticTableViewController) - Dynamically hide / show cells of static UITableViewController.
*   [OKTableViewLiaison (⭐84)](https://github.com/okcupid/OKTableViewLiaison) - Framework to help you better manage UITableView configuration.
*   [ThunderTable (⭐20)](https://github.com/3sidedcube/ThunderTable) - A simple declarative approach to UITableViewController management using a protocol-based approach.

### Table View / Collection View / Collection View

*   [Dwifft (⭐1.8k)](https://github.com/jflinter/Dwifft) - Swift Diff
*   [MEVFloatingButton (⭐298)](https://github.com/manuelescrig/MEVFloatingButton) - An iOS drop-in UITableView, UICollectionView and UIScrollView superclass category for showing a customizable floating button on top of it.
*   [Preheat (⭐633)](https://github.com/kean/Preheat) - Automates prefetching of content in UITableView and UICollectionView
*   [DisplaySwitcher (⭐2.3k)](https://github.com/Yalantis/DisplaySwitcher) - Custom transition between two collection view layouts
*   [Reusable (⭐2.9k)](https://github.com/AliSoftware/Reusable) - A Swift mixin for UITableViewCells and UICollectionViewCells
*   [Sapporo (⭐245)](https://github.com/nghialv/Sapporo) - Cellmodel-driven collectionview manager
*   [StickyCollectionView-Swift (⭐325)](https://github.com/matbeich/StickyCollectionView-Swift) - UICollectionView layout for presenting of the overlapping cells.
*   [TLIndexPathTools (⭐347)](https://github.com/SwiftKickMobile/TLIndexPathTools) - TLIndexPathTools is a small set of classes that can greatly simplify your table and collection views.
*   [IGListKit (⭐12k)](https://github.com/Instagram/IGListKit) - A data-driven UICollectionView framework for building fast and flexible lists.
...
*   [GLTableCollectionView (⭐710)](https://github.com/giulio92/GLTableCollectionView) - Netflix and App Store like UITableView with UICollectionView
*   [EditDistance (⭐90)](https://github.com/kazuhiro4949/EditDistance) - Incremental update tool for UITableView and UICollectionView
*   [SwiftSpreadSheet (⭐635)](https://github.com/stuffrabbit/SwiftSpreadsheet) - Spreadsheet CollectionViewLayout in Swift. Fully customizable.
*   [GenericDataSource (⭐132)](https://github.com/GenericDataSource/GenericDataSource) - A generic small reusable components for data source implementation for UITableView/UICollectionView in Swift.
*   [PagingView (⭐313)](https://github.com/KyoheiG3/PagingView) - Infinite paging, Smart auto layout, Interface of similar to UIKit.
*   [PJFDataSource (⭐88)](https://github.com/square/PJFDataSource) - PJFDataSource is a small library that provides a simple, clean architecture for your app to manage its data sources while providing a consistent user interface for common content states (i.e. loading, loaded, empty, and error).
*   [DataSources (⭐560)](https://github.com/muukii/DataSources) - Type-safe data-driven List-UI Framework. (We can also use ASCollectionNode)
*   [KDDragAndDropCollectionView (⭐501)](https://github.com/mmick66/KDDragAndDropCollectionView) - Dragging & Dropping data across multiple UICollectionViews.
...
*   [CampcotCollectionView (⭐170)](https://github.com/touchlane/CampcotCollectionView) - CampcotCollectionView is a custom UICollectionView written in Swift that allows to expand and collapse sections. It provides a simple API to manage collection view appearance.
*   [Stefan (⭐47)](https://github.com/appunite/Stefan) - A guy that helps you manage collections and placeholders in easy way.
*   [Parade (⭐767)](https://github.com/HelloElephant/Parade) - Parallax Scroll-Jacking Effects Engine for iOS / tvOS.
*   [MSPeekCollectionViewDelegateImplementation (⭐354)](https://github.com/MaherKSantina/MSPeekCollectionViewDelegateImplementation) - A custom paging behavior that peeks the previous and next items in a collection view.
...
*   [ThunderCollection (⭐3)](https://github.com/3sidedcube/ThunderCollection) - A simple declarative approach to UICollectionViewController management using a protocol-based approach.
...
*   [AEAccordion (⭐211)](https://github.com/tadija/AEAccordion) - UITableViewController with accordion effect (expand / collapse cells).
...
*   [CollapsibleTableSectionViewController (⭐348)](https://github.com/jeantimex/CollapsibleTableSectionViewController) - A swift library to support collapsible sections in a table view.
*   [ExpandableCell (⭐711)](https://github.com/younatics/ExpandableCell) - Fully refactored YNExapnadableCell with more concise, bug free. Awesome expandable, collapsible tableview cell for iOS.
...
### Table View / Collection View / Header

*   [ParallaxTableViewHeader (⭐1.3k)](https://github.com/Vinodh-G/ParallaxTableViewHeader) - Parallax scrolling effect on UITableView header view when a tableView is scrolled.
*   [CSStickyHeaderFlowLayout (⭐5.1k)](https://github.com/CSStickyHeaderFlowLayout/CSStickyHeaderFlowLayout) - UICollectionView replacement of UITableView. Do even more like Parallax Header, Sticky Section Header.
*   [GSKStretchyHeaderView (⭐1.7k)](https://github.com/gskbyte/GSKStretchyHeaderView) - Configurable yet easy to use stretchy header view for UITableView and UICollectionView.

### Table View / Collection View / Placeholder
...
*   [HGPlaceholders (⭐2.1k)](https://github.com/HamzaGhazouani/HGPlaceholders) - Nice library to show and create placeholders and Empty States for any UITableView/UICollectionView in your project
*   [ListPlaceholder (⭐626)](https://github.com/malkouz/ListPlaceholder) - ListPlaceholder is a swift library allows you to easily add facebook style animated loading placeholder to your tableviews or collection views
...
### Table View / Collection View / Collection View Layout

*   [CHTCollectionViewWaterfallLayout (⭐4.4k)](https://github.com/chiahsien/CHTCollectionViewWaterfallLayout) - The waterfall (i.e., Pinterest-like) layout for UICollectionView.
*   [FMMosaicLayout (⭐591)](https://github.com/fmitech/FMMosaicLayout) - A drop-in mosaic collection view layout with a focus on simple customizations.
*   [mosaic-layout (⭐254)](https://github.com/vinnyoodles/mosaic-layout) - A mosaic collection view layout inspired by Lightbox's Algorithm, written in Swift
*   [TLLayoutTransitioning (⭐358)](https://github.com/SwiftKickMobile/TLLayoutTransitioning) - Enhanced transitioning between UICollectionView layouts in iOS.
*   [CenteredCollectionView (⭐1.2k)](https://github.com/BenEmdon/CenteredCollectionView) - A lightweight UICollectionViewLayout that *'pages'* and centers it's cells 🎡 written in Swift.
*   [CollectionViewSlantedLayout (⭐2.1k)](https://github.com/yacir/CollectionViewSlantedLayout) - UICollectionViewLayout with slanted content
*   [SquareMosaicLayout (⭐253)](https://github.com/iwheelbuy/SquareMosaicLayout) - An extandable mosaic UICollectionViewLayout with a focus on extremely flexible customizations
*   [BouncyLayout (⭐4.1k)](https://github.com/roberthein/BouncyLayout) - BouncyLayout is a collection view layout that makes your cells bounce.
*   [AZSafariCollectionViewLayout (⭐209)](https://github.com/AfrozZaheer/AZSafariCollectionViewLayout) - AZSafariCollectionViewLayout is replica of safari browser history page layout. very easy to use, IBInspectable are given for easy integration.
...
*   [Swinflate (⭐225)](https://github.com/VladIacobIonut/Swinflate) -  A bunch of layouts providing light and seamless experiences in your CollectionView.

### Tag / Collection View Layout

*   [PARTagPicker (⭐371)](https://github.com/paulrolfe/PARTagPicker) - This pod provides a view controller for choosing and creating tags in the style of wordpress or tumblr.
*   [AMTagListView (⭐767)](https://github.com/andreamazz/AMTagListView) - UIScrollView subclass that allows to add a list of highly customizable tags.
...
*   [TTGTagCollectionView (⭐1.7k)](https://github.com/zekunyan/TTGTagCollectionView) - Show simple text tags or custom tag views in a vertical scrollable view.
*   [TagListView (⭐2.5k)](https://github.com/ElaWorkshop/TagListView) - Simple and highly customizable iOS tag list view, in Swift.
*   [RKTagsView (⭐450)](https://github.com/kuler90/RKTagsView) - Highly customizable iOS tags view (like NSTokenField). Supports editing, multiple selection, Auto Layout and much more.
*   [WSTagsField (⭐1.2k)](https://github.com/whitesmith/WSTagsField) - An iOS text field that represents different Tags.
*   [AKMaskField (⭐347)](https://github.com/artemkrachulov/AKMaskField) - AKMaskField is UITextField subclass which allows enter data in the fixed quantity and in the certain format.
...
*   [SFFocusViewLayout (⭐1.8k)](https://github.com/fdzsergio/SFFocusViewLayout) - UICollectionViewLayout with focused content.

### TextField & TextView / Collection View Layout

*   [JVFloatLabeledTextField (⭐7.2k)](https://github.com/jverdi/JVFloatLabeledTextField) - UITextField subclass with floating labels.
...
*   [UITextField-Shake (⭐748)](https://github.com/andreamazz/UITextField-Shake) - UITextField category that adds shake animation. [Also with Swift version (⭐15)](https://github.com/King-Wizard/UITextField-Shake-Swift)
*   [HTYTextField (⭐313)](https://github.com/hanton/HTYTextField) - A UITextField with bouncy placeholder.
*   [MVAutocompletePlaceSearchTextField (⭐68)](https://github.com/TheMrugraj/MVAutocompletePlaceSearchTextField) - A drop-in Autocompletion control for Place Search like Google Places, Uber, etc.
*   [AutocompleteField (⭐661)](https://github.com/filipstefansson/AutocompleteField) - Add word completion to your UITextFields.
*   [RSKGrowingTextView (⭐940)](https://github.com/ruslanskorb/RSKGrowingTextView) - A light-weight UITextView subclass that automatically grows and shrinks.
*   [RSKPlaceholderTextView (⭐217)](https://github.com/ruslanskorb/RSKPlaceholderTextView) - A light-weight UITextView subclass that adds support for placeholder.
...
*   [Reel Search (⭐2.5k)](https://github.com/Ramotion/reel-search) - RAMReel is a controller that allows you to choose options from a list.
*   [MLPAutoCompleteTextField (⭐1.2k)](https://github.com/EddyBorja/MLPAutoCompleteTextField) - a subclass of UITextField that behaves like a typical UITextField with one notable exception: it manages a drop down table of autocomplete suggestions that update as the user types.
*   [SkyFloatingLabelTextField (⭐4k)](https://github.com/Skyscanner/SkyFloatingLabelTextField) - A beautiful and flexible text field control implementation of "Float Label Pattern". Written in Swift.
*   [VMaskTextField (⭐384)](https://github.com/viniciusmo/VMaskTextField) - VMaskTextField is a library which create an input mask for iOS.
...
*   [RPFloatingPlaceholders (⭐1.1k)](https://github.com/iwasrobbed/RPFloatingPlaceholders) - UITextField and UITextView subclasses with placeholders that change into floating labels when the fields are populated with text.
*   [CurrencyTextField (⭐49)](https://github.com/richa008/CurrencyTextField) - UITextField that automatically formats text to display in the currency format.
...
*   [PLCurrencyTextField (⭐97)](https://github.com/nonameplum/PLCurrencyTextField) - UITextField that support currency in the right way.
...
*   [KMPlaceholderTextView (⭐793)](https://github.com/MoZhouqi/KMPlaceholderTextView) - A UITextView subclass that adds support for multiline placeholder written in Swift.
...
*   [AwesomeTextField (⭐223)](https://github.com/aleksandrshoshiashvili/AwesomeTextFieldSwift) - Awesome TextField is a nice and simple library for iOS. It's highly customisable and easy-to-use tool. Works perfectly for any registration or login forms in your app.
*   [ModernSearchBar (⭐178)](https://github.com/PhilippeBoisney/ModernSearchBar) - The famous iOS search bar with auto completion feature implemented.
*   [SelectableTextView (⭐635)](https://github.com/jhurray/SelectableTextView) - A text view that supports selection and expansion.
*   [CBPinEntryView (⭐185)](https://github.com/Fawxy/CBPinEntryView) - A customisable view written in Swift 4.2 for any pin, code or password entry. Supports one time codes in iOS 12.
*   [GrowingTextView (⭐926)](https://github.com/KennethTsang/GrowingTextView) - An UITextView in Swift3 and Swift2.3. Support auto growing, placeholder and length limit.
*   [DTTextField (⭐303)](https://github.com/iDhaval/DTTextField) - DTTextField is a custom textfield with floating placeholder and error label in Swift3.0.
*   [TextFieldCounter (⭐433)](https://github.com/serralvo/TextFieldCounter) - UITextField character counter with lovable UX.
*   [RSFloatInputView (⭐104)](https://github.com/roytornado/RSFloatInputView) - A Float Input View with smooth animation and supporting icon and seperator written with Swift.
...
*   [InstantSearch iOS (⭐552)](https://github.com/algolia/instantsearch-ios) - A library of widgets and helpers to build instant-search applications on iOS.
*   [SearchTextField (⭐1.1k)](https://github.com/apasccon/SearchTextField) - UITextField subclass with autocompletion suggestions list.
*   [PYSearch (⭐3.8k)](https://github.com/ko1o/PYSearch) - An elegant search controller which replaces the UISearchController for iOS (iPhone & iPad).
*   [styled-text (⭐233)](https://github.com/blueapron/styled-text) - Declarative text styles and streamlined Dynamic Type support for iOS.
*   [TweeTextField (⭐469)](https://github.com/oleghnidets/TweeTextField) - Lightweight set of text fields with nice animation and functionality.
*   [MeasurementTextField (⭐16)](https://github.com/SiarheiFedartsou/MeasurementTextField) - UITextField-based control for (NS)Measurement values input.
...
### Web View / Collection View Layout

*   [Otafuku (⭐52)](https://github.com/tasanobu/Otafuku) - Otafuku provides utility classes to use WKWebView in Swift.
*   [SwiftWebVC (⭐313)](https://github.com/meismyles/SwiftWebVC) - A drop-in inline browser for your Swift iOS app.
*   [SVWebViewController (⭐2.6k)](https://github.com/TransitApp/SVWebViewController) - A drop-in inline browser for your iOS app.
*   [PTPopupWebView (⭐116)](https://github.com/pjocprac/PTPopupWebView) - PTPopupWebView is a simple and useful WebView for iOS, which can be popup and has many of the customized item.
...
*   [SmartlookConsentSDK (⭐183)](https://github.com/smartlook/ios-consent-sdk) - Open source SDK which provides a configurable control panel where user can select their privacy options and store the user preferences for the app.
...
*   [360 VR Player (⭐2k)](https://github.com/hanton/HTY360Player) - A open source, ad-free, native and universal 360 degree panorama video player for iOS.
*   [simple360player (⭐153)](https://github.com/Aralekk/simple360player_iOS) - Free & ad-free 360 VR Video Player. Flat or Stereoscopic. In Swift 2.
*   [Swifty360Player (⭐144)](https://github.com/abdullahselek/Swifty360Player) - iOS 360-degree video player streaming from an AVPlayer with Swift.

### Walkthrough / Intro / Tutorial / Collection View Layout

*   [Onboard (⭐6.5k)](https://github.com/mamaral/Onboard) - Easily create a beautiful and engaging onboarding experience with only a few lines of code.
*   [EAIntroView (⭐3.8k)](https://github.com/ealeksandrov/EAIntroView) - Highly customizable drop-in solution for introduction views.
*   [MYBlurIntroductionView (⭐1.5k)](https://github.com/MatthewYork/MYBlurIntroductionView) - A super-charged version of MYIntroductionView for building custom app introductions and tutorials.
*   [BWWalkthrough (⭐2.8k)](https://github.com/ariok/BWWalkthrough) - A class to build custom walkthroughs for your iOS App.
*   [GHWalkThrough (⭐718)](https://github.com/GnosisHub/GHWalkThrough) - A UICollectionView backed drop-in component for introduction views.
*   [ICETutorial (⭐798)](https://github.com/icepat/ICETutorial) - A nice tutorial like the one introduced in the Path 3.X App.
*   [JazzHands (⭐6.5k)](https://github.com/IFTTT/JazzHands) - Jazz Hands is a simple keyframe-based animation framework for UIKit. Animations can be controlled via gestures, scroll views, KVO, or ReactiveCocoa.
*   [RazzleDazzle (⭐3.4k)](https://github.com/IFTTT/RazzleDazzle) - A simple keyframe-based animation framework for iOS, written in Swift. Perfect for scrolling app intros.
*   [Instructions (⭐4.9k)](https://github.com/ephread/Instructions) - Easily add customizable coach marks into you iOS project.
*   [SwiftyWalkthrough (⭐368)](https://github.com/ruipfcosta/SwiftyWalkthrough) - The easiest way to create a great walkthrough experience in your apps, powered by Swift.
...
*   [Presentation (⭐3k)](https://github.com/hyperoslo/Presentation) - Presentation helps you to make tutorials, release notes and animated pages.
*   [AMPopTip (⭐3k)](https://github.com/andreamazz/AMPopTip) - An animated popover that pops out a given frame, great for subtle UI tips and onboarding.
*   [AlertOnboarding (⭐822)](https://github.com/PhilippeBoisney/AlertOnboarding) - A simple and handsome AlertView for onboard your users in your amazing world.
*   [EasyTipView (⭐2.9k)](https://github.com/teodorpatras/EasyTipView) - Fully customisable tooltip view in Swift.
...
*   [AwesomeSpotlightView (⭐308)](https://github.com/aleksandrshoshiashvili/AwesomeSpotlightView) - Tool to create awesome tutorials or educate user to use application. Or just highlight something on screen. Written in Swift.
...
*   [Material Showcase iOS (⭐346)](https://github.com/aromajoin/material-showcase-ios) - An elegant and beautiful showcase for iOS apps.
...
*   [Swift-ActionCableClient (⭐160)](https://github.com/danielrhodes/Swift-ActionCableClient) - ActionCable is a new WebSocket server being released with Rails 5 which makes it easy to add real-time features to your app.
...
*   [crafter (⭐550)](https://github.com/krzysztofzablocki/crafter) - CLI that allows you to configure iOS project's template using custom DSL syntax, simple to use and quite powerful.
*   [liftoff (⭐1.6k)](https://github.com/liftoffcli/liftoff) - Another CLI for creating iOS projects.
*   [amaro (⭐387)](https://github.com/crushlovely/Amaro) - iOS Boilerplate full of delights.
*   [chairs (⭐228)](https://github.com/orta/chairs) - Swap around your iOS Simulator Documents.
*   [SwiftPlate (⭐1.8k)](https://github.com/JohnSundell/SwiftPlate) - Easily generate cross platform Swift framework projects from the command line.
*   [xcproj (⭐1.7k)](https://github.com/tuist/xcodeproj) - Read and update Xcode projects.
*   [Tuist (⭐3k)](https://github.com/tuist/tuist) - A tool to create, maintain and interact with Xcode projects at scale.
...
*   [SWM (Swift Modules) (⭐60)](https://github.com/jankuca/swm) - A package/dependency manager for Swift projects similar to npm (node.js package manager) or bower (browser package manager from Twitter). Does not require the use of Xcode.
*   [CocoaSeeds (⭐342)](https://github.com/devxoul/CocoaSeeds) - Git Submodule Alternative for Cocoa.
...
*   [Shark (⭐375)](https://github.com/kaandedeoglu/Shark) - Swift Script that transforms the .xcassets folder into a type safe enum.
*   [SBConstants (⭐310)](https://github.com/paulsamuels/SBConstants) - Generate a constants file by grabbing identifiers from storyboards in a project.
*   [R.swift (⭐8.8k)](https://github.com/mac-cain13/R.swift) - Tool to get strong typed, autocompleted resources like images, cells and segues in your Swift project.
*   [SwiftGen (⭐8.3k)](https://github.com/SwiftGen/SwiftGen) - A collection of Swift tools to generate Swift code (enums for your assets, storyboards, Localizable.strings and UIColors).
*   [Blade (⭐823)](https://github.com/jondot/blade) - Generate Xcode image catalogs for iOS / macOS app icons, universal images, and more.
*   [Retini (⭐199)](https://github.com/terwanerik/Retini) - A super simple retina (2x, 3x) image converter.
*   [Jazzy (⭐7.2k)](https://github.com/realm/jazzy) - Soulful docs for Swift & Objective-C.
...
*   [StoryboardMerge (⭐238)](https://github.com/marcinolawski/StoryboardMerge) - Xcode storyboards diff and merge tool.
*   [ai2app (⭐73)](https://github.com/metasmile/ai2appiconset) - Creating AppIcon sets from Adobe Illustrator (all supported formats).
*   [ViewMonitor (⭐728)](https://github.com/daisuke0131/ViewMonitor) - ViewMonitor can measure view positions with accuracy.
*   [abandoned-strings (⭐359)](https://github.com/ijoshsmith/abandoned-strings) - Command line program that detects unused resource strings in an iOS or macOS application.
*   [swiftenv (⭐1.9k)](https://github.com/kylef/swiftenv) - swiftenv allows you to easily install, and switch between multiple versions of Swift.
...
*   [Delta (⭐246)](https://github.com/thoughtbot/Delta) - Managing state is hard. Delta aims to make it simple.
*   [SwiftLintXcode (⭐348)](https://github.com/ypresto/SwiftLintXcode) - An Xcode plug-in to format your code using SwiftLint.
...
*   [Kin (⭐845)](https://github.com/Karumi/Kin) - Have you ever found yourself undoing a merge due to a broken Xcode build? Then Kin is your tool. It will parse your project configuration file and detect errors.
...
*   [SourceKitten (⭐2.1k)](https://github.com/jpsim/SourceKitten) - An adorable little framework and command line tool for interacting with SourceKit.
...
*   [Realm Browser (⭐498)](https://github.com/realm/realm-browser-osx) - Realm Browser is a macOS utility to open and modify realm database files.
*   [SuperDelegate (⭐455)](https://github.com/square/SuperDelegate) – SuperDelegate provides a clean application delegate interface and protects you from bugs in the application lifecycle.
*   [fastlane-plugin-appicon (⭐330)](https://github.com/fastlane-community/fastlane-plugin-appicon) - Generate required icon sizes and iconset from a master application icon.
*   [infer (⭐14k)](https://github.com/facebook/infer) - A static analyzer for Java, C and Objective-C.
...
*   [xcenv (⭐246)](https://github.com/xcenv/xcenv) - Groom your Xcode environment.
*   [playgroundbook (⭐259)](https://github.com/playgroundbooks/playgroundbook) - Tool for Swift Playground books.
*   [Ecno (⭐97)](https://github.com/xmartlabs/Ecno) - Ecno is a task state manager built on top of UserDefaults in pure Swift 3.
...
*   [FBSimulatorControl (⭐3.9k)](https://github.com/facebook/idb) - A macOS library for managing and manipulating iOS Simulators
...
*   [Sourcery (⭐6.8k)](https://github.com/krzysztofzablocki/Sourcery) - A tool that brings meta-programming to Swift, allowing you to code generate Swift code.
*   [AssetChecker 👮 (⭐200)](https://github.com/freshOS/AssetChecker) - Keeps your Assets.xcassets files clean and emits warnings when something is suspicious.
*   [PlayAlways (⭐537)](https://github.com/insidegui/PlayAlways) - Create Xcode playgrounds from your menu bar
*   [GDPerformanceView-Swift (⭐2.2k)](https://github.com/dani-gavrilov/GDPerformanceView-Swift) - Shows FPS, CPU usage, app and iOS versions above the status bar and report FPS and CPU usage via delegate.
*   [Traits (⭐909)](https://github.com/krzysztofzablocki/Traits) - Library for a real-time design and behavior modification of native iOS apps without recompiling (code and interface builder changes are supported).
...
*   [Gluten (⭐8)](https://github.com/wilbertliu/Gluten) - Nano library to unify XIB and it's code.
*   [LicensePlist (⭐2.2k)](https://github.com/mono0926/LicensePlist) - A license list generator of all your dependencies for iOS applications.
...
*   [Tweaks (⭐4.8k)](https://github.com/facebook/Tweaks) - An easy way to fine-tune, and adjust parameters for iOS apps in development.
*   [FengNiao (⭐3k)](https://github.com/onevcat/FengNiao) - A command line tool for cleaning unused resources in Xcode.
*   [LifetimeTracker (⭐2.7k)](https://github.com/krzysztofzablocki/LifetimeTracker) - Find retain cycles / memory leaks sooner.
*   [Plank (⭐463)](https://github.com/pinterest/plank) - A tool for generating immutable model objects.
...
*   [XcodeGen (⭐5.7k)](https://github.com/yonaskolb/XcodeGen) - Command line tool that generates your Xcode project from a spec file and your folder structure.
...
*   [Transformer (⭐284)](https://github.com/andresinaka/transformer) - Easy Online Attributed String Creator. This tool lets you format a string directly in the browser and then copy/paste the attributed string code into your app.
*   [ProvisionQL (⭐2.1k)](https://github.com/ealeksandrov/ProvisionQL) - Quick Look plugin for apps and provisioning profile files.
*   [xib2Storyboard (⭐131)](https://github.com/novemberfiveco/xib2Storyboard) - A tool to convert Xcode .xib to .storyboard files.
*   [Zolang (⭐138)](https://github.com/Zolang/Zolang) - A programming language for sharing logic between iOS, Android and Tools.
*   [xavtool (⭐32)](https://github.com/gabrielrobert/xavtool) - Command-line utility to automatically increase iOS / Android applications version.
...
*   [nef (⭐254)](https://github.com/bow-swift/nef) - A set of command line tools for Xcode Playground: lets you have compile-time verification of your documentation written as Xcode Playgrounds, generates markdown files, integration with Jekyll for building microsites and Carbon to export code snippets.

### Rapid Development / Collection View Layout

*   [Playgrounds (⭐2.6k)](https://github.com/krzysztofzablocki/Playgrounds) - Playgrounds for Objective-C for extremely fast prototyping / learning.
...
*   [Model2App (⭐129)](https://github.com/Q-Mobile/Model2App) - Turn your Swift data model into a working CRUD app.

### Code Injection / Collection View Layout

*   [dyci (⭐1.1k)](https://github.com/DyCI/dyci-main) - Code injection tool.
*   [injectionforxcode (⭐6.5k)](https://github.com/johnno1962/injectionforxcode) - Code injection including Swift.
*   [Vaccine (⭐297)](https://github.com/zenangst/Vaccine) - Vaccine is a framework that aims to make your apps immune to recompile-decease.
...
*   [Reliant (⭐52)](https://github.com/appfoundry/Reliant) - Nonintrusive Objective-C dependency injection.
*   [Kraken (⭐1)](https://github.com/sabirvirtuoso/Kraken) - A Dependency Injection Container for Swift with easy-to-use syntax.
*   [Cleanse (⭐1.7k)](https://github.com/square/Cleanse) - Lightweight Swift Dependency Injection Framework by Square.
...
### App Store / Collection View Layout
...
*   [App Release Checklist (⭐781)](https://github.com/oisin/app-release-checklist/blob/master/checklist.md) - A checklist to pore over before you ship that amazing app that has taken ages to complete, but you don't want to rush out in case you commit a schoolboy error that will end up making you look dumber than you are.
*   [Harpy (⭐2.6k)](https://github.com/ArtSabintsev/Harpy) - Notify users when a new version of your iOS app is available, and prompt them with the App Store link.
*   [appirater (⭐4.7k)](https://github.com/arashpayan/appirater) - A utility that reminds your iPhone app's users to review the app.
...
*   [Appstore Review Guidelines (⭐13)](https://github.com/aashishtamsya/Appstore-Review-Guidelines) - A curated list of points which a developer has to keep in mind before submitting his/her application on appstore for review.
*   [AppVersion (⭐31)](https://github.com/amebalabs/AppVersion) - Keep users on the up-to date version of your App.
...
### Themes / Collection View Layout

*   [Dracula Theme](https://draculatheme.com/xcode/) - A dark theme for Xcode.
*   [Xcode themes list (⭐2.3k)](https://github.com/hdoria/xcode-themes) - Color themes for Xcode.
*   [Solarized-Dark-for-Xcode (⭐363)](https://github.com/ArtSabintsev/Solarized-Dark-for-Xcode/) - Solarized Dark Theme for Xcode 5.
*   [WWDC2016 Xcode Color Scheme (⭐408)](https://github.com/cargath/WWDC2016-Xcode-Color-Scheme) - A color scheme for Xcode based on the WWDC 2016 invitation.
*   [DRL Theme (⭐18)](https://github.com/durul/Xcodetheme) - A soft darkness theme for Xcode.
...
*   [Synx (⭐6.1k)](https://github.com/venmo/synx) - A command-line tool that reorganizes your Xcode project folder to match your Xcode groups.
*   [dsnip (⭐14)](https://github.com/Tintenklecks/IBDelegateCodesippets) - Tool to generate (native) Xcode code snippets from all protocols/delegate methods of UIKit (UITableView, ...)
...
*   [swift-project-template (⭐86)](https://github.com/artemnovichkov/swift-project-template) - Template for iOS Swift project generation.
...
*   [XcodeCodeSnippets (⭐33)](https://github.com/ismetanin/XcodeCodeSnippets) - A set of code snippets for iOS development, includes code and comments snippets.
...
*   [Swift Cheat Sheet (⭐950)](https://github.com/iwasrobbed/Swift-CheatSheet) - A quick reference cheat sheet for common, high level topics in Swift.
*   [Objective-C Cheat Sheet (⭐1.3k)](https://github.com/iwasrobbed/Objective-C-CheatSheet) - A quick reference cheat sheet for common, high level topics in Objective-C.
...
*   [NY Times - Objective C Style Guide (⭐5.8k)](https://github.com/NYTimes/objective-c-style-guide) - The Objective-C Style Guide used by The New York Times.
*   [raywenderlich Style Guide (⭐3.1k)](https://github.com/raywenderlich/objective-c-style-guide) - A style guide that outlines the coding conventions for raywenderlich.com.
*   [GitHub Objective-C Style Guide (⭐1.7k)](https://github.com/github/objective-c-style-guide) - Style guide & coding conventions for Objective-C projects.
*   [Objective-C Coding Convention and Best Practices](https://gist.github.com/soffes/812796) - Gist with coding conventions.
*   [Swift Style Guide by @raywenderlich (⭐12k)](https://github.com/raywenderlich/swift-style-guide) - The official Swift style guide for raywenderlich.com.
*   [Spotify Objective-C Coding Style (⭐238)](https://github.com/spotify/ios-style) - Guidelines for iOS development in use at Spotify.
*   [GitHub - Style guide & coding conventions for Swift projects (⭐4.7k)](https://github.com/github/swift-style-guide) - A guide to our Swift style and conventions by @github.
*   [Futurice iOS Good Practices (⭐11k)](https://github.com/futurice/ios-good-practices) - iOS starting guide and good practices suggestions by [@futurice](https://github.com/futurice).
...
*   [Prolific Interactive Style Guide (⭐171)](https://github.com/prolificinteractive/swift-style-guide) - A style guide for Swift.
*   [Swift Style Guide by LinkedIn (⭐1.4k)](https://github.com/linkedin/swift-style-guide) - LinkedIn's Official Swift Style Guide.
...
*   [iOS8-day-by-day (⭐2.6k)](https://github.com/ScottLogic/iOS8-day-by-day)
*   [iOScreator](https://www.ioscreator.com/)
*   [Mathew Sanders](http://mathewsanders.com/)
*   [iOS Dev Nuggets](http://hboon.com/iosdevnuggets/)
*   [iOS Developer and Designer interview (⭐1.6k)](https://github.com/9magnets/iOS-Developer-and-Designer-Interview-Questions) - A small guide to help those looking to hire a developer or designer for iOS work.
*   [iOS9-day-by-day (⭐1.4k)](https://github.com/ScottLogic/iOS9-day-by-day)
*   [Code Facebook](https://engineering.fb.com/category/ios/)
*   [Feeds for iOS Developer (⭐105)](https://github.com/rgnlax/Feeds-for-iOS-Developer) - The list of RSS feeds for iOS developers.
*   [Cocoa Controls](https://www.cocoacontrols.com/) - Open source UI components for iOS and macOS.

### UIKit references / Collection View Layout

*   [iOS Fonts](http://iosfonts.com/)
*   [UIAppearance list](https://gist.github.com/mattt/5135521)

### Forums and discuss lists / Collection View Layout
...
*   [learn-swift (⭐780)](https://github.com/nettlep/learn-swift) - Learn Apple's Swift programming language interactively through these playgrounds.
...
### Twitter / Collection View Layout
...
*   [awesome-awesomeness (⭐29k)](https://github.com/bayandin/awesome-awesomeness) list.
...
*   Awesome-swift
    ...
    *   [Awesome-Swift-Education (⭐5.5k)](https://github.com/hsavit1/Awesome-Swift-Education) - All of the resources for Learning About Swift.
*   [awesome watchkit apps (⭐241)](https://github.com/sanketfirodiya/sample-watchkit-apps) curated list of sample watchkit apps and tutorials.
*   [iOS Learning Resources (⭐439)](https://github.com/sanketfirodiya/iOS-learning-resources) Comprehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.
...
*   [awesome-ios-chart (⭐1.5k)](https://github.com/ameizi/awesome-ios-chart) - A curated list of awesome iOS chart libraries, including Objective-C and Swift.
*   [awesome-gists (⭐523)](https://github.com/vsouza/awesome-gists#ios) - A list of amazing gists (iOS section).
*   [awesome-ios-ui (⭐11k)](https://github.com/cjwirth/awesome-ios-ui) - A curated list of awesome iOS UI/UX libraries.
...
*   [awesome-interview-questions (⭐51k)](https://github.com/MaximAbramchuck/awesome-interview-questions#ios) - A curated awesome list of lists of interview questions including iOS.
*   [iOS-Playbook (⭐341)](https://github.com/bakkenbaeck/iOS-handbook) - Guidelines and best practices for excellent iOS apps.
*   [iOS-Learning-Materials (⭐1.8k)](https://github.com/jVirus/iOS-Learning-Materials) - Curated list of articles, web-resources, tutorials and code repositories that may help you dig a little bit deeper into iOS.
...
*   [Awesome ARKit (⭐7.4k)](https://github.com/olucurious/Awesome-ARKit) - A curated list of awesome ARKit projects and resources.
*   [CocoaConferences (⭐1k)](https://github.com/Lascorbe/CocoaConferences) - List of cocoa conferences for iOS & macOS developers.
*   [example-ios-apps (⭐718)](https://github.com/jogendra/example-ios-apps) - A curated list of Open Source example iOS apps developed in Swift.
...
*   [Awesome list of open source applications for macOS (⭐33k)](https://github.com/serhii-londar/open-source-mac-os-apps) - List of awesome open source applications for macOS.
*   [Awesome iOS Interview question list (⭐966)](https://github.com/dashvlas/awesome-ios-interview) - Guide for interviewers and interviewees. Review these iOS interview questions - and get some practical tips along the way.
*   [Top App Developers (⭐1.4k)](https://github.com/app-developers/top) - A list of top iOS app developers.

### Contributing and License / Collection View Layout

*   [See the guide (⭐41k)](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md)
...
*   [playcanvas-ar (⭐193)](https://github.com/playcanvas/playcanvas-ar) - Marker-based AR solution built on ARTollkit.
*   [playcanvas-p2.js (⭐20)](https://github.com/playcanvas/playcanvas-p2.js) - An integration with the p2.js 2D physics engine.
*   [playcanvas-spine (⭐38)](https://github.com/playcanvas/playcanvas-spine) - Spine plugin for PlayCanvas for 2D animations.
*   [playcanvas-tween (⭐44)](https://github.com/playcanvas/playcanvas-tween) - Officially supported tween animation plugin.
...
## [62. Awesome Speaking](/content/matteofigus/awesome-speaking/week/README.md)
...
## [63. Awesome Home Assistant](/content/frenck/awesome-home-assistant/week/README.md)
...
## [67. Awesome Rust](/content/rust-unofficial/awesome-rust/week/README.md)
...
## [68. Awesome Python Data Science](/content/krzjoa/awesome-python-data-science/week/README.md)
...
## [69. Awesome Sysadmin](/content/awesome-foss/awesome-sysadmin/week/README.md)
...
- Prev: [Nov 11 - Nov 17, 2019](/content/2019/45/README.md)
- Next: [Oct 28 - Nov 03, 2019](/content/2019/43/README.md)